 ...
 * @author Shai Almog
 */
public class NexWellStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "NexWell";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new NexWellStub());
    }
