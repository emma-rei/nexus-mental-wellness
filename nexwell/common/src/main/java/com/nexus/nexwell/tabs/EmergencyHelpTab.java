...
public class EmergencyHelpTab extends Form {

    public EmergencyHelpTab() {
        ...
        // The design of Emergency Help form for the iOS version follows a specific color pattern below
        // pattern is 12, 23, 31
