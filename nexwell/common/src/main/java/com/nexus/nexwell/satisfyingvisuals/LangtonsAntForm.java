...
import com.nexus.nexwell.satisfyingvisuals.Direction;
import com.nexus.nexwell.satisfyingvisuals.Ant;
...
public class LangtonsAntForm extends Form {
    ...
    public LangtonsAntForm() {
        ...
        getToolbar().addMaterialCommandToLeftBar("Back", FontImage.MATERIAL_ARROW_BACK_IOS_NEW, e -> current.showBack());
        addLongPressListener(e -> current.showBack());
