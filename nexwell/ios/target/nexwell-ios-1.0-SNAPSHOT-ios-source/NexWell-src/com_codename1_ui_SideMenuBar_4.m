...
JAVA_VOID com_codename1_ui_SideMenuBar_4_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_SideMenuBar_getCommandCount___R_int(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1401034827;
...
label_L1401034827:
    ...
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2009810220;
...
label_L1122661733:
    if (ilocals_2_>=virtual_com_codename1_ui_SideMenuBar_getCommandCount___R_int(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L571696027;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L740735495;
...
label_L740735495:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(74))==0) /* IFEQ CustomJump */ goto label_L1864744840;
...
label_L571696027:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$500___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Button(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2069678360;
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1655939830;

label_L2069678360:
    __CN1_DEBUG_INFO(357);
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject));
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L539531479;
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L539531479;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L829985002;
...
label_L1655939830:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject));
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1403664574;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1403664574;
    PUSH_INT(1); /* ICONST_1 */
...
label_L745642964:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject));
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1110103522;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_events_ActionEvent_getX___R_int(threadStateData, locals[1].data.o);
    PUSH_INT(tmpResult); }
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1110103522;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1654999368:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_sideSwipePotential(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1615389290;
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$300___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1615389290;
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$400___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1354314579;
...
label_L1615389290:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1354314579;
    if (virtual_com_codename1_ui_Component_shouldBlockSideSwipe___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1354314579;
