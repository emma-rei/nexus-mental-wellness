...
JAVA_VOID com_codename1_ui_SideMenuBar_4_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_ui_SideMenuBar_getCommandCount___R_int(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1310865036;
...
label_L1310865036:
    ...
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1092407638;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1092407638;
...
label_L1190941229:
    if (ilocals_2_>=virtual_com_codename1_ui_SideMenuBar_getCommandCount___R_int(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1014435252;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1040477753;
...
label_L1040477753:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(74))==0) /* IFEQ CustomJump */ goto label_L1640868131;
...
label_L1014435252:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$500___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Button(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1113783787;
    if (virtual_com_codename1_ui_SideMenuBar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1594500664;
...
label_L1113783787:
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1401034827;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1594500664:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L571696027;
    __CN1_DEBUG_INFO(360);
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject));
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L740735495;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L740735495;
    PUSH_INT(1); /* ICONST_1 */
...
label_L571696027:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject));
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1122661733;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_events_ActionEvent_getX___R_int(threadStateData, locals[1].data.o);
    PUSH_INT(tmpResult); }
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1122661733;
    PUSH_INT(1); /* ICONST_1 */
...
label_L2069678360:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_sideSwipePotential(get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1655939830;
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$300___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1655939830;
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$400___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_4_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L539531479;
...
label_L1655939830:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L539531479;
    if (virtual_com_codename1_ui_Component_shouldBlockSideSwipe___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L539531479;
