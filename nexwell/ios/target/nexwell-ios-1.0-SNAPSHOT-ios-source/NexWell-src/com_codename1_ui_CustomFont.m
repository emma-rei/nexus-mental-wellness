...
JAVA_OBJECT com_codename1_ui_CustomFont_getImageArray___R_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_CustomFont_imageArrayRef(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L116606935;
    __CN1_DEBUG_INFO(71);
...
label_L1544765522:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1500820019;
...
JAVA_INT com_codename1_ui_CustomFont_charWidth___char_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1) {
    ...
    if (ilocals_2_>=0) /* IFGE CustomJump */ goto label_L1776180205;
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_get___java_lang_Object_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject), locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1963943166;
...
label_L1963943166:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L160867654;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(143);
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1338074614;
    __CN1_DEBUG_INFO(144);
    set_field_com_codename1_ui_CustomFont_cache(threadStateData, locals[5].data.o, __cn1ThisObject);
    __CN1_DEBUG_INFO(145);
    if (virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L1415274192;
...
label_L160867654:
    ...
    if (virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_ui_CustomFont_colorCache(__cn1ThisObject))<=5 /* ICONST_5 */) /* IF_ICMPLE CustomJump */ goto label_L1518204977;
...
JAVA_VOID com_codename1_ui_CustomFont_initColor___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (ilocals_2_==get_field_com_codename1_ui_CustomFont_color(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L1719519917;
    if (/* CustomInvoke */com_codename1_ui_CustomFont_checkCacheCurrentColor___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_2_)!=0) /* IFNE CustomJump */ goto label_L1719519917;
...
label_L745835029:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L584580417;
...
label_L72423389:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L291359466;
    __CN1_DEBUG_INFO(209);
    /* VarOp.assignFrom */ ilocals_5_=(BC_ISHR_EXPR(CN1_ARRAY_ELEMENT_INT(locals[2].data.o, ilocals_4_), 24) & 255);
    __CN1_DEBUG_INFO(210);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L217911413;
...
label_L1823354445:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L2000779038;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L137685382;
...
label_L2000779038:
    ...
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1615668218;
    if ((ilocals_6_ + ilocals_8_)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1615668218;
...
label_L663083782:
    if (ilocals_11_>=ilocals_10_) /* IF_ICMPGE CustomJump */ goto label_L1615668218;
    ...
    if (ilocals_12_>=0) /* IFGE CustomJump */ goto label_L482885994;
    __CN1_DEBUG_INFO(249);
    goto label_L857732012;
...
label_L482885994:
    ...
    if (virtual_com_codename1_ui_Graphics_getClipWidth___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L777940932;
    if (virtual_com_codename1_ui_Graphics_getClipHeight___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L777940932;
...
label_L180017308:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1002872041;
...
JAVA_INT com_codename1_ui_CustomFont_stringWidth___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1613729684;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1112569408;
...
JAVA_BOOLEAN com_codename1_ui_CustomFont_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L1308527415;
    __CN1_DEBUG_INFO(372);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1308527415:
    __CN1_DEBUG_INFO(374);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L299684908;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L299684908;
    __CN1_DEBUG_INFO(375);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(376);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_CustomFont_charsets(__cn1ThisObject), get_field_com_codename1_ui_CustomFont_charsets(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L299684908;
...
label_L1974379194:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L219396780;
    __CN1_DEBUG_INFO(379);
    if (CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(__cn1ThisObject), ilocals_4_)==CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_CustomFont_cutOffsets(locals[2].data.o), ilocals_4_)) /* IF_ICMPEQ CustomJump */ goto label_L1278226232;
