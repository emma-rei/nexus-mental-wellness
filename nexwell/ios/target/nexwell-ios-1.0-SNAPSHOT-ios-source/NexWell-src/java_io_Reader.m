...
JAVA_INT java_io_Reader_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL149587946501;
    int tryBlockOffsetL149587946501;
    DEFINE_CATCH_BLOCK(catch_L149587946501, label_L260084831, restoreToL149587946501);
...
label_L1495879465:
 tryBlockOffsetL149587946501 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L149587946501);
    restoreToL149587946501 = threadStateData->threadObjectStackOffset;
...
JAVA_LONG java_io_Reader_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    int restoreToL191120026901;
    int tryBlockOffsetL191120026901;
    DEFINE_CATCH_BLOCK(catch_L191120026901, label_L598357562, restoreToL191120026901);
...
label_L1911200269:
 tryBlockOffsetL191120026901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L191120026901);
    restoreToL191120026901 = threadStateData->threadObjectStackOffset;
