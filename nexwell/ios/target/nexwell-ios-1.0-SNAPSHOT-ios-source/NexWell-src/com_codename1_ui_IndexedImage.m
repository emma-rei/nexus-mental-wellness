...
JAVA_VOID com_codename1_ui_IndexedImage_initOpaque__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_IndexedImage_palette(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1389808948;
    __CN1_DEBUG_INFO(72);
...
label_L1680365850:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1901945192;
    __CN1_DEBUG_INFO(74);
    if ((CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_IndexedImage_palette(__cn1ThisObject), ilocals_2_) & -16777216)==-16777216) /* IF_ICMPEQ CustomJump */ goto label_L666040998;
    __CN1_DEBUG_INFO(75);
...
label_L711483066:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L448782465;
    __CN1_DEBUG_INFO(99);
...
label_L1973491942:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L204354148;
    __CN1_DEBUG_INFO(113);
    if (ilocals_1_!=CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_IndexedImage_palette(__cn1ThisObject), ilocals_3_)) /* IF_ICMPNE CustomJump */ goto label_L276777344;
...
label_L1611966906:
    if (ilocals_8_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L492045670;
...
label_L1242874959:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L181260145;
    __CN1_DEBUG_INFO(163);
    if ((CN1_ARRAY_ELEMENT_INT(get_field_com_codename1_ui_IndexedImage_palette(__cn1ThisObject), ilocals_5_) & -16777216)==0) /* IFEQ CustomJump */ goto label_L2010546406;
...
label_L1150480094:
    if (ilocals_8_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L252247502;
...
label_L684220724:
    if (ilocals_10_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1809456409;
...
JAVA_VOID com_codename1_ui_IndexedImage_drawImage___com_codename1_ui_Graphics_java_lang_Object_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    if (get_static_com_codename1_ui_IndexedImage_lineCache(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L377957453;
    if (CN1_ARRAY_LENGTH(get_static_com_codename1_ui_IndexedImage_lineCache(threadStateData))>=(get_field_com_codename1_ui_IndexedImage_width(__cn1ThisObject) * 3 /* ICONST_3 */)) /* IF_ICMPGE CustomJump */ goto label_L1730129134;
...
label_L1730129134:
    ...
    if (ilocals_5_<=ilocals_4_) /* IF_ICMPLE CustomJump */ goto label_L1185502159;
    __CN1_DEBUG_INFO(286);
    /* VarOp.assignFrom */ ilocals_7_=(ilocals_5_ - ilocals_4_);

label_L1185502159:
    __CN1_DEBUG_INFO(288);
    if (ilocals_6_>=(ilocals_4_ + get_field_com_codename1_ui_IndexedImage_height(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L357291163;
...
label_L1744579245:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L973174587;
...
label_L744021169:
    if (ilocals_13_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L551797833;
...
JAVA_OBJECT com_codename1_ui_IndexedImage_scaled___int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L1458905542;
    if (ilocals_4_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1458905542;
...
JAVA_OBJECT com_codename1_ui_IndexedImage_scaleArray___byte_1ARRAY_int_int_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (ilocals_4_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1745512157;
    if (ilocals_5_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L1745512157;
...
label_L777236628:
    if (ilocals_11_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L48071225;
...
label_L1081159401:
    if (ilocals_13_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L74606989;
    ...
    if (ilocals_15_<0) /* IFLT CustomJump */ goto label_L2071364564;
    if (ilocals_15_>=CN1_ARRAY_LENGTH(locals[6].data.o)) /* IF_ICMPGE CustomJump */ goto label_L2071364564;
    if (ilocals_16_<0) /* IFLT CustomJump */ goto label_L2071364564;
    if (ilocals_16_>=CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L2071364564;
...
label_L1994249754:
    if (ilocals_3_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L972720850;
...
JAVA_OBJECT com_codename1_ui_IndexedImage_toByteArray___R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL624454288cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL624454288cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L624454288cn1_class_id_java_io_IOException1, label_L1066575950, restoreToL624454288cn1_class_id_java_io_IOException1);

label_L624454288:
 tryBlockOffsetL624454288cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L624454288cn1_class_id_java_io_IOException1);
    restoreToL624454288cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
label_L1631047534:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L217479224, 1);
