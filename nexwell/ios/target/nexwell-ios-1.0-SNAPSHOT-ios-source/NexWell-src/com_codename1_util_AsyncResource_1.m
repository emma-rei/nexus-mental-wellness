...
JAVA_VOID com_codename1_util_AsyncResource_1_update___java_util_Observable_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL63062995201;
    int tryBlockOffsetL63062995201;
    DEFINE_CATCH_BLOCK(catch_L63062995201, label_L482877089, restoreToL63062995201);
    int restoreToL48287708902;
    int tryBlockOffsetL48287708902;
    DEFINE_CATCH_BLOCK(catch_L48287708902, label_L482877089, restoreToL48287708902);
    __CN1_DEBUG_INFO(140);
    if (virtual_com_codename1_util_AsyncResource_isDone___R_boolean(threadStateData, get_field_com_codename1_util_AsyncResource_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1559346131, 0);
...
label_L630629952:
 tryBlockOffsetL63062995201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L63062995201);
    restoreToL63062995201 = threadStateData->threadObjectStackOffset;
...
label_L2095996719:
END_TRY(1);    JUMP_TO(label_L1559346131, 0);

label_L482877089:
 tryBlockOffsetL48287708902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L48287708902);
    restoreToL48287708902 = threadStateData->threadObjectStackOffset;
