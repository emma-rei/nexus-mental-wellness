...
JAVA_VOID com_codename1_ui_Container_1___INIT_____com_codename1_ui_Container_com_codename1_ui_layouts_Layout_java_lang_Object_com_codename1_ui_Container_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 3402, 202);
...
JAVA_VOID com_codename1_ui_Container_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 3402, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(303);
    if (get_field_com_codename1_ui_Container_1_val_parentLayout(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1933808172;
...
label_L1933808172:
    ...
    if (get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1382756158;
...
label_L1011920203:
    if (ilocals_2_>=virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, get_field_com_codename1_ui_Container_1_val_oldParent(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1865289764;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[3].data.o, get_field_com_codename1_ui_Container_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1399691256;
...
label_L1865289764:
    ...
    if (ilocals_1_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L927557408;
    __CN1_DEBUG_INFO(320);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3403));     SP -= 1;
