...
JAVA_OBJECT com_codename1_io_CacheMap_getStorageCacheContent___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheContentVec(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1489854600;
    __CN1_DEBUG_INFO(57);
    BC_ALOAD(0);
...
JAVA_VOID com_codename1_io_CacheMap_put___java_lang_Object_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_io_CacheMap_cacheSize(__cn1ThisObject)>virtual_java_util_Hashtable_size___R_int(threadStateData, get_field_com_codename1_io_CacheMap_memoryCache(__cn1ThisObject))) /* IF_ICMPGT CustomJump */ goto label_L1151821341;
...
label_L1080187590:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L484124683;
    ...
    if (CN1_CMP_EXPR(llocals_10_, llocals_4_)<=0) /* IFLE CustomJump */ goto label_L217103506;
    if (locals[7].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1066026148;
...
label_L1151821341:
    ...
    if (get_field_com_codename1_io_CacheMap_alwaysStore(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L87865777;
...
label_L856000892:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L203526568;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[5].data.o, 1 /* ICONST_1 */), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1642286060;
...
JAVA_OBJECT com_codename1_io_CacheMap_get___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1402232732;
...
label_L1402232732:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1404582039;
...
label_L1404582039:
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L687842599;
...
label_L1423553082:
    if (ilocals_5_>=virtual_java_util_Vector_size___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L687842599;
    ...
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(locals[6].data.o, 1 /* ICONST_1 */), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L925800237;
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1178027755;
...
JAVA_VOID com_codename1_io_CacheMap_placeInStorageCache___java_lang_Object_long_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_LONG __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L22733595;
...
label_L656650448:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1116642274;
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(226);
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[9].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1047698758;
...
label_L1047698758:
    __CN1_DEBUG_INFO(223);
    BC_IINC(7, 1);
    goto label_L656650448;

label_L1116642274:
    __CN1_DEBUG_INFO(233);
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[5].data.o)>=get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1899482388;
...
label_L418223232:
    if (ilocals_10_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1843541066;
    ...
    if (CN1_CMP_EXPR(llocals_7_, llocals_12_)<=0) /* IFLE CustomJump */ goto label_L1467853846;
...
JAVA_VOID com_codename1_io_CacheMap_placeInStorageCache___int_java_lang_Object_long_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_LONG __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[8].data.o)<=ilocals_1_) /* IF_ICMPLE CustomJump */ goto label_L1605393415;
...
JAVA_VOID com_codename1_io_CacheMap_clearStorageCache__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_CacheMap_storageCacheSize(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1788841007;
