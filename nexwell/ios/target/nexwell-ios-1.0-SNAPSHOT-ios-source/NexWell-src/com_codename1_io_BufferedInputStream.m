...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(139);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L157567214;
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(151);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1498452883;
...
JAVA_VOID com_codename1_io_BufferedInputStream___INIT_____java_io_InputStream_int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (ilocals_2_>0) /* IFGT CustomJump */ goto label_L493732536;
...
JAVA_VOID com_codename1_io_BufferedInputStream_fill__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L2126991912;
    __CN1_DEBUG_INFO(232);
    set_field_com_codename1_io_BufferedInputStream_pos(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    goto label_L1439651366;

label_L2126991912:
    __CN1_DEBUG_INFO(233);
    if (get_field_com_codename1_io_BufferedInputStream_pos(__cn1ThisObject)<CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_IMPLT CustomJump */ goto label_L1439651366;
    __CN1_DEBUG_INFO(234);
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L148802311;
...
label_L148802311:
    if (CN1_ARRAY_LENGTH(locals[1].data.o)<get_field_com_codename1_io_BufferedInputStream_marklimit(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L2069229734;
...
label_L2069229734:
    ...
    if (ilocals_2_<=get_field_com_codename1_io_BufferedInputStream_marklimit(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1070050294;
...
label_L1070050294:
    ...
    if (locals[1].data.o==get_field_com_codename1_io_BufferedInputStream_buf(__cn1ThisObject)) /* IF_ACMPEQ CustomJump */ goto label_L269923406;
...
label_L1439651366:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_actualAvailable(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1819055096;
...
label_L1819055096:
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L954764819;
    ...
    goto label_L980552419;

label_L954764819:
    __CN1_DEBUG_INFO(265);
    if (ilocals_3_>=0) /* IFGE CustomJump */ goto label_L980552419;
...
JAVA_INT com_codename1_io_BufferedInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L535002407;
...
label_L535002407:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L387505776;
    ...
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1811698326;
    if (ilocals_1_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1811698326;
...
label_L387505776:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_pos(__cn1ThisObject)<get_field_com_codename1_io_BufferedInputStream_count(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1098082328;
...
label_L1098082328:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1165836116;
...
JAVA_VOID com_codename1_io_BufferedInputStream_fireProgress__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_progressListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L340234965;
...
JAVA_INT com_codename1_io_BufferedInputStream_read1___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (ilocals_4_>0) /* IFGT CustomJump */ goto label_L497424937;
    ...
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1204785709;
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1204785709;
    ...
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L1801753119;
    __CN1_DEBUG_INFO(340);
    set_field_com_codename1_io_BufferedInputStream_actualAvailable(threadStateData, -1 /* ICONST_M1 */, __cn1ThisObject);
    goto label_L1134388380;

label_L1801753119:
    __CN1_DEBUG_INFO(342);
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1134388380;
...
label_L497424937:
    ...
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1850169748;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
...
label_L1436741771:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L446264394;
...
JAVA_VOID com_codename1_io_BufferedInputStream_yieldTime__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1456587289cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1456587289cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1456587289cn1_class_id_java_lang_InterruptedException1, label_L839404033, restoreToL1456587289cn1_class_id_java_lang_InterruptedException1);
    __CN1_DEBUG_INFO(364);
    /* VarOp.assignFrom */ llocals_1_ = java_lang_System_currentTimeMillis___R_long(threadStateData);
    __CN1_DEBUG_INFO(365);
    if (CN1_CMP_EXPR((llocals_1_ - get_field_com_codename1_io_BufferedInputStream_elapsedSinceLastYield(__cn1ThisObject)), 300LL)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1725382189, 0);

label_L1456587289:
 tryBlockOffsetL1456587289cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1456587289cn1_class_id_java_lang_InterruptedException1);
    restoreToL1456587289cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
JAVA_INT com_codename1_io_BufferedInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1977202492;
...
label_L99722180:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1510527745;
    ...
    if (ilocals_4_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1675886984;
    __CN1_DEBUG_INFO(423);
    if (get_field_com_codename1_io_BufferedInputStream_printInput(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1530669727;
...
label_L1510527745:
    ...
    if ((((ilocals_2_ | ilocals_3_) | (ilocals_2_ + ilocals_3_)) | (CN1_ARRAY_LENGTH(locals[1].data.o) - (ilocals_2_ + ilocals_3_)))>=0) /* IFGE CustomJump */ goto label_L1398492607;
...
label_L1398492607:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1331108878;
...
label_L528042460:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_stopped(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L209501229;
...
label_L209501229:
    ...
    if (ilocals_5_>0) /* IFGT CustomJump */ goto label_L917379055;
    __CN1_DEBUG_INFO(447);
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1066504752;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
...
label_L917379055:
    ...
    if (ilocals_4_<ilocals_3_) /* IF_IMPLT CustomJump */ goto label_L1735554279;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(456);
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1421965867;
    if (com_codename1_io_BufferedInputStream_superAvailable___R_int(threadStateData, __cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L1421965867;
    __CN1_DEBUG_INFO(457);
    goto label_L556080707;

label_L1421965867:
    __CN1_DEBUG_INFO(459);
    if (get_field_com_codename1_io_BufferedInputStream_yield(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L371694173;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L371694173;
...
label_L556080707:
    ...
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L1809367960;
...
JAVA_LONG com_codename1_io_BufferedInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L882371818;
...
label_L882371818:
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L508067159;
...
label_L508067159:
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L1261105387;
    __CN1_DEBUG_INFO(496);
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1724067349;
...
label_L1261105387:
    ...
    if (CN1_CMP_EXPR(llocals_3_, llocals_1_)>=0) /* IFGE CustomJump */ goto label_L1832418971;
    BC_LLOAD(3);
    goto label_L809960622;
...
JAVA_INT com_codename1_io_BufferedInputStream_available___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_disableBuffering(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L745932773;
...
JAVA_VOID com_codename1_io_BufferedInputStream_reset__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_markpos(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1396320248;
...
JAVA_INT com_codename1_io_BufferedInputStream_superAvailable___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL412520498cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL412520498cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L412520498cn1_class_id_java_io_IOException1, label_L2111326114, restoreToL412520498cn1_class_id_java_io_IOException1);
    int restoreToL1974623939cn1_class_id_java_io_IOException2;
    int tryBlockOffsetL1974623939cn1_class_id_java_io_IOException2;
    DEFINE_CATCH_BLOCK(catch_L1974623939cn1_class_id_java_io_IOException2, label_L2111326114, restoreToL1974623939cn1_class_id_java_io_IOException2);

label_L412520498:
 tryBlockOffsetL412520498cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L412520498cn1_class_id_java_io_IOException1);
    restoreToL412520498cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(592);
    if (get_field_com_codename1_io_BufferedInputStream_actualAvailable(__cn1ThisObject)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1974623939, 0);
...
label_L1974623939:
 tryBlockOffsetL1974623939cn1_class_id_java_io_IOException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1974623939cn1_class_id_java_io_IOException2);
    restoreToL1974623939cn1_class_id_java_io_IOException2 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_io_BufferedInputStream_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_BufferedInputStream_closed(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1776760511;
...
label_L1776760511:
    ...
    if (get_field_com_codename1_io_BufferedInputStream_connection(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1801509276;
...
label_L1801509276:
    ...
    BC_DUP(); /* DUP */
    BC_ASTORE(1);
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1413117445;
    __CN1_DEBUG_INFO(624);
    if (get_field_com_codename1_io_BufferedInputStream_buf(__cn1ThisObject)!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L1801509276;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(627);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L865697287;
