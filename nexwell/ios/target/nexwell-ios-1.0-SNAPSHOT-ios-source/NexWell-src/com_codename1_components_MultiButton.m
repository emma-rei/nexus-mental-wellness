...
JAVA_VOID com_codename1_components_MultiButton___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L366015139;
...
JAVA_VOID com_codename1_components_MultiButton_setCheckBox___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_==virtual_com_codename1_components_MultiButton_isCheckBox___R_boolean(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L363364283;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(169);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1838333871;
...
label_L170113387:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1118775671;
    __CN1_DEBUG_INFO(178);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 

label_L346866494:
    if (ilocals_5_>=virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1118775671;
    ...
    __CN1_DEBUG_INFO(178);
    BC_IINC(5, 1);
    goto label_L346866494;

label_L1118775671:
    __CN1_DEBUG_INFO(182);
    if (virtual_com_codename1_ui_Button_getCommand___R_com_codename1_ui_Command(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1824225731;
...
label_L1824225731:
    ...
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2076470750;
...
JAVA_VOID com_codename1_components_MultiButton_setRadioButton___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_==virtual_com_codename1_components_MultiButton_isRadioButton___R_boolean(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L1083905856;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(307);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L853313886;
    ...
    if (get_field_com_codename1_components_MultiButton_group(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L94280615;
...
label_L94280615:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1567403095;
    __CN1_DEBUG_INFO(319);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 

label_L1163235757:
    if (ilocals_5_>=virtual_java_util_List_size___R_int(threadStateData, locals[4].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1567403095;
...
label_L1567403095:
    ...
    if (virtual_com_codename1_ui_Button_getCommand___R_com_codename1_ui_Command(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L320173600;
...
JAVA_BOOLEAN com_codename1_components_MultiButton_isSelected___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    PUSH_POINTER(get_field_com_codename1_components_MultiButton_emblem(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_RadioButton);
    if(POP_INT() != 0) /* IFNE */ goto label_L1655145542;
    PUSH_POINTER(get_field_com_codename1_components_MultiButton_emblem(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_CheckBox);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1519489617;

label_L1655145542:
    if (virtual_com_codename1_ui_Button_isSelected___R_boolean(threadStateData, get_field_com_codename1_components_MultiButton_emblem(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1519489617;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_components_MultiButton_setSelected___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    PUSH_POINTER(get_field_com_codename1_components_MultiButton_emblem(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_RadioButton);
    if(POP_INT() == 0) /* IFEQ */ goto label_L188513397;
...
JAVA_VOID com_codename1_components_MultiButton_setHorizontalLayout___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (virtual_com_codename1_components_MultiButton_isHorizontalLayout___R_boolean(threadStateData, __cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L53632791;
    __CN1_DEBUG_INFO(374);
    if (virtual_com_codename1_components_MultiButton_isHorizontalLayout___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L904281382;
...
label_L904281382:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1565597755;
...
JAVA_VOID com_codename1_components_MultiButton_setInvertFirstTwoEntries___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_==get_field_com_codename1_components_MultiButton_invert(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L851339053;
    __CN1_DEBUG_INFO(407);
    set_field_com_codename1_components_MultiButton_invert(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(408);
    if (virtual_com_codename1_components_MultiButton_isHorizontalLayout___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L851339053;
    ...
    if (get_field_com_codename1_components_MultiButton_invert(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L602229898;
...
JAVA_VOID com_codename1_components_MultiButton_setIconPosition___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L661543645;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L661543645;
...
JAVA_VOID com_codename1_components_MultiButton_setEmblemPosition___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L841773244;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L841773244;
...
JAVA_OBJECT com_codename1_components_MultiButton_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4326))==0) /* IFEQ CustomJump */ goto label_L1567808902;
...
label_L1567808902:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4327))==0) /* IFEQ CustomJump */ goto label_L1894080751;
...
label_L1894080751:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4328))==0) /* IFEQ CustomJump */ goto label_L1998750048;
...
label_L1998750048:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4329))==0) /* IFEQ CustomJump */ goto label_L435857884;
...
label_L435857884:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4330))==0) /* IFEQ CustomJump */ goto label_L1378863496;
...
label_L1378863496:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4331))==0) /* IFEQ CustomJump */ goto label_L160835898;
...
label_L160835898:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4332))==0) /* IFEQ CustomJump */ goto label_L1792839913;
...
label_L1792839913:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4333))==0) /* IFEQ CustomJump */ goto label_L639922215;
...
label_L639922215:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4334))==0) /* IFEQ CustomJump */ goto label_L183209698;
...
label_L183209698:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4335))==0) /* IFEQ CustomJump */ goto label_L839690620;
...
label_L839690620:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4336))==0) /* IFEQ CustomJump */ goto label_L1012476940;
...
label_L1012476940:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4337))==0) /* IFEQ CustomJump */ goto label_L964282088;
...
label_L964282088:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4272))==0) /* IFEQ CustomJump */ goto label_L1874056123;
...
label_L1874056123:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4338))==0) /* IFEQ CustomJump */ goto label_L950255736;
...
label_L950255736:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4339))==0) /* IFEQ CustomJump */ goto label_L1299161644;
...
label_L1299161644:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4340))==0) /* IFEQ CustomJump */ goto label_L978740207;
...
label_L978740207:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4273))==0) /* IFEQ CustomJump */ goto label_L1258897685;
...
label_L1258897685:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4341))==0) /* IFEQ CustomJump */ goto label_L1829758988;
...
label_L1829758988:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4342))==0) /* IFEQ CustomJump */ goto label_L1564559683;
...
label_L1564559683:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4343))==0) /* IFEQ CustomJump */ goto label_L1417740319;
...
label_L1417740319:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4344))==0) /* IFEQ CustomJump */ goto label_L1434575475;
    __CN1_DEBUG_INFO(1009);
    if (virtual_com_codename1_components_MultiButton_isHorizontalLayout___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1197223751;
...
label_L1434575475:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4345))==0) /* IFEQ CustomJump */ goto label_L276852158;
    __CN1_DEBUG_INFO(1015);
    if (virtual_com_codename1_components_MultiButton_isInvertFirstTwoEntries___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1281168969;
...
label_L276852158:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4346))==0) /* IFEQ CustomJump */ goto label_L378927051;
    __CN1_DEBUG_INFO(1021);
    if (virtual_com_codename1_components_MultiButton_isCheckBox___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L815121481;
...
label_L378927051:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4347))==0) /* IFEQ CustomJump */ goto label_L594260600;
    __CN1_DEBUG_INFO(1027);
    if (virtual_com_codename1_components_MultiButton_isRadioButton___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L119539458;
...
label_L594260600:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4075))==0) /* IFEQ CustomJump */ goto label_L1051890562;
...
label_L1051890562:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4348))==0) /* IFEQ CustomJump */ goto label_L547073937;
    __CN1_DEBUG_INFO(1036);
    if (virtual_com_codename1_components_MultiButton_isSelected___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1578971528;
...
label_L547073937:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4233))==0) /* IFEQ CustomJump */ goto label_L1501701470;
...
JAVA_OBJECT com_codename1_components_MultiButton_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4326))==0) /* IFEQ CustomJump */ goto label_L1929806703;
...
label_L1929806703:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4327))==0) /* IFEQ CustomJump */ goto label_L245128633;
...
label_L245128633:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4328))==0) /* IFEQ CustomJump */ goto label_L960146579;
...
label_L960146579:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4329))==0) /* IFEQ CustomJump */ goto label_L1910163007;
...
label_L1910163007:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4330))==0) /* IFEQ CustomJump */ goto label_L905985680;
...
label_L905985680:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4331))==0) /* IFEQ CustomJump */ goto label_L1511906428;
...
label_L1511906428:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4332))==0) /* IFEQ CustomJump */ goto label_L909098392;
...
label_L909098392:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4333))==0) /* IFEQ CustomJump */ goto label_L300117596;
...
label_L300117596:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4334))==0) /* IFEQ CustomJump */ goto label_L639641166;
...
label_L639641166:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4335))==0) /* IFEQ CustomJump */ goto label_L308994250;
...
label_L308994250:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4336))==0) /* IFEQ CustomJump */ goto label_L1508002914;
...
label_L1508002914:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4337))==0) /* IFEQ CustomJump */ goto label_L1400457356;
...
label_L1400457356:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4272))==0) /* IFEQ CustomJump */ goto label_L1951143675;
...
label_L1951143675:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4339))==0) /* IFEQ CustomJump */ goto label_L837145608;
...
label_L837145608:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4338))==0) /* IFEQ CustomJump */ goto label_L2058293002;
...
label_L2058293002:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4340))==0) /* IFEQ CustomJump */ goto label_L1670055419;
...
label_L1670055419:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4273))==0) /* IFEQ CustomJump */ goto label_L2011442367;
...
label_L2011442367:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4342))==0) /* IFEQ CustomJump */ goto label_L1757344735;
...
label_L1757344735:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4341))==0) /* IFEQ CustomJump */ goto label_L1793816221;
...
label_L1793816221:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4343))==0) /* IFEQ CustomJump */ goto label_L1374950118;
...
label_L1374950118:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4344))==0) /* IFEQ CustomJump */ goto label_L119754163;
...
label_L119754163:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4345))==0) /* IFEQ CustomJump */ goto label_L412903043;
...
label_L412903043:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4346))==0) /* IFEQ CustomJump */ goto label_L695383187;
...
label_L695383187:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4347))==0) /* IFEQ CustomJump */ goto label_L1491136633;
...
label_L1491136633:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4075))==0) /* IFEQ CustomJump */ goto label_L1169387523;
...
label_L1169387523:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4348))==0) /* IFEQ CustomJump */ goto label_L1046527560;
...
label_L1046527560:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4233))==0) /* IFEQ CustomJump */ goto label_L34231099;
...
JAVA_VOID com_codename1_components_MultiButton_setGroup___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    PUSH_POINTER(get_field_com_codename1_components_MultiButton_emblem(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_RadioButton);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1572210747;
...
JAVA_VOID com_codename1_components_MultiButton_setGap___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_1_==get_field_com_codename1_components_MultiButton_gap(__cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L64702694;
...
JAVA_VOID com_codename1_components_MultiButton_setTextPosition___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L955397163;
        case 1: goto label_L1748052869;
        case 2: goto label_L95093096;
        case 3: goto label_L1550771523;
        default: goto label_L1972687241;
    }
...
JAVA_INT com_codename1_components_MultiButton_getTextPosition___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(62), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1239761431;
    __CN1_DEBUG_INFO(1283);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 2 /* ICONST_2 */;

label_L1239761431:
    __CN1_DEBUG_INFO(1285);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(63), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1653273237;
    __CN1_DEBUG_INFO(1286);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1653273237:
    __CN1_DEBUG_INFO(1288);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(65), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L834764756;
    __CN1_DEBUG_INFO(1289);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L834764756:
    __CN1_DEBUG_INFO(1291);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(64), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1610949912;
...
JAVA_VOID com_codename1_components_MultiButton_updateGap__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_components_MultiButton_getIcon___R_com_codename1_ui_Image(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L59979509;
...
label_L59979509:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L213750932;
...
label_L213750932:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1163480574;
...
label_L1163480574:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1600651070;
...
typedef JAVA_VOID (*functionPtr_com_codename1_components_MultiButton_setVisible___boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1);

JAVA_VOID virtual_com_codename1_components_MultiButton_setVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_components_MultiButton_setVisible___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[37])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
typedef JAVA_VOID (*functionPtr_com_codename1_components_MultiButton_setHidden___boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1);

JAVA_VOID virtual_com_codename1_components_MultiButton_setHidden___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_components_MultiButton_setHidden___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[319])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_components_MultiButton_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_components_MultiButton_addActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[405])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_components_MultiButton_setGap___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_components_MultiButton_setGap___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[409])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
