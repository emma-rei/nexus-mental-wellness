...
JAVA_VOID java_util_TimerTask___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3140, 202);
...
JAVA_VOID java_util_TimerTask_runImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 3140, 1163);
    ...
    if (CN1_CMP_EXPR(get_field_java_util_TimerTask_initialDelay(__cn1ThisObject), 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1241569743;
    /* CustomInvoke */java_lang_Thread_sleep___long(threadStateData, get_field_java_util_TimerTask_initialDelay(__cn1ThisObject)); 

label_L1241569743:
    if (get_field_java_util_TimerTask_canceled(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1731656333;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;

label_L1731656333:
    if (get_field_java_util_TimerTask_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1384210339;
    if (get_field_java_util_Timer_canceled(get_field_java_util_TimerTask_parent(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1384210339;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;

label_L1384210339:
    virtual_java_util_TimerTask_run__(threadStateData, __cn1ThisObject); 
    if (CN1_CMP_EXPR(get_field_java_util_TimerTask_repeatDelay(__cn1ThisObject), 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1345401730;

label_L1275143523:
    if (get_field_java_util_TimerTask_canceled(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1345401730;
    /* CustomInvoke */java_lang_Thread_sleep___long(threadStateData, get_field_java_util_TimerTask_repeatDelay(__cn1ThisObject)); 
    if (get_field_java_util_TimerTask_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L481511146;
    if (get_field_java_util_Timer_canceled(get_field_java_util_TimerTask_parent(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L481511146;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
