...
struct clazz class__com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1 = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1 ,0 , &__GC_MARK_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1,  0, cn1_class_id_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1, "com.nexus.nexwell.forms.EmergencyHelpForm..Lambda.1", 0, 0, 0, JAVA_FALSE, &class__java_lang_Object, base_interfaces_for_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1, 1, &__NEW_INSTANCE_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1, 0
, 0, JAVA_TRUE, 0, 0, 0, 0};

JAVA_OBJECT STATIC_FIELD_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance = 0;
JAVA_OBJECT get_static_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(threadStateData);
     return STATIC_FIELD_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance;
}

void set_static_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1StaticVal) {
    __STATIC_INITIALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(threadStateData);
    STATIC_FIELD_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance = __cn1StaticVal;
}
...
JAVA_OBJECT __NEW_INSTANCE_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1), &class__com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1);
com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1___INIT____(threadStateData, o);
    return o;
}
...
JAVA_VOID com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10354, 201);
...
JAVA_VOID com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 10354, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* CustomInvoke */com_nexus_nexwell_forms_EmergencyHelpForm_lambda$new$0___com_codename1_ui_events_ActionEvent(threadStateData, locals[1].data.o); 
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}


JAVA_VOID com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(2, 0, 0, 10354, 859);
    PUSH_POINTER(__NEW_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    set_static_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance(threadStateData, PEEK_OBJ(1));
    SP--;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
JAVA_OBJECT com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_lambdaFactory$___R_com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 10354, 10185);
    PUSH_POINTER(get_static_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1_instance(threadStateData));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
...
void __STATIC_INITIALIZER_com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1(CODENAME_ONE_THREAD_STATE) {
    ...
    com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1___CLINIT____(threadStateData);
monitorExit(threadStateData, (JAVA_OBJECT)&class__com_nexus_nexwell_forms_EmergencyHelpForm__Lambda_1);
