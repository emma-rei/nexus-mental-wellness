...
JAVA_VOID com_codename1_ui_animations_BubbleTransition___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7200, 202);
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7200, 202);
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition___INIT_____int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* duration */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7200, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_setComponentName___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7200, 7201);
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_initTransition__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 12, 0, 7200, 1375);
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L1155317988;
    if (ilocals_4_>0) /* IFGT CustomJump */ goto label_L555019034;
...
label_L555019034:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2119255170;
...
label_L2119255170:
    ...
    PUSH_OBJ(tmpResult); }
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1009195400;
...
label_L1009195400:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L988637485;
...
label_L509489479:
    ...
    BC_ALOAD(8);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1324113830;
...
label_L1324113830:
    ...
    BC_ALOAD(9);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L559389493;
...
label_L559389493:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originSrc(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L632831438;
...
label_L632831438:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1483799557;
...
JAVA_BOOLEAN com_codename1_ui_animations_BubbleTransition_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7200, 1588);
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_originSrc(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1172527629;
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L567367986;
...
label_L567367986:
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_animations_BubbleTransition_clipMotion(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L963036793;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_getBubbleShape___R_com_codename1_ui_geom_GeneralPath(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7200, 7202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(198);
    if (get_field_com_codename1_ui_animations_BubbleTransition_bubbleShape(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L960858222;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(13, 8, 0, 7200, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(212);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L309747389;
    BC_ALOAD(3);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Form);
    if(POP_INT() != 0) /* IFNE */ goto label_L497813380;

label_L309747389:
    if (get_field_com_codename1_ui_animations_BubbleTransition_originDest(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L922985472;
...
label_L922985472:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L571497590;
...
label_L571497590:
    ...
    if (get_field_com_codename1_ui_animations_BubbleTransition_roundBubble(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L36924735;
    if (virtual_com_codename1_ui_Graphics_isShapeClipSupported___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L36924735;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_setRoundBubble___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7200, 7203);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_createMutableImage___int_int_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7200, 304);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 7200, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_paint___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_BOOLEAN __cn1Arg5) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 10, 0, 7200, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1431782037;
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_cleanup__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7200, 1726);
...
JAVA_VOID com_codename1_ui_animations_BubbleTransition_drawDialogCmp___com_codename1_ui_Graphics_com_codename1_ui_Dialog(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 7200, 5459);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_Dialog_getCommandCount___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L1816626863;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1816626863;
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_getDialogParent___com_codename1_ui_Component_R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 7200, 5448);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_findByName___com_codename1_ui_Container_java_lang_String_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    __STATIC_INITIALIZER_com_codename1_ui_animations_BubbleTransition(threadStateData);
    DEFINE_METHOD_STACK(2, 6, 0, 7200, 7205);
...
label_L229014598:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1707510247;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L174730272;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[5].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L174730272;
...
label_L174730272:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1560607671;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1560607671;
...
JAVA_OBJECT com_codename1_ui_animations_BubbleTransition_copy___boolean_R_com_codename1_ui_animations_Transition(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 7200, 2241);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
