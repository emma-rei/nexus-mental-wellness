...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_print___java_util_List_int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(76);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L7511192;
    __CN1_DEBUG_INFO(77);
...
label_L7511192:
    ...
    BC_ASTORE(5);
    __CN1_DEBUG_INFO(81);
    if (ilocals_3_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L171022894;
    __CN1_DEBUG_INFO(82);
    BC_ALOAD(5);
...
label_L948025476:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1426061914;
    __CN1_DEBUG_INFO(88);
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L1081944577;
    __CN1_DEBUG_INFO(89);
...
label_L327662980:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1176189130;
    __CN1_DEBUG_INFO(92);
...
label_L293974199:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L766446793;
    __CN1_DEBUG_INFO(99);
    /* CustomInvoke */virtual_java_lang_StringBuffer_append___char_R_java_lang_StringBuffer(threadStateData, locals[5].data.o, 32); 
    __CN1_DEBUG_INFO(98);
    BC_IINC(4, 1);
    goto label_L293974199;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_toString___int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L247924517;
...
label_L247924517:
    ...
    if (ilocals_4_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L545448164;
...
label_L545448164:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L701379561;
    ...
    if (virtual_java_lang_StringBuffer_length___R_int(threadStateData, locals[6].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L528938970;
...
label_L1954828170:
    if (ilocals_3_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L739078297;
...
label_L701379561:
    ...
    if (virtual_java_lang_StringBuffer_length___R_int(threadStateData, locals[6].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L368191976;
...
label_L1553227495:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L368191976;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_valueToString___java_lang_Object_int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    ilocals_1_ = __cn1Arg2;
    ilocals_2_ = __cn1Arg3;
    int restoreToL1078290151cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL1078290151cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L1078290151cn1_class_id_java_lang_Exception1, label_L1369811130, restoreToL1078290151cn1_class_id_java_lang_Exception1);
    __CN1_DEBUG_INFO(212);
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L384537519, 0);
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[0].data.o, JAVA_NULL /* ACONST_NULL */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1078290151, 0);
...
label_L1078290151:
 tryBlockOffsetL1078290151cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L1078290151cn1_class_id_java_lang_Exception1);
    restoreToL1078290151cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(216);
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1054374766, 0);
...
label_L1111811191:
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L150499707, 0);
    BC_ALOAD(0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1667321053, 0);
...
label_L1667321053:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L513755348, 0);
...
label_L2073911340:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L816162189, 0);
...
label_L816162189:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1506480352, 0);
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_quote___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1031158501;
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L771404135;
...
label_L1383931873:
    if (ilocals_3_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L820961432;
    ...
    SP--;
    switch((*SP).data.i) {
        case 8: goto label_L824425077;
        case 9: goto label_L1032724390;
        case 10: goto label_L1166536953;
        case 12: goto label_L36315889;
        case 13: goto label_L779538643;
        case 34: goto label_L1674086804;
        case 47: goto label_L422751532;
        case 92: goto label_L1674086804;
        default: goto label_L1255946577;
    }
...
label_L1255946577:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2034284329;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_trimNumber___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 46)<=0) /* IFLE CustomJump */ goto label_L415977169;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 101)>=0) /* IFGE CustomJump */ goto label_L415977169;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[0].data.o, 69)>=0) /* IFGE CustomJump */ goto label_L415977169;

label_L1203756577:
    __CN1_DEBUG_INFO(342);
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1849))==0) /* IFEQ CustomJump */ goto label_L279697743;
...
label_L279697743:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_endsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(680))==0) /* IFEQ CustomJump */ goto label_L415977169;
...
JAVA_OBJECT com_codename1_processing_PrettyPrinter_numberToString___java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1653541174;
