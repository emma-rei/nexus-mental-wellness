...
JAVA_BOOLEAN com_codename1_ui_List_isDefaultIgnoreFocusComponentWhenUnfocused___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_List(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 4463, 4464);
...
JAVA_VOID com_codename1_ui_List_setDefaultIgnoreFocusComponentWhenUnfocused___boolean(CODENAME_ONE_THREAD_STATE, JAVA_BOOLEAN __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_List(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4463, 4465);
...
JAVA_VOID com_codename1_ui_List___INIT_____java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 4463, 201);
...
JAVA_VOID com_codename1_ui_List___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 4463, 201);
...
JAVA_VOID com_codename1_ui_List___INIT_____com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4463, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_List_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4468)); 
...
JAVA_VOID com_codename1_ui_List_initLaf___com_codename1_ui_plaf_UIManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 4463, 2387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_int_R_int(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4469), get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(tmpResult); }
    set_field_com_codename1_ui_List_fixedSelection(threadStateData, POP_INT(), POP_OBJ());
    __CN1_DEBUG_INFO(314);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_int_R_int(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4470), get_field_com_codename1_ui_List_itemGap(__cn1ThisObject));
    PUSH_INT(tmpResult); }
    set_field_com_codename1_ui_List_itemGap(threadStateData, POP_INT(), POP_OBJ());
    __CN1_DEBUG_INFO(315);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4471), 1 /* ICONST_1 */);
    PUSH_INT(tmpResult); }
...
JAVA_VOID com_codename1_ui_List_initComponentImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4463, 2694);
    ...
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1130153977;
...
JAVA_VOID com_codename1_ui_List_laidOut__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 2699);
    ...
    if (virtual_com_codename1_ui_List_isScrollable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1130656047;
    if (virtual_com_codename1_ui_List_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1130656047;
    if (get_field_com_codename1_ui_List_scrollToSelected(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1130656047;
    __CN1_DEBUG_INFO(340);
    /* VarOp.assignFrom */ ilocals_1_ = virtual_com_codename1_ui_list_ListModel_getSelectedIndex___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject));
    __CN1_DEBUG_INFO(341);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1130656047;
...
JAVA_VOID com_codename1_ui_List_deinitializeImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 2695);
    ...
    if (get_field_com_codename1_ui_List_listener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L461001437;
...
JAVA_INT com_codename1_ui_List_getSideGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 2549);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(385);
    if (virtual_com_codename1_ui_List_isScrollVisible___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2140396878;
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L2140396878;
...
JAVA_BOOLEAN com_codename1_ui_List_isScrollableY___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 2535);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1523957322;
    if (virtual_com_codename1_ui_List_isAlwaysTensile___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L987255094;

label_L1523957322:
    if (virtual_com_codename1_ui_List_getHeight___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L987255094;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L987255094;
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L987255094;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1937575946;
...
JAVA_BOOLEAN com_codename1_ui_List_isScrollableX___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 2534);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L317053574;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L317053574;
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L317053574;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1697976702;
...
JAVA_INT com_codename1_ui_List_getMaxElementHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4474);
...
JAVA_INT com_codename1_ui_List_getMinElementHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4476);
...
JAVA_VOID com_codename1_ui_List_setMinElementHeight___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4477);
...
JAVA_INT com_codename1_ui_List_size___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 1223);
...
JAVA_INT com_codename1_ui_List_getCurrentSelected___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 4478);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(467);
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L488422671;
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L488422671;
...
JAVA_INT com_codename1_ui_List_getSelectedIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4355);
...
JAVA_VOID com_codename1_ui_List_setSelectedIndex___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4463, 4439);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT com_codename1_ui_List_getVisibleBounds___R_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 5, 0, 4463, 2555);
...
JAVA_INT com_codename1_ui_List_getDragRegionStatus___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 4463, 2426);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(509);
    if (virtual_com_codename1_ui_List_isScrollable___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L117052390;
    __CN1_DEBUG_INFO(510);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L117052390:
    __CN1_DEBUG_INFO(512);
    if (virtual_com_codename1_ui_List_getOrientation___R_int(threadStateData, __cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L989321301;
...
JAVA_VOID com_codename1_ui_List_setSelectedIndex___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 4463, 4439);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(526);
    if (ilocals_1_>=0) /* IFGE CustomJump */ goto label_L1996787860;
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4479));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L1996787860:
    ...
    if (virtual_com_codename1_ui_List_isInitialized___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L260620222;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1505486986;
...
label_L260620222:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1569371800;
...
JAVA_OBJECT com_codename1_ui_List_getSelectedItem___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4480);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(548);
    /* VarOp.assignFrom */ ilocals_1_ = virtual_com_codename1_ui_list_ListModel_getSelectedIndex___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject));
    __CN1_DEBUG_INFO(549);
    if (ilocals_1_>=virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L249109901;
    if (ilocals_1_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L249109901;
...
JAVA_VOID com_codename1_ui_List_setSelectedItem___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 4463, 4481);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L215638041:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1147545255;
    ...
    if (locals[4].data.o==locals[1].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1117747481;
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1244211620;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1244211620;
...
JAVA_OBJECT com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4482);
...
JAVA_VOID com_codename1_ui_List_setShouldCalcPreferredSize___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 4463, 2565);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L2038185019;
    ...
    if (get_field_com_codename1_ui_List_renderingPrototype(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1074976188;
...
locals[3].type=CN1_TYPE_OBJECT;    goto label_L1131786259;
...
label_L1074976188:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L485542604;
...
JAVA_VOID com_codename1_ui_List_dataChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4463, 4483);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    if (virtual_com_codename1_ui_List_getSelectedIndex___R_int(threadStateData, __cn1ThisObject)<virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L83210381;
...
JAVA_VOID com_codename1_ui_List_bindListeners__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 4463, 4484);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(620);
    if (get_field_com_codename1_ui_List_listener(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1385966234;
...
JAVA_VOID com_codename1_ui_List_setModel___com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4463, 4485);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(633);
    if (get_field_com_codename1_ui_List_model(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1015545330;
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L649848324;
...
label_L649848324:
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1015545330;
...
label_L1015545330:
    ...
    if (virtual_com_codename1_ui_List_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L266554246;
...
JAVA_BOOLEAN com_codename1_ui_List_isCommandList___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4488);
...
JAVA_VOID com_codename1_ui_List_setCommandList___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4489);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_List_isIgnoreFocusComponentWhenUnfocused___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4490);
...
JAVA_VOID com_codename1_ui_List_setIgnoreFocusComponentWhenUnfocused___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4491);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_List_getListSizeCalculationSampleCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4494);
...
JAVA_VOID com_codename1_ui_List_setListSizeCalculationSampleCount___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4495);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_List_setRenderer___com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4498);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_List_setListCellRenderer___com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4499);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(797);
    if (get_field_com_codename1_ui_List_renderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1016625178;
...
JAVA_OBJECT com_codename1_ui_List_getRenderer___R_com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4500);
...
JAVA_INT com_codename1_ui_List_getOrientation___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4455);
...
JAVA_VOID com_codename1_ui_List_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 4463, 2673);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (get_field_com_codename1_ui_List_renderingPrototype(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1064528406;
...
label_L1064528406:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1403780103;
...
label_L1403780103:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_list_ListCellRenderer_getListCellRendererComponent___com_codename1_ui_List_java_lang_Object_int_boolean_R_com_codename1_ui_Component(threadStateData, locals[2].data.o, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219), 0 /* ICONST_0 */, 0 /* ICONST_0 */);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_com_codename1_ui_Component_refreshTheme___boolean(threadStateData, SP[-1].data.o, ilocals_1_);     SP -= 1;
...
label_L1174478906:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L747378368;
...
JAVA_VOID com_codename1_ui_List_setOrientation___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4501);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_List_scrollRectToVisible___com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(7, 3, 0, 4463, 2683);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(865);
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L135002781;
    __CN1_DEBUG_INFO(868);
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1204030294;
...
JAVA_VOID com_codename1_ui_List_setHandlesInput___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 4463, 2568);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L133544411;
    __CN1_DEBUG_INFO(885);
    BC_ALOAD(0);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1350395050;
    if (virtual_com_codename1_ui_Form_isSingleFocusMode___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L923032392;
...
JAVA_VOID com_codename1_ui_List_fireClicked__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 2476);
    ...
    BC_ALOAD(0);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1908505175;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1678422332:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L504006221;
...
JAVA_BOOLEAN com_codename1_ui_List_isSelectableInteraction___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2477);
...
JAVA_VOID com_codename1_ui_List_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 4463, 1387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1141783782;
    ...
    BC_ALOAD(0);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1047000562;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L265629779;
...
label_L265629779:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1160247050;
...
label_L1141783782:
    ...
    if (get_field_com_codename1_ui_List_numericKeyActions(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1887115844;
    if (ilocals_2_==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L1887115844;
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1887115844;
    if (ilocals_2_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1887115844;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1887115844;
    __CN1_DEBUG_INFO(933);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(49);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1887115844;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1887115844;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1887115844;
...
JAVA_VOID com_codename1_ui_List_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 4463, 1386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(948);
    if (virtual_com_codename1_ui_List_handlesInput___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1899145692;
...
label_L1899145692:
    ...
    if (virtual_com_codename1_ui_List_getOrientation___R_int(threadStateData, __cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1464031233;
    ...
    if (ilocals_2_==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L765880900;
    if (ilocals_2_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L86506638;
...
label_L1464031233:
    ...
    if (virtual_com_codename1_ui_List_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1639958975;
    __CN1_DEBUG_INFO(963);
    /* VarOp.assignFrom */     ilocals_3_ = 2 /* ICONST_2 */; 
    __CN1_DEBUG_INFO(964);
    /* VarOp.assignFrom */     ilocals_4_ = 5 /* ICONST_5 */; 
    goto label_L745604825;
...
label_L745604825:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L849063257;
    if (ilocals_2_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L86506638;
...
label_L86506638:
    ...
    if (ilocals_2_!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L140702728;
    __CN1_DEBUG_INFO(976);
    BC_IINC(5, -1);
    __CN1_DEBUG_INFO(977);
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L395257482;
    __CN1_DEBUG_INFO(978);
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L871153004;
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L871153004;
...
label_L140702728:
    ...
    if (ilocals_2_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L395257482;
    __CN1_DEBUG_INFO(986);
    BC_IINC(5, 1);
    __CN1_DEBUG_INFO(987);
    if (ilocals_5_<virtual_com_codename1_ui_List_size___R_int(threadStateData, __cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L395257482;
    __CN1_DEBUG_INFO(988);
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1550991149;
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L1550991149;
...
label_L395257482:
    ...
    if (ilocals_5_==virtual_com_codename1_ui_list_ListModel_getSelectedIndex___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L1127174687;
    ...
    if (ilocals_2_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L763008902;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L2074826904;
...
label_L2074826904:
    ...
    if (virtual_com_codename1_ui_List_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L913148823;
    if (virtual_com_codename1_ui_List_getOrientation___R_int(threadStateData, __cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L913148823;
...
label_L913148823:
    ...
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L267098351;
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1985280051;
...
label_L1985280051:
    ...
    if (get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1127174687;
    __CN1_DEBUG_INFO(1009);
    if (ilocals_3_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1461322233;
...
JAVA_VOID com_codename1_ui_List_selectElement___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(7, 5, 0, 4463, 4454);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (virtual_com_codename1_ui_List_getOrientation___R_int(threadStateData, __cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L225511870;
...
label_L225511870:
    ...
    if (virtual_com_codename1_ui_List_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L256522893;
    if (virtual_com_codename1_ui_List_isScrollableX___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L256522893;
...
label_L1578026015:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L148436820;
    __CN1_DEBUG_INFO(1032);
    if (virtual_com_codename1_ui_List_hasFocus___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L224473864;
...
JAVA_BOOLEAN com_codename1_ui_List_hasScrollableParent___com_codename1_ui_Container_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4503);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1041);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L627519623;
    __CN1_DEBUG_INFO(1042);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L627519623:
    __CN1_DEBUG_INFO(1044);
    if (virtual_com_codename1_ui_Container_isScrollable___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L2066213108;
...
JAVA_VOID com_codename1_ui_List_updateAnimationPosition___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 2, 0, 4463, 4504);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1056);
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L881513107;
...
label_L881513107:
    ...
    if (virtual_com_codename1_ui_List_isSmoothScrolling___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L821513849;
    __CN1_DEBUG_INFO(1062);
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L747152360;
...
JAVA_VOID com_codename1_ui_List_initListMotion__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 4463, 4505);
...
JAVA_VOID com_codename1_ui_List_calculateComponentPosition___int_int_com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Dimension_com_codename1_ui_geom_Dimension_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5, JAVA_BOOLEAN __cn1Arg6) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 19, 0, 4463, 4506);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L6214844;
...
label_L6214844:
    ...
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1763750076;
    ...
    SP--;
    switch((*SP).data.i) {
        case 10: goto label_L1710641643;
        case 11: goto label_L1771190979;
        case 12: goto label_L522188921;
        default: goto label_L1943408246;
    }
...
label_L522188921:
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L620261614;
...
label_L1710641643:
    ...
    if ((ilocals_1_ - ilocals_11_)<=0) /* IFLE CustomJump */ goto label_L1014555985;
...
label_L1943408246:
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1547965072;
...
label_L1547965072:
    ...
    if (ilocals_1_!=ilocals_11_) /* IF_ICMPNE CustomJump */ goto label_L2132736278;
...
label_L1763750076:
    ...
    SP--;
    switch((*SP).data.i) {
        case 10: goto label_L1688918025;
        case 11: goto label_L520354720;
        case 12: goto label_L400385823;
        default: goto label_L1002400446;
    }
...
label_L400385823:
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L157783888;
    __CN1_DEBUG_INFO(1158);
    /* VarOp.assignFrom */ ilocals_15_=(ilocals_15_ + ilocals_13_);

label_L157783888:
    __CN1_DEBUG_INFO(1160);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L163160871;
...
label_L1688918025:
    ...
    if ((ilocals_1_ - ilocals_11_)<=0) /* IFLE CustomJump */ goto label_L898283008;
    __CN1_DEBUG_INFO(1171);
    /* VarOp.assignFrom */ ilocals_15_=(ilocals_15_ + ilocals_13_);

label_L898283008:
    __CN1_DEBUG_INFO(1173);
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L14838518;
...
label_L1002400446:
    ...
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1973471376;
...
label_L1973471376:
    ...
    if (ilocals_10_==0) /* IFEQ CustomJump */ goto label_L1141264726;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1141264726;
    ...
    if (ilocals_1_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L932312334;
    __CN1_DEBUG_INFO(1189);
    /* VarOp.assignFrom */ ilocals_18_=(ilocals_18_ - ilocals_13_);

label_L932312334:
    __CN1_DEBUG_INFO(1191);
    if (ilocals_17_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L1141264726;
...
label_L1141264726:
    ...
    if (ilocals_1_!=ilocals_11_) /* IF_ICMPNE CustomJump */ goto label_L411474203;
...
JAVA_INT com_codename1_ui_List_recalcOffset___int_int_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 4463, 4507);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    __CN1_DEBUG_INFO(1213);
    if (((ilocals_1_ + (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject) % ilocals_4_)) + (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject) % ilocals_4_))<ilocals_3_) /* IF_IMPLT CustomJump */ goto label_L1464565578;
...
label_L1464565578:
    ...
    if (((ilocals_1_ + (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject) % ilocals_4_)) + (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject) % ilocals_4_))>=(1 /* ICONST_1 */ - ilocals_4_)) /* IF_ICMPGE CustomJump */ goto label_L1156385423;
...
JAVA_VOID com_codename1_ui_List_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 25, 0, 4463, 2355);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_List_isScrollableX___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L840400805;
...
label_L840400805:
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L177657196;
...
label_L177657196:
    ...
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L111888987;
    __CN1_DEBUG_INFO(1248);
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L717132147;
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L111888987;
...
label_L111888987:
    ...
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L534553956;
    ...
    if (virtual_com_codename1_ui_List_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1140448598;
...
label_L534553956:
    ...
    if (get_field_com_codename1_ui_List_mutableRendererBackgrounds(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L487778643;
    __CN1_DEBUG_INFO(1283);
    /* VarOp.assignFrom */     ilocals_17_ = ilocals_14_;

label_L894332932:
    if (ilocals_17_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1472950462;
    __CN1_DEBUG_INFO(1285);
    if (ilocals_17_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L759564454;
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L759564454;
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L759564454;
    __CN1_DEBUG_INFO(1286);
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L551056181;
...
label_L759564454:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, 1 /* ICONST_1 */);
    PUSH_OBJ(tmpResult); }
    if (ilocals_17_>virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGT CustomJump */ goto label_L650679651;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1003928100;
...
label_L1003928100:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_intersects___int_int_int_int_R_boolean(threadStateData, locals[7].data.o, ilocals_9_, ilocals_10_, ilocals_11_, ilocals_12_)==0) /* IFEQ CustomJump */ goto label_L1492400048;
    __CN1_DEBUG_INFO(1297);
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L553056396;
...
label_L553056396:
    ...
    (*SP).data.i = ilocals_17_; 
    SP++;
    if (ilocals_17_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1115099772;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1283364748;
...
label_L1492400048:
    ...
    if (ilocals_13_==0) /* IFEQ CustomJump */ goto label_L713707020;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L713707020;
...
label_L713707020:
    __CN1_DEBUG_INFO(1283);
    BC_IINC(17, 1);
    goto label_L894332932;

label_L1472950462:
    goto label_L585878713;
...
label_L487778643:
    ...
    if (ilocals_19_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1484119658;
    if (ilocals_19_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1484119658;
...
label_L1062254208:
    if (ilocals_21_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L585878713;
    __CN1_DEBUG_INFO(1325);
    if (ilocals_21_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L646410842;
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L646410842;
    __CN1_DEBUG_INFO(1326);
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L1517677623;
...
label_L646410842:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, 1 /* ICONST_1 */);
    PUSH_OBJ(tmpResult); }
    if (ilocals_21_>virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGT CustomJump */ goto label_L865430810;
    PUSH_INT(1); /* ICONST_1 */
...
label_L773708944:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_intersects___int_int_int_int_R_boolean(threadStateData, locals[7].data.o, ilocals_9_, ilocals_10_, ilocals_11_, ilocals_12_)==0) /* IFEQ CustomJump */ goto label_L1534888240;
    __CN1_DEBUG_INFO(1337);
    if (ilocals_13_!=0) /* IFNE CustomJump */ goto label_L1485208789;
...
label_L1485208789:
    ...
    if (ilocals_21_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1088628578;
...
label_L1534888240:
    ...
    if (ilocals_13_==0) /* IFEQ CustomJump */ goto label_L738590621;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L738590621;
...
label_L738590621:
    ...
    BC_IINC(21, 1);
    goto label_L1062254208;

label_L585878713:
    __CN1_DEBUG_INFO(1358);
    if (/* CustomInvoke */virtual_com_codename1_ui_list_ListCellRenderer_getListFocusComponent___com_codename1_ui_List_R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_List_renderer(__cn1ThisObject), __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1423639915;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L224063653;

label_L1423639915:
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1501688998;
    if (virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1501688998;
...
label_L1675603360:
    ...
    if (ilocals_17_==0) /* IFEQ CustomJump */ goto label_L1864572141;
    if (ilocals_20_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1864572141;
    if (ilocals_20_>=virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1864572141;
...
label_L1864572141:
    ...
    if (get_field_com_codename1_ui_List_paintFocusBehindList(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L900073076;
...
label_L1905420854:
    if (ilocals_21_>ilocals_16_) /* IF_ICMPGT CustomJump */ goto label_L1674899618;
    __CN1_DEBUG_INFO(1373);
    if (ilocals_21_!=virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L2105078741;
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2105078741;
...
label_L2105078741:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, 1 /* ICONST_1 */);
    PUSH_OBJ(tmpResult); }
    if (ilocals_21_>virtual_com_codename1_ui_List_getCurrentSelected___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGT CustomJump */ goto label_L257650296;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1263455953;
...
label_L1263455953:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_intersects___int_int_int_int_R_boolean(threadStateData, locals[7].data.o, ilocals_9_, ilocals_10_, ilocals_11_, ilocals_12_)==0) /* IFEQ CustomJump */ goto label_L172711139;
...
label_L1674899618:
    ...
    if (ilocals_17_==0) /* IFEQ CustomJump */ goto label_L560897187;
...
label_L560897187:
    ...
    if (get_field_com_codename1_ui_List_paintFocusBehindList(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1964117592;
...
label_L1964117592:
    ...
    if (get_field_com_codename1_ui_List_spinnerOverlay(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1217883757;
    __CN1_DEBUG_INFO(1398);
    if (virtual_com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(threadStateData, get_field_com_codename1_ui_List_spinnerOverlay(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L708214419;
...
JAVA_BOOLEAN com_codename1_ui_List_shouldRenderSelection___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 1440);
...
JAVA_VOID com_codename1_ui_List_paintFocus___com_codename1_ui_Graphics_int_com_codename1_ui_geom_Rectangle_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_8_ = 0; /* v8 */
    DEFINE_INSTANCE_METHOD_STACK(8, 9, 0, 4463, 4508);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    ...
    if (get_field_com_codename1_ui_List_ignoreFocusComponentWhenUnfocused(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2137552114;
    if (virtual_com_codename1_ui_List_hasFocus___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2137552114;
...
label_L2137552114:
    ...
    if (virtual_com_codename1_ui_List_shouldRenderSelection___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L443401609;
...
label_L443401609:
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1769616559;
    ...
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1881218549;
...
JAVA_VOID com_codename1_ui_List_renderComponent___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    volatile JAVA_INT ilocals_12_ = 0; /* v12 */
    volatile JAVA_INT ilocals_13_ = 0; /* v13 */
    DEFINE_INSTANCE_METHOD_STACK(5, 15, 0, 4463, 4509);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L954723689;
...
label_L954723689:
    ...
    if (locals[14].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L8415638;
    if (virtual_com_codename1_ui_plaf_Border_isBackgroundPainter___R_boolean(threadStateData, locals[14].data.o)!=0) /* IFNE CustomJump */ goto label_L8415638;
...
JAVA_VOID com_codename1_ui_List_renderComponentBackground___com_codename1_ui_Graphics_com_codename1_ui_Component_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6) {
    ...
    volatile JAVA_INT ilocals_12_ = 0; /* v12 */
    volatile JAVA_INT ilocals_13_ = 0; /* v13 */
    DEFINE_INSTANCE_METHOD_STACK(5, 14, 0, 4463, 4510);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2025198278;
...
JAVA_VOID com_codename1_ui_List_addSelectionListener___com_codename1_ui_events_SelectionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4511);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_List_removeSelectionListener___com_codename1_ui_events_SelectionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4512);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_List_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 1596);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_List_getListeners___R_java_util_Collection(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 3025);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1539);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_util_EventDispatcher_getListenerCollection___R_java_util_Collection(threadStateData, get_field_com_codename1_ui_List_dispatcher(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
...
JAVA_VOID com_codename1_ui_List_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 1597);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_List_fireActionEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 4463, 2482);
...
JAVA_VOID com_codename1_ui_List_fireActionEvent___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 4463, 2482);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1564);
    if (virtual_com_codename1_ui_List_isEnabled___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L629016615;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_hasDragOccured___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L629016615;
    __CN1_DEBUG_INFO(1565);
    if (get_field_com_codename1_ui_List_disposeDialogOnSelection(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L578102596;
...
label_L578102596:
    ...
    if (virtual_com_codename1_ui_List_isCommandList___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L565847109;
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L565847109;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L565847109;
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Command);
    if(POP_INT() == 0) /* IFEQ */ goto label_L565847109;
    if (virtual_com_codename1_ui_Command_isEnabled___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L565847109;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L565847109;
...
label_L565847109:
    ...
    if (virtual_com_codename1_ui_Display_isBuiltinSoundsEnabled___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L629016615;
    __CN1_DEBUG_INFO(1584);
    /* CustomInvoke */virtual_com_codename1_ui_Display_playBuiltinSound___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(71)); 
...
JAVA_VOID com_codename1_ui_List_setInputOnFocus___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_List_focusGainedInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4463, 2485);
    ...
    if (get_field_com_codename1_ui_List_inputOnFocus(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1775383190;
...
JAVA_VOID com_codename1_ui_List_focusLostInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2490);
...
JAVA_INT com_codename1_ui_List_getItemGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4515);
...
JAVA_VOID com_codename1_ui_List_setItemGap___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4516);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_List_setRenderingPrototype___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4517);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_List_getRenderingPrototype___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4518);
...
JAVA_OBJECT com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 4463, 4519);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1686);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1010311355;
    __CN1_DEBUG_INFO(1687);
    if (get_field_com_codename1_ui_List_selectedElemSize(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L929856893;
    __CN1_DEBUG_INFO(1689);
    if (get_field_com_codename1_ui_List_renderingPrototype(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1199894489;
    __CN1_DEBUG_INFO(1690);
    if (virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1199894489;
    __CN1_DEBUG_INFO(1692);
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1069163325;
    __CN1_DEBUG_INFO(1693);
    PUSH_POINTER(__NEW_com_codename1_ui_Label(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Label___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4520));     SP -= 1;
...
label_L1010311355:
    ...
    if (get_field_com_codename1_ui_List_elemSize(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1115349385;
    __CN1_DEBUG_INFO(1704);
    if (get_field_com_codename1_ui_List_renderingPrototype(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L380234542;
    __CN1_DEBUG_INFO(1705);
    if (virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L380234542;
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1983063045;
...
JAVA_OBJECT com_codename1_ui_List_calculateElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_7_ = 0; /* v7 */
    volatile JAVA_INT ilocals_8_ = 0; /* v8 */
    DEFINE_INSTANCE_METHOD_STACK(5, 12, 0, 4463, 4521);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1725);
    if (get_field_com_codename1_ui_List_renderingPrototype(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L410931765;
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L220040730;
...
label_L818010696:
    if (ilocals_8_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L1412752396;
    ...
    BC_ALOAD(9);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L994632067;
...
label_L994632067:
    ...
    if (ilocals_8_!=0) /* IFNE CustomJump */ goto label_L1364058917;
...
JAVA_VOID com_codename1_ui_List_longPointerPress___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* y */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 4463, 2619);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1761);
    if (virtual_com_codename1_ui_List_isEnabled___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1134976216;
...
label_L1134976216:
    ...
    if (get_field_com_codename1_ui_List_longPointerPressAction(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1058994646;
    ...
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L24404443;
...
JAVA_VOID com_codename1_ui_List_pointerPressed___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 4463, 277);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1777);
    if (virtual_com_codename1_ui_List_isEnabled___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1071245351;
...
label_L1071245351:
    ...
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1315447704;
    __CN1_DEBUG_INFO(1782);
    if (virtual_com_codename1_ui_List_isSmoothScrolling___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1315447704;
    __CN1_DEBUG_INFO(1783);
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L108049354;
    __CN1_DEBUG_INFO(1784);
    set_field_com_codename1_ui_List_fixedDraggedPosition(threadStateData, ilocals_2_, __cn1ThisObject);
    goto label_L615014502;
...
label_L615014502:
    ...
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1413491716;
...
label_L1315447704:
    ...
    if (ilocals_4_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1530638839;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1530638839;
...
label_L1530638839:
    ...
    BC_ALOAD(0);
    if (ilocals_3_!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L1490466745;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1058686869;
...
JAVA_VOID com_codename1_ui_List_pointerDragged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* x */
    volatile JAVA_INT ilocals_2_ = 0; /* y */
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4463, 279);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_List_pointerDraggedImpl___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_5_ = 0; /* v5 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 4463, 4522);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1825);
    if (virtual_com_codename1_ui_List_isEnabled___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1785687166;
...
label_L1785687166:
    ...
    if (virtual_com_codename1_ui_List_isSmoothScrolling___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1818090701;
    __CN1_DEBUG_INFO(1829);
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L31184256;
...
label_L31184256:
    ...
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2098041249;
...
label_L2098041249:
    ...
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2142536057;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L538721498;
...
label_L538721498:
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1283906060;
...
label_L1570228900:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)>(-(ilocals_6_))) /* IF_ICMPGT CustomJump */ goto label_L108209958;
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)<virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L1195909598;
    __CN1_DEBUG_INFO(1851);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    goto label_L1195909598;

label_L108209958:
    __CN1_DEBUG_INFO(1853);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)<ilocals_6_) /* IF_IMPLT CustomJump */ goto label_L1195909598;
    __CN1_DEBUG_INFO(1854);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject) - 1 /* ICONST_1 */), __cn1ThisObject);
    __CN1_DEBUG_INFO(1855);
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1195909598;
...
label_L1818090701:
    ...
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1812995265;
...
JAVA_OBJECT com_codename1_ui_List_getSelectedRect___R_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(8, 5, 0, 4463, 2519);
...
JAVA_INT com_codename1_ui_List_pointerSelect___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    volatile JAVA_INT ilocals_9_ = 0; /* v9 */
    DEFINE_INSTANCE_METHOD_STACK(8, 11, 0, 4463, 4523);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    if (virtual_com_codename1_ui_List_isScrollableX___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1030014337;
...
label_L1030014337:
    ...
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1590028899;
    ...
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1100004490;
    __CN1_DEBUG_INFO(1903);
    if (ilocals_2_>=virtual_com_codename1_ui_geom_Rectangle_getY___R_int(threadStateData, locals[8].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1204822967;
...
label_L1204822967:
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L761577728;
...
label_L1100004490:
    ...
    if (virtual_com_codename1_ui_List_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L803149788;
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1852655488;
...
label_L1852655488:
    ...
    if (ilocals_1_<virtual_com_codename1_ui_geom_Rectangle_getX___R_int(threadStateData, locals[8].data.o)) /* IF_IMPLT CustomJump */ goto label_L1695213452;
...
label_L803149788:
    ...
    if (ilocals_1_>=virtual_com_codename1_ui_geom_Rectangle_getX___R_int(threadStateData, locals[8].data.o)) /* IF_ICMPGE CustomJump */ goto label_L779343339;
...
label_L779343339:
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = SP[-1].data.i + (*SP).data.i; /* IADD */
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L2042971662;
...
label_L2147002844:
    if (ilocals_10_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1552133633;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_geom_Rectangle_contains___int_int_R_boolean(threadStateData, locals[8].data.o, ilocals_1_, ilocals_2_)==0) /* IFEQ CustomJump */ goto label_L1335157064;
...
label_L1335157064:
    __CN1_DEBUG_INFO(1944);
    BC_IINC(10, 1);
    goto label_L2147002844;

label_L1552133633:
    __CN1_DEBUG_INFO(1953);
    if (ilocals_3_<0) /* IFLT CustomJump */ goto label_L752772379;
    if (ilocals_3_<virtual_com_codename1_ui_List_size___R_int(threadStateData, __cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1397643446;
...
JAVA_VOID com_codename1_ui_List_pointerReleasedImpl___int_int_boolean_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_14_ = 0; /* v14 */
    volatile JAVA_INT ilocals_15_ = 0; /* v15 */
    DEFINE_INSTANCE_METHOD_STACK(8, 17, 0, 4463, 4525);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    __CN1_DEBUG_INFO(1979);
    if (virtual_com_codename1_ui_List_isEnabled___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1001946422;
...
label_L1001946422:
    ...
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L28612052;
    __CN1_DEBUG_INFO(1983);
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1579015748;
    ...
    goto label_L2134357721;

label_L1579015748:
    __CN1_DEBUG_INFO(1986);
    if (virtual_com_codename1_ui_List_getOrientation___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L119420356;
    PUSH_INT(1); /* ICONST_1 */
...
label_L580979398:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L318644008;
...
label_L1346237136:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L654003462;
...
label_L28612052:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L203854885;
    if (/* CustomInvoke */com_codename1_ui_List_pointerSelect___int_int_R_int(threadStateData, __cn1ThisObject, ilocals_1_, ilocals_2_)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L203854885;
    __CN1_DEBUG_INFO(2006);
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1849941462;
...
label_L1849941462:
    ...
    if (get_field_com_codename1_ui_List_fireOnClick(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1373051324;
    PUSH_INT(get_field_com_codename1_ui_List_fixedSelection(__cn1ThisObject));
    PUSH_INT(9);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L758705661;

label_L1373051324:
    if (get_field_com_codename1_ui_List_fireOnRelease(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L203854885;
...
label_L758705661:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L352830403;
    ...
    if (locals[16].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L352830403;
...
label_L352830403:
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1700397528;
...
JAVA_VOID com_codename1_ui_List_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    volatile JAVA_INT ilocals_1_ = 0; /* x */
    volatile JAVA_INT ilocals_2_ = 0; /* y */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 4463, 278);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_OBJECT com_codename1_ui_List_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 4463, 1856);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2060);
    if (virtual_com_codename1_ui_List_shouldShowHint___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L204078646;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L204078646;
...
label_L204078646:
    ...
    if (get_field_com_codename1_ui_List_spinnerOverlay(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1712635211;
    __CN1_DEBUG_INFO(2070);
    if (virtual_com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(threadStateData, get_field_com_codename1_ui_List_spinnerOverlay(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1712635211;
...
JAVA_VOID com_codename1_ui_List_addItem___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4526);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_List_getFixedSelection___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 4527);
...
JAVA_VOID com_codename1_ui_List_setFixedSelection___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 4528);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_List_deregisterAnimatedInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2678);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2112);
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1294361489;
...
JAVA_BOOLEAN com_codename1_ui_List_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 4463, 1587);
    ...
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2017980204;
    if (get_field_com_codename1_ui_List_listMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2017980204;
    if (virtual_com_codename1_ui_List_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2017980204;
    __CN1_DEBUG_INFO(2126);
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L995911260;
...
label_L2028042905:
    ...
    if (get_field_com_codename1_ui_List_animationPosition(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L103130367;
...
label_L2017980204:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedMotion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1104938392;
    ...
    if (get_field_com_codename1_ui_List_orientation(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L426435961;
...
label_L1781297535:
    ...
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_List_fixedDraggedMotion(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1099248281;
    __CN1_DEBUG_INFO(2150);
    virtual_com_codename1_ui_List_deregisterAnimatedInternal__(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(2153);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)>((-(ilocals_4_)) / 2 /* ICONST_2 */)) /* IF_ICMPGT CustomJump */ goto label_L1624510452;
    __CN1_DEBUG_INFO(2154);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject) + 1 /* ICONST_1 */), __cn1ThisObject);
    __CN1_DEBUG_INFO(2155);
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)<virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L777748410;
    __CN1_DEBUG_INFO(2156);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    goto label_L777748410;

label_L1624510452:
    __CN1_DEBUG_INFO(2158);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)<(ilocals_4_ / 2 /* ICONST_2 */)) /* IF_IMPLT CustomJump */ goto label_L777748410;
    __CN1_DEBUG_INFO(2159);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject) - 1 /* ICONST_1 */), __cn1ThisObject);
    __CN1_DEBUG_INFO(2160);
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L777748410;
...
label_L777748410:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L662000775;
    __CN1_DEBUG_INFO(2166);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1326230282;
    __CN1_DEBUG_INFO(2167);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)>=((-(ilocals_4_)) / 2 /* ICONST_2 */)) /* IF_ICMPGE CustomJump */ goto label_L266843824;
...
label_L1326230282:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)<=(ilocals_4_ / 2 /* ICONST_2 */)) /* IF_ICMPLE CustomJump */ goto label_L2003311844;
...
label_L662000775:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)<0) /* IFLT CustomJump */ goto label_L1570160120;
    PUSH_INT(get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1570160120;
...
label_L1099248281:
    ...
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)>(-(ilocals_4_))) /* IF_ICMPGT CustomJump */ goto label_L1870054092;
    __CN1_DEBUG_INFO(2196);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject) + 1 /* ICONST_1 */), __cn1ThisObject);
    __CN1_DEBUG_INFO(2197);
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)<virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, get_field_com_codename1_ui_List_model(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L812609309;
...
label_L812609309:
    ...
    set_field_com_codename1_ui_List_fixedDraggedPosition(threadStateData, ilocals_2_, __cn1ThisObject);
    goto label_L131582664;

label_L1870054092:
    __CN1_DEBUG_INFO(2201);
    if (get_field_com_codename1_ui_List_fixedDraggedAnimationPosition(__cn1ThisObject)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L131582664;
    __CN1_DEBUG_INFO(2202);
    set_field_com_codename1_ui_List_fixedDraggedSelection(threadStateData, (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject) - 1 /* ICONST_1 */), __cn1ThisObject);
    __CN1_DEBUG_INFO(2203);
    if (get_field_com_codename1_ui_List_fixedDraggedSelection(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L1875304119;
...
JAVA_BOOLEAN com_codename1_ui_List_isTactileTouch___int_int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* y */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 4463, 2717);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2222);
    if (virtual_com_codename1_ui_List_isTactileTouch___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L914293025;
    __CN1_DEBUG_INFO(2223);
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */com_codename1_ui_List_pointerSelect___int_int_R_int(threadStateData, __cn1ThisObject, ilocals_1_, ilocals_2_);
    __CN1_DEBUG_INFO(2224);
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L914293025;
...
JAVA_INT com_codename1_ui_List_getGridPosY___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4463, 2679);
...
JAVA_INT com_codename1_ui_List_calcGrid___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 4463, 4530);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2252);
    /* VarOp.assignFrom */ ilocals_3_=(ilocals_1_ % ilocals_2_);
    __CN1_DEBUG_INFO(2253);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, (ilocals_3_ - ilocals_2_))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L2107873140;
    __CN1_DEBUG_INFO(2254);
    if (ilocals_3_<=(ilocals_2_ / 2 /* ICONST_2 */)) /* IF_ICMPLE CustomJump */ goto label_L1142653826;
...
JAVA_INT com_codename1_ui_List_getGridPosX___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4463, 2680);
...
JAVA_OBJECT com_codename1_ui_List_paramString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 2667);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2276);
    /* VarOp.assignFrom */ locals[1].type=CN1_TYPE_INVALID;    locals[1].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(4531);
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2277);
    if (get_field_com_codename1_ui_List_elemSize(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L502386384;
...
label_L502386384:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, locals[1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4532));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4533));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP-=1;
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4535));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ALOAD(0);
...
JAVA_VOID com_codename1_ui_List_setHint___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4463, 2741);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_List_getHint___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2739);
...
JAVA_OBJECT com_codename1_ui_List_getHintIcon___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2740);
...
JAVA_VOID com_codename1_ui_List_setHint___java_lang_String_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4463, 2741);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_List_getHintLabelImpl___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2735);
...
JAVA_VOID com_codename1_ui_List_setHintLabelImpl___com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4463, 2736);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_List_shouldShowHint___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4463, 2737);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2345);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_com_codename1_ui_list_ListModel_getSize___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1397338694;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L850429804;
...
JAVA_VOID com_codename1_ui_List___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 4463, 859);
...
JAVA_OBJECT virtual_com_codename1_ui_List_getBounds___R_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getBounds___R_com_codename1_ui_geom_Rectangle)__cn1ThisObject->__codenameOneParentClsReference->vtable[145])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setShouldCalcPreferredSize___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setShouldCalcPreferredSize___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[154])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_handlesInput___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_handlesInput___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[155])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setHandlesInput___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setHandlesInput___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[156])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_hasFocus___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_hasFocus___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[157])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getComponentForm___R_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getComponentForm___R_com_codename1_ui_Form)__cn1ThisObject->__codenameOneParentClsReference->vtable[159])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_repaint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_repaint__)__cn1ThisObject->__codenameOneParentClsReference->vtable[161])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_List_getScrollAnimationSpeed___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getScrollAnimationSpeed___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[168])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isSmoothScrolling___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isSmoothScrolling___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[175])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setSmoothScrolling___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setSmoothScrolling___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[176])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_FLOAT virtual_com_codename1_ui_List_getDragSpeed___boolean_R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getDragSpeed___boolean_R_float)__cn1ThisObject->__codenameOneParentClsReference->vtable[221])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[222])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_installDefaultPainter___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_installDefaultPainter___com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[236])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_refreshTheme___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[241])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isDragActivated___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isDragActivated___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[244])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setDragActivated___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setDragActivated___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[245])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_deregisterAnimatedInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_deregisterAnimatedInternal__)__cn1ThisObject->__codenameOneParentClsReference->vtable[247])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isScrollVisible___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isScrollVisible___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[258])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setScrollVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setScrollVisible___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[259])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isInitialized___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[268])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isEnabled___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isEnabled___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[275])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setEnabled___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setEnabled___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[277])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isRTL___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isRTL___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[282])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isTactileTouch___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isTactileTouch___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[285])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getHintLabelImpl___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getHintLabelImpl___R_com_codename1_ui_Label)__cn1ThisObject->__codenameOneParentClsReference->vtable[298])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_shouldShowHint___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_shouldShowHint___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[300])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_paintHint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_paintHint___com_codename1_ui_Graphics)__cn1ThisObject->__codenameOneParentClsReference->vtable[301])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getHint___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getHint___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[302])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getHintIcon___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getHintIcon___R_com_codename1_ui_Image)__cn1ThisObject->__codenameOneParentClsReference->vtable[303])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setHint___java_lang_String_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setHint___java_lang_String_com_codename1_ui_Image)__cn1ThisObject->__codenameOneParentClsReference->vtable[304])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isAlwaysTensile___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isAlwaysTensile___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[308])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setAlwaysTensile___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setAlwaysTensile___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[309])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_addActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[323])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_removeActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[324])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_modelChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_modelChanged___int_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[325])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_List_listSelectionChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_listSelectionChanged___int_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[326])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_INT virtual_com_codename1_ui_List_getMaxElementHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getMaxElementHeight___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[327])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_List_getMinElementHeight___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getMinElementHeight___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[328])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setMinElementHeight___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setMinElementHeight___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[329])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_List_size___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_size___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[330])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_List_getCurrentSelected___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getCurrentSelected___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[331])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_List_getSelectedIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getSelectedIndex___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[332])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setSelectedIndex___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setSelectedIndex___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[333])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setSelectedIndex___int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setSelectedIndex___int_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[334])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getSelectedItem___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getSelectedItem___R_java_lang_Object)__cn1ThisObject->__codenameOneParentClsReference->vtable[335])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setSelectedItem___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setSelectedItem___java_lang_Object)__cn1ThisObject->__codenameOneParentClsReference->vtable[336])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel)__cn1ThisObject->__codenameOneParentClsReference->vtable[337])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_dataChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_dataChanged___int_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[338])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setModel___com_codename1_ui_list_ListModel(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setModel___com_codename1_ui_list_ListModel)__cn1ThisObject->__codenameOneParentClsReference->vtable[339])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_isCommandList___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_isCommandList___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[340])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setCommandList___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setCommandList___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[341])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_List_getListSizeCalculationSampleCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getListSizeCalculationSampleCount___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[344])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setListSizeCalculationSampleCount___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setListSizeCalculationSampleCount___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[345])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setRenderer___com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setRenderer___com_codename1_ui_list_ListCellRenderer)__cn1ThisObject->__codenameOneParentClsReference->vtable[346])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setListCellRenderer___com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setListCellRenderer___com_codename1_ui_list_ListCellRenderer)__cn1ThisObject->__codenameOneParentClsReference->vtable[347])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getRenderer___R_com_codename1_ui_list_ListCellRenderer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getRenderer___R_com_codename1_ui_list_ListCellRenderer)__cn1ThisObject->__codenameOneParentClsReference->vtable[348])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_List_getOrientation___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getOrientation___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[349])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setOrientation___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setOrientation___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[350])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_scrollRectToVisible___com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_scrollRectToVisible___com_codename1_ui_geom_Rectangle)__cn1ThisObject->__codenameOneParentClsReference->vtable[351])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_selectElement___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_selectElement___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[352])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_List_shouldRenderSelection___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_shouldRenderSelection___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[353])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_addSelectionListener___com_codename1_ui_events_SelectionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_addSelectionListener___com_codename1_ui_events_SelectionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[354])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_removeSelectionListener___com_codename1_ui_events_SelectionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_removeSelectionListener___com_codename1_ui_events_SelectionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[355])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_fireActionEvent___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_fireActionEvent___com_codename1_ui_events_ActionEvent)__cn1ThisObject->__codenameOneParentClsReference->vtable[357])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_List_getItemGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getItemGap___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[359])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setItemGap___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setItemGap___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[360])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setRenderingPrototype___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setRenderingPrototype___java_lang_Object)__cn1ThisObject->__codenameOneParentClsReference->vtable[361])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getRenderingPrototype___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getRenderingPrototype___R_java_lang_Object)__cn1ThisObject->__codenameOneParentClsReference->vtable[362])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension)__cn1ThisObject->__codenameOneParentClsReference->vtable[363])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_List_addItem___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_addItem___java_lang_Object)__cn1ThisObject->__codenameOneParentClsReference->vtable[364])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setFixedSelection___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setFixedSelection___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[366])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_List_setHint___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_List_setHint___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[367])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
void __INIT_VTABLE_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[143] = &com_codename1_ui_List_calcPreferredSize___R_com_codename1_ui_geom_Dimension;
    vtable[146] = &com_codename1_ui_List_getVisibleBounds___R_com_codename1_ui_geom_Rectangle;
    vtable[154] = &com_codename1_ui_List_setShouldCalcPreferredSize___boolean;
    vtable[156] = &com_codename1_ui_List_setHandlesInput___boolean;
    vtable[164] = &com_codename1_ui_List_keyPressed___int;
    vtable[165] = &com_codename1_ui_List_keyReleased___int;
    vtable[177] = &com_codename1_ui_List_pointerHover___int_1ARRAY_int_1ARRAY;
    vtable[179] = &com_codename1_ui_List_pointerHoverReleased___int_1ARRAY_int_1ARRAY;
    ...
    vtable[239] = &com_codename1_ui_List_paramString___R_java_lang_String;
    vtable[241] = &com_codename1_ui_List_refreshTheme___boolean;
    vtable[247] = &com_codename1_ui_List_deregisterAnimatedInternal__;
    vtable[248] = &com_codename1_ui_List_getGridPosY___R_int;
    vtable[249] = &com_codename1_ui_List_getGridPosX___R_int;
    vtable[263] = &com_codename1_ui_List_initComponentImpl__;
    vtable[264] = &com_codename1_ui_List_deinitializeImpl__;
    vtable[265] = &com_codename1_ui_List_laidOut__;
    vtable[284] = &com_codename1_ui_List_isTactileTouch___int_int_R_boolean;
    vtable[298] = &com_codename1_ui_List_getHintLabelImpl___R_com_codename1_ui_Label;
    vtable[299] = &com_codename1_ui_List_setHintLabelImpl___com_codename1_ui_Label;
    vtable[300] = &com_codename1_ui_List_shouldShowHint___R_boolean;
    vtable[302] = &com_codename1_ui_List_getHint___R_java_lang_String;
    vtable[303] = &com_codename1_ui_List_getHintIcon___R_com_codename1_ui_Image;
    vtable[304] = &com_codename1_ui_List_setHint___java_lang_String_com_codename1_ui_Image;
    vtable[323] = &com_codename1_ui_List_addActionListener___com_codename1_ui_events_ActionListener;
    vtable[324] = &com_codename1_ui_List_removeActionListener___com_codename1_ui_events_ActionListener;
    vtable[325] = &com_codename1_ui_List_modelChanged___int_int;
    vtable[326] = &com_codename1_ui_List_listSelectionChanged___int_int;
    vtable[327] = &com_codename1_ui_List_getMaxElementHeight___R_int;
    vtable[328] = &com_codename1_ui_List_getMinElementHeight___R_int;
    vtable[329] = &com_codename1_ui_List_setMinElementHeight___int;
    vtable[330] = &com_codename1_ui_List_size___R_int;
    vtable[331] = &com_codename1_ui_List_getCurrentSelected___R_int;
    vtable[332] = &com_codename1_ui_List_getSelectedIndex___R_int;
    vtable[333] = &com_codename1_ui_List_setSelectedIndex___int;
    vtable[334] = &com_codename1_ui_List_setSelectedIndex___int_boolean;
    vtable[335] = &com_codename1_ui_List_getSelectedItem___R_java_lang_Object;
    vtable[336] = &com_codename1_ui_List_setSelectedItem___java_lang_Object;
    vtable[337] = &com_codename1_ui_List_getModel___R_com_codename1_ui_list_ListModel;
    vtable[338] = &com_codename1_ui_List_dataChanged___int_int;
    vtable[339] = &com_codename1_ui_List_setModel___com_codename1_ui_list_ListModel;
    vtable[340] = &com_codename1_ui_List_isCommandList___R_boolean;
    vtable[341] = &com_codename1_ui_List_setCommandList___boolean;
    vtable[342] = &com_codename1_ui_List_isIgnoreFocusComponentWhenUnfocused___R_boolean;
    vtable[343] = &com_codename1_ui_List_setIgnoreFocusComponentWhenUnfocused___boolean;
    vtable[344] = &com_codename1_ui_List_getListSizeCalculationSampleCount___R_int;
    vtable[345] = &com_codename1_ui_List_setListSizeCalculationSampleCount___int;
    vtable[346] = &com_codename1_ui_List_setRenderer___com_codename1_ui_list_ListCellRenderer;
    vtable[347] = &com_codename1_ui_List_setListCellRenderer___com_codename1_ui_list_ListCellRenderer;
    vtable[348] = &com_codename1_ui_List_getRenderer___R_com_codename1_ui_list_ListCellRenderer;
    vtable[349] = &com_codename1_ui_List_getOrientation___R_int;
    vtable[350] = &com_codename1_ui_List_setOrientation___int;
    vtable[351] = &com_codename1_ui_List_scrollRectToVisible___com_codename1_ui_geom_Rectangle;
    vtable[352] = &com_codename1_ui_List_selectElement___int;
    vtable[353] = &com_codename1_ui_List_shouldRenderSelection___R_boolean;
    vtable[354] = &com_codename1_ui_List_addSelectionListener___com_codename1_ui_events_SelectionListener;
    vtable[355] = &com_codename1_ui_List_removeSelectionListener___com_codename1_ui_events_SelectionListener;
    vtable[356] = &com_codename1_ui_List_getListeners___R_java_util_Collection;
    vtable[357] = &com_codename1_ui_List_fireActionEvent___com_codename1_ui_events_ActionEvent;
    vtable[358] = &com_codename1_ui_List_setInputOnFocus___boolean;
    vtable[359] = &com_codename1_ui_List_getItemGap___R_int;
    vtable[360] = &com_codename1_ui_List_setItemGap___int;
    vtable[361] = &com_codename1_ui_List_setRenderingPrototype___java_lang_Object;
    vtable[362] = &com_codename1_ui_List_getRenderingPrototype___R_java_lang_Object;
    vtable[363] = &com_codename1_ui_List_getElementSize___boolean_boolean_R_com_codename1_ui_geom_Dimension;
    vtable[364] = &com_codename1_ui_List_addItem___java_lang_Object;
    vtable[365] = &com_codename1_ui_List_getFixedSelection___R_int;
    vtable[366] = &com_codename1_ui_List_setFixedSelection___int;
    vtable[367] = &com_codename1_ui_List_setHint___java_lang_String;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_List.vtable = malloc(sizeof(void*) *368);
