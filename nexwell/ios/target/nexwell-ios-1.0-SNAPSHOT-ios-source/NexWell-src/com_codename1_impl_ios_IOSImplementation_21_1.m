...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_21_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL100140936301;
    int tryBlockOffsetL100140936301;
    DEFINE_CATCH_BLOCK(catch_L100140936301, label_L692838068, restoreToL100140936301);
    int restoreToL69283806802;
    int tryBlockOffsetL69283806802;
    DEFINE_CATCH_BLOCK(catch_L69283806802, label_L692838068, restoreToL69283806802);
...
label_L1001409363:
 tryBlockOffsetL100140936301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L100140936301);
    restoreToL100140936301 = threadStateData->threadObjectStackOffset;
...
label_L692838068:
 tryBlockOffsetL69283806802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L69283806802);
    restoreToL69283806802 = threadStateData->threadObjectStackOffset;
