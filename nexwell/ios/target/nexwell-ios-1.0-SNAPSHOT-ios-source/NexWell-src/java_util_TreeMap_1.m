...
const struct clazz *base_interfaces_for_java_util_TreeMap_1[] = {};
struct clazz class__java_util_TreeMap_1 = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_java_util_TreeMap_1 ,0 , &__GC_MARK_java_util_TreeMap_1,  0, cn1_class_id_java_util_TreeMap_1, "java.util.TreeMap.1", 0, 0, 0, JAVA_FALSE, &class__java_util_AbstractSet, base_interfaces_for_java_util_TreeMap_1, 0, 0, 0
, 0, 0, 0, JAVA_TRUE, 0, 0};

JAVA_OBJECT get_field_java_util_TreeMap_1_this_0(JAVA_OBJECT __cn1T) {
  return (*(struct obj__java_util_TreeMap_1*)__cn1T).java_util_TreeMap_1_this_0;
}

void set_field_java_util_TreeMap_1_this_0(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__java_util_TreeMap_1*)__cn1T).java_util_TreeMap_1_this_0 = __cn1Val;
}

JAVA_VOID __FINALIZER_java_util_TreeMap_1(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete) {
    __FINALIZER_java_util_AbstractSet(threadStateData, objToDelete);
}

void __GC_MARK_java_util_TreeMap_1(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    struct obj__java_util_TreeMap_1* objInstance = (struct obj__java_util_TreeMap_1*)objToMark;
    gcMarkObject(threadStateData, objInstance->java_util_TreeMap_1_this_0, force);
    __GC_MARK_java_util_AbstractSet(threadStateData, objToMark, force);
}

JAVA_OBJECT __NEW_java_util_TreeMap_1(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_java_util_TreeMap_1(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__java_util_TreeMap_1), &class__java_util_TreeMap_1);
    return o;
}
...
JAVA_VOID java_util_TreeMap_1___INIT_____java_util_TreeMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6227, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    set_field_java_util_TreeMap_1_this_0(threadStateData, locals[1].data.o, __cn1ThisObject);
...
JAVA_BOOLEAN java_util_TreeMap_1_contains___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6227, 905);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_util_TreeMap_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_java_util_TreeMap_1_this_0(__cn1ThisObject), locals[1].data.o);
    PUSH_INT(tmpResult); }
...
JAVA_INT java_util_TreeMap_1_size___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6227, 1224);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_util_TreeMap_size(get_field_java_util_TreeMap_1_this_0(__cn1ThisObject)));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return SP[-1].data.i;
}


JAVA_VOID java_util_TreeMap_1_clear__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6227, 1229);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     virtual_java_util_TreeMap_clear__(threadStateData, get_field_java_util_TreeMap_1_this_0(__cn1ThisObject)); 
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
...
JAVA_OBJECT java_util_TreeMap_1_iterator___R_java_util_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 6227, 1230);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_POINTER(__NEW_java_util_TreeMap_UnboundedKeyIterator(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_util_TreeMap_UnboundedKeyIterator___INIT_____java_util_TreeMap(threadStateData, SP[-1].data.o, get_field_java_util_TreeMap_1_this_0(__cn1ThisObject));     SP -= 1;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
...
void __INIT_VTABLE_java_util_TreeMap_1(CODENAME_ONE_THREAD_STATE, void** vtable) {
        __INIT_VTABLE_java_util_AbstractSet(threadStateData, vtable);
    vtable[10] = &java_util_TreeMap_1_iterator___R_java_util_Iterator;
    vtable[13] = &java_util_TreeMap_1_clear__;
    vtable[14] = &java_util_TreeMap_1_contains___java_lang_Object_R_boolean;
    vtable[20] = &java_util_TreeMap_1_size___R_int;
}

static int __java_util_TreeMap_1_LOADED__=0;
void __STATIC_INITIALIZER_java_util_TreeMap_1(CODENAME_ONE_THREAD_STATE) {
    if(__java_util_TreeMap_1_LOADED__) return;

    monitorEnter(threadStateData, (JAVA_OBJECT)&class__java_util_TreeMap_1);
    if(class__java_util_TreeMap_1.initialized) {
        monitorExit(threadStateData, (JAVA_OBJECT)&class__java_util_TreeMap_1);
        return;
    }

    class__java_util_TreeMap_1.vtable = malloc(sizeof(void*) *23);
    __INIT_VTABLE_java_util_TreeMap_1(threadStateData, class__java_util_TreeMap_1.vtable);
    class__java_util_TreeMap_1.initialized = JAVA_TRUE;
monitorExit(threadStateData, (JAVA_OBJECT)&class__java_util_TreeMap_1);
__java_util_TreeMap_1_LOADED__=1;
}
