...
#define virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_R_java_lang_Boolean com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_R_java_lang_Boolean
