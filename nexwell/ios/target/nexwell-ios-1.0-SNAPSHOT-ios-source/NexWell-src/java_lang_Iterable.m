...
void __STATIC_INITIALIZER_java_lang_Iterable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed][0] = 323;
