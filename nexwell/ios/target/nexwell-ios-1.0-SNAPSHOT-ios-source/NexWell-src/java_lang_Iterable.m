...
void __STATIC_INITIALIZER_java_lang_Iterable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_AccountForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_AccountForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_PomodoroTimer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_PomodoroTimer][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_MusicForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_MusicForm][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_EmergencyHelpForm][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_LoginForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_LoginForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_ChaosGame] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_ChaosGame][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_components_RichTextView] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_components_RichTextView][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_impl_CodenameOneImplementation_7] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_impl_CodenameOneImplementation_7][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Toolbar][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_MenuBar] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_MenuBar][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar_8] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar_8][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_TextSelection_SelectionMenu] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_TextSelection_SelectionMenu][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Toolbar_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Toolbar_2][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Toolbar_ToolbarSideMenu] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Toolbar_ToolbarSideMenu][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SearchBar] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SearchBar][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_TextSelection_SelectionMask] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_TextSelection_SelectionMask][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar_10] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar_10][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Container] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Container][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Tabs] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Tabs][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_ComboBox_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_ComboBox_1][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_ComponentGroup] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_ComponentGroup][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_InterFormContainer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_InterFormContainer][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Form] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Form][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_SideMenuBar][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_Spinner3D_ScrollingContainer][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_GenericSpinner] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_GenericSpinner][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_Spinner3D_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_Spinner3D_2][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_BaseSpinner] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_spinner_BaseSpinner][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_scene_Scene] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_scene_Scene][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_InteractionDialog][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_SpanLabel] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_SpanLabel][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_FileTree] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_FileTree][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_MultiButton] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_MultiButton][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_SpanButton] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_SpanButton][0] = 323;
