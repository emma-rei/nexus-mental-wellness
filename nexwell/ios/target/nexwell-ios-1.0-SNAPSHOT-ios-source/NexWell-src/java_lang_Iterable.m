...
void __STATIC_INITIALIZER_java_lang_Iterable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_HomePageForm_BreathingTimer] = malloc(sizeof(int*) * 13);
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_SearchForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_SearchForm][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_Settings] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_Settings][0] = 323;
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_nexus_nexwell_forms_ResourcesForm] = malloc(sizeof(int*) * 13);
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Sheet] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_ui_Sheet][0] = 323;
    ...
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_ToastBar_ToastBarComponent] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Iterable[cn1_class_id_com_codename1_components_ToastBar_ToastBarComponent][0] = 323;
