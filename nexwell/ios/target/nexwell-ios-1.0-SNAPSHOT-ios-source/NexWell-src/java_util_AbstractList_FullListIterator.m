...
JAVA_VOID java_util_AbstractList_FullListIterator___INIT_____java_util_AbstractList_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1258, 201);
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ goto label_L1202683709;
    if (ilocals_2_<=get_field_java_util_AbstractList_FullListIterator_numLeft(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L2087885397;
...
JAVA_VOID java_util_AbstractList_FullListIterator_add___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1258, 1226);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1;
    int tryBlockOffsetL1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1, label_L1002021887, restoreToL1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1);
    if (get_field_java_util_AbstractList_FullListIterator_expectedModCount(__cn1ThisObject)==get_field_java_util_AbstractList_modCount(get_field_java_util_AbstractList_FullListIterator_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1712943792, 0);
...
label_L1712943792:
 tryBlockOffsetL1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IndexOutOfBoundsException, catch_L1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1);
    restoreToL1712943792cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
...
label_L1953886321:
END_TRY(1);    JUMP_TO(label_L1525919705, 0);
...
JAVA_BOOLEAN java_util_AbstractList_FullListIterator_hasPrevious___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1258, 1253);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_AbstractList_FullListIterator_numLeft(__cn1ThisObject)>=virtual_java_util_AbstractList_size___R_int(threadStateData, get_field_java_util_AbstractList_FullListIterator_this_0(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L842741472;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_INT java_util_AbstractList_FullListIterator_nextIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1258, 1254);
...
JAVA_OBJECT java_util_AbstractList_FullListIterator_previous___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1258, 1255);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL771775563cn1_class_id_java_lang_IndexOutOfBoundsException1;
    int tryBlockOffsetL771775563cn1_class_id_java_lang_IndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L771775563cn1_class_id_java_lang_IndexOutOfBoundsException1, label_L1766505436, restoreToL771775563cn1_class_id_java_lang_IndexOutOfBoundsException1);
    if (get_field_java_util_AbstractList_FullListIterator_expectedModCount(__cn1ThisObject)==get_field_java_util_AbstractList_modCount(get_field_java_util_AbstractList_FullListIterator_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L771775563, 0);
    PUSH_POINTER(__NEW_java_util_ConcurrentModificationException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ConcurrentModificationException___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L771775563:
 tryBlockOffsetL771775563cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IndexOutOfBoundsException, catch_L771775563cn1_class_id_java_lang_IndexOutOfBoundsException1);
    restoreToL771775563cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
...
JAVA_INT java_util_AbstractList_FullListIterator_previousIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1258, 1256);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     { JAVA_INT tmpResult = virtual_java_util_AbstractList_size___R_int(threadStateData, get_field_java_util_AbstractList_FullListIterator_this_0(__cn1ThisObject));
    PUSH_INT(tmpResult); }
    PUSH_INT(get_field_java_util_AbstractList_FullListIterator_numLeft(__cn1ThisObject));
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
...
JAVA_VOID java_util_AbstractList_FullListIterator_set___java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1258, 1222);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1;
    int tryBlockOffsetL1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1, label_L1164440413, restoreToL1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1);
    if (get_field_java_util_AbstractList_FullListIterator_expectedModCount(__cn1ThisObject)==get_field_java_util_AbstractList_modCount(get_field_java_util_AbstractList_FullListIterator_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1610525991, 0);
    PUSH_POINTER(__NEW_java_util_ConcurrentModificationException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ConcurrentModificationException___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L1610525991:
 tryBlockOffsetL1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IndexOutOfBoundsException, catch_L1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1);
    restoreToL1610525991cn1_class_id_java_lang_IndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
...
label_L2055792297:
END_TRY(1);    JUMP_TO(label_L1666607455, 0);
