...
JAVA_VOID java_util_TreeMap_SubMapKeySet___INIT_____java_util_TreeMap_SubMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6272, 202);
...
JAVA_BOOLEAN java_util_TreeMap_SubMapKeySet_contains___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6272, 905);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN java_util_TreeMap_SubMapKeySet_isEmpty___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6272, 906);
...
JAVA_INT java_util_TreeMap_SubMapKeySet_size___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6272, 1224);
...
JAVA_BOOLEAN java_util_TreeMap_SubMapKeySet_remove___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6272, 1232);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (/* CustomInvoke */virtual_java_util_TreeMap_SubMap_remove___java_lang_Object_R_java_lang_Object(threadStateData, get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject), locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1357563986;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L384587033;
...
JAVA_OBJECT java_util_TreeMap_SubMapKeySet_iterator___R_java_util_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 6, 0, 6272, 1230);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_TreeMap_SubMap_hasStart(get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L49752459;
...
label_L49752459:
    ...
    BC_ASTORE(1);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L514455215;
    PUSH_INT(get_field_java_util_TreeMap_Node_left_idx(locals[1].data.o));
    goto label_L1780034814;
...
label_L411506101:
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1360657223;
...
label_L1360657223:
    if (get_field_java_util_TreeMap_SubMap_hasEnd(get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1905485420;
    PUSH_POINTER(__NEW_java_util_TreeMap_UnboundedKeyIterator(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject)));
    BC_ALOAD(1);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L551479935;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L58940486;
...
locals[3].type=CN1_TYPE_OBJECT;    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject)));
    ...
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L501107890;
...
label_L959869407:
    ...
    BC_ISTORE(5);
    if (get_field_java_util_TreeMap_SubMap_lastKeyNode(get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1449263511;
    if (ilocals_5_<=get_field_java_util_TreeMap_Node_right_idx(get_field_java_util_TreeMap_SubMap_lastKeyNode(get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject)))) /* IF_ICMPLE CustomJump */ goto label_L1449263511;
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;locals[3].data.o = get_field_java_util_TreeMap_Node_next(locals[3].data.o);
locals[3].type=CN1_TYPE_OBJECT;    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L116237769;
    PUSH_INT(get_field_java_util_TreeMap_Node_left_idx(locals[3].data.o));
    goto label_L1438098656;
...
label_L1449263511:
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1594199808;
    PUSH_POINTER(__NEW_java_util_TreeMap_UnboundedKeyIterator(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject)));
    BC_ALOAD(1);
...
label_L1594199808:
    ...
    BC_DUP(); /* DUP */
    BC_ALOAD(1);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L422396878;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1912962767;
...
label_L1912962767:
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapKeySet_subMap(__cn1ThisObject)));
    BC_ALOAD(3);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L452805835;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1769190683;
