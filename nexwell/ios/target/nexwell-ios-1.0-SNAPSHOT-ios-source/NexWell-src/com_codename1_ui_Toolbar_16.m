...
JAVA_VOID com_codename1_ui_Toolbar_16___INIT_____com_codename1_ui_Toolbar_com_codename1_ui_Container_com_codename1_ui_Container_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 7175, 201);
...
JAVA_VOID com_codename1_ui_Toolbar_16_scrollChanged___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 10, 0, 7175, 2802);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ilocals_4_ = __cn1Arg4;
    int restoreToL102776172001;
    int tryBlockOffsetL102776172001;
    DEFINE_CATCH_BLOCK(catch_L102776172001, label_L1679401185, restoreToL102776172001);
    int restoreToL176037867202;
    int tryBlockOffsetL176037867202;
    DEFINE_CATCH_BLOCK(catch_L176037867202, label_L1679401185, restoreToL176037867202);
    int restoreToL167940118503;
    int tryBlockOffsetL167940118503;
    DEFINE_CATCH_BLOCK(catch_L167940118503, label_L1679401185, restoreToL167940118503);
    __CN1_DEBUG_INFO(2360);
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$500___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L671959170, 0);
    if (virtual_com_codename1_ui_Container_isTensileMotionInProgress___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_val_contentPane(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1152342155, 0);
...
label_L1027761720:
 tryBlockOffsetL102776172001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L102776172001);
    restoreToL102776172001 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(2367);
    /* VarOp.assignFrom */ ilocals_5_=(ilocals_2_ - ilocals_4_);
    __CN1_DEBUG_INFO(2368);
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L64068997, 1);
...
label_L64068997:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ JUMP_TO(label_L719727542, 1);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, ilocals_6_)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1760378672, 0);
...
label_L1760378672:
 tryBlockOffsetL176037867202 = threadStateData->tryBlockOffset;
    ...
    if (ilocals_6_==virtual_com_codename1_ui_Toolbar_getY___R_int(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1454922150, 1);
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$800___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1493883713, 1);
...
END_TRY(1);    __CN1_DEBUG_INFO(2395);
    ...
    JUMP_TO(label_L1118494797, 0);

label_L1679401185:
 tryBlockOffsetL167940118503 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L167940118503);
    restoreToL167940118503 = threadStateData->threadObjectStackOffset;
