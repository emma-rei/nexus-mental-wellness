...
JAVA_VOID com_codename1_ui_Toolbar_16_scrollChanged___int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    int restoreToL21813910901;
    int tryBlockOffsetL21813910901;
    DEFINE_CATCH_BLOCK(catch_L21813910901, label_L94354228, restoreToL21813910901);
    int restoreToL105265889202;
    int tryBlockOffsetL105265889202;
    DEFINE_CATCH_BLOCK(catch_L105265889202, label_L94354228, restoreToL105265889202);
    int restoreToL9435422803;
    int tryBlockOffsetL9435422803;
    DEFINE_CATCH_BLOCK(catch_L9435422803, label_L94354228, restoreToL9435422803);
    __CN1_DEBUG_INFO(2360);
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$500___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L459875531, 0);
    if (virtual_com_codename1_ui_Container_isTensileMotionInProgress___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_val_contentPane(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L982337150, 0);
...
label_L218139109:
 tryBlockOffsetL21813910901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L21813910901);
    restoreToL21813910901 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(2367);
    /* VarOp.assignFrom */ ilocals_5_=(ilocals_2_ - ilocals_4_);
    __CN1_DEBUG_INFO(2368);
    if (ilocals_5_==0) /* IFEQ CustomJump */ JUMP_TO(label_L337460547, 1);
...
label_L337460547:
    ...
    if (ilocals_2_<0) /* IFLT CustomJump */ JUMP_TO(label_L1822651119, 1);
    if (/* CustomInvoke */java_lang_Math_abs___int_R_int(threadStateData, ilocals_6_)>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1052658892, 0);
...
label_L1052658892:
 tryBlockOffsetL105265889202 = threadStateData->tryBlockOffset;
    ...
    if (ilocals_6_==virtual_com_codename1_ui_Toolbar_getY___R_int(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1859142611, 1);
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$800___com_codename1_ui_Toolbar_R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_16_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L324701295, 1);
...
label_L94354228:
 tryBlockOffsetL9435422803 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L9435422803);
    restoreToL9435422803 = threadStateData->threadObjectStackOffset;
