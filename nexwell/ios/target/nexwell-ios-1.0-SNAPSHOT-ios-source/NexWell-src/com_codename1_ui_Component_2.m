...
JAVA_VOID com_codename1_ui_Component_2___INIT_____com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8173, 202);
...
JAVA_VOID com_codename1_ui_Component_2_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 8173, 204);
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_putClientProperty___java_lang_String_java_lang_Object(threadStateData, get_field_com_codename1_ui_Component_2_this_0(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(2512), JAVA_NULL /* ACONST_NULL */); 
