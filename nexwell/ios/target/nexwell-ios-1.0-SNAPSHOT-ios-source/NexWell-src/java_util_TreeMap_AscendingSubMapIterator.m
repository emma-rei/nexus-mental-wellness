...
JAVA_VOID java_util_TreeMap_AscendingSubMapIterator___INIT_____java_util_TreeMap_NavigableSubMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6241, 201);
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMapIterator_getBoundaryNode___R_java_util_TreeMap_Entry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6241, 6242);
...
locals[1].type=CN1_TYPE_OBJECT;    if (get_field_java_util_TreeMap_NavigableSubMap_toEnd(get_field_java_util_TreeMap_AscendingSubMapIterator_subMap(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1790421142;
    if (get_field_java_util_TreeMap_NavigableSubMap_hiInclusive(get_field_java_util_TreeMap_AscendingSubMapIterator_subMap(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L846947180;
...
label_L1616974404:
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L927327686;
...
label_L27319466:
    if (get_field_java_util_TreeMap_AscendingSubMapIterator_node(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1003752023;
...
label_L1003752023:
    ...
    if (get_field_java_util_TreeMap_AscendingSubMapIterator_offset(__cn1ThisObject)==get_field_java_util_TreeMap_Node_right_idx(get_field_java_util_TreeMap_AscendingSubMapIterator_node(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L266272063;
...
label_L266272063:
    ...
    if (get_field_java_util_TreeMap_AscendingSubMapIterator_node(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L226744878;
...
label_L226744878:
    if (get_field_java_util_TreeMap_AscendingSubMapIterator_lastNode(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L172032696;
    BC_ALOAD(0);
    ...
    POP_MANY(2);
    if (get_field_java_util_TreeMap_AscendingSubMapIterator_boundaryPair(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L299644693;
    if (get_field_java_util_TreeMap_Entry_node(get_field_java_util_TreeMap_AscendingSubMapIterator_boundaryPair(__cn1ThisObject))!=get_field_java_util_TreeMap_AscendingSubMapIterator_lastNode(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L299644693;
    if (get_field_java_util_TreeMap_Entry_index(get_field_java_util_TreeMap_AscendingSubMapIterator_boundaryPair(__cn1ThisObject))!=get_field_java_util_TreeMap_AscendingSubMapIterator_lastOffset(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L299644693;
...
JAVA_BOOLEAN java_util_TreeMap_AscendingSubMapIterator_hasNext___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 6241, 1249);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (JAVA_NULL /* ACONST_NULL */==get_field_java_util_TreeMap_AscendingSubMapIterator_node(__cn1ThisObject)) /* IF_ACMPEQ CustomJump */ goto label_L1771243284;
    PUSH_INT(1); /* ICONST_1 */
