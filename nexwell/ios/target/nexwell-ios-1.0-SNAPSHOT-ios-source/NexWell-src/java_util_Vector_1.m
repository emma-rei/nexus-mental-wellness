...
JAVA_VOID java_util_Vector_1___INIT_____java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6113, 202);
...
JAVA_BOOLEAN java_util_Vector_1_hasMoreElements___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 6113, 2000);
...
JAVA_OBJECT java_util_Vector_1_nextElement___R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 6113, 2001);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL119649625801;
    int tryBlockOffsetL119649625801;
    DEFINE_CATCH_BLOCK(catch_L119649625801, label_L1748876332, restoreToL119649625801);
...
label_L1196496258:
 tryBlockOffsetL119649625801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L119649625801);
    restoreToL119649625801 = threadStateData->threadObjectStackOffset;
