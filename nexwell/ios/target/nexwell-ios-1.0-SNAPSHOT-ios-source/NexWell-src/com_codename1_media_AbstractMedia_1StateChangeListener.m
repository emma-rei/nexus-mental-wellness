...
JAVA_VOID com_codename1_media_AbstractMedia_1StateChangeListener___INIT_____com_codename1_media_AbstractMedia_com_codename1_media_AsyncMedia_PlayRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 8667, 201);
...
JAVA_VOID com_codename1_media_AbstractMedia_1StateChangeListener_actionPerformed___com_codename1_media_AsyncMedia_MediaStateChangeEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8667, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(221);
    if (virtual_com_codename1_media_AsyncMedia_PlayRequest_isDone___R_boolean(threadStateData, get_field_com_codename1_media_AbstractMedia_1StateChangeListener_val_out(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1252310945;
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1252310945;
    ...
    if (get_field_com_codename1_media_AbstractMedia_1StateChangeListener_onError(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L553703553;
