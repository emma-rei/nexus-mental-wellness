...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_TextureCache_get___com_codename1_ui_geom_Shape_com_codename1_ui_Stroke_R_com_codename1_impl_ios_IOSImplementation_TextureAlphaMaskProxy(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L703627308;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L979420182;
...
label_L490630452:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[9].data.o)!=0) /* IFNE CustomJump */ goto label_L1626529981;
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L1184694332;
    if (ilocals_17_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1184694332;
...
label_L1184694332:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1799424291;
        case 1: goto label_L1472012329;
        case 2: goto label_L540923243;
        case 3: goto label_L244297136;
        case 4: goto label_L1835316563;
        default: goto label_L1399225534;
    }
...
label_L1399225534:
    ...
    goto label_L490630452;

label_L1626529981:
    __CN1_DEBUG_INFO(2402);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1857007886;
