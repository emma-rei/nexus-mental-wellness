...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_TextureCache_get___com_codename1_ui_geom_Shape_com_codename1_ui_Stroke_R_com_codename1_impl_ios_IOSImplementation_TextureAlphaMaskProxy(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1514955661;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L333879495;
...
label_L1626529981:
    ...
    if (virtual_com_codename1_ui_geom_PathIterator_isDone___R_boolean(threadStateData, locals[9].data.o)!=0) /* IFNE CustomJump */ goto label_L183304529;
    ...
    if (ilocals_7_!=0) /* IFNE CustomJump */ goto label_L645643802;
    if (ilocals_17_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L645643802;
...
label_L645643802:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L521331027;
        case 1: goto label_L949314262;
        case 2: goto label_L1511004956;
        case 3: goto label_L559998250;
        case 4: goto label_L703627308;
        default: goto label_L979420182;
    }
...
label_L979420182:
    ...
    goto label_L1626529981;

label_L183304529:
    __CN1_DEBUG_INFO(2402);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1184694332;
