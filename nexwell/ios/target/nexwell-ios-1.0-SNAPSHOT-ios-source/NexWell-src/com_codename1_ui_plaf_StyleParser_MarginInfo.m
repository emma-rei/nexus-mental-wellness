...
label_L490218:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L53871235;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1047);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L1944370016;
        default: goto label_L162114152;
    }
...
label_L1944370016:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L976782276;
...
label_L976782276:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L22249027;
        default: goto label_L1463478962;
    }
...
label_L1843161040:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L319086807;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1079);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L2003287374;
        default: goto label_L1997059690;
    }
...
label_L2003287374:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1128198660;
