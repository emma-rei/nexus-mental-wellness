...
JAVA_VOID com_codename1_util_EasyThread_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL108835839601;
    int tryBlockOffsetL108835839601;
    DEFINE_CATCH_BLOCK(catch_L108835839601, label_L133861375, restoreToL108835839601);
    int restoreToL13386137502;
    int tryBlockOffsetL13386137502;
    DEFINE_CATCH_BLOCK(catch_L13386137502, label_L133861375, restoreToL13386137502);
    int restoreToL1681736858cn1_class_id_java_lang_Throwable3;
    int tryBlockOffsetL1681736858cn1_class_id_java_lang_Throwable3;
    DEFINE_CATCH_BLOCK(catch_L1681736858cn1_class_id_java_lang_Throwable3, label_L1143171370, restoreToL1681736858cn1_class_id_java_lang_Throwable3);
    __CN1_DEBUG_INFO(47);
...
label_L1593794124:
    __CN1_DEBUG_INFO(49);
    if (/* CustomInvoke */com_codename1_util_EasyThread_access$000___com_codename1_util_EasyThread_R_boolean(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L561370431, 0);

label_L1681736858:
 tryBlockOffsetL1681736858cn1_class_id_java_lang_Throwable3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1681736858cn1_class_id_java_lang_Throwable3);
    restoreToL1681736858cn1_class_id_java_lang_Throwable3 = threadStateData->threadObjectStackOffset;
...
label_L1088358396:
 tryBlockOffsetL108835839601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L108835839601);
    restoreToL108835839601 = threadStateData->threadObjectStackOffset;
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L699278615, 2);
    __CN1_DEBUG_INFO(53);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2054738602, 2);
    __CN1_DEBUG_INFO(55);
    /* CustomInvoke */PUSH_OBJ(com_codename1_util_EasyThread_access$200___com_codename1_util_EasyThread_R_java_util_ArrayList(threadStateData, get_field_com_codename1_util_EasyThread_1_this_0(__cn1ThisObject)));
...
label_L98487731:
END_TRY(1);    JUMP_TO(label_L715029325, 1);

label_L133861375:
 tryBlockOffsetL13386137502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L13386137502);
    restoreToL13386137502 = threadStateData->threadObjectStackOffset;
...
label_L715029325:
    __CN1_DEBUG_INFO(63);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1916822932, 1);
    __CN1_DEBUG_INFO(64);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_java_lang_Runnable);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1309738228, 1);
    __CN1_DEBUG_INFO(65);
    virtual_java_lang_Runnable_run__(threadStateData, locals[1].data.o); 
    JUMP_TO(label_L1916822932, 1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(75);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[2].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1593794124, 0);
