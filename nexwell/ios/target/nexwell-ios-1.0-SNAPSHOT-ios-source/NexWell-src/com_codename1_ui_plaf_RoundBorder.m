...
JAVA_OBJECT com_codename1_ui_plaf_RoundBorder_stroke___float_boolean_R_com_codename1_ui_plaf_RoundBorder(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_FLOAT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_RoundBorder_strokeThickness(__cn1ThisObject), 0 /* FCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2001568374;
...
label_L2001568374:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1826777478;
...
JAVA_OBJECT com_codename1_ui_plaf_RoundBorder_createTargetImage___com_codename1_ui_Component_int_int_boolean_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_shadowMM(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L737335019;
...
label_L737335019:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_shadowOpacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1835848160;
...
label_L158882051:
    if (ilocals_12_<0) /* IFLT CustomJump */ goto label_L1990828041;
...
label_L1990828041:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1835848160;
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1835848160;
...
label_L1835848160:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_uiid(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L872452937;
    if (virtual_com_codename1_ui_Graphics_isShapeClipSupported___R_boolean(threadStateData, locals[10].data.o)==0) /* IFEQ CustomJump */ goto label_L872452937;
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_rectangle(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1063823352;
    __CN1_DEBUG_INFO(435);
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L83554804;
...
label_L1333858345:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyLeftRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2133547083;
...
label_L92694321:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyRightRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1453347620;
...
label_L1063823352:
    ...
    if (ilocals_8_==ilocals_9_) /* IF_ICMPEQ CustomJump */ goto label_L35826861;
    __CN1_DEBUG_INFO(457);
    if (ilocals_8_<=ilocals_9_) /* IF_ICMPLE CustomJump */ goto label_L1456465598;
...
label_L875293430:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_strokeOpacity(__cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L2131595007;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2131595007;
...
JAVA_VOID com_codename1_ui_plaf_RoundBorder_paintBorderBackground___com_codename1_ui_Graphics_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (ilocals_3_<=0) /* IFLE CustomJump */ goto label_L63583816;
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L63583816;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L714721945;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(493);
    if (CN1_CMP_EXPR(get_field_com_codename1_ui_plaf_RoundBorder_CacheValue_modificationTime(locals[8].data.o), get_field_com_codename1_ui_plaf_RoundBorder_modificationTime(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L714721945;
    ...
    SP++;
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L714721945;
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundBorder_CacheValue_img(locals[8].data.o))!=ilocals_4_) /* IF_ICMPNE CustomJump */ goto label_L714721945;
...
JAVA_VOID com_codename1_ui_plaf_RoundBorder_fillShape___com_codename1_ui_Graphics_int_int_int_int_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_BOOLEAN __cn1Arg6) {
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_rectangle(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2014729464;
    if (ilocals_4_>ilocals_5_) /* IF_ICMPGT CustomJump */ goto label_L716985796;
...
label_L2014729464:
    ...
    if (ilocals_4_==ilocals_5_) /* IF_ICMPEQ CustomJump */ goto label_L1318424328;
    __CN1_DEBUG_INFO(539);
    if (ilocals_4_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1908455234;
...
label_L1318424328:
    ...
    if (ilocals_9_>=5 /* ICONST_5 */) /* IF_ICMPGE CustomJump */ goto label_L1002146838;
...
label_L1002146838:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L1944186064;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1944186064;
    __CN1_DEBUG_INFO(552);
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L300859499;
    if (get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L300859499;
    { JAVA_FLOAT tmpResult = virtual_com_codename1_ui_Stroke_getLineWidth___R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundBorder_stroke(__cn1ThisObject));
    PUSH_FLOAT(tmpResult); }
...
label_L1700794291:
    ...
    PUSH_INT(360);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L39642165;
...
label_L432914967:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyLeftRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1599248355;
...
label_L757257137:
    ...
    if (get_field_com_codename1_ui_plaf_RoundBorder_onlyRightRounded(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2126751933;
...
JAVA_BOOLEAN com_codename1_ui_plaf_RoundBorder_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=__cn1ThisObject) /* IF_ACMPNE CustomJump */ goto label_L1120887625;
    PUSH_INT(1); /* ICONST_1 */
