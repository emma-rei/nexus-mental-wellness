...
JAVA_VOID com_codename1_ui_MenuBar___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5363, 201);
...
JAVA_INT com_codename1_ui_MenuBar_componentCountOffset___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5363, 5364);
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L864864095;
    ...
    if (locals[2].data.o!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L864864095;
    ...
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L864864095;
...
JAVA_VOID com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 7, 0, 5363, 5365);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(0);
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5366), 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L1329938019;
    BC_ALOAD(1);
...
label_L2090589929:
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5367), 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    set_field_com_codename1_ui_MenuBar_hideEmptyCommands(threadStateData, POP_INT(), POP_OBJ());
    __CN1_DEBUG_INFO(153);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getComponentStyle___java_lang_String_R_com_codename1_ui_plaf_Style(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4887));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_ui_MenuBar_menuStyle(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(154);
    /* CustomInvoke */virtual_com_codename1_ui_MenuBar_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4905)); 
    __CN1_DEBUG_INFO(155);
    BC_ALOAD(0);
    PUSH_POINTER(__NEW_com_codename1_ui_Command(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5368), STRING_FROM_CONSTANT_POOL_OFFSET(4887));
    PUSH_OBJ(tmpResult); }
    ...
    if (virtual_com_codename1_ui_plaf_LookAndFeel_getDefaultMenuTransitionIn___R_com_codename1_ui_animations_Transition(threadStateData, locals[3].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2063332705;
    if (virtual_com_codename1_ui_plaf_LookAndFeel_getDefaultMenuTransitionOut___R_com_codename1_ui_animations_Transition(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L798516062;
...
label_L1237907176:
    ...
    if (ilocals_4_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1795560878;
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1795560878;
    __CN1_DEBUG_INFO(170);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1316205906;
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(0); /* ICONST_0 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4911));
    PUSH_OBJ(tmpResult); }
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(1); /* ICONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4918));
    PUSH_OBJ(tmpResult); }
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(2); /* ICONST_2 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4926));
    PUSH_OBJ(tmpResult); }
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    ...
    if (virtual_com_codename1_ui_Form_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L572370257;
    __CN1_DEBUG_INFO(177);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(4918)); 
    __CN1_DEBUG_INFO(178);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(4926)); 
...
label_L753692748:
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1998371610;
...
label_L1316205906:
    ...
    if (virtual_com_codename1_ui_Form_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L605440398;
...
label_L911857585:
    if (ilocals_6_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L604990529;
    ...
    __CN1_DEBUG_INFO(214);
    BC_IINC(6, 1);
    goto label_L911857585;

label_L604990529:
    goto label_L538292941;

label_L1795560878:
    __CN1_DEBUG_INFO(219);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1004219512;
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L538292941;
...
JAVA_INT com_codename1_ui_MenuBar_getCommandBehavior___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 1451);
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_impl_CodenameOneImplementation_getSoftkeyCount___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L293326812;
    __CN1_DEBUG_INFO(258);
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1939970407;
    if (ilocals_1_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1939970407;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1939970407;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
...
JAVA_VOID com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 2871);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2872);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(292);
    if (get_field_com_codename1_ui_MenuBar_selectCommand(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L567391009;
...
JAVA_VOID com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 2873);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2874);
...
JAVA_OBJECT com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5363, 5370);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1589931229;
...
JAVA_OBJECT com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_com_codename1_ui_Container_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5363, 5370);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L1187748003:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L589610983;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L288169102;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(339);
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1028259121;
...
label_L1028259121:
    ...
    goto label_L1075236033;

label_L288169102:
    __CN1_DEBUG_INFO(343);
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1075236033;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1075236033;
...
JAVA_VOID com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5363, 5371);
    ...
    PUSH_INT(3); /* ICONST_3 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1073427864;
...
label_L1073427864:
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1302984483;
...
label_L992955027:
    ...
    BC_ALOAD(1);
    /* LDC: 'Center'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(137));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(65), locals[4].data.o); 
    __CN1_DEBUG_INFO(371);
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(64), locals[3].data.o); 
...
JAVA_OBJECT com_codename1_ui_MenuBar_findLeftTitleContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5363, 5372);
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L557568981;
...
JAVA_OBJECT com_codename1_ui_MenuBar_findRightTitleContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5373);
...
JAVA_VOID com_codename1_ui_MenuBar_updateTitleCommandPlacement__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 5363, 5374);
    ...
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1191863711;
    __CN1_DEBUG_INFO(392);
    virtual_com_codename1_ui_MenuBar_installMenuBar__(threadStateData, __cn1ThisObject); 
    goto label_L1159234226;
...
label_L1191863711:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1159234226;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1159234226;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
...
label_L1159234226:
    ...
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L77738832;
    __CN1_DEBUG_INFO(401);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2071522666;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2071522666;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1875532039;
...
label_L2071522666:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1875532039;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1875532039;
...
label_L1875532039:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1858493278;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L77738832;

label_L1858493278:
    __CN1_DEBUG_INFO(411);
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2079051109;
    __CN1_DEBUG_INFO(412);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1195670735;
...
label_L77738832:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2063275841;
    __CN1_DEBUG_INFO(423);
    PUSH_INT(7);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L641449963;
...
label_L52354732:
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1742235652;
...
label_L1742235652:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(137), locals[4].data.o); 
...
JAVA_VOID com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5363, 2875);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_Form_getToolbar___R_com_codename1_ui_Toolbar(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1169894049;
...
label_L1169894049:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1048842522;
...
label_L1048842522:
    ...
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1260012504;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1260012504;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1873189623;
...
label_L1260012504:
    ...
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1873189623;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2876);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5376);
...
JAVA_VOID com_codename1_ui_MenuBar_updateCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5363, 5378);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1934908288;
...
label_L1934908288:
    ...
    if (ilocals_1_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L1833343025;
...
label_L1833343025:
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1960514242;
    __CN1_DEBUG_INFO(510);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 0 /* ICONST_0 */), STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
    __CN1_DEBUG_INFO(511);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L804347788;
    __CN1_DEBUG_INFO(516);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 2 /* ICONST_2 */), STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
    __CN1_DEBUG_INFO(517);
    if (ilocals_2_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L2124978601;
    __CN1_DEBUG_INFO(518);
    if (ilocals_2_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L662045021;
...
label_L804347788:
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ goto label_L775911842;
    ...
    if (ilocals_2_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L341887005;
    __CN1_DEBUG_INFO(534);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L59465509;
    if (ilocals_2_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L59465509;
...
label_L1733903473:
    ...
    if (ilocals_2_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1969969319;
    __CN1_DEBUG_INFO(551);
    if (virtual_com_codename1_ui_Form_isVisible___R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1969969319;
...
JAVA_VOID com_codename1_ui_MenuBar_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 5363, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(563);
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L750797656;
...
label_L750797656:
    ...
    if (get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1756726852;
...
label_L1418550995:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1172450799;
    __CN1_DEBUG_INFO(570);
    if (locals[3].data.o!=CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), ilocals_4_)) /* IF_ACMPNE CustomJump */ goto label_L1793325972;
    __CN1_DEBUG_INFO(571);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_softCommand(__cn1ThisObject), ilocals_4_)!=get_field_com_codename1_ui_MenuBar_menuCommand(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1142402835;
...
label_L1142402835:
    ...
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_softCommand(__cn1ThisObject), ilocals_4_)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L13928051;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L13928051;
...
label_L1793325972:
    ...
    BC_IINC(4, 1);
    goto label_L1418550995;

label_L1172450799:
    __CN1_DEBUG_INFO(585);
    goto label_L566698125;

label_L1756726852:
    __CN1_DEBUG_INFO(587);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Button);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1481731217;
    __CN1_DEBUG_INFO(588);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L157971930:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1481731217;
    __CN1_DEBUG_INFO(589);
    if (locals[2].data.o!=CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), ilocals_3_)) /* IF_ACMPNE CustomJump */ goto label_L2081595126;
...
label_L1519173630:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2081595126;
    __CN1_DEBUG_INFO(592);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1121401953;
...
label_L1121401953:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1519173630;

label_L2081595126:
    __CN1_DEBUG_INFO(588);
    BC_IINC(3, 1);
    goto label_L157971930;
...
label_L1481731217:
    ...
    if (virtual_com_codename1_ui_Command_isEnabled___R_boolean(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L1642577711;
...
label_L635739314:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L566698125;
    __CN1_DEBUG_INFO(607);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L438874950;
...
label_L438874950:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L635739314;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5363, 5379);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_MenuBar_updateSoftButtonStyle___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5363, 5380);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (ilocals_2_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L2138765681;
...
JAVA_VOID com_codename1_ui_MenuBar_setUnselectedStyle___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 5363, 2661);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L590884726;
    __CN1_DEBUG_INFO(647);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 

label_L2085952212:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L590884726;
...
JAVA_OBJECT com_codename1_ui_MenuBar_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 1856);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(657);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2102724832;
    ...
    if (virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 0 /* ICONST_0 */))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1431099210;
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(219));
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L938279178;
...
label_L1431099210:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1664757401;
...
label_L1664757401:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L938279178;
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 1 /* ICONST_1 */))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L938279178;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<3 /* ICONST_3 */) /* IF_IMPLT CustomJump */ goto label_L914171926;
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject));
    PUSH_INT(2); /* ICONST_2 */
    CHECK_ARRAY_ACCESS(2, SP[-1].data.i); /* AALOAD */
    SP--; SP[-1].type = CN1_TYPE_INVALID; 
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L95964948;
...
label_L95964948:
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 2 /* ICONST_2 */))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L938279178;
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isMenuShowing___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5382);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(684);

{
    JAVA_INT ___returnValue=get_field_com_codename1_ui_MenuBar_menuDisplaying(__cn1ThisObject);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return ___returnValue;
}
}
...
JAVA_VOID com_codename1_ui_MenuBar_showMenu__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5363, 5383);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Dialog___INIT_____java_lang_String_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4887), STRING_FROM_CONSTANT_POOL_OFFSET(219));     SP -= 1;
    BC_ASTORE(1);
    ...
    if (get_field_com_codename1_ui_MenuBar_menuCellRenderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1518529528;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getMenuBar___R_com_codename1_ui_MenuBar(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1518529528;
...
label_L1518529528:
    ...
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1761495255;
    ...
    goto label_L933027910;

label_L1761495255:
    __CN1_DEBUG_INFO(718);
    /* CustomInvoke */virtual_com_codename1_ui_Dialog_addCommand___com_codename1_ui_Command(threadStateData, locals[1].data.o, get_field_com_codename1_ui_MenuBar_cancelMenuItem(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(719);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L933027910;
...
label_L933027910:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1880869198;
...
label_L1880869198:
    ...
    if (locals[2].data.o==get_field_com_codename1_ui_MenuBar_cancelMenuItem(__cn1ThisObject)) /* IF_ACMPEQ CustomJump */ goto label_L1032532382;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(734);
    if (locals[2].data.o!=get_field_com_codename1_ui_MenuBar_selectMenuItem(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L665419272;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2011636843;
    ...
    goto label_L2011636843;

label_L665419272:
    __CN1_DEBUG_INFO(741);
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;    locals[3].data.o = locals[2].data.o;
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(743);
    if (com_codename1_ui_MenuBar_isTouchMenus___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2011636843;
...
label_L2011636843:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1032532382;
...
label_L1032532382:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1494794848;
...
label_L1494794848:
    ...
    if (locals[3].data.o!=get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1031479068;
    __CN1_DEBUG_INFO(762);
    virtual_com_codename1_ui_Dialog_disposeImpl__(threadStateData, locals[1].data.o); 
    goto label_L1372483461;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5384);
...
JAVA_VOID com_codename1_ui_MenuBar_updateBackBorderToRTL___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5363, 5385);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L524606891;
...
JAVA_VOID com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5363, 5386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(781);
    if (virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L5248993;
    if (virtual_com_codename1_ui_MenuBar_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L5248993;
    __CN1_DEBUG_INFO(782);
    if (/* CustomInvoke */virtual_com_codename1_ui_Button_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5387))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L5248993;
    __CN1_DEBUG_INFO(783);
    /* CustomInvoke */virtual_com_codename1_ui_Button_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5387), get_static_java_lang_Boolean_TRUE(threadStateData)); 
...
JAVA_VOID com_codename1_ui_MenuBar_addTwoTitleButtons___com_codename1_ui_Container_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 5363, 5388);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    /* LDC: 'TitleCommand'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(4605));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1706453768;
    ...
    BC_ALOAD(1);
    /* LDC: 'BackCommand'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(4607));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    com_codename1_ui_MenuBar_ensureCommandsInContainer___com_codename1_ui_Command_com_codename1_ui_Command_com_codename1_ui_Container_java_lang_String_java_lang_String(threadStateData, SP[-6].data.o, SP[-5].data.o, SP[-4].data.o, SP[-3].data.o, SP[-2].data.o, SP[-1].data.o);     SP-= 6;
...
label_L1706453768:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2125903542;
...
JAVA_VOID com_codename1_ui_MenuBar_updateGridCommands___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 5363, 5389);
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ goto label_L685871974;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1529303412;
...
label_L609116570:
    ...
    if (ilocals_2_>=virtual_com_codename1_ui_MenuBar_getComponentCount___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L284123040;
...
label_L1641931089:
    ...
    if (virtual_com_codename1_ui_MenuBar_getComponentCount___R_int(threadStateData, __cn1ThisObject)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1092822;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5007)); 
...
label_L1505964934:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L187019413;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1555055322;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5363, 5390);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1461360262;
    __CN1_DEBUG_INFO(833);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5391)); 
...
JAVA_VOID com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 5363, 5392);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1906128360;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1906128360;
...
label_L1906128360:
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L795156371;
    __CN1_DEBUG_INFO(851);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5375), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1878677242;
    __CN1_DEBUG_INFO(852);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5393), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L795156371;
...
label_L1878677242:
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    if(POP_INT() > 0) /* IFGT */ goto label_L1817662245;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1954355506;
    __CN1_DEBUG_INFO(857);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4607)); 
...
label_L1817662245:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1935870377;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4607));
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1318313145;
...
label_L795156371:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L411787317;
        case 1: goto label_L77811359;
        case 2: goto label_L1868964323;
        case 3: goto label_L1069571746;
        default: goto label_L2089360295;
    }
...
label_L411787317:
    ...
    goto label_L1648387359;

label_L77811359:
    __CN1_DEBUG_INFO(883);
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1022830989;
...
label_L33510911:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1648387359;
...
label_L1069571746:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L891232836;
    __CN1_DEBUG_INFO(900);
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1419166053;
...
label_L1419166053:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2089360295;
    __CN1_DEBUG_INFO(908);
    virtual_com_codename1_ui_MenuBar_removeAll__(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(909);
    virtual_com_codename1_ui_MenuBar_initTitleBarStatus__(threadStateData, __cn1ThisObject); 
    goto label_L2089360295;
...
label_L2089360295:
    ...
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5394));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(919);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L704894556;
    __CN1_DEBUG_INFO(921);
    PUSH_INT(58836); /* LDC */
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getComponentStyle___java_lang_String_R_com_codename1_ui_plaf_Style(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5007));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L704894556:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_MenuBar_2___INIT_____com_codename1_ui_MenuBar_java_lang_String_com_codename1_ui_Image(threadStateData, SP[-1].data.o, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219), locals[4].data.o);     SP -= 1;
...
label_L1369977147:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTablet___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1715657818;
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L71148574;
...
JAVA_VOID com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 5395);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(952);
    if (get_field_com_codename1_ui_MenuBar_hideEmptyCommands(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L344751179;
    __CN1_DEBUG_INFO(953);
    if (virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L537524656;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L344751179;

label_L537524656:
    __CN1_DEBUG_INFO(954);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2345)); 
...
JAVA_VOID com_codename1_ui_MenuBar_ensureCommandsInContainer___com_codename1_ui_Command_com_codename1_ui_Command_com_codename1_ui_Container_java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5363, 5396);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    if(POP_INT() != 0) /* IFNE */ goto label_L1356419559;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L967643830;
...
label_L967643830:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1320443884;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L555740147;
...
label_L1356419559:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1003737182;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1790598448;
...
label_L1790598448:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L102577332;
...
label_L102577332:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1484982263;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[5].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L2113367449;
...
label_L1003737182:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(2); /* ICONST_2 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1167916234;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[4].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L717998169;
...
label_L717998169:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1790430792;
...
label_L1790430792:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L745205026;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[5].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L238169801;
...
label_L238169801:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(2);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L2060432982;
...
JAVA_VOID com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5363, 2968);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1027);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1436944861;
...
label_L1436944861:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1258103238;
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5375), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1258103238;
...
label_L1258103238:
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1292325833;
    BC_ALOAD(1);
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1292325833;
...
label_L337029130:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L1906029492;
    __CN1_DEBUG_INFO(1043);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1044);
    if (ilocals_2_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1389055824;
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1389055824;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1389055824;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1906029492;

label_L1389055824:
    __CN1_DEBUG_INFO(1046);
    if (ilocals_2_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L631621595;
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L80903581;
    BC_ALOAD(0);
    BC_ALOAD(1);
    ...
    SP-=1;
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L631621595;
...
label_L631621595:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L687372448;
    __CN1_DEBUG_INFO(1051);
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L541135648;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L541135648;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L726762476;
...
label_L541135648:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L726762476;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L726762476;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 2970);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1078);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1462661081;
    if (ilocals_1_<virtual_java_util_Vector_size___R_int(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L2136911375;
...
JAVA_INT com_codename1_ui_MenuBar_getCommandCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2969);
...
JAVA_VOID com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 5363, 2968);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1100);
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1488395499;
    if (get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1488395499;
    __CN1_DEBUG_INFO(1101);
    virtual_com_codename1_ui_MenuBar_installMenuBar__(threadStateData, __cn1ThisObject); 

label_L1488395499:
    __CN1_DEBUG_INFO(1105);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L626941486;
...
label_L626941486:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L19578363;
    ...
    if (ilocals_3_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L185488647;
    if (ilocals_3_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L185488647;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L185488647;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L19578363;

label_L185488647:
    __CN1_DEBUG_INFO(1116);
    if (ilocals_3_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1807634633;
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1807634633;
...
label_L1807634633:
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1011276990;
...
label_L1011276990:
    ...
    if (ilocals_3_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1750563752;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L285781448;
...
label_L1750563752:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L285781448;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L285781448;
...
label_L285781448:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L145329976;
    __CN1_DEBUG_INFO(1128);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L33558975;
...
JAVA_VOID com_codename1_ui_MenuBar_installMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5363, 5397);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1146);
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1373220972;
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L99295602;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1107275448;
...
label_L1107275448:
    ...
    if (ilocals_2_>1 /* ICONST_1 */) /* IF_ICMPGT CustomJump */ goto label_L1139851985;
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1139851985;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1373220972;

label_L1139851985:
    __CN1_DEBUG_INFO(1157);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getProperty___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2829), JAVA_NULL /* ACONST_NULL */);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L1373220972;
    __CN1_DEBUG_INFO(1158);
    /* CustomInvoke */virtual_com_codename1_ui_Form_addComponentToForm___java_lang_Object_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(63), __cn1ThisObject); 
...
JAVA_VOID com_codename1_ui_MenuBar_unInstallMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5363, 5398);
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1605783571;
...
label_L1605783571:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(137), locals[3].data.o); 
...
JAVA_VOID com_codename1_ui_MenuBar_removeAllCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5363, 2985);
    ...
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L59382310;
    if (ilocals_1_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L59382310;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L59382310;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1069350529;

label_L59382310:
    __CN1_DEBUG_INFO(1192);
    if (virtual_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2048869869;
...
JAVA_VOID com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5363, 2971);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1210);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1211);
    if (ilocals_2_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L390374517;
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L390374517;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L390374517;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1145882513;

label_L390374517:
    __CN1_DEBUG_INFO(1215);
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */virtual_java_util_Vector_indexOf___java_lang_Object_R_int(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o);
    __CN1_DEBUG_INFO(1216);
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L475816303;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L476868388;
    if (virtual_com_codename1_ui_Button_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L476868388;
...
label_L476868388:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L475816303;
...
JAVA_VOID com_codename1_ui_MenuBar_addSelectCommand___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 3275);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1233);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L783882192;
    __CN1_DEBUG_INFO(1234);
    if (get_field_com_codename1_ui_MenuBar_selectCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L208350681;
...
JAVA_VOID com_codename1_ui_MenuBar_removeSelectCommand__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 5363, 5399);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1243);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1933799970;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5363, 5400);
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2388), STRING_FROM_CONSTANT_POOL_OFFSET(2389));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_OBJECT com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5363, 5401);
...
JAVA_OBJECT com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5363, 5402);
    ...
    PUSH_POINTER(__NEW_com_codename1_ui_Command(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3140), STRING_FROM_CONSTANT_POOL_OFFSET(464));
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_getMenuIcons___R_com_codename1_ui_Image_1ARRAY(threadStateData, locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isLSK___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_MenuBar(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 5363, 5403);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1305);
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L212416033;
    if (ilocals_0_!=get_static_com_codename1_ui_MenuBar_leftSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L212416033;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isRSK___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_0_ = 0; /* keyCode */
    __STATIC_INITIALIZER_com_codename1_ui_MenuBar(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 5363, 5404);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1309);
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L1066949254;
    if (ilocals_0_==get_static_com_codename1_ui_MenuBar_rightSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1470295349;
    if (ilocals_0_!=get_static_com_codename1_ui_MenuBar_rightSK2(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L1066949254;

label_L1470295349:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L318755294;
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5363, 5405);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1320);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1026001741;
...
label_L1026001741:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)!=0) /* IFNE CustomJump */ goto label_L1083615749;
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)!=0) /* IFNE CustomJump */ goto label_L1083615749;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1083615749;
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L10304615;
    if (get_field_com_codename1_ui_MenuBar_clearCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1083615749;

label_L10304615:
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L1820355723;
    if (get_field_com_codename1_ui_MenuBar_clearCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1083615749;

label_L1820355723:
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1845297077;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1845297077;
...
JAVA_VOID com_codename1_ui_MenuBar_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* keyCode */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5363, 1386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1337);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1338);
    if (ilocals_2_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L407877261;
...
label_L407877261:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1910034407;
    __CN1_DEBUG_INFO(1342);
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L508756323;
    __CN1_DEBUG_INFO(1343);
    if (get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1910034407;
...
label_L508756323:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L349717579;
    __CN1_DEBUG_INFO(1349);
    if (get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1910034407;
...
label_L349717579:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1910034407;
...
JAVA_VOID com_codename1_ui_MenuBar_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 5363, 1387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1365);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1366);
    if (ilocals_2_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L1900438403;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1900438403;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1900438403;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1900438403;
...
label_L1900438403:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1188445627;
    ...
    if (ilocals_3_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L1082684443;
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L1082684443;
    __CN1_DEBUG_INFO(1372);
    if (get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L379886173;
    __CN1_DEBUG_INFO(1373);
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject));locals[4].type=CN1_TYPE_OBJECT;
label_L594570680:
    __CN1_DEBUG_INFO(1374);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L379886173;
    __CN1_DEBUG_INFO(1375);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1421650289;
    if (virtual_com_codename1_ui_Dialog_isMenu___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1421650289;
...
label_L1421650289:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L594570680;
...
label_L1082684443:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L542895457;
    __CN1_DEBUG_INFO(1385);
    if (get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L312470853;
...
label_L542895457:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L593045830;
    __CN1_DEBUG_INFO(1392);
    if (get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L65310008;
...
label_L593045830:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1188445627;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1409);
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L2083215552;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L296974277;
    if (get_field_com_codename1_ui_MenuBar_minimizeOnBack(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L296974277;
...
label_L2083215552:
    ...
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L2076864428;
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L296974277;
...
label_L296974277:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1549840544;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[4].data.o)!=0) /* IFNE CustomJump */ goto label_L1549840544;
...
JAVA_VOID com_codename1_ui_MenuBar_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5363, 2673);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (virtual_com_codename1_ui_plaf_Style_isModified___R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_menuStyle(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2049646260;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L2049646260;
...
label_L1881949035:
    ...
    if (get_field_com_codename1_ui_MenuBar_menuCellRenderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1479800269;
...
label_L603184112:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L17808347;
...
JAVA_OBJECT com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 9, 0, 5363, 5406);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5407), 0 /* ICONST_0 */);
    __CN1_DEBUG_INFO(1480);
    /* VarOp.assignFrom */     ilocals_6_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(1481);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L836170750;
    ...
    if (virtual_com_codename1_ui_Form_getSoftButtonCount___R_int(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1980560788;
...
label_L178342381:
    ...
    goto label_L925908754;

label_L836170750:
    __CN1_DEBUG_INFO(1493);
    PUSH_FLOAT(1); /* FCONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5408), STRING_FROM_CONSTANT_POOL_OFFSET(5409));
    PUSH_OBJ(tmpResult); }
    ...
    PUSH_FLOAT(1); /* FCONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5410), STRING_FROM_CONSTANT_POOL_OFFSET(5411));
    PUSH_OBJ(tmpResult); }
    { JAVA_FLOAT tmpResult = java_lang_Float_parseFloat___java_lang_String_R_float(threadStateData, SP[-1].data.o);
    SP[-1].data.f = tmpResult; SP[-1].type = CN1_TYPE_FLOAT; }
    PUSH_FLOAT(100.0); /* LDC */
...
label_L925908754:
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L838820617;
...
label_L838820617:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L542019831;
...
label_L542019831:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L547380018;
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5412), 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L547380018;
    __CN1_DEBUG_INFO(1510);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Dialog_showPacked___java_lang_String_boolean_R_com_codename1_ui_Command(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(63), 1 /* ICONST_1 */);
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5363, 3941);
    ...
    if (virtual_com_codename1_ui_MenuBar_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L375273627;
    __CN1_DEBUG_INFO(1526);
    if (virtual_com_codename1_ui_plaf_LookAndFeel_isReverseSoftButtons___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1551103602;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L149818403;
...
JAVA_INT com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5363, 5413);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L1305002218:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L716550087;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 5363, 5416);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1983706553;
    __CN1_DEBUG_INFO(1578);
    BC_ALOAD(2);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5417));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    virtual_com_codename1_ui_Button_setIcon___com_codename1_ui_Image(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    goto label_L1911600942;

label_L1983706553:
    __CN1_DEBUG_INFO(1580);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5418), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1911600942;
    __CN1_DEBUG_INFO(1581);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
...
label_L1911600942:
    ...
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_com_codename1_ui_Command_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5415));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1588);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2050291306;
    ...
    goto label_L793808700;

label_L2050291306:
    __CN1_DEBUG_INFO(1591);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5007)); 

label_L793808700:
    __CN1_DEBUG_INFO(1593);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Command_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(115));locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1594);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1053832786;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 5363, 5419);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_isTouchMenus___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1257090913;
...
label_L1010156357:
    if (ilocals_4_>=virtual_java_util_Vector_size___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L389519344;
    ...
    __CN1_DEBUG_INFO(1614);
    BC_IINC(4, 1);
    goto label_L1010156357;

label_L389519344:
    __CN1_DEBUG_INFO(1618);
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5420), 0 /* ICONST_0 */)!=0) /* IFNE CustomJump */ goto label_L57151543;
    ...
    if (ilocals_4_<=virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L609825180;
...
label_L609825180:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L268086000;
    PUSH_INT(1); /* ICONST_1 */
...
label_L499609505:
    ...
    if (ilocals_5_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1592601990;
...
label_L1658273453:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L869610006;
    if (ilocals_6_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L869610006;
    if (ilocals_7_<2 /* ICONST_2 */) /* IF_IMPLT CustomJump */ goto label_L869610006;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i % (*SP).data.i; /* IREM */
    if(POP_INT() == 0) /* IFEQ */ goto label_L1772270518;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1329492804;
...
label_L1329492804:
    ...
    if (ilocals_8_==ilocals_5_) /* IF_ICMPEQ CustomJump */ goto label_L2013853240;
    __CN1_DEBUG_INFO(1633);
    goto label_L869610006;
...
label_L2013853240:
    ...
    SP--; SP[-1].data.i = SP[-1].data.i % (*SP).data.i; /* IREM */
    BC_ISTORE(6);
    goto label_L1658273453;

label_L869610006:
    __CN1_DEBUG_INFO(1637);
    if (ilocals_8_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L1592601990;
...
label_L1592601990:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_layouts_GridLayout_setFillLastRow___boolean(threadStateData, locals[6].data.o, /* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5421), 1 /* ICONST_1 */)); 
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCommands___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5422);
...
JAVA_OBJECT com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5363, 5423);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_List_setUIID___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4802)); 
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3197)); 
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5424)); 
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L579660439;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 5363, 5425);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1687);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L487219656;
...
label_L487219656:
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Button);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1181947538;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5426);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5427);
...
JAVA_INT com_codename1_ui_MenuBar_getDragRegionStatus___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 5363, 2426);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5428);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2856);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getParentForm___R_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 5429);
...
JAVA_VOID com_codename1_ui_MenuBar_initTitleBarStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5363, 2837);
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isTouchMenus___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5363, 4027);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1764);
    /* VarOp.assignFrom */ ilocals_1_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1765);
    if (ilocals_1_==3 /* ICONST_3 */) /* IF_ICMPEQ CustomJump */ goto label_L2016146960;
    if (ilocals_1_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1035363280;
    __CN1_DEBUG_INFO(1766);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTouchScreenDevice___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1035363280;

label_L2016146960:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1945915791;
...
JAVA_VOID com_codename1_ui_MenuBar___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 5363, 859);
    __CN1_DEBUG_INFO(95);
    if (com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L769986276;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getImplementation___R_com_codename1_impl_CodenameOneImplementation(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L182052414;
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_repaint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_repaint__)__cn1ThisObject->__codenameOneParentClsReference->vtable[161])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_keyPressed___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[164])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_keyReleased___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[165])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_refreshTheme___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[241])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_isRTL___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_isRTL___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[282])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setLayout___com_codename1_ui_layouts_Layout(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setLayout___com_codename1_ui_layouts_Layout)__cn1ThisObject->__codenameOneParentClsReference->vtable[334])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addComponent___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addComponent___com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[341])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addComponent___int_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addComponent___int_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[346])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeComponent___com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeComponent___com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[350])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeAll__)__cn1ThisObject->__codenameOneParentClsReference->vtable[355])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_revalidate__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_revalidate__)__cn1ThisObject->__codenameOneParentClsReference->vtable[358])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_getComponentCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getComponentCount___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[376])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getComponentAt___int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getComponentAt___int_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[377])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getComponentAt___int_int_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getComponentAt___int_int_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[383])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form)__cn1ThisObject->__codenameOneParentClsReference->vtable[408])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommandBehavior___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[409])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[410])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[411])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[412])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[413])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[414])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__)__cn1ThisObject->__codenameOneParentClsReference->vtable[415])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[416])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[417])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[418])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[419])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_BOOLEAN (*functionPtr_com_codename1_ui_MenuBar_isMenuShowing___R_boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_isMenuShowing___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_isMenuShowing___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[420])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_showMenu__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_showMenu__)__cn1ThisObject->__codenameOneParentClsReference->vtable[421])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY)__cn1ThisObject->__codenameOneParentClsReference->vtable[422])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[423])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[424])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__)__cn1ThisObject->__codenameOneParentClsReference->vtable[425])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[426])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[427])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[428])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommandCount___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[429])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[430])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_installMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_installMenuBar__)__cn1ThisObject->__codenameOneParentClsReference->vtable[431])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_unInstallMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_unInstallMenuBar__)__cn1ThisObject->__codenameOneParentClsReference->vtable[432])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeAllCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeAllCommands__)__cn1ThisObject->__codenameOneParentClsReference->vtable[433])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[434])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addSelectCommand___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addSelectCommand___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[435])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeSelectCommand__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeSelectCommand__)__cn1ThisObject->__codenameOneParentClsReference->vtable[436])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[437])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[438])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[439])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[440])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[441])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[442])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[443])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[444])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[445])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCommands___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommands___R_java_util_Vector)__cn1ThisObject->__codenameOneParentClsReference->vtable[446])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List)__cn1ThisObject->__codenameOneParentClsReference->vtable[447])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[448])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[449])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[450])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container)__cn1ThisObject->__codenameOneParentClsReference->vtable[451])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[452])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_initTitleBarStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_initTitleBarStatus__)__cn1ThisObject->__codenameOneParentClsReference->vtable[454])(threadStateData, __cn1ThisObject);
}
...
void __INIT_VTABLE_com_codename1_ui_MenuBar(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[143] = &com_codename1_ui_MenuBar_calcPreferredSize___R_com_codename1_ui_geom_Dimension;
    vtable[164] = &com_codename1_ui_MenuBar_keyPressed___int;
    vtable[165] = &com_codename1_ui_MenuBar_keyReleased___int;
    vtable[233] = &com_codename1_ui_MenuBar_setUnselectedStyle___com_codename1_ui_plaf_Style;
    vtable[241] = &com_codename1_ui_MenuBar_refreshTheme___boolean;
    vtable[407] = &com_codename1_ui_MenuBar_actionPerformed___com_codename1_ui_events_ActionEvent;
    vtable[408] = &com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form;
    vtable[409] = &com_codename1_ui_MenuBar_getCommandBehavior___R_int;
    vtable[410] = &com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command;
    vtable[411] = &com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command;
    vtable[412] = &com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command;
    vtable[413] = &com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command;
    vtable[414] = &com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button;
    vtable[415] = &com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__;
    vtable[416] = &com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command;
    vtable[417] = &com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command;
    vtable[418] = &com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command;
    vtable[419] = &com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button;
    vtable[420] = &com_codename1_ui_MenuBar_isMenuShowing___R_boolean;
    vtable[421] = &com_codename1_ui_MenuBar_showMenu__;
    vtable[422] = &com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY;
    vtable[423] = &com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button;
    vtable[424] = &com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button;
    vtable[425] = &com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__;
    vtable[426] = &com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button;
    vtable[427] = &com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command;
    vtable[428] = &com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command;
    vtable[429] = &com_codename1_ui_MenuBar_getCommandCount___R_int;
    vtable[430] = &com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int;
    vtable[431] = &com_codename1_ui_MenuBar_installMenuBar__;
    vtable[432] = &com_codename1_ui_MenuBar_unInstallMenuBar__;
    vtable[433] = &com_codename1_ui_MenuBar_removeAllCommands__;
    vtable[434] = &com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command;
    vtable[435] = &com_codename1_ui_MenuBar_addSelectCommand___java_lang_String;
    vtable[436] = &com_codename1_ui_MenuBar_removeSelectCommand__;
    vtable[437] = &com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command;
    vtable[438] = &com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command;
    vtable[439] = &com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command;
    vtable[440] = &com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean;
    vtable[441] = &com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command;
    vtable[442] = &com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean;
    vtable[443] = &com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int;
    vtable[444] = &com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button;
    vtable[445] = &com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component;
    vtable[446] = &com_codename1_ui_MenuBar_getCommands___R_java_util_Vector;
    vtable[447] = &com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List;
    vtable[448] = &com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command;
    vtable[449] = &com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command;
    vtable[450] = &com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command;
    vtable[451] = &com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container;
    vtable[452] = &com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component;
    vtable[453] = &com_codename1_ui_MenuBar_getParentForm___R_com_codename1_ui_Form;
    vtable[454] = &com_codename1_ui_MenuBar_initTitleBarStatus__;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_MenuBar(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_MenuBar.vtable = malloc(sizeof(void*) *455);
