...
JAVA_VOID com_codename1_ui_MenuBar___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5364, 202);
...
JAVA_INT com_codename1_ui_MenuBar_componentCountOffset___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5364, 5365);
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1325147644;
    ...
    if (locals[2].data.o!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L1325147644;
    ...
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1325147644;
...
JAVA_VOID com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 7, 0, 5364, 5366);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(0);
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5367), 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L2128859746;
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L2128859746;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L60221145;
...
label_L60221145:
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5368), 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    set_field_com_codename1_ui_MenuBar_hideEmptyCommands(threadStateData, POP_INT(), POP_OBJ());
    __CN1_DEBUG_INFO(153);
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getComponentStyle___java_lang_String_R_com_codename1_ui_plaf_Style(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4888));
    PUSH_OBJ(tmpResult); }
    set_field_com_codename1_ui_MenuBar_menuStyle(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(154);
    /* CustomInvoke */virtual_com_codename1_ui_MenuBar_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4906)); 
    __CN1_DEBUG_INFO(155);
    BC_ALOAD(0);
    PUSH_POINTER(__NEW_com_codename1_ui_Command(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5369), STRING_FROM_CONSTANT_POOL_OFFSET(4888));
    PUSH_OBJ(tmpResult); }
    ...
    if (virtual_com_codename1_ui_plaf_LookAndFeel_getDefaultMenuTransitionIn___R_com_codename1_ui_animations_Transition(threadStateData, locals[3].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1966114624;
    if (virtual_com_codename1_ui_plaf_LookAndFeel_getDefaultMenuTransitionOut___R_com_codename1_ui_animations_Transition(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1523359711;
...
label_L979117606:
    ...
    if (ilocals_4_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L239648666;
    if (ilocals_5_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L239648666;
    __CN1_DEBUG_INFO(170);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2142450580;
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(0); /* ICONST_0 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4912));
    PUSH_OBJ(tmpResult); }
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(1); /* ICONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4919));
    PUSH_OBJ(tmpResult); }
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    ...
    BC_DUP(); /* DUP */
    PUSH_INT(2); /* ICONST_2 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4927));
    PUSH_OBJ(tmpResult); }
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    ...
    if (virtual_com_codename1_ui_Form_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1103067610;
    __CN1_DEBUG_INFO(177);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(4919)); 
    __CN1_DEBUG_INFO(178);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(4927)); 
...
label_L445192925:
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1366741625;
...
label_L2142450580:
    ...
    if (virtual_com_codename1_ui_Form_isRTL___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L926905424;
...
label_L947647193:
    if (ilocals_6_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1610155589;
    ...
    __CN1_DEBUG_INFO(214);
    BC_IINC(6, 1);
    goto label_L947647193;

label_L1610155589:
    goto label_L1957338226;

label_L239648666:
    __CN1_DEBUG_INFO(219);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1545644729;
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1957338226;
...
JAVA_INT com_codename1_ui_MenuBar_getCommandBehavior___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 1452);
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_impl_CodenameOneImplementation_getSoftkeyCount___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L203409962;
    __CN1_DEBUG_INFO(258);
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1429462130;
    if (ilocals_1_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1429462130;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1429462130;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
...
JAVA_VOID com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 2872);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2873);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(292);
    if (get_field_com_codename1_ui_MenuBar_selectCommand(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L373342545;
...
JAVA_VOID com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 2874);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2875);
...
JAVA_OBJECT com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5364, 5371);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1566269351;
...
JAVA_OBJECT com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_com_codename1_ui_Container_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5364, 5371);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L179233442:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L44249014;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L101740901;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(339);
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L373973695;
...
label_L373973695:
    ...
    goto label_L300659126;

label_L101740901:
    __CN1_DEBUG_INFO(343);
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L300659126;
    ...
    if (locals[6].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L300659126;
...
JAVA_VOID com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5364, 5372);
    ...
    PUSH_INT(3); /* ICONST_3 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L254812619;
...
label_L254812619:
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1252713736;
...
label_L100703210:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(66), locals[4].data.o); 
    __CN1_DEBUG_INFO(371);
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(65), locals[3].data.o); 
...
JAVA_OBJECT com_codename1_ui_MenuBar_findLeftTitleContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5364, 5373);
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2076627578;
...
JAVA_OBJECT com_codename1_ui_MenuBar_findRightTitleContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5374);
...
JAVA_VOID com_codename1_ui_MenuBar_updateTitleCommandPlacement__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 5364, 5375);
    ...
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1970707120;
    __CN1_DEBUG_INFO(392);
    virtual_com_codename1_ui_MenuBar_installMenuBar__(threadStateData, __cn1ThisObject); 
    goto label_L1751753651;
...
label_L1970707120:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1751753651;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1751753651;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
...
label_L1751753651:
    ...
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L1790229151;
    __CN1_DEBUG_INFO(401);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L665641137;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L665641137;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1716411886;
...
label_L665641137:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1716411886;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1716411886;
...
label_L1716411886:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1126112943;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1790229151;

label_L1126112943:
    __CN1_DEBUG_INFO(411);
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L212874257;
    __CN1_DEBUG_INFO(412);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1280959582;
...
label_L1790229151:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1491890454;
    __CN1_DEBUG_INFO(423);
    PUSH_INT(7);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1673389762;
...
label_L1855997464:
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1842881670;
...
label_L1842881670:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(138), locals[4].data.o); 
...
JAVA_VOID com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5364, 2876);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_Form_getToolbar___R_com_codename1_ui_Toolbar(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1443335402;
...
label_L1443335402:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1510009630;
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5376), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1510009630;
...
label_L1510009630:
    ...
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L922547904;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L922547904;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L447486093;
...
label_L922547904:
    ...
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L447486093;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2877);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5377);
...
JAVA_VOID com_codename1_ui_MenuBar_updateCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5364, 5379);
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1881585646;
...
label_L1881585646:
    ...
    if (ilocals_1_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L757332719;
...
label_L757332719:
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2092450685;
    __CN1_DEBUG_INFO(510);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 0 /* ICONST_0 */), STRING_FROM_CONSTANT_POOL_OFFSET(220)); 
    __CN1_DEBUG_INFO(511);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 1 /* ICONST_1 */), STRING_FROM_CONSTANT_POOL_OFFSET(220)); 
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L103433239;
    __CN1_DEBUG_INFO(516);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 2 /* ICONST_2 */), STRING_FROM_CONSTANT_POOL_OFFSET(220)); 
    __CN1_DEBUG_INFO(517);
    if (ilocals_2_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L1140202235;
    __CN1_DEBUG_INFO(518);
    if (ilocals_2_<=3 /* ICONST_3 */) /* IF_ICMPLE CustomJump */ goto label_L1898996968;
...
label_L103433239:
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ goto label_L468950278;
    ...
    if (ilocals_2_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1747025217;
    __CN1_DEBUG_INFO(534);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L449074057;
    if (ilocals_2_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L449074057;
...
label_L969014795:
    ...
    if (ilocals_2_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1525241607;
    __CN1_DEBUG_INFO(551);
    if (virtual_com_codename1_ui_Form_isVisible___R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1525241607;
...
JAVA_VOID com_codename1_ui_MenuBar_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 5364, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(563);
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1653153736;
...
label_L1653153736:
    ...
    if (get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L914039525;
...
label_L820422499:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L16556935;
    __CN1_DEBUG_INFO(570);
    if (locals[3].data.o!=CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), ilocals_4_)) /* IF_ACMPNE CustomJump */ goto label_L280862192;
    __CN1_DEBUG_INFO(571);
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_softCommand(__cn1ThisObject), ilocals_4_)!=get_field_com_codename1_ui_MenuBar_menuCommand(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L987805552;
...
label_L987805552:
    ...
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_softCommand(__cn1ThisObject), ilocals_4_)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1440995011;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L1440995011;
...
label_L280862192:
    ...
    BC_IINC(4, 1);
    goto label_L820422499;

label_L16556935:
    __CN1_DEBUG_INFO(585);
    goto label_L1279852178;

label_L914039525:
    __CN1_DEBUG_INFO(587);
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Button);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1932303196;
    __CN1_DEBUG_INFO(588);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L557593923:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1932303196;
    __CN1_DEBUG_INFO(589);
    if (locals[2].data.o!=CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), ilocals_3_)) /* IF_ACMPNE CustomJump */ goto label_L942804532;
...
label_L920497855:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L942804532;
    __CN1_DEBUG_INFO(592);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1030384622;
...
label_L1030384622:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L920497855;

label_L942804532:
    __CN1_DEBUG_INFO(588);
    BC_IINC(3, 1);
    goto label_L557593923;
...
label_L1932303196:
    ...
    if (virtual_com_codename1_ui_Command_isEnabled___R_boolean(threadStateData, locals[3].data.o)!=0) /* IFNE CustomJump */ goto label_L165137662;
...
label_L1023344953:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1279852178;
    __CN1_DEBUG_INFO(607);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1728897841;
...
label_L1728897841:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1023344953;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5364, 5380);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_MenuBar_updateSoftButtonStyle___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5364, 5381);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (ilocals_2_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L2083106248;
...
JAVA_VOID com_codename1_ui_MenuBar_setUnselectedStyle___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 5364, 2662);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1261321871;
    __CN1_DEBUG_INFO(647);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 

label_L1270565296:
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1261321871;
...
JAVA_OBJECT com_codename1_ui_MenuBar_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 1857);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(657);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L252276535;
    ...
    if (virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 0 /* ICONST_0 */))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1056953587;
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(220));
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L69160933;
...
label_L1056953587:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L368603167;
...
label_L368603167:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L69160933;
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 1 /* ICONST_1 */))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L69160933;
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<3 /* ICONST_3 */) /* IF_IMPLT CustomJump */ goto label_L1363989824;
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject));
    PUSH_INT(2); /* ICONST_2 */
    CHECK_ARRAY_ACCESS(2, SP[-1].data.i); /* AALOAD */
    SP--; SP[-1].type = CN1_TYPE_INVALID; 
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L299162582;
...
label_L299162582:
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject), 2 /* ICONST_2 */))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L69160933;
...
JAVA_VOID com_codename1_ui_MenuBar_showMenu__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5364, 5384);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Dialog___INIT_____java_lang_String_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4888), STRING_FROM_CONSTANT_POOL_OFFSET(220));     SP -= 1;
    BC_ASTORE(1);
    ...
    if (get_field_com_codename1_ui_MenuBar_menuCellRenderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1867177582;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getMenuBar___R_com_codename1_ui_MenuBar(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1867177582;
...
label_L1867177582:
    ...
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L971256592;
    ...
    goto label_L246745017;

label_L971256592:
    __CN1_DEBUG_INFO(718);
    /* CustomInvoke */virtual_com_codename1_ui_Dialog_addCommand___com_codename1_ui_Command(threadStateData, locals[1].data.o, get_field_com_codename1_ui_MenuBar_cancelMenuItem(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(719);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L246745017;
...
label_L246745017:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L956856274;
...
label_L956856274:
    ...
    if (locals[2].data.o==get_field_com_codename1_ui_MenuBar_cancelMenuItem(__cn1ThisObject)) /* IF_ACMPEQ CustomJump */ goto label_L550707;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(734);
    if (locals[2].data.o!=get_field_com_codename1_ui_MenuBar_selectMenuItem(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L409778321;
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1052962026;
    ...
    goto label_L1052962026;

label_L409778321:
    __CN1_DEBUG_INFO(741);
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;    locals[3].data.o = locals[2].data.o;
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(743);
    if (com_codename1_ui_MenuBar_isTouchMenus___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1052962026;
...
label_L1052962026:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L550707;
...
label_L550707:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_commandList(POP_OBJ()));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1141811719;
...
label_L1141811719:
    ...
    if (locals[3].data.o!=get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L133987402;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5385);
...
JAVA_VOID com_codename1_ui_MenuBar_updateBackBorderToRTL___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5364, 5386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5364, 5387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(781);
    if (virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1649026294;
    if (virtual_com_codename1_ui_MenuBar_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1649026294;
    __CN1_DEBUG_INFO(782);
    if (/* CustomInvoke */virtual_com_codename1_ui_Button_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5388))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1649026294;
    __CN1_DEBUG_INFO(783);
    /* CustomInvoke */virtual_com_codename1_ui_Button_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5388), get_static_java_lang_Boolean_TRUE(threadStateData)); 
...
JAVA_VOID com_codename1_ui_MenuBar_addTwoTitleButtons___com_codename1_ui_Container_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 5364, 5389);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(2);
    /* LDC: 'TitleCommand'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(4606));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L112200409;
    ...
    BC_ALOAD(1);
    /* LDC: 'BackCommand'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(4608));
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    com_codename1_ui_MenuBar_ensureCommandsInContainer___com_codename1_ui_Command_com_codename1_ui_Command_com_codename1_ui_Container_java_lang_String_java_lang_String(threadStateData, SP[-6].data.o, SP[-5].data.o, SP[-4].data.o, SP[-3].data.o, SP[-2].data.o, SP[-1].data.o);     SP-= 6;
...
label_L112200409:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1329938019;
...
JAVA_VOID com_codename1_ui_MenuBar_updateGridCommands___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 5364, 5390);
    ...
    if (ilocals_2_<=0) /* IFLE CustomJump */ goto label_L2063332705;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L798516062;
...
label_L1795560878:
    ...
    if (ilocals_2_>=virtual_com_codename1_ui_MenuBar_getComponentCount___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1237907176;
...
label_L572370257:
    ...
    if (virtual_com_codename1_ui_MenuBar_getComponentCount___R_int(threadStateData, __cn1ThisObject)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1316205906;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5008)); 
...
label_L605440398:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L753692748;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1998371610;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5364, 5391);
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1798180728;
    __CN1_DEBUG_INFO(833);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5392)); 
...
JAVA_VOID com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 5364, 5393);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L604990529;
    { JAVA_INT tmpResult = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L604990529;
...
label_L604990529:
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L911857585;
    __CN1_DEBUG_INFO(851);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5376), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L538292941;
    __CN1_DEBUG_INFO(852);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5394), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L911857585;
...
label_L538292941:
    ...
    PUSH_INT(tmpResult); }
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    if(POP_INT() > 0) /* IFGT */ goto label_L1004219512;
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4608));
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1684615718;
    __CN1_DEBUG_INFO(857);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4608)); 
...
label_L1004219512:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L477463877;
...
label_L911857585:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: goto label_L1939970407;
        case 1: goto label_L1584688439;
        case 2: goto label_L1847301137;
        case 3: goto label_L567391009;
        default: goto label_L1589931229;
    }
...
label_L1939970407:
    ...
    goto label_L589610983;

label_L1584688439:
    __CN1_DEBUG_INFO(883);
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L288169102;
...
label_L1028259121:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L589610983;
...
label_L567391009:
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1187748003;
...
label_L1187748003:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1589931229;
    __CN1_DEBUG_INFO(908);
    virtual_com_codename1_ui_MenuBar_removeAll__(threadStateData, __cn1ThisObject); 
    __CN1_DEBUG_INFO(909);
    virtual_com_codename1_ui_MenuBar_initTitleBarStatus__(threadStateData, __cn1ThisObject); 
    goto label_L1589931229;
...
label_L1589931229:
    ...
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5395));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(919);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1302984483;
    __CN1_DEBUG_INFO(921);
    PUSH_INT(58836); /* LDC */
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_MenuBar_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getComponentStyle___java_lang_String_R_com_codename1_ui_plaf_Style(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5008));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L1302984483:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_MenuBar_2___INIT_____com_codename1_ui_MenuBar_java_lang_String_com_codename1_ui_Image(threadStateData, SP[-1].data.o, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(220), locals[4].data.o);     SP -= 1;
...
label_L1073427864:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTablet___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L992955027;
    ...
    if (virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L557568981;
...
JAVA_VOID com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 5396);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(952);
    if (get_field_com_codename1_ui_MenuBar_hideEmptyCommands(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1191863711;
    __CN1_DEBUG_INFO(953);
    if (virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1159234226;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Button_getText___R_java_lang_String(threadStateData, locals[1].data.o);
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1191863711;

label_L1159234226:
    __CN1_DEBUG_INFO(954);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2346)); 
...
JAVA_VOID com_codename1_ui_MenuBar_ensureCommandsInContainer___com_codename1_ui_Command_com_codename1_ui_Command_com_codename1_ui_Container_java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5364, 5397);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L2071522666;
...
label_L2071522666:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1875532039;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1858493278;
...
label_L77738832:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(1); /* ICONST_1 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2079051109;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1195670735;
...
label_L1195670735:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L2063275841;
...
label_L2063275841:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L641449963;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[5].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L52354732;
...
label_L2079051109:
    ...
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    PUSH_INT(2); /* ICONST_2 */
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1742235652;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[4].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1169894049;
...
label_L1169894049:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1048842522;
...
label_L1048842522:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1260012504;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, SP[-1].data.o, locals[5].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1873189623;
...
label_L1873189623:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(2);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1934908288;
...
JAVA_VOID com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5364, 2969);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1027);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1960514242;
...
label_L1960514242:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L804347788;
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5376), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L804347788;
...
label_L804347788:
    ...
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L2124978601;
    BC_ALOAD(1);
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L2124978601;
...
label_L662045021:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L186075763;
    __CN1_DEBUG_INFO(1043);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1044);
    if (ilocals_2_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L775911842;
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L775911842;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L775911842;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L186075763;

label_L775911842:
    __CN1_DEBUG_INFO(1046);
    if (ilocals_2_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L341887005;
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L59465509;
    BC_ALOAD(0);
    BC_ALOAD(1);
    ...
    SP-=1;
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L341887005;
...
label_L341887005:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L847174133;
    __CN1_DEBUG_INFO(1051);
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1733903473;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1733903473;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1969969319;
...
label_L1733903473:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1969969319;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1969969319;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 2971);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1078);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1756726852;
    if (ilocals_1_<virtual_java_util_Vector_size___R_int(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L1172450799;
...
JAVA_INT com_codename1_ui_MenuBar_getCommandCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2970);
...
JAVA_VOID com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 5364, 2969);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(1100);
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1793325972;
    if (get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1793325972;
    __CN1_DEBUG_INFO(1101);
    virtual_com_codename1_ui_MenuBar_installMenuBar__(threadStateData, __cn1ThisObject); 

label_L1793325972:
    __CN1_DEBUG_INFO(1105);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1142402835;
...
label_L1142402835:
    ...
    PUSH_POINTER(get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L13928051;
    ...
    if (ilocals_3_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L1418550995;
    if (ilocals_3_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L1418550995;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1418550995;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L13928051;

label_L1418550995:
    __CN1_DEBUG_INFO(1116);
    if (ilocals_3_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L566698125;
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getBackCommand___R_com_codename1_ui_Command(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L566698125;
...
label_L566698125:
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1481731217;
...
label_L1481731217:
    ...
    if (ilocals_3_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L2081595126;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1121401953;
...
label_L2081595126:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1121401953;
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getTitle___R_java_lang_String(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ goto label_L1121401953;
...
label_L1121401953:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(1);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1519173630;
    __CN1_DEBUG_INFO(1128);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L157971930;
...
JAVA_VOID com_codename1_ui_MenuBar_installMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5364, 5398);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1146);
    if (virtual_com_codename1_ui_MenuBar_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1642577711;
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L635739314;
...
label_L635739314:
    ...
    if (ilocals_2_>1 /* ICONST_1 */) /* IF_ICMPGT CustomJump */ goto label_L2138765681;
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L2138765681;
    if (ilocals_1_!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1642577711;

label_L2138765681:
    __CN1_DEBUG_INFO(1157);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getProperty___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2830), JAVA_NULL /* ACONST_NULL */);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L1642577711;
    __CN1_DEBUG_INFO(1158);
    /* CustomInvoke */virtual_com_codename1_ui_Form_addComponentToForm___java_lang_Object_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(64), __cn1ThisObject); 
...
JAVA_VOID com_codename1_ui_MenuBar_unInstallMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5364, 5399);
    ...
    if (virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[3].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L590884726;
...
label_L590884726:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Container_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(138), locals[3].data.o); 
...
JAVA_VOID com_codename1_ui_MenuBar_removeAllCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 5364, 2986);
    ...
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L2085952212;
    if (ilocals_1_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L2085952212;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2085952212;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2102724832;

label_L2085952212:
    __CN1_DEBUG_INFO(1192);
    if (virtual_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1431099210;
...
JAVA_VOID com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 5364, 2972);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1210);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1211);
    if (ilocals_2_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L938279178;
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L938279178;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L938279178;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1664757401;

label_L938279178:
    __CN1_DEBUG_INFO(1215);
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */virtual_java_util_Vector_indexOf___java_lang_Object_R_int(threadStateData, get_field_com_codename1_ui_MenuBar_commands(__cn1ThisObject), locals[1].data.o);
    __CN1_DEBUG_INFO(1216);
    if (ilocals_3_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L914171926;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L95964948;
    if (virtual_com_codename1_ui_Button_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L95964948;
...
label_L95964948:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L914171926;
...
JAVA_VOID com_codename1_ui_MenuBar_addSelectCommand___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 3276);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1233);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1518529528;
    __CN1_DEBUG_INFO(1234);
    if (get_field_com_codename1_ui_MenuBar_selectCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1761495255;
...
JAVA_VOID com_codename1_ui_MenuBar_removeSelectCommand__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 5364, 5400);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1243);
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L933027910;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5364, 5401);
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2389), STRING_FROM_CONSTANT_POOL_OFFSET(2390));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_OBJECT com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5364, 5402);
...
JAVA_OBJECT com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 5364, 5403);
    ...
    PUSH_POINTER(__NEW_com_codename1_ui_Command(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3141), STRING_FROM_CONSTANT_POOL_OFFSET(465));
    PUSH_OBJ(tmpResult); }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_getMenuIcons___R_com_codename1_ui_Image_1ARRAY(threadStateData, locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isLSK___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_MenuBar(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 5364, 5404);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1305);
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L1880869198;
    if (ilocals_0_!=get_static_com_codename1_ui_MenuBar_leftSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L1880869198;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1032532382;
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isRSK___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_0_ = 0; /* keyCode */
    __STATIC_INITIALIZER_com_codename1_ui_MenuBar(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 5364, 5405);
    ilocals_0_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1309);
    if (ilocals_0_==0) /* IFEQ CustomJump */ goto label_L665419272;
    if (ilocals_0_==get_static_com_codename1_ui_MenuBar_rightSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L2011636843;
    if (ilocals_0_!=get_static_com_codename1_ui_MenuBar_rightSK2(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L665419272;

label_L2011636843:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1494794848;
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5364, 5406);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1320);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1031479068;
...
label_L1031479068:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)!=0) /* IFNE CustomJump */ goto label_L1372483461;
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)!=0) /* IFNE CustomJump */ goto label_L1372483461;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1372483461;
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L524606891;
    if (get_field_com_codename1_ui_MenuBar_clearCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1372483461;

label_L524606891:
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L5248993;
    if (get_field_com_codename1_ui_MenuBar_clearCommand(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1372483461;

label_L5248993:
    if (get_field_com_codename1_ui_MenuBar_thirdSoftButton(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1706453768;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1706453768;
...
JAVA_VOID com_codename1_ui_MenuBar_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* keyCode */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5364, 1387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1337);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1338);
    if (ilocals_2_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L1193710204;
...
label_L1193710204:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L2125903542;
    __CN1_DEBUG_INFO(1342);
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L2128169374;
    __CN1_DEBUG_INFO(1343);
    if (get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2125903542;
    ...
    goto label_L2125903542;

label_L2128169374:
    __CN1_DEBUG_INFO(1348);
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L685871974;
    __CN1_DEBUG_INFO(1349);
    if (get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2125903542;
...
JAVA_VOID com_codename1_ui_MenuBar_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 5364, 1388);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1365);
    /* VarOp.assignFrom */ ilocals_2_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1366);
    if (ilocals_2_<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L1529303412;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1529303412;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1529303412;
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1529303412;
...
label_L1529303412:
    ...
    if (virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L284123040;
    ...
    if (ilocals_3_>=2 /* ICONST_2 */) /* IF_ICMPGE CustomJump */ goto label_L609116570;
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L609116570;
    __CN1_DEBUG_INFO(1372);
    if (get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1092822;
    __CN1_DEBUG_INFO(1373);
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_MenuBar_commandList(__cn1ThisObject));locals[4].type=CN1_TYPE_OBJECT;
label_L187019413:
    __CN1_DEBUG_INFO(1374);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1092822;
    __CN1_DEBUG_INFO(1375);
    BC_ALOAD(4);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1641931089;
    if (virtual_com_codename1_ui_Dialog_isMenu___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1641931089;
...
label_L1641931089:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Container_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    goto label_L187019413;
...
label_L609116570:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isLSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L1555055322;
    __CN1_DEBUG_INFO(1385);
    if (get_field_com_codename1_ui_MenuBar_left(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1505964934;
...
label_L1555055322:
    ...
    if (/* CustomInvoke */com_codename1_ui_MenuBar_isRSK___int_R_boolean(threadStateData, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L1461360262;
    __CN1_DEBUG_INFO(1392);
    if (get_field_com_codename1_ui_MenuBar_right(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1906128360;
...
label_L1461360262:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L284123040;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1409);
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L795156371;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1878677242;
    if (get_field_com_codename1_ui_MenuBar_minimizeOnBack(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1878677242;
...
label_L795156371:
    ...
    if (ilocals_1_==get_static_com_codename1_ui_MenuBar_clearSK(threadStateData)) /* IF_ICMPEQ CustomJump */ goto label_L1817662245;
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_backspaceSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L1878677242;
...
label_L1878677242:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1954355506;
    ...
    if (virtual_com_codename1_ui_events_ActionEvent_isConsumed___R_boolean(threadStateData, locals[4].data.o)!=0) /* IFNE CustomJump */ goto label_L1954355506;
...
JAVA_VOID com_codename1_ui_MenuBar_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5364, 2674);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (virtual_com_codename1_ui_plaf_Style_isModified___R_boolean(threadStateData, get_field_com_codename1_ui_MenuBar_menuStyle(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1935870377;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1935870377;
...
label_L1318313145:
    ...
    if (get_field_com_codename1_ui_MenuBar_menuCellRenderer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L411787317;
...
label_L1868964323:
    if (ilocals_3_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_MenuBar_soft(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L77811359;
...
JAVA_OBJECT com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 9, 0, 5364, 5407);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* VarOp.assignFrom */ ilocals_3_ = /* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5408), 0 /* ICONST_0 */);
    __CN1_DEBUG_INFO(1480);
    /* VarOp.assignFrom */     ilocals_6_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(1481);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1069571746;
    ...
    if (virtual_com_codename1_ui_Form_getSoftButtonCount___R_int(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject))<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L2089360295;
...
label_L1648387359:
    ...
    goto label_L1022830989;

label_L1069571746:
    __CN1_DEBUG_INFO(1493);
    PUSH_FLOAT(1); /* FCONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5409), STRING_FROM_CONSTANT_POOL_OFFSET(5410));
    PUSH_OBJ(tmpResult); }
    ...
    PUSH_FLOAT(1); /* FCONST_1 */
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5411), STRING_FROM_CONSTANT_POOL_OFFSET(5412));
    PUSH_OBJ(tmpResult); }
    { JAVA_FLOAT tmpResult = java_lang_Float_parseFloat___java_lang_String_R_float(threadStateData, SP[-1].data.o);
    SP[-1].data.f = tmpResult; SP[-1].type = CN1_TYPE_FLOAT; }
    PUSH_FLOAT(100.0); /* LDC */
...
label_L1022830989:
    ...
    if (virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L33510911;
...
label_L33510911:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L891232836;
...
label_L891232836:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1419166053;
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5413), 1 /* ICONST_1 */)==0) /* IFEQ CustomJump */ goto label_L1419166053;
    __CN1_DEBUG_INFO(1510);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Dialog_showPacked___java_lang_String_boolean_R_com_codename1_ui_Command(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(64), 1 /* ICONST_1 */);
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5364, 3942);
    ...
    if (virtual_com_codename1_ui_MenuBar_isRTL___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1369977147;
    __CN1_DEBUG_INFO(1526);
    if (virtual_com_codename1_ui_plaf_LookAndFeel_isReverseSoftButtons___R_boolean(threadStateData, locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L704894556;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1715657818;
...
JAVA_INT com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 5364, 5414);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
label_L344751179:
    if (ilocals_4_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L71148574;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 5364, 5417);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (virtual_com_codename1_ui_Button_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1356419559;
    __CN1_DEBUG_INFO(1578);
    BC_ALOAD(2);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5418));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    virtual_com_codename1_ui_Button_setIcon___com_codename1_ui_Image(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    goto label_L967643830;

label_L1356419559:
    __CN1_DEBUG_INFO(1580);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5419), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L967643830;
    __CN1_DEBUG_INFO(1581);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setText___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(220)); 
...
label_L967643830:
    ...
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_com_codename1_ui_Command_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5416));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1588);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1320443884;
    ...
    goto label_L555740147;

label_L1320443884:
    __CN1_DEBUG_INFO(1591);
    /* CustomInvoke */virtual_com_codename1_ui_Button_setUIID___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5008)); 

label_L555740147:
    __CN1_DEBUG_INFO(1593);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Command_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(116));locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1594);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1003737182;
...
JAVA_OBJECT com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 9, 0, 5364, 5420);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_LookAndFeel_isTouchMenus___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1790598448;
...
label_L1484982263:
    if (ilocals_4_>=virtual_java_util_Vector_size___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L102577332;
    ...
    __CN1_DEBUG_INFO(1614);
    BC_IINC(4, 1);
    goto label_L1484982263;

label_L102577332:
    __CN1_DEBUG_INFO(1618);
    if (/* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5421), 0 /* ICONST_0 */)!=0) /* IFNE CustomJump */ goto label_L2113367449;
    ...
    if (ilocals_4_<=virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1167916234;
...
label_L1167916234:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L717998169;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1790430792:
    ...
    if (ilocals_5_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L745205026;
...
label_L1258103238:
    ...
    if (ilocals_6_==0) /* IFEQ CustomJump */ goto label_L238169801;
    if (ilocals_6_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L238169801;
    if (ilocals_7_<2 /* ICONST_2 */) /* IF_IMPLT CustomJump */ goto label_L238169801;
    ...
    SP++;
    SP--; SP[-1].data.i = SP[-1].data.i % (*SP).data.i; /* IREM */
    if(POP_INT() == 0) /* IFEQ */ goto label_L2060432982;
    PUSH_INT(1); /* ICONST_1 */
...
label_L777970377:
    ...
    if (ilocals_8_==ilocals_5_) /* IF_ICMPEQ CustomJump */ goto label_L1436944861;
    __CN1_DEBUG_INFO(1633);
    goto label_L238169801;
...
label_L1436944861:
    ...
    SP--; SP[-1].data.i = SP[-1].data.i % (*SP).data.i; /* IREM */
    BC_ISTORE(6);
    goto label_L1258103238;

label_L238169801:
    __CN1_DEBUG_INFO(1637);
    if (ilocals_8_!=ilocals_5_) /* IF_ICMPNE CustomJump */ goto label_L745205026;
...
label_L745205026:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_layouts_GridLayout_setFillLastRow___boolean(threadStateData, locals[6].data.o, /* CustomInvoke */virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5422), 1 /* ICONST_1 */)); 
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCommands___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5423);
...
JAVA_OBJECT com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5364, 5424);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* CustomInvoke */virtual_com_codename1_ui_List_setUIID___java_lang_String(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4803)); 
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3198)); 
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Component_setUIID___java_lang_String(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5425)); 
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Form_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, get_field_com_codename1_ui_MenuBar_parent(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5408), 0 /* ICONST_0 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L337029130;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 5364, 5426);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1687);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1906029492;
...
label_L1906029492:
    ...
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Button);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1389055824;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5427);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5428);
...
JAVA_INT com_codename1_ui_MenuBar_getDragRegionStatus___int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 5364, 2427);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_OBJECT com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5429);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2857);
...
JAVA_OBJECT com_codename1_ui_MenuBar_getParentForm___R_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 5430);
...
JAVA_VOID com_codename1_ui_MenuBar_initTitleBarStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5364, 2838);
...
JAVA_BOOLEAN com_codename1_ui_MenuBar_isTouchMenus___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5364, 4028);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1764);
    /* VarOp.assignFrom */ ilocals_1_ = virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(threadStateData, __cn1ThisObject);
    __CN1_DEBUG_INFO(1765);
    if (ilocals_1_==3 /* ICONST_3 */) /* IF_ICMPEQ CustomJump */ goto label_L631621595;
    if (ilocals_1_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L80903581;
    __CN1_DEBUG_INFO(1766);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTouchScreenDevice___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L80903581;

label_L631621595:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L687372448;
...
JAVA_VOID com_codename1_ui_MenuBar___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 5364, 860);
    __CN1_DEBUG_INFO(95);
    if (com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L541135648;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getImplementation___R_com_codename1_impl_CodenameOneImplementation(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() != JAVA_NULL) /* IFNONNULL */ goto label_L726762476;
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form)__cn1ThisObject->__codenameOneParentClsReference->vtable[406])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_getCommandBehavior___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommandBehavior___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[407])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[408])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[409])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[410])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[411])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[412])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__)__cn1ThisObject->__codenameOneParentClsReference->vtable[413])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[414])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[415])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[416])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[417])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_showMenu__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_showMenu__)__cn1ThisObject->__codenameOneParentClsReference->vtable[418])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY)__cn1ThisObject->__codenameOneParentClsReference->vtable[419])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[420])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[421])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__)__cn1ThisObject->__codenameOneParentClsReference->vtable[422])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[423])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[424])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[425])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_getCommandCount___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommandCount___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[426])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[427])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_installMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_installMenuBar__)__cn1ThisObject->__codenameOneParentClsReference->vtable[428])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_unInstallMenuBar__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_unInstallMenuBar__)__cn1ThisObject->__codenameOneParentClsReference->vtable[429])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeAllCommands__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeAllCommands__)__cn1ThisObject->__codenameOneParentClsReference->vtable[430])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[431])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_addSelectCommand___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_addSelectCommand___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[432])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_removeSelectCommand__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_removeSelectCommand__)__cn1ThisObject->__codenameOneParentClsReference->vtable[433])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[434])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[435])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[436])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[437])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[438])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[439])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[440])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button)__cn1ThisObject->__codenameOneParentClsReference->vtable[441])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[442])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCommands___R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCommands___R_java_util_Vector)__cn1ThisObject->__codenameOneParentClsReference->vtable[443])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List)__cn1ThisObject->__codenameOneParentClsReference->vtable[444])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[445])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[446])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command)__cn1ThisObject->__codenameOneParentClsReference->vtable[447])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container)__cn1ThisObject->__codenameOneParentClsReference->vtable[448])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[449])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_MenuBar_initTitleBarStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_MenuBar_initTitleBarStatus__)__cn1ThisObject->__codenameOneParentClsReference->vtable[451])(threadStateData, __cn1ThisObject);
}
...
void __INIT_VTABLE_com_codename1_ui_MenuBar(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[405] = &com_codename1_ui_MenuBar_actionPerformed___com_codename1_ui_events_ActionEvent;
    vtable[406] = &com_codename1_ui_MenuBar_initMenuBar___com_codename1_ui_Form;
    vtable[407] = &com_codename1_ui_MenuBar_getCommandBehavior___R_int;
    vtable[408] = &com_codename1_ui_MenuBar_setDefaultCommand___com_codename1_ui_Command;
    vtable[409] = &com_codename1_ui_MenuBar_getDefaultCommand___R_com_codename1_ui_Command;
    vtable[410] = &com_codename1_ui_MenuBar_setClearCommand___com_codename1_ui_Command;
    vtable[411] = &com_codename1_ui_MenuBar_getClearCommand___R_com_codename1_ui_Command;
    vtable[412] = &com_codename1_ui_MenuBar_findCommandComponent___com_codename1_ui_Command_R_com_codename1_ui_Button;
    vtable[413] = &com_codename1_ui_MenuBar_adaptTitleLayoutBackCommandStructure__;
    vtable[414] = &com_codename1_ui_MenuBar_setBackCommand___com_codename1_ui_Command;
    vtable[415] = &com_codename1_ui_MenuBar_getBackCommand___R_com_codename1_ui_Command;
    vtable[416] = &com_codename1_ui_MenuBar_getSelectCommand___R_com_codename1_ui_Command;
    vtable[417] = &com_codename1_ui_MenuBar_createSoftButton___java_lang_String_R_com_codename1_ui_Button;
    vtable[418] = &com_codename1_ui_MenuBar_showMenu__;
    vtable[419] = &com_codename1_ui_MenuBar_getSoftButtons___R_com_codename1_ui_Button_1ARRAY;
    vtable[420] = &com_codename1_ui_MenuBar_verifyBackCommandRTL___com_codename1_ui_Button;
    vtable[421] = &com_codename1_ui_MenuBar_createBackCommandButton___R_com_codename1_ui_Button;
    vtable[422] = &com_codename1_ui_MenuBar_synchronizeCommandsWithButtonsInBackbutton__;
    vtable[423] = &com_codename1_ui_MenuBar_hideEmptyCommand___com_codename1_ui_Button;
    vtable[424] = &com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command;
    vtable[425] = &com_codename1_ui_MenuBar_getCommand___int_R_com_codename1_ui_Command;
    vtable[426] = &com_codename1_ui_MenuBar_getCommandCount___R_int;
    vtable[427] = &com_codename1_ui_MenuBar_addCommand___com_codename1_ui_Command_int;
    vtable[428] = &com_codename1_ui_MenuBar_installMenuBar__;
    vtable[429] = &com_codename1_ui_MenuBar_unInstallMenuBar__;
    vtable[430] = &com_codename1_ui_MenuBar_removeAllCommands__;
    vtable[431] = &com_codename1_ui_MenuBar_removeCommand___com_codename1_ui_Command;
    vtable[432] = &com_codename1_ui_MenuBar_addSelectCommand___java_lang_String;
    vtable[433] = &com_codename1_ui_MenuBar_removeSelectCommand__;
    vtable[434] = &com_codename1_ui_MenuBar_createSelectCommand___R_com_codename1_ui_Command;
    vtable[435] = &com_codename1_ui_MenuBar_createMenuSelectCommand___R_com_codename1_ui_Command;
    vtable[436] = &com_codename1_ui_MenuBar_createMenuCancelCommand___R_com_codename1_ui_Command;
    vtable[437] = &com_codename1_ui_MenuBar_handlesKeycode___int_R_boolean;
    vtable[438] = &com_codename1_ui_MenuBar_showMenuDialog___com_codename1_ui_Dialog_R_com_codename1_ui_Command;
    vtable[439] = &com_codename1_ui_MenuBar_isReverseSoftButtons___R_boolean;
    vtable[440] = &com_codename1_ui_MenuBar_calculateTouchCommandGridColumns___com_codename1_ui_Container_R_int;
    vtable[441] = &com_codename1_ui_MenuBar_createTouchCommandButton___com_codename1_ui_Command_R_com_codename1_ui_Button;
    vtable[442] = &com_codename1_ui_MenuBar_createCommandComponent___java_util_Vector_R_com_codename1_ui_Component;
    vtable[443] = &com_codename1_ui_MenuBar_getCommands___R_java_util_Vector;
    vtable[444] = &com_codename1_ui_MenuBar_createCommandList___java_util_Vector_R_com_codename1_ui_List;
    vtable[445] = &com_codename1_ui_MenuBar_getComponentSelectedCommand___com_codename1_ui_Component_R_com_codename1_ui_Command;
    vtable[446] = &com_codename1_ui_MenuBar_getSelectMenuItem___R_com_codename1_ui_Command;
    vtable[447] = &com_codename1_ui_MenuBar_getCancelMenuItem___R_com_codename1_ui_Command;
    vtable[448] = &com_codename1_ui_MenuBar_getTitleAreaContainer___R_com_codename1_ui_Container;
    vtable[449] = &com_codename1_ui_MenuBar_getTitleComponent___R_com_codename1_ui_Component;
    vtable[450] = &com_codename1_ui_MenuBar_getParentForm___R_com_codename1_ui_Form;
    vtable[451] = &com_codename1_ui_MenuBar_initTitleBarStatus__;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_MenuBar(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_MenuBar.vtable = malloc(sizeof(void*) *452);
