...
label_L1732538491:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L1757252775;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(977);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L1260955583;
        default: goto label_L221692355;
    }
...
label_L1260955583:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L157990006;
...
label_L157990006:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1298780808;
        default: goto label_L1131577797;
    }
...
label_L614785733:
    if (ilocals_3_>=4/* ICONST_4 */) /* IF_ICMPGE CustomJump */ goto label_L2020702385;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1009);
    ...
    SP--;
    switch((*SP).data.i) {
        case 99: goto label_L668637515;
        default: goto label_L1894861020;
    }
...
label_L668637515:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L53871235;
