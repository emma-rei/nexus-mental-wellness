...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_fillPolygon___int_int_int_1ARRAY_int_1ARRAY_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    int restoreToL169145898901;
    int tryBlockOffsetL169145898901;
    DEFINE_CATCH_BLOCK(catch_L169145898901, label_L648630181, restoreToL169145898901);
    int restoreToL64863018102;
    int tryBlockOffsetL64863018102;
    DEFINE_CATCH_BLOCK(catch_L64863018102, label_L648630181, restoreToL64863018102);
    __CN1_DEBUG_INFO(5006);
    if (/* CustomInvoke */com_codename1_ui_geom_GeneralPath_isConvexPolygon___int_1ARRAY_int_1ARRAY_R_boolean(threadStateData, locals[3].data.o, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1179272258, 0);
...
label_L1691458989:
 tryBlockOffsetL169145898901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L169145898901);
    restoreToL169145898901 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(5011);
    /* VarOp.assignFrom */     ilocals_7_ = 0 /* ICONST_0 */; 

label_L1970612644:
    if (ilocals_7_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1002911155, 1);
    __CN1_DEBUG_INFO(5012);
    if (ilocals_7_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1467977993, 1);
...
label_L648630181:
 tryBlockOffsetL64863018102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L64863018102);
    restoreToL64863018102 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_applyPaint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_paint(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2006835220;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2006835220;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_unapplyPaint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_paint(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1547817015;
    PUSH_POINTER(get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_paint(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_impl_ios_IOSImplementation_RadialGradient);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1547817015;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_applyTransform__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_transformApplied(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1178777373;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_setNativeClipping___com_codename1_impl_ios_IOSImplementation_ClipShape(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_impl_ios_IOSImplementation_ClipShape_isRect___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L340789130;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_nativeDrawArc___int_int_int_int_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6, JAVA_INT __cn1Arg7, JAVA_INT __cn1Arg8) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_drawingArcPath(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1774589469;
...
label_L1774589469:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpStroke1px(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L988786279;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_nativeFillArc___int_int_int_int_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_INT __cn1Arg6, JAVA_INT __cn1Arg7, JAVA_INT __cn1Arg8) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_drawingArcPath(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L773296871;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_nativeDrawAlphaMask___com_codename1_impl_ios_IOSImplementation_TextureAlphaMask(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1729734072;
    ...
    BC_LCMP();
    if(POP_INT() == 0) /* IFEQ */ goto label_L1729734072;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_GlobalGraphics_nativeDrawShape___com_codename1_ui_geom_Shape_com_codename1_ui_Stroke(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL184878550101;
    int tryBlockOffsetL184878550101;
    DEFINE_CATCH_BLOCK(catch_L184878550101, label_L1052127672, restoreToL184878550101);
    int restoreToL164235661502;
    int tryBlockOffsetL164235661502;
    DEFINE_CATCH_BLOCK(catch_L164235661502, label_L1052127672, restoreToL164235661502);
    int restoreToL105212767203;
    int tryBlockOffsetL105212767203;
    DEFINE_CATCH_BLOCK(catch_L105212767203, label_L1052127672, restoreToL105212767203);
    __CN1_DEBUG_INFO(5240);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_geom_GeneralPath);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2037202079, 0);
    __CN1_DEBUG_INFO(5241);
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_transform(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1811880447, 0);
    if (virtual_com_codename1_ui_Transform_isIdentity___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_transform(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1105282397, 0);
...
label_L1811880447:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1314228008, 0);
...
label_L1314228008:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1590481849, 0);
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(5259);
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpDrawShape(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L116356643, 0);
...
label_L116356643:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpTransform(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1692523793, 0);
...
label_L1692523793:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpTransform2(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1544067887, 0);
...
label_L1544067887:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpRect2(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1771687225, 0);
...
label_L1771687225:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpDrawStroke(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L347791431, 0);
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(5282);
    ...
    if (CN1_CMP_EXPR(dlocals_8_, 1 /* DCONST_1 */)>=0) /* IFGE CustomJump */ JUMP_TO(label_L2128195220, 0);
    /* VarOp.assignFrom */     dlocals_8_ = 1 /* DCONST_1 */; 

label_L2128195220:
    __CN1_DEBUG_INFO(5289);
    if (CN1_CMP_EXPR(dlocals_6_, 1 /* DCONST_1 */)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1720746883, 0);
...
label_L1848785501:
 tryBlockOffsetL184878550101 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L184878550101);
    restoreToL184878550101 = threadStateData->threadObjectStackOffset;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1095203437, 1);
...
label_L1095203437:
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L45880026, 1);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L824357143, 1);
...
label_L824357143:
    ...
    if (locals[11].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1397530667, 1);
    ...
    PUSH_POINTER(get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpDrawShape(__cn1ThisObject));
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L698498109, 1);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L1265287441, 1);
...
label_L1265287441:
    ...
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$4800___com_codename1_impl_ios_IOSImplementation_R_com_codename1_impl_ios_IOSImplementation_TextureCache(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_this_0(__cn1ThisObject)));
    PUSH_POINTER(get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_tmpDrawShape(__cn1ThisObject));
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1877240674, 1);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L1495257933, 1);
...
label_L1397530667:
    ...
    if (locals[11].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1642356615, 0);
...
label_L1642356615:
 tryBlockOffsetL164235661502 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L164235661502);
    restoreToL164235661502 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(5319);
    if (get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_paint(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2090563811, 1);
    PUSH_POINTER(get_field_com_codename1_impl_ios_IOSImplementation_GlobalGraphics_paint(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_com_codename1_impl_ios_IOSImplementation_RadialGradient);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L2090563811, 1);
...
END_TRY(1);    __CN1_DEBUG_INFO(5329);
    ...
    JUMP_TO(label_L812168041, 0);

label_L1052127672:
 tryBlockOffsetL105212767203 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L105212767203);
    restoreToL105212767203 = threadStateData->threadObjectStackOffset;
