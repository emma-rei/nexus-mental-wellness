...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_Color_cache___R_java_util_Map(CODENAME_ONE_THREAD_STATE) {
    ...
    if (get_static_com_codename1_ui_plaf_CSSBorder_Color_cache(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2062755811;
...
label_L894844492:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1950158148;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_Color_parse___java_lang_String_R_com_codename1_ui_plaf_CSSBorder_Color(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L1842844180;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(100);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L251161714;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_validate___java_lang_String_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4579))!=0) /* IFNE CustomJump */ goto label_L305334212;
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5699))!=0) /* IFNE CustomJump */ goto label_L305334212;
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5700))!=0) /* IFNE CustomJump */ goto label_L305334212;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5701), locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L378797968;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L181663498;
    __CN1_DEBUG_INFO(895);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(896);
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(locals[2].data.o)!=get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L5557427;
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_color(locals[2].data.o)!=get_field_com_codename1_ui_plaf_CSSBorder_Color_color(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L5557427;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L162716758;
...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_Color___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4579))==0) /* IFEQ CustomJump */ goto label_L1646207916;
    __CN1_DEBUG_INFO(906);
    { JAVA_INT tmpResult = virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o);
    PUSH_INT(tmpResult); }
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2002903874;
...
label_L2002903874:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1320791629;
...
label_L1320791629:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=5 /* ICONST_5 */) /* IF_ICMPNE CustomJump */ goto label_L1428223605;
...
label_L1428223605:
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L757298272;
...
label_L1646207916:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5699))==0) /* IFEQ CustomJump */ goto label_L1223820621;
...
label_L1223820621:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(5701), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1262092760;
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_Color_isTransparent___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_Color_alpha(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L435930516;
    PUSH_INT(1); /* ICONST_1 */
