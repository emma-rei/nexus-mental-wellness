...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView___INIT_____com_codename1_impl_ios_IOSImplementation_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 9659, 201);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_finalize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1658704411;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1658704411;
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_isFocusable___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9659, 2556);
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L381930033;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L756637412;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_onPositionSizeChange__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L761973299;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L761973299;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 1, 0, 9659, 1848);
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L564893839;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L564893839;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L691096777;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L691096777;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_setLightweightMode___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1312348533;
    if (CN1_CMP_EXPR(CN1_ARRAY_ELEMENT_LONG(get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_nativePeer(__cn1ThisObject), 0 /* ICONST_0 */), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1312348533;
    __CN1_DEBUG_INFO(6911);
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1312348533;
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L905488851;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1223303171;
...
label_L1223303171:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1312348533;
...
JAVA_OBJECT com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_generatePeerImage___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 9659, 3804);
    ...
    if (CN1_CMP_EXPR(llocals_2_, 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1797159635;
...
label_L1797159635:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_impl_ios_IOSImplementation_NativeImage___INIT_____com_codename1_impl_ios_IOSImplementation_java_lang_String(threadStateData, SP[-1].data.o, get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_this_0(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(9660));     SP -= 1;
    BC_ASTORE(4);
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_shouldRenderPeerImage___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_lightweightMode(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1676010932;
    if (virtual_com_codename1_impl_ios_IOSImplementation_NativeIPhoneView_isInitialized___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L329481770;

label_L1676010932:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L173059685;
