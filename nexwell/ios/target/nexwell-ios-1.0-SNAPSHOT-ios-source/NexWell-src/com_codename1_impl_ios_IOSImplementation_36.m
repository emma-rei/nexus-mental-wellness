...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_36___INIT_____java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9604, 202);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_36_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9604, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1446261940cn1_class_id_java_lang_Throwable1;
    int tryBlockOffsetL1446261940cn1_class_id_java_lang_Throwable1;
    DEFINE_CATCH_BLOCK(catch_L1446261940cn1_class_id_java_lang_Throwable1, label_L161113555, restoreToL1446261940cn1_class_id_java_lang_Throwable1);

label_L1446261940:
 tryBlockOffsetL1446261940cn1_class_id_java_lang_Throwable1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Throwable, catch_L1446261940cn1_class_id_java_lang_Throwable1);
    restoreToL1446261940cn1_class_id_java_lang_Throwable1 = threadStateData->threadObjectStackOffset;
