...
JAVA_INT com_codename1_io_tar_TarInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    __CN1_DEBUG_INFO(80);
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L365475676;
    __CN1_DEBUG_INFO(81);
...
JAVA_INT com_codename1_io_tar_TarInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(96);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L654067279;
    __CN1_DEBUG_INFO(97);
    ...
    PUSH_LONG(tmpResult); }
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L292880130;
    __CN1_DEBUG_INFO(98);
...
label_L292880130:
    ...
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L654067279;
...
label_L654067279:
    ...
    if (ilocals_4_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L427354807;
    __CN1_DEBUG_INFO(107);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1239075987;
...
label_L1696149270:
    ...
    SP++;
    PUSH_INT(512);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L231744985;
    ...
    if (ilocals_4_>=0) /* IFGE CustomJump */ goto label_L1005209486;
    __CN1_DEBUG_INFO(135);
    goto label_L231744985;
...
label_L536160881:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L2058930546;
    /* VarOp.assignFrom */ ilocals_8_=CN1_ARRAY_ELEMENT_BYTE(locals[5].data.o, ilocals_7_);
    __CN1_DEBUG_INFO(145);
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1993004305;
    __CN1_DEBUG_INFO(146);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(147);
    goto label_L2058930546;
...
label_L2058930546:
    ...
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L859363078;
...
JAVA_VOID com_codename1_io_tar_TarInputStream_closeCurrentEntry__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L259484490;
    __CN1_DEBUG_INFO(166);
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L800413160;
...
label_L1817190424:
    ...
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L800413160;
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L430261453;
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    ...
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L430261453;
...
JAVA_VOID com_codename1_io_tar_TarInputStream_skipPad__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_io_tar_TarInputStream_bytesRead(__cn1ThisObject), 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1489583075;
    ...
    if (ilocals_1_<=0) /* IFLE CustomJump */ goto label_L1489583075;
    __CN1_DEBUG_INFO(196);
    /* VarOp.assignFrom */     llocals_2_ = 0 /* LCONST_0 */; 

label_L1574317831:
    __CN1_DEBUG_INFO(197);
    if (CN1_CMP_EXPR(llocals_2_, ((JAVA_LONG)(512 - ilocals_1_)))>=0) /* IFGE CustomJump */ goto label_L1489583075;
...
JAVA_LONG com_codename1_io_tar_TarInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_tar_TarInputStream_defaultSkip(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1852218204;
...
label_L1852218204:
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L64697960;
...
label_L209366140:
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L308020179;
    __CN1_DEBUG_INFO(226);
    BC_ALOAD(0);
    BC_ALOAD(5);
    PUSH_INT(0); /* ICONST_0 */
    if (CN1_CMP_EXPR(llocals_3_, 2048LL)>=0) /* IFGE CustomJump */ goto label_L2124327048;
    BC_LLOAD(3);
...
label_L620261500:
    ...
    if (ilocals_6_>=0) /* IFGE CustomJump */ goto label_L2118806269;
