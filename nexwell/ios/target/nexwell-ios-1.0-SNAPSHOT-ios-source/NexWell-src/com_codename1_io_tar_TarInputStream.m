...
JAVA_VOID com_codename1_io_tar_TarInputStream___INIT_____java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 8978, 202);
...
JAVA_BOOLEAN com_codename1_io_tar_TarInputStream_markSupported___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8978, 986);
...
JAVA_VOID com_codename1_io_tar_TarInputStream_reset__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 8978, 988);
    monitorEnterBlock(threadStateData, __cn1ThisObject);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_io_IOException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8369));     SP -= 1;
...
JAVA_INT com_codename1_io_tar_TarInputStream_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8978, 987);
    ...
    __CN1_DEBUG_INFO(80);
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L286222051;
    __CN1_DEBUG_INFO(81);
...
JAVA_INT com_codename1_io_tar_TarInputStream_read___byte_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 8978, 987);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(96);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2011580998;
    __CN1_DEBUG_INFO(97);
    ...
    PUSH_LONG(tmpResult); }
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L1369913459;
    __CN1_DEBUG_INFO(98);
...
label_L1369913459:
    ...
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L2011580998;
...
label_L2011580998:
    ...
    if (ilocals_4_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L875191127;
    __CN1_DEBUG_INFO(107);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1584929615;
...
JAVA_OBJECT com_codename1_io_tar_TarInputStream_getNextEntry___R_com_codename1_io_tar_TarEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 9, 0, 8978, 8979);
...
label_L361960650:
    ...
    SP++;
    PUSH_INT(512);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L462020284;
    ...
    if (ilocals_4_>=0) /* IFGE CustomJump */ goto label_L1929713950;
    __CN1_DEBUG_INFO(135);
    goto label_L462020284;
...
label_L93367172:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L196069204;
    /* VarOp.assignFrom */ ilocals_8_=CN1_ARRAY_ELEMENT_BYTE(locals[5].data.o, ilocals_7_);
    __CN1_DEBUG_INFO(145);
    if (ilocals_8_==0) /* IFEQ CustomJump */ goto label_L1585874083;
    __CN1_DEBUG_INFO(146);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(147);
    goto label_L196069204;

label_L1585874083:
    __CN1_DEBUG_INFO(144);
    BC_IINC(7, 1);
    goto label_L93367172;

label_L196069204:
    __CN1_DEBUG_INFO(151);
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L145279672;
...
JAVA_VOID com_codename1_io_tar_TarInputStream_closeCurrentEntry__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 8978, 8980);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(165);
    if (get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2101881246;
    __CN1_DEBUG_INFO(166);
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L394332424;
...
label_L1501477292:
    ...
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L394332424;
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L390946039;
    { JAVA_LONG tmpResult = virtual_com_codename1_io_tar_TarEntry_getSize___R_long(threadStateData, get_field_com_codename1_io_tar_TarInputStream_currentEntry(__cn1ThisObject));
    PUSH_LONG(tmpResult); }
    PUSH_LONG(get_field_com_codename1_io_tar_TarInputStream_currentFileSize(__cn1ThisObject));
    SP--; SP[-1].data.l = (SP[-1].data.l - (*SP).data.l); /* LSUB */
    ...
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L390946039;
    __CN1_DEBUG_INFO(173);
    PUSH_POINTER(__NEW_java_io_IOException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_io_IOException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8981));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_io_tar_TarInputStream_skipPad__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 8978, 8982);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(192);
    if (CN1_CMP_EXPR(get_field_com_codename1_io_tar_TarInputStream_bytesRead(__cn1ThisObject), 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L1707503556;
    ...
    if (ilocals_1_<=0) /* IFLE CustomJump */ goto label_L1707503556;
    __CN1_DEBUG_INFO(196);
    /* VarOp.assignFrom */     llocals_2_ = 0 /* LCONST_0 */; 

label_L2056319805:
    __CN1_DEBUG_INFO(197);
    if (CN1_CMP_EXPR(llocals_2_, ((JAVA_LONG)(512 - ilocals_1_)))>=0) /* IFGE CustomJump */ goto label_L1707503556;
...
JAVA_LONG com_codename1_io_tar_TarInputStream_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    volatile JAVA_LONG llocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_6_ = 0; /* v6 */
    DEFINE_INSTANCE_METHOD_STACK(7, 7, 0, 8978, 989);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     llocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(212);
    if (get_field_com_codename1_io_tar_TarInputStream_defaultSkip(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L130527868;
...
label_L130527868:
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)>0) /* IFGT CustomJump */ goto label_L735627505;
...
label_L469018523:
    ...
    if (CN1_CMP_EXPR(llocals_3_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ goto label_L2109094401;
    __CN1_DEBUG_INFO(226);
    BC_ALOAD(0);
    BC_ALOAD(5);
    PUSH_INT(0); /* ICONST_0 */
    if (CN1_CMP_EXPR(llocals_3_, 2048LL)>=0) /* IFGE CustomJump */ goto label_L4339601;
    BC_LLOAD(3);
    goto label_L984363447;
...
label_L984363447:
    ...
    if (ilocals_6_>=0) /* IFGE CustomJump */ goto label_L1474230611;
    __CN1_DEBUG_INFO(228);
    goto label_L2109094401;

label_L1474230611:
    __CN1_DEBUG_INFO(230);
    /* VarOp.assignFrom */ llocals_3_=(llocals_3_ - ((JAVA_LONG)ilocals_6_));
    __CN1_DEBUG_INFO(231);
    goto label_L469018523;
