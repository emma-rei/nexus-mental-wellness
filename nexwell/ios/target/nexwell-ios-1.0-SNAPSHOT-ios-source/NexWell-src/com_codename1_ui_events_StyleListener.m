...
class_array1__com_codename1_ui_events_StyleListener.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_AccountForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_AccountForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_PomodoroTimer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_PomodoroTimer][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Toolbar_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Toolbar_2][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_SearchBar] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_SearchBar][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_FloatingActionButton] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_FloatingActionButton][0] = 12;
