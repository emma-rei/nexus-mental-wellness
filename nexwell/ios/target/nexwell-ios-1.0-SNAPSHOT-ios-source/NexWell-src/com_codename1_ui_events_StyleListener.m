...
class_array1__com_codename1_ui_events_StyleListener.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_MusicForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_MusicForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm_BreathingTimer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm_BreathingTimer][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm_PomodoroTimer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_HomePageForm_PomodoroTimer][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_MainForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_MainForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_EmergencyHelpForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_EmergencyHelpForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_SearchForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_SearchForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_Settings] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_Settings][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_ResourcesForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_ResourcesForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_BreathingTimerForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_BreathingTimerForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_PomodoroForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_PomodoroForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_GamesContainer] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_forms_GamesContainer][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_ChaosGame] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_ChaosGame][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_CircleProgress] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_CircleProgress][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_BaseRoundProgress] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_BaseRoundProgress][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_CircleFilledProgress] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_CircleFilledProgress][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_RichTextView] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_components_RichTextView][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeComponent] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeComponent][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Sheet] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Sheet][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Tabs] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Tabs][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_RadioButton] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_RadioButton][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Slider] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_Slider][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_ComponentGroup] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_ComponentGroup][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_CheckBox] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_ui_CheckBox][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_MultiButton] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_MultiButton][0] = 12;
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_Switch] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_Switch][0] = 12;
    ...
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_ToastBar_ToastBarComponent] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_StyleListener[cn1_class_id_com_codename1_components_ToastBar_ToastBarComponent][0] = 12;
