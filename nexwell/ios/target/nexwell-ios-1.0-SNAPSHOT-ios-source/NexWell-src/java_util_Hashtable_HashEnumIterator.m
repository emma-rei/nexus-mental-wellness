...
label_L1297189682:
    if (get_field_java_util_Hashtable_HashEnumIterator_start(__cn1ThisObject)<=get_field_java_util_Hashtable_firstSlot(get_field_java_util_Hashtable_HashEnumIterator_this_0(__cn1ThisObject))) /* IF_ICMPLE CustomJump */ goto label_L1272123492;
    ...
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ goto label_L1297189682;
