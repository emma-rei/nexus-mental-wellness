...
JAVA_VOID com_codename1_ui_SideMenuBar_8_sizeChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (virtual_com_codename1_ui_SideMenuBar_8_getWidth___R_int(threadStateData, __cn1ThisObject)==ilocals_4_) /* IF_ICMPEQ CustomJump */ goto label_L354350463;
...
label_L277437206:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1428469551;
...
JAVA_VOID com_codename1_ui_SideMenuBar_8_pointerDragged___int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_SideMenuBar_8_manualMotionLock(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L750795985;
...
label_L750795985:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1310167355;
    if (get_field_com_codename1_ui_SideMenuBar_8_pressedInRightPanel(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1310167355;
...
label_L1310167355:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$200___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L345780740;
...
JAVA_VOID com_codename1_ui_SideMenuBar_8_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (get_field_com_codename1_ui_SideMenuBar_8_manualMotionLock(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1693540983;
...
label_L1693540983:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_8_val_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(74)) /* IF_ACMPNE CustomJump */ goto label_L1232792716;
    __CN1_DEBUG_INFO(1237);
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L999699153;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1315908533;
...
label_L1232792716:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L568462037;
    __CN1_DEBUG_INFO(1241);
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1063423209;
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$200___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1063423209;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1063423209;
...
label_L568462037:
    ...
    PUSH_INT(2); /* ICONST_2 */
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1063423209;
...
label_L1063423209:
    ...
    if (/* CustomInvoke */com_codename1_ui_SideMenuBar_access$200___com_codename1_ui_SideMenuBar_R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L904409454;
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_SideMenuBar_access$600___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject)));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Container_contains___int_int_R_boolean(threadStateData, SP[-1].data.o, ilocals_1_, ilocals_2_);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L40736485;
...
label_L904409454:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L862486751;
...
JAVA_VOID com_codename1_ui_SideMenuBar_8_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (ilocals_1_!=get_static_com_codename1_ui_MenuBar_leftSK(threadStateData)) /* IF_ICMPNE CustomJump */ goto label_L407263135;
    __CN1_DEBUG_INFO(1328);
    if (get_field_com_codename1_ui_SideMenuBar_transitionRunning(get_field_com_codename1_ui_SideMenuBar_8_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1825662648;
...
JAVA_VOID virtual_com_codename1_ui_SideMenuBar_8_registerAnimated___com_codename1_ui_animations_Animation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_SideMenuBar_8_registerAnimated___com_codename1_ui_animations_Animation)__cn1ThisObject->__codenameOneParentClsReference->vtable[463])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_SideMenuBar_8_deregisterAnimated___com_codename1_ui_animations_Animation(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_SideMenuBar_8_deregisterAnimated___com_codename1_ui_animations_Animation)__cn1ThisObject->__codenameOneParentClsReference->vtable[466])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
void __INIT_VTABLE_com_codename1_ui_SideMenuBar_8(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[431] = &com_codename1_ui_SideMenuBar_8_sizeChanged___int_int;
    vtable[476] = &com_codename1_ui_SideMenuBar_8_actionCommandImpl___com_codename1_ui_Command_com_codename1_ui_events_ActionEvent;
    vtable[498] = &com_codename1_ui_SideMenuBar_8_shouldSendPointerReleaseToOtherForm___R_boolean;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_SideMenuBar_8(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_SideMenuBar_8.vtable = malloc(sizeof(void*) *531);
