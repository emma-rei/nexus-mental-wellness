...
JAVA_VOID com_codename1_ui_SideMenuBar_7___INIT_____com_codename1_ui_SideMenuBar_com_codename1_ui_Image_boolean_com_codename1_ui_Image_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 7030, 202);
...
JAVA_VOID com_codename1_ui_SideMenuBar_7_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 7030, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(913);
    if (get_field_com_codename1_ui_SideMenuBar_7_img(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L664656217;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1178090104;
...
label_L1178090104:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L918716909;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L38027658;
...
label_L918716909:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1278615395;
...
label_L664656217:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1320248993;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1320248993;
...
label_L1320248993:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1431064234;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L704482919;
...
label_L1431064234:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_7_val_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L236220307;
