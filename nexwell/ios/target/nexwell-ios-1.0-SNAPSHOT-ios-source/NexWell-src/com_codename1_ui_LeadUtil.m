...
JAVA_OBJECT com_codename1_ui_LeadUtil_leadParentImpl___com_codename1_ui_Component_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __CN1_DEBUG_INFO(41);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L542641486;
    __CN1_DEBUG_INFO(42);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L542641486:
    __CN1_DEBUG_INFO(44);
    if (get_field_com_codename1_ui_Component_hasLead(locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L566039179;
    __CN1_DEBUG_INFO(46);
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2951941;
    __CN1_DEBUG_INFO(47);
    /* VarOp.assignFrom */ locals[1].data.o = virtual_com_codename1_ui_Container_getLeadParent___R_com_codename1_ui_Container(threadStateData, locals[0].data.o);locals[1].type=CN1_TYPE_OBJECT;    goto label_L1262693971;
...
label_L1262693971:
    __CN1_DEBUG_INFO(51);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L566039179;
    __CN1_DEBUG_INFO(52);
...
JAVA_OBJECT com_codename1_ui_LeadUtil_leadComponentImpl___com_codename1_ui_Component_R_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(65);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L730949640;
    __CN1_DEBUG_INFO(66);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L730949640:
    __CN1_DEBUG_INFO(71);
    if (virtual_com_codename1_ui_Component_isDraggable___R_boolean(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L1659969211;
    if (virtual_com_codename1_ui_Component_scrollableXFlag___R_boolean(threadStateData, locals[0].data.o)!=0) /* IFNE CustomJump */ goto label_L1659969211;
    if (virtual_com_codename1_ui_Component_scrollableYFlag___R_boolean(threadStateData, locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L1659969211;

label_L1659969211:
    __CN1_DEBUG_INFO(74);
    if (get_field_com_codename1_ui_Component_hasLead(locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L174871747;
    __CN1_DEBUG_INFO(75);
...
JAVA_VOID com_codename1_ui_LeadUtil_pointerPressed___com_codename1_ui_Component_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __CN1_DEBUG_INFO(90);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1477431915;
    __CN1_DEBUG_INFO(91);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L1477431915:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2029920330;
    if (virtual_com_codename1_impl_CodenameOneImplementation_isScrollWheeling___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))!=0) /* IFNE CustomJump */ goto label_L2029920330;
    if (virtual_com_codename1_ui_Component_isFocusable___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L2029920330;
    if (virtual_com_codename1_ui_Component_isEnabled___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L2029920330;
    __CN1_DEBUG_INFO(98);
...
label_L2029920330:
    ...
    if (locals[0].data.o==locals[3].data.o) /* IF_ACMPEQ CustomJump */ goto label_L311487784;
...
JAVA_VOID com_codename1_ui_LeadUtil_pointerDragged___com_codename1_ui_Component_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2050124277;
...
label_L2050124277:
    ...
    if (locals[0].data.o==locals[3].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1552445522;
...
label_L1442707449:
    ...
    if (locals[0].data.o==locals[3].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1083292099;
...
JAVA_VOID com_codename1_ui_LeadUtil_pointerReleased___com_codename1_ui_Component_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L688197093;
...
label_L688197093:
    ...
    if (locals[3].data.o==locals[0].data.o) /* IF_ACMPEQ CustomJump */ goto label_L907080311;
...
JAVA_VOID com_codename1_ui_LeadUtil_pointerHoverReleased___com_codename1_ui_Component_int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L208181619;
...
label_L208181619:
    ...
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_LeadUtil_leadParentImpl___com_codename1_ui_Component_R_com_codename1_ui_Component(threadStateData, locals[0].data.o));
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1106933404;
...
label_L1074868579:
    ...
    if (locals[3].data.o==locals[0].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1906565212;
...
label_L969432090:
    ...
    if (locals[3].data.o==locals[0].data.o) /* IF_ACMPEQ CustomJump */ goto label_L722764585;
...
label_L2010856706:
    ...
    if (locals[0].data.o==locals[3].data.o) /* IF_ACMPEQ CustomJump */ goto label_L2027549979;
...
label_L602748972:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1810748644;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1810748644;
