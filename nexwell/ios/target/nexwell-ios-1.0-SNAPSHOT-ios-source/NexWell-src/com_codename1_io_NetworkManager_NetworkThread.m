...
JAVA_VOID com_codename1_io_NetworkManager_NetworkThread___INIT_____com_codename1_io_NetworkManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 3220, 202);
...
JAVA_OBJECT com_codename1_io_NetworkManager_NetworkThread_getCurrentRequest___R_com_codename1_io_ConnectionRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3220, 3221);
...
JAVA_VOID com_codename1_io_NetworkManager_NetworkThread_start__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 3220, 1167);
    ...
    /* CustomInvoke */virtual_com_codename1_impl_CodenameOneImplementation_startThread___java_lang_String_java_lang_Runnable(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(3222), __cn1ThisObject);     SP -= 1;
...
JAVA_VOID com_codename1_io_NetworkManager_NetworkThread_interrupt__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 3220, 1160);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(245);
    if (get_field_com_codename1_io_NetworkManager_NetworkThread_threadInstance(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L301601202;
...
JAVA_BOOLEAN com_codename1_io_NetworkManager_NetworkThread_runCurrentRequest___com_codename1_io_ConnectionRequest_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 11, 0, 3220, 3224);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL559298332cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL559298332cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L559298332cn1_class_id_java_lang_InterruptedException1, label_L1189050702, restoreToL559298332cn1_class_id_java_lang_InterruptedException1);
    int restoreToL559526002;
    int tryBlockOffsetL559526002;
    DEFINE_CATCH_BLOCK(catch_L559526002, label_L1557571623, restoreToL559526002);
    int restoreToL76776084703;
    int tryBlockOffsetL76776084703;
    DEFINE_CATCH_BLOCK(catch_L76776084703, label_L1557571623, restoreToL76776084703);
    int restoreToL155757162304;
    int tryBlockOffsetL155757162304;
    DEFINE_CATCH_BLOCK(catch_L155757162304, label_L1557571623, restoreToL155757162304);
    int restoreToL823669238cn1_class_id_java_io_IOException5;
    int tryBlockOffsetL823669238cn1_class_id_java_io_IOException5;
    DEFINE_CATCH_BLOCK(catch_L823669238cn1_class_id_java_io_IOException5, label_L1825984578, restoreToL823669238cn1_class_id_java_io_IOException5);
    int restoreToL823669238cn1_class_id_java_lang_RuntimeException6;
    int tryBlockOffsetL823669238cn1_class_id_java_lang_RuntimeException6;
    DEFINE_CATCH_BLOCK(catch_L823669238cn1_class_id_java_lang_RuntimeException6, label_L1987377620, restoreToL823669238cn1_class_id_java_lang_RuntimeException6);
    int restoreToL82366923807;
    int tryBlockOffsetL82366923807;
    DEFINE_CATCH_BLOCK(catch_L82366923807, label_L1264380765, restoreToL82366923807);
    int restoreToL182598457808;
    int tryBlockOffsetL182598457808;
    DEFINE_CATCH_BLOCK(catch_L182598457808, label_L1264380765, restoreToL182598457808);
    int restoreToL198737762009;
    int tryBlockOffsetL198737762009;
    DEFINE_CATCH_BLOCK(catch_L198737762009, label_L1264380765, restoreToL198737762009);
    int restoreToL1264380765010;
    int tryBlockOffsetL1264380765010;
    DEFINE_CATCH_BLOCK(catch_L1264380765010, label_L1264380765, restoreToL1264380765010);
    ...
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L581100929, 0);
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2091447767, 0);
    __CN1_DEBUG_INFO(260);
    releaseForReturnInException(threadStateData, cn1LocalsBeginInThread, methodBlockOffset); return 0 /* ICONST_0 */;

label_L2091447767:
    __CN1_DEBUG_INFO(262);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L581100929, 0);
    BC_ALOAD(4);
    ...
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L581100929, 0);
...
label_L5595260:
 tryBlockOffsetL559526002 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L559526002);
    restoreToL559526002 = threadStateData->threadObjectStackOffset;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L767760847, 0);
...
label_L767760847:
 tryBlockOffsetL76776084703 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L76776084703);
    restoreToL76776084703 = threadStateData->threadObjectStackOffset;
...
label_L559298332:
 tryBlockOffsetL559298332cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L559298332cn1_class_id_java_lang_InterruptedException1);
    restoreToL559298332cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L356641286:
END_TRY(1);    JUMP_TO(label_L581100929, 0);

label_L1557571623:
 tryBlockOffsetL155757162304 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L155757162304);
    restoreToL155757162304 = threadStateData->threadObjectStackOffset;
...
label_L823669238:
 tryBlockOffsetL82366923807 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L82366923807);
    restoreToL82366923807 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL823669238cn1_class_id_java_lang_RuntimeException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_RuntimeException, catch_L823669238cn1_class_id_java_lang_RuntimeException6);
    restoreToL823669238cn1_class_id_java_lang_RuntimeException6 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL823669238cn1_class_id_java_io_IOException5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L823669238cn1_class_id_java_io_IOException5);
    restoreToL823669238cn1_class_id_java_io_IOException5 = threadStateData->threadObjectStackOffset;
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L886205032, 3);
        case 30: JUMP_TO(label_L267331432, 3);
        case 50: JUMP_TO(label_L978799163, 3);
        case 80: JUMP_TO(label_L1933458457, 3);
        case 100: JUMP_TO(label_L1410894140, 3);
        default: JUMP_TO(label_L582627504, 3);
    }
...
label_L582627504:
    ...
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L582787150, 3);
...
label_L582787150:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getShowOnInit___R_com_codename1_ui_Dialog(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L543198964, 3);
...
END_TRY(1);    __CN1_DEBUG_INFO(315);
    ...
    JUMP_TO(label_L815903405, 0);

label_L805744373:

label_L525151848:
END_TRY(1);    __CN1_DEBUG_INFO(357);
    JUMP_TO(label_L1131228089, 0);

label_L1825984578:
 tryBlockOffsetL182598457808 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L182598457808);
    restoreToL182598457808 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(315);
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(316);
    if (virtual_com_codename1_io_ConnectionRequest_isFailSilently___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L68439370, 1);
    __CN1_DEBUG_INFO(317);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$600___com_codename1_io_NetworkManager_com_codename1_io_ConnectionRequest_java_lang_Exception_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject), get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject), locals[4].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L539452434, 1);
...
label_L1987377620:
 tryBlockOffsetL198737762009 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L198737762009);
    restoreToL198737762009 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(324);
    BC_ASTORE(4);
    __CN1_DEBUG_INFO(325);
    if (virtual_com_codename1_io_ConnectionRequest_isFailSilently___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L934563470, 1);
    __CN1_DEBUG_INFO(326);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$600___com_codename1_io_NetworkManager_com_codename1_io_ConnectionRequest_java_lang_Exception_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject), get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject), locals[4].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L300690223, 1);
...
label_L1264380765:
 tryBlockOffsetL1264380765010 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L1264380765010);
    restoreToL1264380765010 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(334);
    BC_ASTORE(8);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L1665400909, 0);
...
label_L815903405:
    ...
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1980883605, 0);
...
label_L1980883605:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L114559531, 0);
...
label_L114559531:
    ...
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L176150399, 0);
...
label_L176150399:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getDisposeOnCompletion___R_com_codename1_ui_Dialog(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1241184277, 0);
    if (virtual_com_codename1_io_ConnectionRequest_isRedirecting___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1241184277, 0);
...
label_L497983073:
    ...
    /* CustomInvoke */virtual_java_lang_Thread_setPriority___int(threadStateData, SP[-1].data.o, 5 /* ICONST_5 */);     SP -= 1;
    __CN1_DEBUG_INFO(335);
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L371556236, 0);
    __CN1_DEBUG_INFO(336);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */virtual_com_codename1_ui_Display_setFramerate___int(threadStateData, SP[-1].data.o, ilocals_2_);     SP -= 1;
...
label_L371556236:
    __CN1_DEBUG_INFO(338);
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1645577752, 0);
    __CN1_DEBUG_INFO(339);
    set_field_com_codename1_io_ConnectionRequest_complete(threadStateData, 1 /* ICONST_1 */, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject));

label_L1645577752:
    __CN1_DEBUG_INFO(341);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2083643423, 0);
    __CN1_DEBUG_INFO(342);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    PUSH_POINTER(__NEW_com_codename1_io_NetworkEvent(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
label_L2083643423:
    __CN1_DEBUG_INFO(344);
    if (virtual_com_codename1_io_ConnectionRequest_getDisposeOnCompletion___R_com_codename1_ui_Dialog(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2034604138, 0);
    if (virtual_com_codename1_io_ConnectionRequest_isRedirecting___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L2034604138, 0);
    __CN1_DEBUG_INFO(347);
    /* VarOp.assignFrom */ locals[10].type=CN1_TYPE_INVALID;locals[10].data.o = get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject);
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(348);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
label_L175168244:
    ...
    /* CustomInvoke */virtual_java_lang_Thread_setPriority___int(threadStateData, SP[-1].data.o, 5 /* ICONST_5 */);     SP -= 1;
    __CN1_DEBUG_INFO(335);
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L181021195, 0);
    __CN1_DEBUG_INFO(336);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */virtual_com_codename1_ui_Display_setFramerate___int(threadStateData, SP[-1].data.o, ilocals_2_);     SP -= 1;
...
label_L181021195:
    __CN1_DEBUG_INFO(338);
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L2030568021, 0);
    __CN1_DEBUG_INFO(339);
    set_field_com_codename1_io_ConnectionRequest_complete(threadStateData, 1 /* ICONST_1 */, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject));

label_L2030568021:
    __CN1_DEBUG_INFO(341);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L752571350, 0);
    __CN1_DEBUG_INFO(342);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    PUSH_POINTER(__NEW_com_codename1_io_NetworkEvent(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
label_L752571350:
    __CN1_DEBUG_INFO(344);
    if (virtual_com_codename1_io_ConnectionRequest_getDisposeOnCompletion___R_com_codename1_ui_Dialog(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1656369221, 0);
    if (virtual_com_codename1_io_ConnectionRequest_isRedirecting___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1656369221, 0);
    __CN1_DEBUG_INFO(347);
    /* VarOp.assignFrom */ locals[10].type=CN1_TYPE_INVALID;locals[10].data.o = get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject);
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(348);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
label_L1665400909:
    ...
    /* CustomInvoke */virtual_java_lang_Thread_setPriority___int(threadStateData, SP[-1].data.o, 5 /* ICONST_5 */);     SP -= 1;
    __CN1_DEBUG_INFO(335);
    if (ilocals_2_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L14181307, 0);
    __CN1_DEBUG_INFO(336);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */virtual_com_codename1_ui_Display_setFramerate___int(threadStateData, SP[-1].data.o, ilocals_2_);     SP -= 1;
...
label_L14181307:
    __CN1_DEBUG_INFO(338);
    if (ilocals_3_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1995167125, 0);
    __CN1_DEBUG_INFO(339);
    set_field_com_codename1_io_ConnectionRequest_complete(threadStateData, 1 /* ICONST_1 */, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject));

label_L1995167125:
    __CN1_DEBUG_INFO(341);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1163979541, 0);
    __CN1_DEBUG_INFO(342);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$500___com_codename1_io_NetworkManager_R_com_codename1_ui_util_EventDispatcher(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    PUSH_POINTER(__NEW_com_codename1_io_NetworkEvent(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
label_L1163979541:
    __CN1_DEBUG_INFO(344);
    if (virtual_com_codename1_io_ConnectionRequest_getDisposeOnCompletion___R_com_codename1_ui_Dialog(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L576698206, 0);
    if (virtual_com_codename1_io_ConnectionRequest_isRedirecting___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L576698206, 0);
    __CN1_DEBUG_INFO(347);
    /* VarOp.assignFrom */ locals[10].type=CN1_TYPE_INVALID;locals[10].data.o = get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject);
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(348);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
JAVA_VOID com_codename1_io_NetworkManager_NetworkThread_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 3220, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL8900163301;
    int tryBlockOffsetL8900163301;
    DEFINE_CATCH_BLOCK(catch_L8900163301, label_L1228340166, restoreToL8900163301);
    int restoreToL26566859802;
    int tryBlockOffsetL26566859802;
    DEFINE_CATCH_BLOCK(catch_L26566859802, label_L1228340166, restoreToL26566859802);
    int restoreToL108941138003;
    int tryBlockOffsetL108941138003;
    DEFINE_CATCH_BLOCK(catch_L108941138003, label_L1228340166, restoreToL108941138003);
    int restoreToL122834016604;
    int tryBlockOffsetL122834016604;
    DEFINE_CATCH_BLOCK(catch_L122834016604, label_L1228340166, restoreToL122834016604);
    int restoreToL94300983605;
    int tryBlockOffsetL94300983605;
    DEFINE_CATCH_BLOCK(catch_L94300983605, label_L189565366, restoreToL94300983605);
    int restoreToL18956536606;
    int tryBlockOffsetL18956536606;
    DEFINE_CATCH_BLOCK(catch_L18956536606, label_L189565366, restoreToL18956536606);
    int restoreToL830420755cn1_class_id_java_lang_InterruptedException7;
    int tryBlockOffsetL830420755cn1_class_id_java_lang_InterruptedException7;
    DEFINE_CATCH_BLOCK(catch_L830420755cn1_class_id_java_lang_InterruptedException7, label_L1425418950, restoreToL830420755cn1_class_id_java_lang_InterruptedException7);
    int restoreToL83042075508;
    int tryBlockOffsetL83042075508;
    DEFINE_CATCH_BLOCK(catch_L83042075508, label_L2078827576, restoreToL83042075508);
    int restoreToL207882757609;
    int tryBlockOffsetL207882757609;
    DEFINE_CATCH_BLOCK(catch_L207882757609, label_L2078827576, restoreToL207882757609);
...
label_L925150096:
    ...
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L100550728, 0);
    if (get_field_com_codename1_io_NetworkManager_NetworkThread_stopped(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L100550728, 0);
    __CN1_DEBUG_INFO(364);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$400___com_codename1_io_NetworkManager_R_java_util_Vector(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    { JAVA_INT tmpResult = virtual_java_util_Vector_size___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1787846776, 0);
...
label_L89001633:
 tryBlockOffsetL8900163301 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L8900163301);
    restoreToL8900163301 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(368);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$400___com_codename1_io_NetworkManager_R_java_util_Vector(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    { JAVA_INT tmpResult = virtual_java_util_Vector_size___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L265668598, 0);
    __CN1_DEBUG_INFO(369);
    BC_ALOAD(1);
    monitorExit(threadStateData, POP_OBJ());

label_L2106136915:
END_TRY(1);    JUMP_TO(label_L925150096, 0);

label_L265668598:
 tryBlockOffsetL26566859802 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L26566859802);
    restoreToL26566859802 = threadStateData->threadObjectStackOffset;
    ...
    if (virtual_com_codename1_io_ConnectionRequest_isKilled___R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1089411380, 0);
...
label_L1089411380:
 tryBlockOffsetL108941138003 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L108941138003);
    restoreToL108941138003 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$800___com_codename1_io_NetworkManager_R_int(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))<=2000000000) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L689251057, 1);
...
label_L958999821:
END_TRY(1);    JUMP_TO(label_L140425810, 0);

label_L1228340166:
 tryBlockOffsetL122834016604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L122834016604);
    restoreToL122834016604 = threadStateData->threadObjectStackOffset;
...
label_L140425810:
    ...
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$900___com_codename1_io_NetworkManager_R_java_util_Hashtable(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L439679202, 0);
...
label_L573207593:
    ...
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L439679202, 0);
    ...
    JUMP_TO(label_L573207593, 0);

label_L439679202:
    __CN1_DEBUG_INFO(390);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_NetworkThread_runCurrentRequest___com_codename1_io_ConnectionRequest_R_boolean(threadStateData, __cn1ThisObject, get_field_com_codename1_io_NetworkManager_NetworkThread_currentRequest(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L581486647, 0);
    __CN1_DEBUG_INFO(391);
    JUMP_TO(label_L925150096, 0);
...
label_L943009836:
 tryBlockOffsetL94300983605 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L94300983605);
    restoreToL94300983605 = threadStateData->threadObjectStackOffset;
...
label_L307042380:
END_TRY(1);    JUMP_TO(label_L1599695386, 0);

label_L189565366:
 tryBlockOffsetL18956536606 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L18956536606);
    restoreToL18956536606 = threadStateData->threadObjectStackOffset;
...
label_L830420755:
 tryBlockOffsetL83042075508 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L83042075508);
    restoreToL83042075508 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL830420755cn1_class_id_java_lang_InterruptedException7 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L830420755cn1_class_id_java_lang_InterruptedException7);
    restoreToL830420755cn1_class_id_java_lang_InterruptedException7 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(405);
    /* CustomInvoke */PUSH_OBJ(com_codename1_io_NetworkManager_access$400___com_codename1_io_NetworkManager_R_java_util_Vector(threadStateData, get_field_com_codename1_io_NetworkManager_NetworkThread_this_0(__cn1ThisObject)));
    { JAVA_INT tmpResult = virtual_java_util_Vector_size___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1654094587, 1);
...
label_L608132930:
END_TRY(1);    JUMP_TO(label_L2002799238, 0);

label_L2078827576:
 tryBlockOffsetL207882757609 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L207882757609);
    restoreToL207882757609 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_io_NetworkManager_NetworkThread_access$000___com_codename1_io_NetworkManager_NetworkThread_R_com_codename1_io_ConnectionRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_io_NetworkManager_NetworkThread(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 3220, 218);
