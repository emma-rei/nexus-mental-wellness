...
void __STATIC_INITIALIZER_java_lang_Runnable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm__Lambda_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm__Lambda_1][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm__Lambda_5] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm__Lambda_5][0] = 10;
