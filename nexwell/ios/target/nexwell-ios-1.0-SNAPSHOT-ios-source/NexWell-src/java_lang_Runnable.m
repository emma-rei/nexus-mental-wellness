...
void __STATIC_INITIALIZER_java_lang_Runnable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_NexWellStub] = malloc(sizeof(int*) * 13);
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_homepage_UIController__Lambda_1][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame__Lambda_4] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame__Lambda_4][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_BubbleGame__Lambda_3] = malloc(sizeof(int*) * 13);
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm__Lambda_6][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm__Lambda_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_games_SnakeGameForm__Lambda_2][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_Sheet_6] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_Sheet_6][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_Sheet_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_Sheet_3][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_Status_1_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_Status_1_1][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_2][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_Status_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_Status_1][0] = 10;
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_components_ToastBar_3][0] = 10;
