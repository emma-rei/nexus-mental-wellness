...
void __STATIC_INITIALIZER_java_lang_Runnable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_3][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_SearchBar_2_1_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_SearchBar_2_1_1][0] = 10;
    ...
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_SearchBar_2_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_java_lang_Runnable[cn1_class_id_com_codename1_ui_SearchBar_2_1][0] = 10;
