...
JAVA_VOID com_codename1_ui_Container_MorphAnimation___INIT_____com_codename1_ui_Container_int_com_codename1_ui_animations_Motion_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (com_codename1_ui_animations_Motion_isSlowMotion___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1798823822;
...
JAVA_BOOLEAN com_codename1_ui_Container_MorphAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_finished(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1801694172;
    PUSH_INT(1); /* ICONST_1 */
...
label_L930695665:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1594424832;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4317);
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2086532629;
...
JAVA_VOID com_codename1_ui_Container_MorphAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_animatedComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L165631567;
...
label_L37878764:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L438432831;
...
label_L165631567:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_motions(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1682586333;
...
label_L1248908034:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1902094533;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1266048658;
...
label_L1266048658:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_opacity(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1181041291;
...
label_L1181041291:
    __CN1_DEBUG_INFO(4345);
    BC_IINC(2, 1);
    goto label_L1248908034;

label_L1902094533:
    __CN1_DEBUG_INFO(4361);
    if (get_field_com_codename1_ui_Container_MorphAnimation_scrollTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2144965699;
...
label_L2144965699:
    ...
    BC_LCMP();
    if(POP_INT() < 0) /* IFLT */ goto label_L102946788;
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1782561969;
...
label_L1782561969:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_dontRevalidate(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L102946788;
