...
JAVA_VOID com_codename1_ui_Container_MorphAnimation___INIT_____com_codename1_ui_Container_int_com_codename1_ui_animations_Motion_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7207, 201);
    ...
    if (com_codename1_ui_animations_Motion_isSlowMotion___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1075314220;
...
JAVA_BOOLEAN com_codename1_ui_Container_MorphAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7207, 2791);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4310);
    if (get_field_com_codename1_ui_Container_MorphAnimation_finished(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L425842522;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_Container_MorphAnimation_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 9, 0, 7207, 930);
...
label_L2067076166:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L65168514;
...
label_L1801694172:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L2096827468;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4317);
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1798823822;
...
JAVA_VOID com_codename1_ui_Container_MorphAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 7207, 2792);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4327);
    if (get_field_com_codename1_ui_Container_MorphAnimation_animatedComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1594424832;
...
label_L798579452:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L169251264;
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_opacity(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2086532629;
...
label_L1594424832:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_motions(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L165631567;
...
label_L37878764:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L930695665;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L438432831;
    __CN1_DEBUG_INFO(4350);
    goto label_L2131366717;
...
label_L438432831:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_opacity(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2131366717;
...
label_L930695665:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_scrollTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1902094533;
...
label_L1902094533:
    ...
    BC_LCMP();
    if(POP_INT() < 0) /* IFLT */ goto label_L1682586333;
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1266048658;
...
label_L1266048658:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_dontRevalidate(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1682586333;
