...
JAVA_VOID com_codename1_ui_Container_MorphAnimation___INIT_____com_codename1_ui_Container_int_com_codename1_ui_animations_Motion_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7208, 202);
    ...
    if (com_codename1_ui_animations_Motion_isSlowMotion___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L733357076;
...
JAVA_BOOLEAN com_codename1_ui_Container_MorphAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7208, 2792);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4310);
    if (get_field_com_codename1_ui_Container_MorphAnimation_finished(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1094528209;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1682774881;
...
JAVA_VOID com_codename1_ui_Container_MorphAnimation_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 9, 0, 7208, 931);
...
label_L525275084:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L38023477;
...
label_L1017203956:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L407380973;
...
locals[8].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(4317);
    if (locals[8].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L817614737;
...
label_L817614737:
    ...
    BC_IINC(7, 1);
    goto label_L1017203956;

label_L407380973:
    __CN1_DEBUG_INFO(4315);
    BC_IINC(3, 1);
    goto label_L525275084;
...
JAVA_VOID com_codename1_ui_Container_MorphAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 7208, 2793);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(4327);
    if (get_field_com_codename1_ui_Container_MorphAnimation_animatedComponents(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1187053699;
...
label_L2035215096:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L686327949;
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_opacity(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L513324936;
...
label_L1187053699:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_motions(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1535472351;
...
label_L284456930:
    if (ilocals_2_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L935667786;
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L8039120;
...
label_L8039120:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_opacity(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L250448141;
...
label_L250448141:
    __CN1_DEBUG_INFO(4345);
    BC_IINC(2, 1);
    goto label_L284456930;

label_L935667786:
    __CN1_DEBUG_INFO(4361);
    if (get_field_com_codename1_ui_Container_MorphAnimation_scrollTo(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1620573353;
...
label_L1620573353:
    ...
    BC_LCMP();
    if(POP_INT() < 0) /* IFLT */ goto label_L904848961;
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1462350864;
...
label_L1462350864:
    ...
    if (get_field_com_codename1_ui_Container_MorphAnimation_dontRevalidate(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L904848961;
