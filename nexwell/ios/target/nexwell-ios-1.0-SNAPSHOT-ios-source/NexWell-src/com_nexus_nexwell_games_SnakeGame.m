...
JAVA_VOID com_nexus_nexwell_games_SnakeGame___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 10580, 201);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_move__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 10580, 1006);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(36);
    if (get_field_com_nexus_nexwell_games_SnakeGame_gameOver(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L164714495;
    __CN1_DEBUG_INFO(38);
    ...
    PUSH_INT(tmpResult); }
    if (get_field_com_nexus_nexwell_games_SnakeGame_direction(__cn1ThisObject)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L789982400;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L1576277927;

label_L789982400:
    if (get_field_com_nexus_nexwell_games_SnakeGame_direction(__cn1ThisObject)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L2080643905;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1576277927;
...
label_L1576277927:
    ...
    PUSH_INT(tmpResult); }
    if (get_field_com_nexus_nexwell_games_SnakeGame_direction(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2137642385;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L1627883152;

label_L2137642385:
    if (get_field_com_nexus_nexwell_games_SnakeGame_direction(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L481553464;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1627883152;
...
label_L1627883152:
    ...
    BC_ASTORE(2);
    __CN1_DEBUG_INFO(43);
    if (virtual_com_codename1_ui_geom_Point_getX___R_int(threadStateData, locals[2].data.o)<0) /* IFLT CustomJump */ goto label_L1076966140;
    if (virtual_com_codename1_ui_geom_Point_getY___R_int(threadStateData, locals[2].data.o)<0) /* IFLT CustomJump */ goto label_L1076966140;
    if (virtual_com_codename1_ui_geom_Point_getX___R_int(threadStateData, locals[2].data.o)>=get_field_com_nexus_nexwell_games_SnakeGame_boardWidth(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1076966140;
    if (virtual_com_codename1_ui_geom_Point_getY___R_int(threadStateData, locals[2].data.o)>=get_field_com_nexus_nexwell_games_SnakeGame_boardHeight(__cn1ThisObject)) /* IF_ICMPGE CustomJump */ goto label_L1076966140;
    if (/* CustomInvoke */virtual_java_util_ArrayList_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_nexus_nexwell_games_SnakeGame_snake(__cn1ThisObject), locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1908781622;
...
label_L1721045976:
    if (ilocals_3_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_nexus_nexwell_games_SnakeGame_snake(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L749443480;
    __CN1_DEBUG_INFO(49);
    ...
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L796553753;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_ArrayList_get___int_R_java_lang_Object(threadStateData, get_field_com_nexus_nexwell_games_SnakeGame_snake(__cn1ThisObject), ilocals_3_);
    PUSH_OBJ(tmpResult); }
...
label_L749443480:
    __CN1_DEBUG_INFO(56);
    if (virtual_com_codename1_ui_geom_Point_getX___R_int(threadStateData, locals[2].data.o)!=virtual_com_codename1_ui_geom_Point_getX___R_int(threadStateData, get_field_com_nexus_nexwell_games_SnakeGame_food(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L975001918;
    if (virtual_com_codename1_ui_geom_Point_getY___R_int(threadStateData, locals[2].data.o)!=virtual_com_codename1_ui_geom_Point_getY___R_int(threadStateData, get_field_com_nexus_nexwell_games_SnakeGame_food(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L975001918;
    __CN1_DEBUG_INFO(58);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_placeFood__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 10580, 10581);
...
label_L1250582716:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1250582716;
    __CN1_DEBUG_INFO(76);
    BC_ALOAD(0);
    PUSH_POINTER(__NEW_com_codename1_ui_geom_Point(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_showGameOverMessage__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 10580, 10582);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Dialog___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10583));     SP -= 1;
    BC_ASTORE(1);
    __CN1_DEBUG_INFO(82);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Button___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10584));     SP -= 1;
    BC_ASTORE(3);
    __CN1_DEBUG_INFO(85);
    BC_ALOAD(3);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_restartGame__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 10580, 10586);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_setDirection___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10580, 9026);
...
JAVA_OBJECT com_nexus_nexwell_games_SnakeGame_getSnake___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10580, 10587);
...
JAVA_OBJECT com_nexus_nexwell_games_SnakeGame_getFood___R_com_codename1_ui_geom_Point(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10580, 10588);
...
JAVA_BOOLEAN com_nexus_nexwell_games_SnakeGame_isGameOver___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10580, 10589);
...
JAVA_BOOLEAN com_nexus_nexwell_games_SnakeGame_isCancel___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10580, 10590);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_setCancel___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10580, 10591);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_lambda$showGameOverMessage$1___com_nexus_nexwell_games_SnakeGame_com_codename1_ui_Dialog_com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    __STATIC_INITIALIZER_com_nexus_nexwell_games_SnakeGame(threadStateData);
    DEFINE_METHOD_STACK(2, 3, 0, 10580, 10592);
...
JAVA_VOID com_nexus_nexwell_games_SnakeGame_lambda$showGameOverMessage$0___com_nexus_nexwell_games_SnakeGame_com_codename1_ui_Dialog_com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    __STATIC_INITIALIZER_com_nexus_nexwell_games_SnakeGame(threadStateData);
    DEFINE_METHOD_STACK(1, 3, 0, 10580, 10593);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
