...
JAVA_VOID com_codename1_ui_Tabs_1___INIT_____com_codename1_ui_Tabs_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10352, 202);
...
JAVA_VOID com_codename1_ui_Tabs_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 10352, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(648);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$000___com_codename1_ui_Tabs_R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1446676917;
    __CN1_DEBUG_INFO(649);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$100___com_codename1_ui_Tabs_R_java_lang_String(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1349373781;
...
label_L1349373781:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$200___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L655059806;
...
label_L655059806:
    ...
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1446676917;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1446676917;
...
label_L1446676917:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2123681939;
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2086767061;
...
label_L2086767061:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$200___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1112073835;
