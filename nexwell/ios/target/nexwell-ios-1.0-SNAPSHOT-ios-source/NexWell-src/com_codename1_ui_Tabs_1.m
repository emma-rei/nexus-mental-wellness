...
JAVA_VOID com_codename1_ui_Tabs_1___INIT_____com_codename1_ui_Tabs_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10447, 201);
...
JAVA_VOID com_codename1_ui_Tabs_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 10447, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(648);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$000___com_codename1_ui_Tabs_R_com_codename1_ui_Component(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1202547191;
    __CN1_DEBUG_INFO(649);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$100___com_codename1_ui_Tabs_R_java_lang_String(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L730955696;
...
label_L730955696:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$200___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1582330795;
...
label_L1582330795:
    ...
    if (ilocals_2_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1202547191;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1202547191;
...
label_L1202547191:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1010983633;
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Container);
    if(POP_INT() == 0) /* IFEQ */ goto label_L269244031;
...
label_L269244031:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$200___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_1_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L817944369;
