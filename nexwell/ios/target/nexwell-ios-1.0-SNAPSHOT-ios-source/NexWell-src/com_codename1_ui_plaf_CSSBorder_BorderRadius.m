...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderRadius___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))<=0) /* IFLE CustomJump */ goto label_L302085789;
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1257758058;
    ...
    POP_MANY(2);
    goto label_L1174919051;

label_L1257758058:
    __CN1_DEBUG_INFO(670);
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L992524208;
...
label_L992524208:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L570723286;
...
label_L570723286:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1449926257;
...
label_L1174919051:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L774840504;
    ...
    POP_MANY(2);
    goto label_L1346672634;

label_L774840504:
    __CN1_DEBUG_INFO(694);
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1444477983;
...
label_L1444477983:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L1622277947;
...
label_L1622277947:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L927742325;
...
label_L302085789:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1386903362;
        case 2: goto label_L1024266763;
        case 3: goto label_L1801196366;
        case 4: goto label_L886693791;
        default: goto label_L902348321;
    }
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_BorderRadius_hasNonZeroRadius___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1619034073;
    if (virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1808652004;

label_L1619034073:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L294832421;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1808652004;

label_L294832421:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1633375360;
...
label_L1633375360:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L38179269;
...
label_L38179269:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L129572255;
...
label_L129572255:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L6633388;
...
label_L6633388:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L992054388;
...
label_L992054388:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L232782444;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject));
    __CN1_DEBUG_INFO(772);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L232782444;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1807010830;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1556201248;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L775893582;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1188006919;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L190245996;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1522494105;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L231055042;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L928023753;
