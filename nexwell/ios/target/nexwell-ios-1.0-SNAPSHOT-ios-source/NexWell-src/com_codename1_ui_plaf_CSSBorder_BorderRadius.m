...
JAVA_VOID com_codename1_ui_plaf_CSSBorder_BorderRadius___INIT_____com_codename1_ui_plaf_CSSBorder_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 5761, 202);
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(18))<=0) /* IFLE CustomJump */ goto label_L342997389;
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1427396510;
    ...
    POP_MANY(2);
    goto label_L1489251468;

label_L1427396510:
    __CN1_DEBUG_INFO(670);
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L988952272;
...
label_L988952272:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L592858578;
...
label_L592858578:
    ...
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L1418286721;
...
label_L1418286721:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5767));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1489251468:
    __CN1_DEBUG_INFO(689);
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L768647376;
    ...
    POP_MANY(2);
    goto label_L113202956;

label_L768647376:
    __CN1_DEBUG_INFO(694);
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L395752148;
...
label_L395752148:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L154522617;
...
label_L154522617:
    ...
    if (CN1_ARRAY_LENGTH(locals[5].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L558576687;
...
label_L342997389:
    ...
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */com_codename1_io_Util_split___java_lang_String_java_lang_String_R_java_lang_String_1ARRAY(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(614));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(715);
    BC_ALOAD(3);
    { /* ARRAYLENGTH */
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L2131888461;
        case 2: goto label_L1486862157;
        case 3: goto label_L537729597;
        case 4: goto label_L2111916009;
        default: goto label_L307655033;
    }
...
label_L307655033:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5769));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_BOOLEAN com_codename1_ui_plaf_CSSBorder_BorderRadius_hasNonZeroRadius___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 5761, 5770);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(765);
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L936810913;
    if (virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftX(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2135077268;

label_L936810913:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L149647258;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2135077268;

label_L149647258:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L689375815;
...
label_L689375815:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L714048853;
...
label_L714048853:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1076580225;
...
label_L1076580225:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L334462881;
...
label_L334462881:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L37427881;
...
label_L37427881:
    if (get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1414042262;
    PUSH_POINTER(get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY(__cn1ThisObject));
    __CN1_DEBUG_INFO(772);
    { JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_CSSBorder_ScalarUnit_isZero___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1414042262;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5771);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(776);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L645919967;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5772);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(783);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2085313771;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5773);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(790);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1812442582;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_topRightRadiusY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5774);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(797);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L237413343;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5775);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(804);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1470523336;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomLeftY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5776);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(811);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1898763731;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightX___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5777);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(818);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L546619197;
...
JAVA_FLOAT com_codename1_ui_plaf_CSSBorder_BorderRadius_bottomRightY___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 5761, 5778);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(825);
    if (com_codename1_ui_plaf_CSSBorder_access$600___R_com_codename1_ui_plaf_CSSBorder_Context(threadStateData)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L454547627;
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderRadius_toCSSString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5761, 5617);
    ...
    SP-=1;
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5779));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    PUSH_POINTER(get_field_com_codename1_ui_plaf_CSSBorder_BorderRadius_topLeftY(__cn1ThisObject));
...
JAVA_OBJECT com_codename1_ui_plaf_CSSBorder_BorderRadius_access$200___com_codename1_ui_plaf_CSSBorder_BorderRadius_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_plaf_CSSBorder_BorderRadius(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 5761, 800);
