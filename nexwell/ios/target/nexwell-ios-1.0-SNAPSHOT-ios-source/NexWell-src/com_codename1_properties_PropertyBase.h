...
extern struct clazz class_array1__com_codename1_properties_PropertyBase;
...
extern JAVA_OBJECT __NEW_ARRAY_com_codename1_properties_PropertyBase(CODENAME_ONE_THREAD_STATE, JAVA_INT size);
