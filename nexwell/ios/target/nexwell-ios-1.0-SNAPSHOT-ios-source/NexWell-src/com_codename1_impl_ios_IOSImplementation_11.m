...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL93778588801;
    int tryBlockOffsetL93778588801;
    DEFINE_CATCH_BLOCK(catch_L93778588801, label_L990684641, restoreToL93778588801);
    int restoreToL99068464102;
    int tryBlockOffsetL99068464102;
    DEFINE_CATCH_BLOCK(catch_L99068464102, label_L990684641, restoreToL99068464102);
    __CN1_DEBUG_INFO(987);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1538462491, 0);
    __CN1_DEBUG_INFO(988);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_finished(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1423752095, 0);
    __CN1_DEBUG_INFO(989);
    PUSH_INT(get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1962865655, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L704869156, 0);
...
label_L937785888:
 tryBlockOffsetL93778588801 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L93778588801);
    restoreToL93778588801 = threadStateData->threadObjectStackOffset;
    ...
    if (com_codename1_impl_ios_IOSImplementation_access$800___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1777043124, 1);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1777043124, 1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData)));
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_TextArea);
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1777043124, 1);
...
label_L1777043124:
    ...
    if (virtual_com_codename1_impl_ios_IOSNative_isAsyncEditMode___R_boolean(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_nativeInstance(threadStateData))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1482344533, 1);
...
label_L1482344533:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1538849250, 1);
...
label_L940357603:
END_TRY(1);    JUMP_TO(label_L1788034018, 0);

label_L990684641:
 tryBlockOffsetL99068464102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L99068464102);
    restoreToL99068464102 = threadStateData->threadObjectStackOffset;
...
label_L1788034018:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1601756706, 0);
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1601756706, 0);
...
label_L1366212088:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1300576734, 0);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1300576734, 0);
