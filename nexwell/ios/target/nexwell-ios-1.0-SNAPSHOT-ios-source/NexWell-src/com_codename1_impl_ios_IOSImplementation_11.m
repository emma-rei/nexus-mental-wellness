...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_11_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1308462701;
    int tryBlockOffsetL1308462701;
    DEFINE_CATCH_BLOCK(catch_L1308462701, label_L698498109, restoreToL1308462701);
    int restoreToL69849810902;
    int tryBlockOffsetL69849810902;
    DEFINE_CATCH_BLOCK(catch_L69849810902, label_L698498109, restoreToL69849810902);
    __CN1_DEBUG_INFO(987);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1265287441, 0);
    __CN1_DEBUG_INFO(988);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_finished(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1877240674, 0);
    __CN1_DEBUG_INFO(989);
    PUSH_INT(get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject));
    PUSH_INT(-2);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1495257933, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1642356615, 0);
...
label_L13084627:
 tryBlockOffsetL1308462701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L1308462701);
    restoreToL1308462701 = threadStateData->threadObjectStackOffset;
    ...
    if (com_codename1_impl_ios_IOSImplementation_access$800___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2090563811, 1);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2090563811, 1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData)));
...
label_L2090563811:
    ...
    if (virtual_com_codename1_impl_ios_IOSNative_isAsyncEditMode___R_boolean(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_nativeInstance(threadStateData))==0) /* IFEQ CustomJump */ JUMP_TO(label_L812168041, 1);
...
label_L812168041:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L399149970, 1);
...
label_L2034639977:
END_TRY(1);    JUMP_TO(label_L1418851979, 0);

label_L698498109:
 tryBlockOffsetL69849810902 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L69849810902);
    restoreToL69849810902 = threadStateData->threadObjectStackOffset;
...
label_L1418851979:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1936375962, 0);
    if (virtual_com_codename1_ui_Form_isFormBottomPaddingEditingMode___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1936375962, 0);
...
label_L116184677:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1161382705, 0);
    if (get_field_com_codename1_impl_ios_IOSImplementation_11_val_cursorPositon(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1161382705, 0);
