...
JAVA_VOID com_codename1_xml_Element___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 202);
...
JAVA_VOID com_codename1_xml_Element___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7736, 202);
...
JAVA_VOID com_codename1_xml_Element___INIT_____java_lang_String_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7736, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_xml_Element_isTextElement___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 7737);
...
JAVA_OBJECT com_codename1_xml_Element_getTagName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7736, 7738);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(119);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1296074566;
    __CN1_DEBUG_INFO(120);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7739));     SP -= 1;
...
JAVA_VOID com_codename1_xml_Element_setAttribute___java_lang_Object_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7736, 7740);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(142);
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1793414776;
...
JAVA_VOID com_codename1_xml_Element_addChild___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7736, 7741);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_xml_Element_setParent___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7736, 2467);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_xml_Element_getParent___R_com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 992);
...
JAVA_INT com_codename1_xml_Element_getNumChildren___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 7742);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(185);
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1271355282;
...
JAVA_OBJECT com_codename1_xml_Element_getChildAt___int_R_com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7736, 7746);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(248);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1377968609;
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1377968609;
    if (ilocals_1_<virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_IMPLT CustomJump */ goto label_L335938576;
...
JAVA_BOOLEAN com_codename1_xml_Element_cmpTagName___java_lang_String_com_codename1_xml_Element_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_xml_Element(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 7736, 7747);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(262);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(1649), locals[0].data.o)==0) /* IFEQ CustomJump */ goto label_L92510173;
...
JAVA_VOID com_codename1_xml_Element_getDescendantsByTagNameInternal___java_util_Vector_java_lang_String_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 6, 0, 7736, 7751);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L755820705;
    __CN1_DEBUG_INFO(323);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 

label_L747909318:
    __CN1_DEBUG_INFO(324);
    if (ilocals_4_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L755820705;
    ...
    if (ilocals_3_<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L657827804;
...
label_L657827804:
    ...
    if (get_field_com_codename1_xml_Element_textElement(locals[5].data.o)!=0) /* IFNE CustomJump */ goto label_L1419454167;
    if (/* CustomInvoke */com_codename1_xml_Element_cmpTagName___java_lang_String_com_codename1_xml_Element_R_boolean(threadStateData, locals[2].data.o, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1419454167;
...
JAVA_OBJECT com_codename1_xml_Element_getDescendantsByTagName___java_lang_String_int_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 7736, 7755);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(388);
    if (ilocals_2_>=1 /* ICONST_1 */) /* IF_ICMPGE CustomJump */ goto label_L987666875;
    __CN1_DEBUG_INFO(389);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7754));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L987666875:
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L423039171;
...
JAVA_OBJECT com_codename1_xml_Element_getDescendantsByTagName___java_lang_String_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7736, 7755);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_xml_Element_getChildrenByTagName___java_lang_String_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7736, 7756);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_xml_Element_setAttribute___java_lang_String_java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L756603373;
    __CN1_DEBUG_INFO(530);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7760));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT com_codename1_xml_Element_getAttribute___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7736, 7605);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(592);
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1337181808;
    __CN1_DEBUG_INFO(593);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L1337181808:
    __CN1_DEBUG_INFO(595);
    if (get_field_com_codename1_xml_Element_caseSensitive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1802274860;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1802274860;
...
JAVA_VOID com_codename1_xml_Element_setChildParent___com_codename1_xml_Element(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7736, 7763);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(605);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1369857878;
...
label_L1369857878:
    ...
    if (virtual_com_codename1_xml_Element_getParent___R_com_codename1_xml_Element(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L148222723;
    __CN1_DEBUG_INFO(610);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7765));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L148222723:
    __CN1_DEBUG_INFO(612);
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1501852719;
...
JAVA_OBJECT com_codename1_xml_Element_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7736, 4109);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(690);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1798768880;
...
JAVA_VOID com_codename1_xml_Element_setText___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7736, 3046);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(703);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2009180110;
    __CN1_DEBUG_INFO(704);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7772));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT com_codename1_xml_Element_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7736, 896);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(716);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_xml_Element_toString___java_lang_String_R_java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(220));
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
...
JAVA_OBJECT com_codename1_xml_Element_toString___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 7736, 896);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(728);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(729);
    if (get_field_com_codename1_xml_Element_textElement(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L346327277;
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5392));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    if (get_field_com_codename1_xml_Element_attributes(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1128092982;
...
label_L270447913:
    if (virtual_java_util_Enumeration_hasMoreElements___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1128092982;
...
label_L1128092982:
    ...
    if (get_field_com_codename1_xml_Element_children(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1788579635;
    __CN1_DEBUG_INFO(740);
    /* VarOp.assignFrom */     ilocals_3_ = 0 /* ICONST_0 */; 

label_L1523093869:
    if (ilocals_3_>=virtual_java_util_ArrayList_size___R_int(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1788579635;
...
JAVA_BOOLEAN com_codename1_xml_Element_isEmpty___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 906);
    ...
    if (virtual_java_util_ArrayList_isEmpty___R_boolean(threadStateData, get_field_com_codename1_xml_Element_children(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1227792007;
...
JAVA_OBJECT com_codename1_xml_Element_iterator___R_java_util_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7736, 1230);
