...
JAVA_BOOLEAN com_codename1_components_InfiniteProgress_isDefaultMaterialDesignMode___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_components_InfiniteProgress(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 2337, 2338);
    __CN1_DEBUG_INFO(80);
...
JAVA_VOID com_codename1_components_InfiniteProgress_setDefaultMaterialDesignMode___boolean(CODENAME_ONE_THREAD_STATE, JAVA_BOOLEAN __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_components_InfiniteProgress(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 2337, 2339);
...
JAVA_VOID com_codename1_components_InfiniteProgress_setDefaultMaterialDesignColor___int(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_components_InfiniteProgress(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 2337, 2341);
    ilocals_0_ = __cn1Arg1;
...
JAVA_VOID com_codename1_components_InfiniteProgress___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 2337, 202);
    ...
    /* CustomInvoke */virtual_com_codename1_components_InfiniteProgress_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(2342)); 
...
JAVA_VOID com_codename1_components_InfiniteProgress_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 2337, 1849);
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L121715777;
    __CN1_DEBUG_INFO(192);
    BC_ALOAD(0);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2347));
...
label_L121715777:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1098372135;
...
JAVA_VOID com_codename1_components_InfiniteProgress_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 2337, 1327);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L193580025;
...
JAVA_BOOLEAN com_codename1_components_InfiniteProgress_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 2337, 1588);
...
JAVA_BOOLEAN com_codename1_components_InfiniteProgress_animate___boolean_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 2337, 1588);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(230);
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L791773777;
    __CN1_DEBUG_INFO(231);
    if (virtual_com_codename1_components_InfiniteProgress_isVisible___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L563876034;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L791773777;
...
label_L791773777:
    ...
    if (com_codename1_ui_Component_animate___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1580543546;
    if ((get_field_com_codename1_components_InfiniteProgress_tick(__cn1ThisObject) % get_field_com_codename1_components_InfiniteProgress_tickCount(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L455536646;

label_L1580543546:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L950454841;
...
label_L950454841:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L2038290415;
...
JAVA_INT com_codename1_components_InfiniteProgress_getMaterialDesignSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 2337, 2348);
    ...
    /* LDC: '6.667f'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(2350));
...
JAVA_INT com_codename1_components_InfiniteProgress_getMaterialImageSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_FLOAT flocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 2337, 2351);
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 2337, 1857);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(262);
    if (get_field_com_codename1_components_InfiniteProgress_materialDesignMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L248410628;
...
label_L248410628:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L583275803;
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InfiniteProgress_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2354), JAVA_NULL /* ACONST_NULL */);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ASTORE(2);
    __CN1_DEBUG_INFO(272);
    /* VarOp.assignFrom */     ilocals_3_ = 7829367;
    __CN1_DEBUG_INFO(273);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L742257784;
...
label_L583275803:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1005096127;
...
JAVA_VOID com_codename1_components_InfiniteProgress_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(13, 16, 0, 2337, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(295);
    if (virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1187747732;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1187747732;
...
label_L1187747732:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialDesignMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1143287451;
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L133729363;
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2022339943;
...
label_L133729363:
    ...
    BC_ALOAD(0);
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1650928341;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L257655284;
...
label_L2022339943:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1275203160;
...
label_L1143287451:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1021494356;
...
label_L1021494356:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1868936733;
    __CN1_DEBUG_INFO(346);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Image_rotate___int_R_com_codename1_ui_Image(threadStateData, get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject), ilocals_2_);locals[4].type=CN1_TYPE_OBJECT;    goto label_L868816231;
...
label_L1868936733:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L868816231;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 2337, 2362);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(393);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2360))==0) /* IFEQ CustomJump */ goto label_L398110471;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 2337, 2363);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(403);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2360))==0) /* IFEQ CustomJump */ goto label_L1028655552;
...
JAVA_INT com_codename1_components_InfiniteProgress_getTintColor___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 2337, 2364);
...
JAVA_VOID com_codename1_components_InfiniteProgress_setTintColor___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 2337, 2365);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_components_InfiniteProgress___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 2337, 860);
    __CN1_DEBUG_INFO(72);
