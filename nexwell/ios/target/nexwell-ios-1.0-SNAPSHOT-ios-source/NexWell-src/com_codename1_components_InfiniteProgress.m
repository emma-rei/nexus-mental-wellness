...
JAVA_VOID com_codename1_components_InfiniteProgress_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1715607464;
...
label_L1715607464:
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1263153428;
...
JAVA_VOID com_codename1_components_InfiniteProgress_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1257619788;
...
JAVA_BOOLEAN com_codename1_components_InfiniteProgress_animate___boolean_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L1960113474;
    __CN1_DEBUG_INFO(231);
    if (virtual_com_codename1_components_InfiniteProgress_isVisible___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L39670567;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1960113474;
...
label_L1960113474:
    ...
    if (com_codename1_ui_Component_animate___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L411369705;
    if ((get_field_com_codename1_components_InfiniteProgress_tick(__cn1ThisObject) % get_field_com_codename1_components_InfiniteProgress_tickCount(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L2082364692;

label_L411369705:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L800311600;
...
label_L800311600:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1201632138;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialDesignMode(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1999483352;
...
label_L1999483352:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2035659988;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1218320519;
...
label_L2035659988:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1948328253;
...
JAVA_VOID com_codename1_components_InfiniteProgress_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1855520016;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Display_getCurrent___R_com_codename1_ui_Form(threadStateData, SP[-1].data.o);
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InfiniteProgress_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1855520016;
...
label_L1855520016:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L39676643;
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_components_InfiniteProgress_materialLengthAngle(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L2131266396;
...
label_L39676643:
    ...
    BC_ALOAD(0);
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1456572880;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L345250566;
...
label_L2131266396:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_materialLengthDirection(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2104975621;
...
label_L977213187:
    ...
    if (get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L484166022;
...
label_L484166022:
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L673430832;
    __CN1_DEBUG_INFO(346);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Image_rotate___int_R_com_codename1_ui_Image(threadStateData, get_field_com_codename1_components_InfiniteProgress_animation(__cn1ThisObject), ilocals_2_);locals[4].type=CN1_TYPE_OBJECT;    goto label_L1847234168;
...
label_L673430832:
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1847234168;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_getPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2359))==0) /* IFEQ CustomJump */ goto label_L1510737536;
...
JAVA_OBJECT com_codename1_components_InfiniteProgress_setPropertyValue___java_lang_String_java_lang_Object_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(2359))==0) /* IFEQ CustomJump */ goto label_L416900030;
...
void __STATIC_INITIALIZER_com_codename1_components_InfiniteProgress(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_components_InfiniteProgress.vtable = malloc(sizeof(void*) *326);
