...
JAVA_VOID com_codename1_ui_scene_PerspectiveCamera___INIT_____com_codename1_ui_scene_Scene_double_double_double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_DOUBLE __cn1Arg2, JAVA_DOUBLE __cn1Arg3, JAVA_DOUBLE __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 8, 0, 10012, 201);
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10013));
...
JAVA_OBJECT com_codename1_ui_scene_PerspectiveCamera_getTransform___R_com_codename1_ui_Transform(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 26, 0, 10012, 416);
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10014));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10015));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
