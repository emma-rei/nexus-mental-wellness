...
JAVA_VOID com_codename1_io_MultipartRequest_addData___java_lang_String_byte_1ARRAY_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_filenames(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1881420492;
...
JAVA_VOID com_codename1_io_MultipartRequest_addArgument___java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (/* CustomInvoke */virtual_java_util_Hashtable_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_filenames(__cn1ThisObject), locals[1].data.o)!=0) /* IFNE CustomJump */ goto label_L1553991340;
...
JAVA_LONG com_codename1_io_MultipartRequest_calculateContentLength___R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1640773463cn1_class_id_java_io_UnsupportedEncodingException1;
    int tryBlockOffsetL1640773463cn1_class_id_java_io_UnsupportedEncodingException1;
    DEFINE_CATCH_BLOCK(catch_L1640773463cn1_class_id_java_io_UnsupportedEncodingException1, label_L230944166, restoreToL1640773463cn1_class_id_java_io_UnsupportedEncodingException1);
    int restoreToL1615983603cn1_class_id_java_io_UnsupportedEncodingException2;
    int tryBlockOffsetL1615983603cn1_class_id_java_io_UnsupportedEncodingException2;
    DEFINE_CATCH_BLOCK(catch_L1615983603cn1_class_id_java_io_UnsupportedEncodingException2, label_L326265195, restoreToL1615983603cn1_class_id_java_io_UnsupportedEncodingException2);
    int restoreToL775100687cn1_class_id_java_io_UnsupportedEncodingException3;
    int tryBlockOffsetL775100687cn1_class_id_java_io_UnsupportedEncodingException3;
    DEFINE_CATCH_BLOCK(catch_L775100687cn1_class_id_java_io_UnsupportedEncodingException3, label_L2091367901, restoreToL775100687cn1_class_id_java_io_UnsupportedEncodingException3);
...
label_L1205331126:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L544100739, 0);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L844248821, 0);
    ...
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[16].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L854276325, 0);

label_L1640773463:
 tryBlockOffsetL1640773463cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L1640773463cn1_class_id_java_io_UnsupportedEncodingException1);
    restoreToL1640773463cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->threadObjectStackOffset;
...
label_L854276325:
    ...
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L559126422, 0);
...
label_L844248821:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L34994391, 0);
...
label_L1818817180:
    if (ilocals_20_>=ilocals_19_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1775420512, 0);
...
locals[21].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(271);
    ...
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[16].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L55220696, 0);

label_L1615983603:
 tryBlockOffsetL1615983603cn1_class_id_java_io_UnsupportedEncodingException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L1615983603cn1_class_id_java_io_UnsupportedEncodingException2);
    restoreToL1615983603cn1_class_id_java_io_UnsupportedEncodingException2 = threadStateData->threadObjectStackOffset;
...
label_L55220696:
    ...
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L333890884, 0);
...
label_L775100687:
 tryBlockOffsetL775100687cn1_class_id_java_io_UnsupportedEncodingException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L775100687cn1_class_id_java_io_UnsupportedEncodingException3);
    restoreToL775100687cn1_class_id_java_io_UnsupportedEncodingException3 = threadStateData->threadObjectStackOffset;
...
label_L1615264672:
    ...
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1648285165;
    __CN1_DEBUG_INFO(312);
    if (virtual_com_codename1_io_MultipartRequest_shouldStop___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1240016676;
...
label_L1240016676:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L732214059;
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1395523773;
    __CN1_DEBUG_INFO(330);
    virtual_java_io_Writer_flush__(threadStateData, locals[2].data.o); 

label_L1395523773:
    __CN1_DEBUG_INFO(332);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1202402952;
    __CN1_DEBUG_INFO(333);
    /* CustomInvoke */virtual_java_io_Writer_write___java_lang_String(threadStateData, locals[2].data.o, locals[5].data.o); 
    goto label_L1207695710;

label_L1202402952:
    __CN1_DEBUG_INFO(335);
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1229465441;
...
label_L1207695710:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1791032605;
...
label_L732214059:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_array_1_id_java_lang_String);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1950456251;
...
label_L2110350270:
    if (ilocals_9_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L1827192676;
...
locals[10].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(349);
    if (ilocals_6_!=0) /* IFNE CustomJump */ goto label_L1679027895;
...
label_L1679027895:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L156684093;
    __CN1_DEBUG_INFO(364);
    virtual_java_io_Writer_flush__(threadStateData, locals[2].data.o); 

label_L156684093:
    __CN1_DEBUG_INFO(366);
    if (/* CustomInvoke */virtual_java_util_Vector_contains___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_MultipartRequest_ignoreEncoding(__cn1ThisObject), locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1898058733;
    ...
    goto label_L1478005042;

label_L1898058733:
    __CN1_DEBUG_INFO(369);
    if (get_field_com_codename1_io_MultipartRequest_base64Binaries(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L587573968;
...
label_L1478005042:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L471180970;
...
label_L1950456251:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1640299572;
...
locals[6].type=CN1_TYPE_OBJECT;    goto label_L1577603673;
...
label_L301601202:
    ...
    if (ilocals_8_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1760173749;
    __CN1_DEBUG_INFO(401);
    if (virtual_com_codename1_io_MultipartRequest_shouldStop___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L772369088;
...
label_L772369088:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L226230494;
...
label_L1760173749:
    ...
    if (get_static_com_codename1_io_MultipartRequest_leaveInputStreamsOpen(threadStateData)!=0) /* IFNE CustomJump */ goto label_L1281853983;
    __CN1_DEBUG_INFO(412);
    /* CustomInvoke */com_codename1_io_Util_cleanup___java_lang_Object(threadStateData, locals[6].data.o); 
    goto label_L1281853983;
...
label_L1791032605:
    ...
    if (get_static_com_codename1_io_MultipartRequest_canFlushStream(threadStateData)==0) /* IFEQ CustomJump */ goto label_L560990653;
    __CN1_DEBUG_INFO(426);
    virtual_java_io_Writer_flush__(threadStateData, locals[2].data.o); 

label_L560990653:
    __CN1_DEBUG_INFO(428);
    goto label_L1615264672;
