...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4___INIT_____com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9609, 202);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_4_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 9609, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL205743114701;
    int tryBlockOffsetL205743114701;
    DEFINE_CATCH_BLOCK(catch_L205743114701, label_L1537912396, restoreToL205743114701);
    __CN1_DEBUG_INFO(625);
    if (get_field_com_codename1_impl_ios_IOSImplementation_4_val_current(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1533972343, 0);
    __CN1_DEBUG_INFO(626);
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$200___com_codename1_impl_ios_IOSImplementation_R_com_codename1_ui_TextArea(threadStateData, get_static_com_codename1_impl_ios_IOSImplementation_instance(threadStateData))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1533972343, 0);
...
label_L2057431147:
 tryBlockOffsetL205743114701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L205743114701);
    restoreToL205743114701 = threadStateData->threadObjectStackOffset;
