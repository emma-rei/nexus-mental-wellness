...
JAVA_VOID com_codename1_ui_spinner_Picker_1___INIT_____com_codename1_ui_spinner_Picker(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 9788, 202);
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(9, 9, 0, 9788, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(303);
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$000___com_codename1_ui_spinner_Picker_com_codename1_ui_events_ActionEvent_R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L193206035;
...
label_L193206035:
    ...
    if (virtual_com_codename1_ui_spinner_Picker_isEditing___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1072635499;
...
label_L1072635499:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$100___com_codename1_ui_spinner_Picker_R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L83812683;
...
label_L298045999:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isNativePickerTypeSupported___int_R_boolean(threadStateData, SP[-1].data.o, /* CustomInvoke */com_codename1_ui_spinner_Picker_access$200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject)));
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L978609035;
    ...
    SP--;
    switch((*SP).data.i) {
        case 5: goto label_L2106535660;
        case 6: goto label_L2106535660;
        case 7: goto label_L2106535660;
        default: goto label_L243821743;
    }
...
label_L2106535660:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(780));
...
label_L243821743:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L30770683;
...
label_L978609035:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1364765175;
        case 2: goto label_L2089747578;
        case 3: goto label_L1132974836;
        case 4: goto label_L499119900;
        case 5: goto label_L154985037;
        case 6: goto label_L154985037;
        case 7: goto label_L154985037;
        case 8: goto label_L227843012;
        default: goto label_L1887041776;
    }
...
label_L499119900:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$700___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L303888116;
...
label_L303888116:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2094809200;
...
label_L1790862011:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L2094809200;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1430240916;
    ...
    goto label_L2094809200;

label_L1430240916:
    __CN1_DEBUG_INFO(354);
    BC_IINC(7, 1);
    goto label_L1790862011;

label_L2094809200:
    __CN1_DEBUG_INFO(361);
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L526418510;
...
label_L1364765175:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L18976274;
...
label_L700603324:
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeConstant___java_lang_String_int_R_int(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9789), 1900);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L812666757;
...
label_L2089747578:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$800___com_codename1_ui_spinner_Picker_R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L731498807;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(12);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L731498807;
...
label_L650482504:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o, locals[7].data.o)==0) /* IFEQ CustomJump */ goto label_L501293975;
    __CN1_DEBUG_INFO(410);
    if (virtual_com_codename1_ui_spinner_Picker_isShowMeridiem___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L794778569;
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(12);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1256914788;
    __CN1_DEBUG_INFO(413);
    if (virtual_com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ goto label_L1077901986;
    __CN1_DEBUG_INFO(414);
    PUSH_INT(12);
    BC_ISTORE(8);
    goto label_L1077901986;

label_L1256914788:
    __CN1_DEBUG_INFO(417);
    if (virtual_com_codename1_ui_spinner_TimeSpinner_isCurrentMeridiem___R_boolean(threadStateData, locals[7].data.o)==0) /* IFEQ CustomJump */ goto label_L1077901986;
...
label_L1132974836:
    ...
    if (virtual_com_codename1_ui_spinner_Picker_isShowMeridiem___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L16948473;
    if (virtual_com_codename1_ui_spinner_DateTimeSpinner_isCurrentMeridiem___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L16948473;
...
label_L470696546:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L668979499;
    ...
    if (virtual_com_codename1_ui_spinner_Picker_isShowMeridiem___R_boolean(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1128856117;
    if (virtual_com_codename1_ui_spinner_DateTimeSpinner_isCurrentMeridiem___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1128856117;
...
label_L154985037:
    ...
    /* CustomInvoke */PUSH_INT(com_codename1_ui_spinner_Picker_access$200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject)));
    PUSH_INT(6);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L952833542;
    ...
    goto label_L1640287933;

label_L952833542:
    __CN1_DEBUG_INFO(467);
    /* CustomInvoke */PUSH_INT(com_codename1_ui_spinner_Picker_access$200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject)));
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1640287933;
...
label_L1640287933:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(threadStateData, __cn1ThisObject, locals[2].data.o, locals[8].data.o)==0) /* IFEQ CustomJump */ goto label_L1700334050;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createStringPicker3D___R_com_codename1_ui_spinner_Spinner3D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 9788, 9790);
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1902831987;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createDatePicker3D___R_com_codename1_ui_spinner_DateSpinner3D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 9788, 9791);
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L292665982;
    PUSH_POINTER(__NEW_java_util_Date(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_Date___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
...
label_L1451700171:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$900___com_codename1_ui_spinner_Picker_R_java_util_Date(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2067540704;
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1000___com_codename1_ui_spinner_Picker_R_java_util_Date(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2067540704;
    ...
    SP[-1].data.l = tmpResult; SP[-1].type = CN1_TYPE_LONG; }
    BC_LCMP();
    if(POP_INT() >= 0) /* IFGE */ goto label_L1564173701;
...
label_L1564173701:
    ...
    SP[-1].data.l = tmpResult; SP[-1].type = CN1_TYPE_LONG; }
    BC_LCMP();
    if(POP_INT() <= 0) /* IFLE */ goto label_L2067540704;
    __CN1_DEBUG_INFO(506);
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */com_codename1_ui_spinner_Picker_access$900___com_codename1_ui_spinner_Picker_R_java_util_Date(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject));locals[2].type=CN1_TYPE_OBJECT;
label_L2067540704:
    __CN1_DEBUG_INFO(509);
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1090885142;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createCalendarPicker___R_com_codename1_ui_spinner_CalendarPicker(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 9788, 9792);
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L887248018;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createTimePicker3D___R_com_codename1_ui_spinner_TimeSpinner3D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 9788, 9793);
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1100___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L1596693928;
    ...
    PUSH_INT(24);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1596693928;
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))<=/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1100___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))) /* IF_ICMPLE CustomJump */ goto label_L1596693928;
...
label_L1596693928:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1770701191;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createDateTimePicker3D___R_com_codename1_ui_spinner_DateTimeSpinner3D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 9788, 9794);
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$900___com_codename1_ui_spinner_Picker_R_java_util_Date(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1710607075;
...
label_L1710607075:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1000___com_codename1_ui_spinner_Picker_R_java_util_Date(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1714478376;
...
label_L1714478376:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1100___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L1493806736;
    /* CustomInvoke */PUSH_INT(com_codename1_ui_spinner_Picker_access$1100___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject)));
    PUSH_INT(24);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1493806736;
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))<=/* CustomInvoke */com_codename1_ui_spinner_Picker_access$1100___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))) /* IF_ICMPLE CustomJump */ goto label_L1493806736;
...
label_L1493806736:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1149892111;
...
JAVA_OBJECT com_codename1_ui_spinner_Picker_1_createDurationPicker3D___R_com_codename1_ui_spinner_DurationSpinner3D(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 9788, 9795);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(7);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1876548582;
    PUSH_INT(8);
    goto label_L2066777507;
...
label_L1876548582:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(6);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1879190852;
    PUSH_INT(4); /* ICONST_4 */
    goto label_L2066777507;
...
label_L2066777507:
    ...
    if (/* CustomInvoke */com_codename1_ui_spinner_Picker_access$600___com_codename1_ui_spinner_Picker_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2065453085;
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_endEditing___int_com_codename1_components_InteractionDialog_com_codename1_ui_spinner_InternalPickerWidget(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 9788, 9796);
    ...
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L634988826;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(596);
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1146116328;
    __CN1_DEBUG_INFO(598);
    if (ilocals_1_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1565881543;
    __CN1_DEBUG_INFO(599);
    /* VarOp.assignFrom */ locals[4].data.o = /* CustomInvoke */virtual_com_codename1_ui_Form_getNextComponent___com_codename1_ui_Component_R_com_codename1_ui_Component(threadStateData, locals[5].data.o, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject));locals[4].type=CN1_TYPE_OBJECT;    goto label_L1146116328;

label_L1565881543:
    __CN1_DEBUG_INFO(600);
    if (ilocals_1_!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L1146116328;
...
label_L1146116328:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L634988826;
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_showInteractionDialog__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 19, 0, 9788, 9797);
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1517972788;
        case 2: goto label_L914824856;
        case 3: goto label_L1893107640;
        case 4: goto label_L106116649;
        case 5: goto label_L256501786;
        case 6: goto label_L256501786;
        case 7: goto label_L256501786;
        case 8: goto label_L28591285;
        default: goto label_L1167849596;
    }
...
label_L1167849596:
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9798));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___int_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, /* CustomInvoke */com_codename1_ui_spinner_Picker_access$200___com_codename1_ui_spinner_Picker_R_int(threadStateData, get_field_com_codename1_ui_spinner_Picker_1_this_0(__cn1ThisObject)));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    { JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_toString___R_java_lang_String(threadStateData, SP[-1].data.o);
...
label_L1525050520:
    ...
    /* LDC: 'DialogTitle'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(3230));
    PUSH_INT(1); /* ICONST_1 */
    SP--;
    ...
    BC_ALOAD(3);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L447694566;
    /* LDC: 'PickerDialogTablet'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9799));
    goto label_L958212330;

label_L447694566:
    /* LDC: 'PickerDialog'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9800));
...
label_L958212330:
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Label___INIT_____java_lang_String_java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(220), STRING_FROM_CONSTANT_POOL_OFFSET(9801));     SP -= 1;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L601849773;
...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(703);
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: 'SpinnerWrapper'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9804));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InteractionDialog_getContentPane___R_com_codename1_ui_Container(threadStateData, locals[3].data.o);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_com_codename1_ui_Container_add___java_lang_Object_com_codename1_ui_Component_R_com_codename1_ui_Container(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(138), locals[6].data.o);     SP -= 1;
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L2059830767;
...
label_L574406413:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1246754285;
    /* LDC: 'PickerButtonTablet'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9805));
    goto label_L98415362;
...
locals[9].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(741);
    ...
    if (virtual_java_util_ListIterator_hasNext___R_boolean(threadStateData, locals[10].data.o)==0) /* IFEQ CustomJump */ goto label_L1266333611;
    __CN1_DEBUG_INFO(743);
    PUSH_POINTER(__NEW_com_codename1_ui_Button(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* LDC: ''*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(220));
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L217693470;
    /* LDC: 'PickerButtonTablet'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9805));
...
locals[11].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(763);
    if (virtual_java_util_ListIterator_hasPrevious___R_boolean(threadStateData, locals[10].data.o)==0) /* IFEQ CustomJump */ goto label_L1367421029;
    __CN1_DEBUG_INFO(764);
    PUSH_POINTER(__NEW_com_codename1_ui_Button(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* LDC: ''*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(220));
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1331171857;
    /* LDC: 'PickerButtonTablet'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(9805));
    goto label_L235423657;
...
label_L1367421029:
    ...
    if (locals[11].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1366572224;
...
label_L1366572224:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L154021011;
...
label_L154021011:
    ...
    BC_ALOAD(13);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L107577149;
    /* LDC: 'PickerButtonBarTablet'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(5181));
...
label_L1242584406:
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_InteractionDialog_getContentPane___R_com_codename1_ui_Container(threadStateData, locals[3].data.o);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_com_codename1_ui_Container_add___java_lang_Object_com_codename1_ui_Component_R_com_codename1_ui_Container(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(63), locals[13].data.o);     SP -= 1;
    ...
    if (locals[14].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L980607720;
    __CN1_DEBUG_INFO(800);
    PUSH_POINTER(__NEW_java_lang_RuntimeException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_RuntimeException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9808));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L980607720:
    ...
    if (ilocals_15_!=0) /* IFNE CustomJump */ goto label_L1111497601;
...
label_L1111497601:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTablet___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L253564003;
...
JAVA_BOOLEAN com_codename1_ui_spinner_Picker_1_showDialog___com_codename1_ui_Dialog_com_codename1_ui_Component_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(7, 7, 0, 9788, 2935);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(844);
    /* CustomInvoke */virtual_com_codename1_ui_Dialog_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(138), locals[2].data.o); 
    __CN1_DEBUG_INFO(845);
    PUSH_POINTER(__NEW_com_codename1_ui_Button(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    PUSH_POINTER(__NEW_com_codename1_ui_Command(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_Command___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(756));     SP -= 1;
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_codename1_ui_spinner_Picker_1_8___INIT_____com_codename1_ui_spinner_Picker_1_java_lang_String_boolean_1ARRAY(threadStateData, SP[-1].data.o, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(465), locals[4].data.o);     SP -= 1;
    com_codename1_ui_Button___INIT_____com_codename1_ui_Command(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    BC_ASTORE(5);
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Dialog_addComponent___java_lang_Object_com_codename1_ui_Component(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(64), locals[6].data.o); 
    __CN1_DEBUG_INFO(856);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTablet___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1780974980;
...
label_L687408978:
    ...
    if (CN1_ARRAY_ELEMENT_BYTE(locals[4].data.o, 0 /* ICONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1327542306;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_VOID com_codename1_ui_spinner_Picker_1_access$1600___com_codename1_ui_spinner_Picker_1_int_com_codename1_components_InteractionDialog_com_codename1_ui_spinner_InternalPickerWidget(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_spinner_Picker_1(threadStateData);
    DEFINE_METHOD_STACK(4, 4, 0, 9788, 5666);
