#ifndef __COM_NEXUS_NEXWELL_HOMEPAGE_HOMEPAGEFORM__
#define __COM_NEXUS_NEXWELL_HOMEPAGE_HOMEPAGEFORM__

#include "cn1_globals.h"
#include "com_codename1_ui_Form.h"
extern struct clazz class__com_nexus_nexwell_homepage_HomePageForm;
extern void __INIT_VTABLE_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE, void** vtable);
extern void __STATIC_INITIALIZER_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE);
extern void __FINALIZER_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete);
extern void __GC_MARK_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force);
extern JAVA_OBJECT __NEW_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE);
extern JAVA_OBJECT __NEW_INSTANCE_com_nexus_nexwell_homepage_HomePageForm(CODENAME_ONE_THREAD_STATE);
...
JAVA_INT com_nexus_nexwell_homepage_HomePageForm_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_nexus_nexwell_homepage_HomePageForm_notify__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_VOID com_nexus_nexwell_homepage_HomePageForm_notifyAll__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);
...
JAVA_VOID com_nexus_nexwell_homepage_HomePageForm_wait___long_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1, JAVA_INT __cn1Arg2);
...
extern JAVA_OBJECT get_static_com_nexus_nexwell_homepage_HomePageForm_STORAGE_NAME();
extern JAVA_OBJECT STATIC_FIELD_com_nexus_nexwell_homepage_HomePageForm_STORAGE_NAME;
extern void set_static_com_nexus_nexwell_homepage_HomePageForm_STORAGE_NAME(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT v);
#define get_static_com_nexus_nexwell_homepage_HomePageForm_activePeerCount(threadStateArgument) get_static_com_codename1_ui_Form_activePeerCount(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_activePeerCount(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_activePeerCount(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_rippleMotion(threadStateArgument) get_static_com_codename1_ui_Form_rippleMotion(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_rippleMotion(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_rippleMotion(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_rippleComponent(threadStateArgument) get_static_com_codename1_ui_Form_rippleComponent(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_rippleComponent(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_rippleComponent(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_rippleX(threadStateArgument) get_static_com_codename1_ui_Form_rippleX(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_rippleX(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_rippleX(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_rippleY(threadStateArgument) get_static_com_codename1_ui_Form_rippleY(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_rippleY(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_rippleY(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_comboLock(threadStateArgument) get_static_com_codename1_ui_Form_comboLock(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_comboLock(threadStateArgument, valueArgument) set_static_com_codename1_ui_Form_comboLock(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_enableLayoutOnPaint(threadStateArgument) get_static_com_codename1_ui_Container_enableLayoutOnPaint(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_enableLayoutOnPaint(threadStateArgument, valueArgument) set_static_com_codename1_ui_Container_enableLayoutOnPaint(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_sidemenuBarTranslation(threadStateArgument) get_static_com_codename1_ui_Container_sidemenuBarTranslation(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_sidemenuBarTranslation(threadStateArgument, valueArgument) set_static_com_codename1_ui_Container_sidemenuBarTranslation(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_blockOverdraw(threadStateArgument) get_static_com_codename1_ui_Container_blockOverdraw(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_blockOverdraw(threadStateArgument, valueArgument) set_static_com_codename1_ui_Container_blockOverdraw(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DEFAULT_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_DEFAULT_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DEFAULT_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DEFAULT_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_CROSSHAIR_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_CROSSHAIR_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_CROSSHAIR_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_CROSSHAIR_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_TEXT_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_TEXT_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_TEXT_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_TEXT_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_WAIT_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_WAIT_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_WAIT_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_WAIT_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_SW_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_SW_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_SW_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_SW_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_SE_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_SE_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_SE_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_SE_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_NW_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_NW_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_NW_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_NW_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_NE_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_NE_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_NE_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_NE_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_N_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_N_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_N_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_N_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_S_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_S_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_S_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_S_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_W_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_W_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_W_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_W_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_E_RESIZE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_E_RESIZE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_E_RESIZE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_E_RESIZE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_HAND_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_HAND_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_HAND_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_HAND_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_MOVE_CURSOR(threadStateArgument) get_static_com_codename1_ui_Component_MOVE_CURSOR(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_MOVE_CURSOR(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_MOVE_CURSOR(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_NOT_DRAGGABLE(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_NOT_DRAGGABLE(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_NOT_DRAGGABLE(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_NOT_DRAGGABLE(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_X(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_X(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_X(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_X(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_Y(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_Y(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_Y(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_Y(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_XY(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_XY(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_POSSIBLE_DRAG_XY(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_POSSIBLE_DRAG_XY(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_X(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_X(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_X(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_X(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_Y(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_Y(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_Y(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_Y(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_XY(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_XY(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_LIKELY_DRAG_XY(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_LIKELY_DRAG_XY(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_X(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_X(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_X(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_X(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_Y(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_Y(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_Y(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_Y(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_XY(threadStateArgument) get_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_XY(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_DRAG_REGION_IMMEDIATELY_DRAG_XY(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_DRAG_REGION_IMMEDIATELY_DRAG_XY(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CONSTANT_ASCENT(threadStateArgument) get_static_com_codename1_ui_Component_BRB_CONSTANT_ASCENT(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CONSTANT_ASCENT(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BRB_CONSTANT_ASCENT(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CONSTANT_DESCENT(threadStateArgument) get_static_com_codename1_ui_Component_BRB_CONSTANT_DESCENT(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CONSTANT_DESCENT(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BRB_CONSTANT_DESCENT(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CENTER_OFFSET(threadStateArgument) get_static_com_codename1_ui_Component_BRB_CENTER_OFFSET(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BRB_CENTER_OFFSET(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BRB_CENTER_OFFSET(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BRB_OTHER(threadStateArgument) get_static_com_codename1_ui_Component_BRB_OTHER(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BRB_OTHER(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BRB_OTHER(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_revalidateOnStyleChange(threadStateArgument) get_static_com_codename1_ui_Component_revalidateOnStyleChange(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_revalidateOnStyleChange(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_revalidateOnStyleChange(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_CENTER(threadStateArgument) get_static_com_codename1_ui_Component_CENTER(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_CENTER(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_CENTER(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_TOP(threadStateArgument) get_static_com_codename1_ui_Component_TOP(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_TOP(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_TOP(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_LEFT(threadStateArgument) get_static_com_codename1_ui_Component_LEFT(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_LEFT(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_LEFT(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BOTTOM(threadStateArgument) get_static_com_codename1_ui_Component_BOTTOM(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BOTTOM(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BOTTOM(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_RIGHT(threadStateArgument) get_static_com_codename1_ui_Component_RIGHT(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_RIGHT(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_RIGHT(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_BASELINE(threadStateArgument) get_static_com_codename1_ui_Component_BASELINE(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_BASELINE(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_BASELINE(threadStateArgument, valueArgument)
#define get_static_com_nexus_nexwell_homepage_HomePageForm_restoreDragPercentage(threadStateArgument) get_static_com_codename1_ui_Component_restoreDragPercentage(threadStateArgument)
#define set_static_com_nexus_nexwell_homepage_HomePageForm_restoreDragPercentage(threadStateArgument, valueArgument) set_static_com_codename1_ui_Component_restoreDragPercentage(threadStateArgument, valueArgument)
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_ioThread(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_loaded(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_titleArea(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_focusScrolling(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_tint(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_showListener(JAVA_OBJECT t);
...
JAVA_INT get_field_com_nexus_nexwell_homepage_HomePageForm_initialPressX(JAVA_OBJECT t);
...
JAVA_INT get_field_com_nexus_nexwell_homepage_HomePageForm_initialPressY(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_revalidateFromRoot(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_scrollableX(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_scrollableY(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm__tmpRenderingElevatedComponents(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_hasLead(JAVA_OBJECT t);
...
JAVA_INT get_field_com_nexus_nexwell_homepage_HomePageForm_renderedElevation(JAVA_OBJECT t);
...
JAVA_INT get_field_com_nexus_nexwell_homepage_HomePageForm_renderedElevationComponentIndex(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_scrollSize(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_shouldCalcPreferredSize(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_shouldCalcScrollSize(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_draggedMotionX(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_draggedMotionY(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_noBind(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_pointerPressedListeners(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_pointerReleasedListeners(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_pointerDraggedListeners(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_dragFinishedListeners(JAVA_OBJECT t);
...
JAVA_OBJECT get_field_com_nexus_nexwell_homepage_HomePageForm_longPressListeners(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_isUnselectedStyle(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_doNotPaint(JAVA_OBJECT t);
...
JAVA_BOOLEAN get_field_com_nexus_nexwell_homepage_HomePageForm_internalRegisteredAnimated(JAVA_OBJECT t);
...
struct obj__com_nexus_nexwell_homepage_HomePageForm {
    DEBUG_GC_VARIABLES
    ...
    JAVA_OBJECT com_nexus_nexwell_homepage_HomePageForm_ioThread;
    JAVA_BOOLEAN com_nexus_nexwell_homepage_HomePageForm_loaded;
};



#endif //__COM_NEXUS_NEXWELL_HOMEPAGE_HOMEPAGEFORM__
