...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition___INIT_____com_codename1_ui_SideMenuBar_int_boolean_int_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_OBJECT __cn1Arg5) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 7207, 202);
...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition_initTransition__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 7207, 1375);
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(76)) /* IF_ACMPNE CustomJump */ goto label_L1185502159;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L357291163;
    __CN1_DEBUG_INFO(1535);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L973174587;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L551797833;
...
label_L973174587:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1744579245;
...
label_L744021169:
    ...
    goto label_L1458905542;

label_L357291163:
    __CN1_DEBUG_INFO(1552);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1745512157;
    ...
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_SideMenuBar_access$600___com_codename1_ui_SideMenuBar_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_SideMenuBar_MenuTransition_this_0(__cn1ThisObject)));
    /* LDC: '$parent'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(7022));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_SideMenuBar_MenuTransition_getSource___R_com_codename1_ui_Component(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
...
label_L1185502159:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(75)) /* IF_ACMPNE CustomJump */ goto label_L48071225;
    __CN1_DEBUG_INFO(1563);
    BC_ALOAD(0);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L74606989;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L2071364564;
...
label_L48071225:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1081159401;
    __CN1_DEBUG_INFO(1566);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L777236628;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L972720850;
    __CN1_DEBUG_INFO(1569);
    BC_ALOAD(0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_animations_Motion_createEaseInOutMotion___int_int_int_R_com_codename1_ui_animations_Motion(threadStateData, 0 /* ICONST_0 */, get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject), get_field_com_codename1_ui_SideMenuBar_MenuTransition_speed(__cn1ThisObject)));
    set_field_com_codename1_ui_SideMenuBar_MenuTransition_motion(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    goto label_L1994249754;
...
label_L777236628:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_dest(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1066575950;
...
label_L1994249754:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L217479224;
...
label_L1081159401:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2034411604;
...
label_L1458905542:
    ...
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_plaf_UIManager_isThemeConstant___java_lang_String_boolean_R_boolean(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7005), 1 /* ICONST_1 */);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    BC_ISTORE(1);
    ...
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_SideMenuBar_getUIManager___R_com_codename1_ui_plaf_UIManager(threadStateData, get_field_com_codename1_ui_SideMenuBar_MenuTransition_this_0(__cn1ThisObject));
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6993));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    set_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    __CN1_DEBUG_INFO(1600);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1404612586;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1404612586;
...
label_L1404612586:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(75)) /* IF_ACMPNE CustomJump */ goto label_L1815095837;
    __CN1_DEBUG_INFO(1605);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L866370634;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1607453282;
...
label_L1815095837:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1235155342;
    __CN1_DEBUG_INFO(1608);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1235155342;
...
JAVA_BOOLEAN com_codename1_ui_SideMenuBar_MenuTransition_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7207, 1588);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1617);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_motion(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L613630562;
    ...
    PUSH_POINTER(get_field_com_codename1_ui_SideMenuBar_MenuTransition_this_0(__cn1ThisObject));
    if (virtual_com_codename1_ui_animations_Motion_isFinished___R_boolean(threadStateData, get_field_com_codename1_ui_SideMenuBar_MenuTransition_motion(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L155140910;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L679613617;
...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition_cleanup__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7207, 1726);
...
JAVA_VOID com_codename1_ui_SideMenuBar_MenuTransition_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 7207, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L384752294;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_getDisplayHeight___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L384752294;
    __CN1_DEBUG_INFO(1635);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L676338251;
...
label_L384752294:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_placement(__cn1ThisObject)!=STRING_FROM_CONSTANT_POOL_OFFSET(76)) /* IF_ACMPNE CustomJump */ goto label_L1527061084;
    __CN1_DEBUG_INFO(1645);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1671084561;
    __CN1_DEBUG_INFO(1646);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L54617902;
...
label_L1671084561:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1489997716;
...
label_L1527061084:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_isRTL(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1848900782;
...
label_L1848900782:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_areMutableImagesFast___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1724091985;
    __CN1_DEBUG_INFO(1672);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L274996233;
    __CN1_DEBUG_INFO(1673);
    /* CustomInvoke */virtual_com_codename1_ui_Component_paintComponent___com_codename1_ui_Graphics_boolean(threadStateData, locals[3].data.o, locals[1].data.o, 1 /* ICONST_1 */); 
    __CN1_DEBUG_INFO(1674);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L888378046;
...
label_L888378046:
    ...
    goto label_L1163189762;

label_L274996233:
    __CN1_DEBUG_INFO(1679);
    /* CustomInvoke */virtual_com_codename1_ui_Component_paintComponent___com_codename1_ui_Graphics_boolean(threadStateData, locals[2].data.o, locals[1].data.o, 1 /* ICONST_1 */); 
    __CN1_DEBUG_INFO(1680);
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1067414015;
...
label_L1724091985:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_fwd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L262911569;
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L669365112;
...
label_L262911569:
    ...
    if (get_field_com_codename1_ui_SideMenuBar_MenuTransition_shadow(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1143135560;
