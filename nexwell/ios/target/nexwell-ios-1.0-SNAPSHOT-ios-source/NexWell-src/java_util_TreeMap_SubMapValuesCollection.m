...
JAVA_VOID java_util_TreeMap_SubMapValuesCollection___INIT_____java_util_TreeMap_SubMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6274, 202);
...
JAVA_BOOLEAN java_util_TreeMap_SubMapValuesCollection_isEmpty___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6274, 906);
...
JAVA_OBJECT java_util_TreeMap_SubMapValuesCollection_iterator___R_java_util_Iterator(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(7, 5, 0, 6274, 1230);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_TreeMap_SubMap_hasStart(get_field_java_util_TreeMap_SubMapValuesCollection_subMap(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L640113647;
...
label_L640113647:
    ...
    BC_ASTORE(1);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2011997442;
...
label_L124323713:
    if (get_field_java_util_TreeMap_SubMap_hasEnd(get_field_java_util_TreeMap_SubMapValuesCollection_subMap(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L773989906;
    PUSH_POINTER(__NEW_java_util_TreeMap_UnboundedValueIterator(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapValuesCollection_subMap(__cn1ThisObject)));
    BC_ALOAD(1);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1631086936;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1944978632;
...
label_L1239183618:
    ...
    BC_ISTORE(4);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1804379080;
    if (ilocals_4_<=get_field_java_util_TreeMap_Node_right_idx(locals[3].data.o)) /* IF_ICMPLE CustomJump */ goto label_L1804379080;
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;locals[3].data.o = get_field_java_util_TreeMap_Node_next(locals[3].data.o);
locals[3].type=CN1_TYPE_OBJECT;    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1757880885;
...
label_L278240974:
    BC_ISTORE(4);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1804379080;
    PUSH_POINTER(__NEW_java_util_TreeMap_UnboundedValueIterator(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapValuesCollection_subMap(__cn1ThisObject)));
    BC_ALOAD(1);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L980138431;
    PUSH_INT(0); /* ICONST_0 */
...
label_L1804379080:
    ...
    BC_DUP(); /* DUP */
    BC_ALOAD(1);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1710265848;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1504642150;
...
label_L1504642150:
    /* CustomInvoke */PUSH_OBJ(java_util_TreeMap_SubMap_access$400___java_util_TreeMap_SubMap_R_java_util_TreeMap(threadStateData, get_field_java_util_TreeMap_SubMapValuesCollection_subMap(__cn1ThisObject)));
    BC_ALOAD(3);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1047460013;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L879583678;
...
JAVA_INT java_util_TreeMap_SubMapValuesCollection_size___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 6274, 1224);
