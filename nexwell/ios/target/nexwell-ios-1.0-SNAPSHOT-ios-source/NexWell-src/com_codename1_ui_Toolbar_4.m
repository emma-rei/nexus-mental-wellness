...
JAVA_VOID com_codename1_ui_Toolbar_4___INIT_____com_codename1_ui_Toolbar_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7187, 202);
...
JAVA_VOID com_codename1_ui_Toolbar_4_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7187, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1010434098;
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L1010434098;
    if (com_codename1_ui_Toolbar_access$400___R_boolean(threadStateData)==0) /* IFEQ CustomJump */ goto label_L1010434098;
    if (virtual_com_codename1_ui_Form_findCurrentlyEditingComponent___R_com_codename1_ui_Component(threadStateData, locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1010434098;
    if (virtual_com_codename1_ui_Form_isEditing___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L2095793272;
...
label_L2095793272:
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$000___com_codename1_ui_Toolbar_R_com_codename1_components_InteractionDialog(threadStateData, get_field_com_codename1_ui_Toolbar_4_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2145040140;
    __CN1_DEBUG_INFO(1310);
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_com_codename1_ui_Form_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_Toolbar_4_val_parent(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(7185));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1311);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L632115057;
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L632115057;
    ...
    if (virtual_com_codename1_ui_Toolbar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1241182310;
...
label_L632115057:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2145040140;
...
label_L2145040140:
    ...
    if (/* CustomInvoke */com_codename1_ui_Toolbar_access$200___com_codename1_ui_Toolbar_R_com_codename1_components_InteractionDialog(threadStateData, get_field_com_codename1_ui_Toolbar_4_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1872012709;
    __CN1_DEBUG_INFO(1325);
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_com_codename1_ui_Form_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, get_field_com_codename1_ui_Toolbar_4_val_parent(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(7186));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1326);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1163664780;
    if (virtual_java_lang_Boolean_booleanValue___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L1163664780;
    __CN1_DEBUG_INFO(1327);
    /* CustomInvoke */virtual_com_codename1_ui_Form_putClientProperty___java_lang_String_java_lang_Object(threadStateData, get_field_com_codename1_ui_Toolbar_4_val_parent(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(7189), get_static_java_lang_Boolean_TRUE(threadStateData)); 
    __CN1_DEBUG_INFO(1328);
    if (virtual_com_codename1_ui_Toolbar_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_Toolbar_4_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L172299409;
...
label_L1163664780:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_components_InteractionDialog_isShowing___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1872012709;
