...
JAVA_VOID java_lang_System_1___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1154, 202);
...
JAVA_VOID java_lang_System_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 1154, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1017021094cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL1017021094cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L1017021094cn1_class_id_java_lang_InterruptedException1, label_L1768882706, restoreToL1017021094cn1_class_id_java_lang_InterruptedException1);
    int restoreToL101702109402;
    int tryBlockOffsetL101702109402;
    DEFINE_CATCH_BLOCK(catch_L101702109402, label_L1463022229, restoreToL101702109402);
    ...
    int restoreToL113926411104;
    int tryBlockOffsetL113926411104;
    DEFINE_CATCH_BLOCK(catch_L113926411104, label_L472991420, restoreToL113926411104);
    ...
    int restoreToL1687374541cn1_class_id_java_lang_InterruptedException6;
    int tryBlockOffsetL1687374541cn1_class_id_java_lang_InterruptedException6;
    DEFINE_CATCH_BLOCK(catch_L1687374541cn1_class_id_java_lang_InterruptedException6, label_L1455855843, restoreToL1687374541cn1_class_id_java_lang_InterruptedException6);
...
label_L1017021094:
 tryBlockOffsetL101702109402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L101702109402);
    restoreToL101702109402 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1017021094cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1017021094cn1_class_id_java_lang_InterruptedException1);
    restoreToL1017021094cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1687374541:
 tryBlockOffsetL1687374541cn1_class_id_java_lang_InterruptedException6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1687374541cn1_class_id_java_lang_InterruptedException6);
    restoreToL1687374541cn1_class_id_java_lang_InterruptedException6 = threadStateData->threadObjectStackOffset;
...
label_L1139264111:
 tryBlockOffsetL113926411104 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L113926411104);
    restoreToL113926411104 = threadStateData->threadObjectStackOffset;
