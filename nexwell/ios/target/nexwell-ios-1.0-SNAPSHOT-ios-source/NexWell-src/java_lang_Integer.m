...
JAVA_VOID java_lang_Integer___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1067, 201);
...
JAVA_BYTE java_lang_Integer_byteValue___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 1014);
...
JAVA_DOUBLE java_lang_Integer_doubleValue___R_double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1067, 1016);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
...
JAVA_BOOLEAN java_lang_Integer_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1067, 876);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L65080774;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L65080774;
    if (get_field_java_lang_Integer_value(locals[1].data.o)!=get_field_java_lang_Integer_value(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L65080774;
    PUSH_INT(1); /* ICONST_1 */
...
JAVA_FLOAT java_lang_Integer_floatValue___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 1017);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
...
JAVA_INT java_lang_Integer_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 881);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return SP[-1].data.i;
}
...
JAVA_INT java_lang_Integer_intValue___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 1018);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return SP[-1].data.i;
}
...
JAVA_LONG java_lang_Integer_longValue___R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1067, 1022);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
...
JAVA_INT java_lang_Integer_parseInt___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 1067, 1068);
...
JAVA_INT java_lang_Integer_parseInt___java_lang_String_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(4, 6, 0, 1067, 1068);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_1_ = __cn1Arg2;
    if (ilocals_1_<2 /* ICONST_2 */) /* IF_IMPLT CustomJump */ goto label_L1172535934;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(36);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1648700617;
...
label_L1172535934:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1069));
...
label_L1648700617:
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1765900922;
...
label_L1765900922:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L94830685;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
label_L94830685:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1539947037;
    PUSH_INT(1); /* ICONST_1 */
...
label_L270661321:
    BC_ISTORE(4);
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L1964434661;
    BC_IINC(3, 1);
    if (ilocals_3_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1964434661;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
label_L1585571244:
    BC_ISTORE(5);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L1099552523;
    BC_IINC(3, 1);
    if (ilocals_3_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L1099552523;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
JAVA_INT java_lang_Integer_parse___java_lang_String_int_int_boolean_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(2, 9, 0, 1067, 1070);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_1_ = __cn1Arg2;
...
label_L839771540:
    if (ilocals_1_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L66724371;
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    BC_ISTORE(7);
    if (ilocals_7_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1047934137;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());

label_L1047934137:
    if (ilocals_4_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1862994526;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());

label_L1862994526:
    /* VarOp.assignFrom */ ilocals_8_=((ilocals_5_ * ilocals_2_) - ilocals_7_);
    if (ilocals_8_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1614133563;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
label_L66724371:
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1037163664;
    /* VarOp.assignFrom */ ilocals_5_=(-(ilocals_5_));
    if (ilocals_5_>=0) /* IFGE CustomJump */ goto label_L1037163664;
    /* CustomInvoke */PUSH_OBJ(java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT java_lang_Integer_invalidInt___java_lang_String_R_java_lang_NumberFormatException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 1067, 1071);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    PUSH_POINTER(__NEW_java_lang_NumberFormatException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1072));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_SHORT java_lang_Integer_shortValue___R_short(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 1024);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_INT(get_field_java_lang_Integer_value(__cn1ThisObject));
...
JAVA_OBJECT java_lang_Integer_toHexString___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 1067, 1075);
...
JAVA_OBJECT java_lang_Integer_intToHexString___int_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(5, 6, 0, 1067, 1076);
...
label_L1200546947:
    ...
    if ((ilocals_2_ - ilocals_4_)<ilocals_1_) /* IF_IMPLT CustomJump */ goto label_L1200546947;
...
JAVA_OBJECT java_lang_Integer_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1067, 895);
...
JAVA_OBJECT java_lang_Integer_valueOf___java_lang_String_R_java_lang_Integer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(3, 1, 0, 1067, 898);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT java_lang_Integer_valueOf___java_lang_String_int_R_java_lang_Integer(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    __STATIC_INITIALIZER_java_lang_Integer(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 1067, 898);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_1_ = __cn1Arg2;
    PUSH_POINTER(__NEW_java_lang_Integer(threadStateData)); /* NEW */
...
JAVA_INT java_lang_Integer_compareTo___java_lang_Integer_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1067, 870);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (get_field_java_lang_Integer_value(__cn1ThisObject)>=get_field_java_lang_Integer_value(locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1751403001;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L1717433286;

label_L1751403001:
    if (get_field_java_lang_Integer_value(__cn1ThisObject)<=get_field_java_lang_Integer_value(locals[1].data.o)) /* IF_ICMPLE CustomJump */ goto label_L1756819670;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1717433286;
...
JAVA_VOID java_lang_Integer___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 1067, 859);
