...
JAVA_VOID java_util_TreeMap_AbstractSubMapIterator___INIT_____java_util_TreeMap_NavigableSubMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 6246, 202);
    ...
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */java_util_TreeMap_NavigableSubMap_access$000___java_util_TreeMap_NavigableSubMap_R_java_util_TreeMap_Entry(threadStateData, locals[1].data.o);locals[2].type=CN1_TYPE_OBJECT;    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L626742236;
    if (get_field_java_util_TreeMap_NavigableSubMap_toEnd(locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L500772834;
    if (/* CustomInvoke */virtual_java_util_TreeMap_NavigableSubMap_checkUpperBound___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, get_field_java_util_TreeMap_Entry_key(locals[2].data.o))!=0) /* IFNE CustomJump */ goto label_L500772834;
    goto label_L626742236;
...
JAVA_VOID java_util_TreeMap_AbstractSubMapIterator_remove__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 6246, 1232);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_TreeMap_AbstractSubMapIterator_expectedModCount(__cn1ThisObject)!=get_field_java_util_TreeMap_modCount(get_field_java_util_TreeMap_NavigableSubMap_m(get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(__cn1ThisObject)))) /* IF_ICMPNE CustomJump */ goto label_L1800659519;
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_expectedModCount(__cn1ThisObject)!=get_field_java_util_TreeMap_modCount(get_field_java_util_TreeMap_NavigableSubMap_m(get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(__cn1ThisObject)))) /* IF_ICMPNE CustomJump */ goto label_L1691538257;
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_node(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L459848100;
...
label_L1335505684:
    BC_ASTORE(1);
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L992768706;
    /* VarOp.assignFrom */ ilocals_2_ = get_field_java_util_TreeMap_AbstractSubMapIterator_lastOffset(__cn1ThisObject);
    if (ilocals_2_!=get_field_java_util_TreeMap_Node_left_idx(get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L1226204845;
    ...
    goto label_L393040818;

label_L1226204845:
    if (ilocals_2_!=get_field_java_util_TreeMap_Node_right_idx(get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L158453976;
...
label_L158453976:
    ...
    /* VarOp.assignFrom */ locals[1].data.o = /* CustomInvoke */virtual_java_util_TreeMap_removeMiddleElement___java_util_TreeMap_Node_int_R_java_lang_Object(threadStateData, get_field_java_util_TreeMap_NavigableSubMap_m(get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(__cn1ThisObject)), get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject), ilocals_2_);locals[1].type=CN1_TYPE_OBJECT;    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L393040818;
    if (ilocals_3_<=get_field_java_util_TreeMap_Node_right_idx(get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject))) /* IF_ICMPLE CustomJump */ goto label_L393040818;
...
label_L393040818:
    ...
    set_field_java_util_TreeMap_AbstractSubMapIterator_boundaryPair(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
    POP_MANY(2);
    goto label_L1368594774;

label_L726281927:
    set_field_java_util_TreeMap_AbstractSubMapIterator_node(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);

label_L1368594774:
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_node(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1447499999;
    if (/* CustomInvoke */virtual_java_util_TreeMap_NavigableSubMap_isInRange___java_lang_Object_R_boolean(threadStateData, get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(__cn1ThisObject), CN1_ARRAY_ELEMENT_OBJECT(get_field_java_util_TreeMap_Node_keys(get_field_java_util_TreeMap_AbstractSubMapIterator_node(__cn1ThisObject)), get_field_java_util_TreeMap_AbstractSubMapIterator_offset(__cn1ThisObject)))!=0) /* IFNE CustomJump */ goto label_L1447499999;
    set_field_java_util_TreeMap_AbstractSubMapIterator_node(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
...
JAVA_VOID java_util_TreeMap_AbstractSubMapIterator_makeNext__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 6246, 5728);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_TreeMap_AbstractSubMapIterator_expectedModCount(__cn1ThisObject)==get_field_java_util_TreeMap_modCount(get_field_java_util_TreeMap_NavigableSubMap_m(get_field_java_util_TreeMap_AbstractSubMapIterator_subMap(__cn1ThisObject)))) /* IF_ICMPEQ CustomJump */ goto label_L413601558;
    PUSH_POINTER(__NEW_java_util_ConcurrentModificationException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ConcurrentModificationException___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
label_L413601558:
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_node(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1658926803;
...
label_L1658926803:
    ...
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_offset(__cn1ThisObject)==get_field_java_util_TreeMap_Node_right_idx(get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject))) /* IF_ICMPEQ CustomJump */ goto label_L210652080;
    set_field_java_util_TreeMap_AbstractSubMapIterator_offset(threadStateData, (get_field_java_util_TreeMap_AbstractSubMapIterator_offset(__cn1ThisObject) + 1 /* ICONST_1 */), __cn1ThisObject);
    goto label_L1652149987;
...
label_L210652080:
    ...
    if (get_field_java_util_TreeMap_AbstractSubMapIterator_node(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1652149987;
...
label_L1652149987:
    if (get_field_java_util_TreeMap_Entry_node(get_field_java_util_TreeMap_AbstractSubMapIterator_boundaryPair(__cn1ThisObject))!=get_field_java_util_TreeMap_AbstractSubMapIterator_lastNode(__cn1ThisObject)) /* IF_ACMPNE CustomJump */ goto label_L1107730949;
    if (get_field_java_util_TreeMap_Entry_index(get_field_java_util_TreeMap_AbstractSubMapIterator_boundaryPair(__cn1ThisObject))!=get_field_java_util_TreeMap_AbstractSubMapIterator_lastOffset(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1107730949;
    set_field_java_util_TreeMap_AbstractSubMapIterator_node(threadStateData, JAVA_NULL /* ACONST_NULL */, __cn1ThisObject);
...
JAVA_OBJECT java_util_TreeMap_AbstractSubMapIterator_createEntry___java_util_TreeMap_Node_int_R_java_util_TreeMap_Entry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 6246, 5712);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
