...
JAVA_VOID java_util_LinkedHashMap___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 5870, 201);
...
JAVA_VOID java_util_LinkedHashMap___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5870, 201);
...
JAVA_VOID java_util_LinkedHashMap___INIT_____int_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 5870, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     JAVA_INT ilocals_1_ = __cn1Arg1;
...
JAVA_VOID java_util_LinkedHashMap___INIT_____int_float_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 5870, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     JAVA_INT ilocals_1_ = __cn1Arg1;
    JAVA_FLOAT flocals_2_ = __cn1Arg2;
...
JAVA_BOOLEAN java_util_LinkedHashMap_containsValue___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 5870, 1983);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;locals[2].data.o = get_field_java_util_LinkedHashMap_head(__cn1ThisObject);
locals[2].type=CN1_TYPE_OBJECT;    if (JAVA_NULL /* ACONST_NULL */!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L961160488;

label_L262366552:
    if (JAVA_NULL /* ACONST_NULL */==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1647766367;
    if (JAVA_NULL /* ACONST_NULL */!=get_field_java_util_LinkedHashMap_LinkedHashMapEntry_value(locals[2].data.o)) /* IF_ACMPNE CustomJump */ goto label_L2082351774;
...
locals[2].type=CN1_TYPE_OBJECT;    goto label_L262366552;

label_L961160488:
    if (JAVA_NULL /* ACONST_NULL */==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1647766367;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, get_field_java_util_LinkedHashMap_LinkedHashMapEntry_value(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L1730704097;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1730704097:
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;locals[2].data.o = get_field_java_util_LinkedHashMap_LinkedHashMapEntry_chainForward(locals[2].data.o);
locals[2].type=CN1_TYPE_OBJECT;    goto label_L961160488;
...
JAVA_OBJECT java_util_LinkedHashMap_newElementArray___int_R_java_util_HashMap_Entry_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5870, 1242);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     JAVA_INT ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT java_util_LinkedHashMap_get___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 5870, 610);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L848363848;
    /* VarOp.assignFrom */ locals[2].data.o = virtual_java_util_LinkedHashMap_findNullKeyEntry___R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject);locals[2].type=CN1_TYPE_OBJECT;    goto label_L1062635358;
...
label_L1062635358:
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L726379593;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L726379593:
    if (get_field_java_util_LinkedHashMap_accessOrder(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L265321659;
    if (get_field_java_util_LinkedHashMap_tail(__cn1ThisObject)==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L265321659;
...
JAVA_OBJECT java_util_LinkedHashMap_createHashedEntry___java_lang_Object_int_int_R_java_util_HashMap_Entry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 5870, 5712);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT java_util_LinkedHashMap_putImpl___java_lang_Object_java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 5870, 5710);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    if (get_field_java_util_LinkedHashMap_elementCount(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1148254374;
    BC_ALOAD(0);
    BC_ALOAD(0);
...
label_L1148254374:
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2089016471;
    /* VarOp.assignFrom */ locals[3].data.o = virtual_java_util_LinkedHashMap_findNullKeyEntry___R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject);locals[3].type=CN1_TYPE_OBJECT;    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2001223946;
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1946645411;
    virtual_java_util_LinkedHashMap_rehash__(threadStateData, __cn1ThisObject); 

label_L1946645411:
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_java_util_LinkedHashMap_createHashedEntry___java_lang_Object_int_int_R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject, JAVA_NULL /* ACONST_NULL */, 0 /* ICONST_0 */, 0 /* ICONST_0 */);locals[3].type=CN1_TYPE_OBJECT;    goto label_L938545229;
...
label_L2089016471:
    ...
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_java_util_LinkedHashMap_findNonNullKeyEntry___java_lang_Object_int_int_R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject, locals[1].data.o, ilocals_5_, ilocals_4_);locals[3].type=CN1_TYPE_OBJECT;    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1433666880;
    set_field_java_util_LinkedHashMap_modCount(threadStateData, (get_field_java_util_LinkedHashMap_modCount(__cn1ThisObject) + 1 /* ICONST_1 */), __cn1ThisObject);
    BC_ALOAD(0);
    PUSH_INT(get_field_java_util_LinkedHashMap_elementCount(__cn1ThisObject));
    PUSH_INT(1); /* ICONST_1 */
    ...
    set_field_java_util_LinkedHashMap_elementCount(threadStateData, POP_INT(), POP_OBJ());
    PUSH_INT(get_field_java_util_LinkedHashMap_threshold(__cn1ThisObject));
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1610702581;
    virtual_java_util_LinkedHashMap_rehash__(threadStateData, __cn1ThisObject); 
    /* VarOp.assignFrom */ ilocals_5_=((ilocals_4_ & 2147483647) % CN1_ARRAY_LENGTH(get_field_java_util_LinkedHashMap_elementData(__cn1ThisObject)));

label_L1610702581:
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_java_util_LinkedHashMap_createHashedEntry___java_lang_Object_int_int_R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject, locals[1].data.o, ilocals_5_, ilocals_4_);locals[3].type=CN1_TYPE_OBJECT;    goto label_L938545229;
...
JAVA_VOID java_util_LinkedHashMap_linkEntry___java_util_LinkedHashMap_LinkedHashMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 5870, 5871);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (get_field_java_util_LinkedHashMap_tail(__cn1ThisObject)!=locals[1].data.o) /* IF_ACMPNE CustomJump */ goto label_L794075965;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;

label_L794075965:
    if (get_field_java_util_LinkedHashMap_head(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L270056930;
    BC_ALOAD(0);
    BC_ALOAD(0);
    BC_ALOAD(1);
    BC_DUP_X1(); /* DUP_X1 */
...
locals[3].type=CN1_TYPE_OBJECT;    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1706292388;
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L254801937;
    if (get_field_java_util_LinkedHashMap_accessOrder(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L90767234;
...
label_L1706292388:
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1355457888;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;

label_L1355457888:
    if (get_field_java_util_LinkedHashMap_accessOrder(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L707161353;
...
JAVA_OBJECT java_util_LinkedHashMap_entrySet___R_java_util_Set(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5870, 1985);
...
JAVA_OBJECT java_util_LinkedHashMap_keySet___R_java_util_Set(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 5870, 1988);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_LinkedHashMap_keySet(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1522132780;
    BC_ALOAD(0);
...
JAVA_OBJECT java_util_LinkedHashMap_values___R_java_util_Collection(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 5870, 1863);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_LinkedHashMap_valuesCollection(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L409962262;
    BC_ALOAD(0);
...
JAVA_OBJECT java_util_LinkedHashMap_remove___java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 5870, 1231);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */virtual_java_util_LinkedHashMap_removeEntry___java_lang_Object_R_java_util_HashMap_Entry(threadStateData, __cn1ThisObject, locals[1].data.o);locals[2].type=CN1_TYPE_OBJECT;    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L495702238;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L495702238:
    /* VarOp.assignFrom */ locals[3].type=CN1_TYPE_INVALID;locals[3].data.o = get_field_java_util_LinkedHashMap_LinkedHashMapEntry_chainBackward(locals[2].data.o);
locals[3].type=CN1_TYPE_OBJECT;    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o = get_field_java_util_LinkedHashMap_LinkedHashMapEntry_chainForward(locals[2].data.o);
locals[4].type=CN1_TYPE_OBJECT;    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L73181251;
    set_field_java_util_LinkedHashMap_LinkedHashMapEntry_chainForward(threadStateData, locals[4].data.o, locals[3].data.o);
    goto label_L298430307;

label_L73181251:
    set_field_java_util_LinkedHashMap_head(threadStateData, locals[4].data.o, __cn1ThisObject);

label_L298430307:
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1970982267;
    set_field_java_util_LinkedHashMap_LinkedHashMapEntry_chainBackward(threadStateData, locals[3].data.o, locals[4].data.o);
    goto label_L917831210;
...
JAVA_BOOLEAN java_util_LinkedHashMap_removeEldestEntry___java_util_Map_Entry_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 5870, 5872);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    PUSH_INT(0); /* ICONST_0 */
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return SP[-1].data.i;
...
JAVA_VOID java_util_LinkedHashMap_clear__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 5870, 1228);
...
JAVA_OBJECT java_util_LinkedHashMap_access$000___java_util_LinkedHashMap_R_java_util_LinkedHashMap_LinkedHashMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_util_LinkedHashMap(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 5870, 217);
...
JAVA_OBJECT java_util_LinkedHashMap_access$102___java_util_LinkedHashMap_java_util_LinkedHashMap_LinkedHashMapEntry_R_java_util_LinkedHashMap_LinkedHashMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_java_util_LinkedHashMap(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 5870, 1147);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT java_util_LinkedHashMap_access$002___java_util_LinkedHashMap_java_util_LinkedHashMap_LinkedHashMapEntry_R_java_util_LinkedHashMap_LinkedHashMapEntry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_java_util_LinkedHashMap(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 5870, 1521);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
