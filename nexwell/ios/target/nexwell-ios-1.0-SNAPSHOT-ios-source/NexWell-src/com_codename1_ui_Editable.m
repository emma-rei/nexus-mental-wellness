...
void __STATIC_INITIALIZER_com_codename1_ui_Editable(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_com_codename1_ui_Editable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed] = malloc(sizeof(int*) * 16);
    classToInterfaceMap_com_codename1_ui_Editable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed][0] = 13;
    classToInterfaceMap_com_codename1_ui_Editable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed][1] = 14;
    classToInterfaceMap_com_codename1_ui_Editable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed][2] = 15;
    classToInterfaceMap_com_codename1_ui_Editable[cn1_class_id_com_nexus_nexwell_homepage_ContentFeed][3] = 16;
