...
JAVA_OBJECT com_codename1_l10n_L10NManager_getSymbols___R_com_codename1_l10n_DateFormatSymbols(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_l10n_L10NManager_symbols(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L509024;
    __CN1_DEBUG_INFO(47);
    BC_ALOAD(0);
...
JAVA_OBJECT com_codename1_l10n_L10NManager_getLongMonthName___java_util_Date_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL454690685cn1_class_id_com_codename1_l10n_ParseException1;
    int tryBlockOffsetL454690685cn1_class_id_com_codename1_l10n_ParseException1;
    DEFINE_CATCH_BLOCK(catch_L454690685cn1_class_id_com_codename1_l10n_ParseException1, label_L1508155460, restoreToL454690685cn1_class_id_com_codename1_l10n_ParseException1);
...
label_L454690685:
 tryBlockOffsetL454690685cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_com_codename1_l10n_ParseException, catch_L454690685cn1_class_id_com_codename1_l10n_ParseException1);
    restoreToL454690685cn1_class_id_com_codename1_l10n_ParseException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_l10n_L10NManager_limitLength___java_lang_String_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)<=ilocals_2_) /* IF_ICMPLE CustomJump */ goto label_L1273224758;
...
label_L148823752:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1543760718;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(138);
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[6].data.o)!=0) /* IFNE CustomJump */ goto label_L1645805674;
...
label_L1271141733:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L511929069;
...
JAVA_OBJECT com_codename1_l10n_L10NManager_format___double_int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L846052901;
...
label_L958575255:
    if (ilocals_6_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1685759068;
