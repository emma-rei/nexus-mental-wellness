...
JAVA_VOID java_io_InputStreamReader___INIT_____java_io_InputStream(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7726, 202);
    ...
    set_field_java_io_InputStreamReader_enc(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(132), __cn1ThisObject);
...
JAVA_VOID java_io_InputStreamReader_complete__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 7726, 6646);
...
JAVA_OBJECT java_io_InputStreamReader_readInputStream___java_io_InputStream_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_io_InputStreamReader(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 7726, 2247);
...
JAVA_VOID java_io_InputStreamReader_copy___java_io_InputStream_java_io_OutputStream_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_java_io_InputStreamReader(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 7726, 2241);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
label_L989889899:
    if (ilocals_4_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1003206025;
...
JAVA_VOID java_io_InputStreamReader___INIT_____java_io_InputStream_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7726, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID java_io_InputStreamReader_close__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7726, 930);
...
JAVA_BOOLEAN java_io_InputStreamReader_markSupported___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7726, 986);
...
JAVA_INT java_io_InputStreamReader_read___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 7726, 987);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_io_InputStreamReader_c(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L806813022;
    BC_ALOAD(0);
    PUSH_INT(1); /* ICONST_1 */
...
label_L806813022:
    ...
    if (ilocals_1_>=0) /* IFGE CustomJump */ goto label_L902860396;
...
JAVA_INT java_io_InputStreamReader_read___char_1ARRAY_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 7726, 987);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_2_ = __cn1Arg2;
    JAVA_INT ilocals_3_ = __cn1Arg3;
    if (get_field_java_io_InputStreamReader_cbuffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1406206626;
...
label_L1406206626:
    if (get_field_java_io_InputStreamReader_cbufferOff(__cn1ThisObject)!=CN1_ARRAY_LENGTH(get_field_java_io_InputStreamReader_cbuffer(__cn1ThisObject))) /* IF_ICMPNE CustomJump */ goto label_L1816522350;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;
...
label_L1521238608:
    if (get_field_java_io_InputStreamReader_cbufferOff(__cn1ThisObject)>=CN1_ARRAY_LENGTH(get_field_java_io_InputStreamReader_cbuffer(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1799230133;
    if (ilocals_3_<=ilocals_4_) /* IF_ICMPLE CustomJump */ goto label_L1799230133;
    ...
    goto label_L1521238608;

label_L1799230133:
    if (ilocals_4_!=ilocals_3_) /* IF_ICMPNE CustomJump */ goto label_L20156341;
...
JAVA_LONG java_io_InputStreamReader_skip___long_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7726, 989);
