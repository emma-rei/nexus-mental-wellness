...
JAVA_VOID java_util_TreeMap_AscendingSubMap___INIT_____java_lang_Object_boolean_java_util_TreeMap_java_lang_Object_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4, JAVA_BOOLEAN __cn1Arg5) {
    DEFINE_INSTANCE_METHOD_STACK(6, 6, 0, 6237, 201);
...
JAVA_VOID java_util_TreeMap_AscendingSubMap___INIT_____java_util_TreeMap_java_lang_Object_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 6237, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID java_util_TreeMap_AscendingSubMap___INIT_____java_util_TreeMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6237, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_higherEntry___java_lang_Object_R_java_util_Map_Entry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 6237, 6174);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */java_util_TreeMap_NavigableSubMap_access$1300___java_util_TreeMap_NavigableSubMap_java_lang_Object_R_java_util_TreeMap_Entry(threadStateData, __cn1ThisObject, locals[1].data.o);locals[2].type=CN1_TYPE_OBJECT;    if (JAVA_NULL /* ACONST_NULL */==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L1452442375;
    if (/* CustomInvoke */virtual_java_util_TreeMap_AscendingSubMap_isInRange___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, get_field_java_util_TreeMap_Entry_key(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L1452442375;
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_ceilingEntry___java_lang_Object_R_java_util_Map_Entry(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 6237, 6172);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* VarOp.assignFrom */ locals[2].data.o = /* CustomInvoke */java_util_TreeMap_NavigableSubMap_access$1500___java_util_TreeMap_NavigableSubMap_java_lang_Object_R_java_util_TreeMap_Entry(threadStateData, __cn1ThisObject, locals[1].data.o);locals[2].type=CN1_TYPE_OBJECT;    if (JAVA_NULL /* ACONST_NULL */==locals[2].data.o) /* IF_ACMPEQ CustomJump */ goto label_L369347944;
    if (/* CustomInvoke */virtual_java_util_TreeMap_AscendingSubMap_isInRange___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, get_field_java_util_TreeMap_Entry_key(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L369347944;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_util_TreeMap_newImmutableEntry___java_util_TreeMap_Entry_R_java_util_AbstractMap_SimpleImmutableEntry(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_entrySet___R_java_util_Set(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 6237, 1985);
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_navigableKeySet___R_java_util_NavigableSet(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 6237, 6180);
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_subMap___java_lang_Object_boolean_java_lang_Object_boolean_R_java_util_NavigableMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    DEFINE_INSTANCE_METHOD_STACK(7, 5, 0, 6237, 6183);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_2_ = __cn1Arg2;
    locals[3].data.o = __cn1Arg3;
    ...
    if (get_field_java_util_TreeMap_AscendingSubMap_fromStart(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1021258849;
    if (get_field_java_util_TreeMap_AscendingSubMap_loInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L330128595;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L330128595;
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))>0) /* IFGT CustomJump */ goto label_L1021258849;
    goto label_L473153915;

label_L330128595:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L473153915;

label_L1021258849:
    if (get_field_java_util_TreeMap_AscendingSubMap_toEnd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1542520418;
    if (get_field_java_util_TreeMap_AscendingSubMap_hiInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L503938393;
    if (ilocals_4_!=0) /* IFNE CustomJump */ goto label_L1731977615;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L503938393;
    if (/* CustomInvoke */virtual_java_lang_Object_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L503938393;

label_L1731977615:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[3].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L1542520418;
    goto label_L473153915;

label_L503938393:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[3].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1542520418;
...
label_L1542520418:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, locals[3].data.o)<=0) /* IFLE CustomJump */ goto label_L1703009290;
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_lang_IllegalArgumentException___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_headMap___java_lang_Object_boolean_R_java_util_NavigableMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(7, 3, 0, 6237, 6184);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_2_ = __cn1Arg2;
    if (get_field_java_util_TreeMap_AscendingSubMap_fromStart(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L970865974;
    if (get_field_java_util_TreeMap_AscendingSubMap_loInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1827171553;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1827171553;
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))>0) /* IFGT CustomJump */ goto label_L970865974;
    goto label_L1424482154;

label_L1827171553:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))>=0) /* IFGE CustomJump */ goto label_L970865974;
...
label_L970865974:
    if (get_field_java_util_TreeMap_AscendingSubMap_toEnd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1072506992;
    if (get_field_java_util_TreeMap_AscendingSubMap_hiInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1997702454;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1997702454;
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L1072506992;
    goto label_L1479696465;

label_L1997702454:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1072506992;
...
label_L1072506992:
    if (/* CustomInvoke */virtual_java_util_TreeMap_AscendingSubMap_checkUpperBound___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L851765426;
    if (get_field_java_util_TreeMap_AscendingSubMap_fromStart(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1690101810;
    PUSH_POINTER(__NEW_java_util_TreeMap_AscendingSubMap(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
...
JAVA_OBJECT java_util_TreeMap_AscendingSubMap_tailMap___java_lang_Object_boolean_R_java_util_NavigableMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(7, 3, 0, 6237, 6185);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_2_ = __cn1Arg2;
    if (get_field_java_util_TreeMap_AscendingSubMap_fromStart(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L124058278;
    if (get_field_java_util_TreeMap_AscendingSubMap_loInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1277108979;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1277108979;
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))>0) /* IFGT CustomJump */ goto label_L124058278;
    goto label_L1502335674;

label_L1277108979:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_lo(__cn1ThisObject))>=0) /* IFGE CustomJump */ goto label_L124058278;
...
label_L124058278:
    if (get_field_java_util_TreeMap_AscendingSubMap_toEnd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1517640897;
    if (get_field_java_util_TreeMap_AscendingSubMap_hiInclusive(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2061774051;
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L2061774051;
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<0) /* IFLT CustomJump */ goto label_L1517640897;
    goto label_L1331270134;

label_L2061774051:
    if (/* CustomInvoke */virtual_java_util_TreeMap_keyCompare___java_lang_Object_java_lang_Object_R_int(threadStateData, get_field_java_util_TreeMap_AscendingSubMap_m(__cn1ThisObject), locals[1].data.o, get_field_java_util_TreeMap_AscendingSubMap_hi(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1517640897;
...
label_L1517640897:
    if (/* CustomInvoke */virtual_java_util_TreeMap_AscendingSubMap_checkLowerBound___java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1212191909;
    if (get_field_java_util_TreeMap_AscendingSubMap_toEnd(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L941836856;
    PUSH_POINTER(__NEW_java_util_TreeMap_AscendingSubMap(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
