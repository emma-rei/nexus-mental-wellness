...
JAVA_VOID com_codename1_ui_util_EventDispatcher_CallbackClass___INIT_____com_codename1_ui_util_EventDispatcher_java_lang_Object_1ARRAY_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    DEFINE_INSTANCE_METHOD_STACK(2, 4, 0, 6422, 202);
...
JAVA_VOID com_codename1_ui_util_EventDispatcher_CallbackClass_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(7, 2, 0, 6422, 204);
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L1343838143;
    __CN1_DEBUG_INFO(85);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6423));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L1343838143:
    __CN1_DEBUG_INFO(88);
    if (get_field_com_codename1_ui_util_EventDispatcher_styleListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1562221939;
    __CN1_DEBUG_INFO(89);
...
label_L1562221939:
    __CN1_DEBUG_INFO(94);
    if (get_field_com_codename1_ui_util_EventDispatcher_actionListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L187737357;
    __CN1_DEBUG_INFO(95);
...
label_L187737357:
    __CN1_DEBUG_INFO(99);
    if (get_field_com_codename1_ui_util_EventDispatcher_focusListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1984577117;
...
label_L1984577117:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_dataChangeListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1819552644;
...
label_L1819552644:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_selectionListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1572066684;
...
label_L1572066684:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_scrollListenerArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1403325194;
...
label_L1403325194:
    ...
    if (get_field_com_codename1_ui_util_EventDispatcher_bindTargetArray(get_field_com_codename1_ui_util_EventDispatcher_CallbackClass_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1958375413;
