...
JAVA_VOID com_codename1_ui_Tabs_SwipeListener_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL81059332701;
    int tryBlockOffsetL81059332701;
    DEFINE_CATCH_BLOCK(catch_L81059332701, label_L1872774414, restoreToL81059332701);
    int restoreToL78057077602;
    int tryBlockOffsetL78057077602;
    DEFINE_CATCH_BLOCK(catch_L78057077602, label_L1872774414, restoreToL78057077602);
    int restoreToL10218511403;
    int tryBlockOffsetL10218511403;
    DEFINE_CATCH_BLOCK(catch_L10218511403, label_L1872774414, restoreToL10218511403);
    int restoreToL47916097604;
    int tryBlockOffsetL47916097604;
    DEFINE_CATCH_BLOCK(catch_L47916097604, label_L1872774414, restoreToL47916097604);
    ...
    if (virtual_com_codename1_ui_Tabs_getComponentCount___R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L927369095, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1400___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L927369095, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1500___com_codename1_ui_Tabs_R_com_codename1_ui_animations_Motion(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1374431318, 0);
...
label_L1374431318:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L1901018532, 0);
        case 1: JUMP_TO(label_L480943798, 0);
        case 2: JUMP_TO(label_L525551643, 0);
...
label_L1901018532:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L669501311, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1869652507, 0);
    BC_ALOAD(4);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1869652507, 0);
...
label_L810593327:
 tryBlockOffsetL81059332701 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L81059332701);
    restoreToL81059332701 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1450);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1793469566, 1);
    BC_ALOAD(4);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1793469566, 1);
    __CN1_DEBUG_INFO(1451);
    if (virtual_com_codename1_ui_Component_shouldBlockSideSwipe___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L780570776, 0);
...
label_L780570776:
 tryBlockOffsetL78057077602 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L78057077602);
    restoreToL78057077602 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1459);
    if (virtual_com_codename1_ui_Component_isScrollable___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L935552520, 1);
    __CN1_DEBUG_INFO(1460);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1565096593, 1);
    __CN1_DEBUG_INFO(1461);
    if (virtual_com_codename1_ui_Component_isScrollableX___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L102185114, 0);
...
label_L102185114:
 tryBlockOffsetL10218511403 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L10218511403);
    restoreToL10218511403 = threadStateData->threadObjectStackOffset;
    ...
    JUMP_TO(label_L1793469566, 1);

label_L1565096593:
    __CN1_DEBUG_INFO(1474);
    if (virtual_com_codename1_ui_Component_isScrollableY___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L479160976, 0);
...
label_L479160976:
 tryBlockOffsetL47916097604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L47916097604);
    restoreToL47916097604 = threadStateData->threadObjectStackOffset;
...
label_L935552520:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L810593327, 0);

label_L1793469566:
END_TRY(1);    __CN1_DEBUG_INFO(1491);
    /* CustomInvoke */com_codename1_ui_Tabs_access$1802___com_codename1_ui_Tabs_boolean_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject), 0 /* ICONST_0 */); 
    __CN1_DEBUG_INFO(1492);
    JUMP_TO(label_L1869652507, 0);
...
label_L480943798:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1600___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L423095039, 0);
...
label_L423095039:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L2114701475, 0);
    __CN1_DEBUG_INFO(1513);
    if (virtual_com_codename1_ui_Tabs_isEagerSwipeMode___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1259283097, 0);
...
label_L1259283097:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1700___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L856047451, 0);
    __CN1_DEBUG_INFO(1517);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L356539350, 0);
    ...
    { JAVA_INT tmpResult = java_lang_Math_abs___int_R_int(threadStateData, SP[-1].data.i);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L356539350, 0);
...
label_L356539350:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L892262157, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    /* CustomInvoke */PUSH_INT(com_codename1_ui_Tabs_access$2100___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    ...
    { JAVA_INT tmpResult = java_lang_Math_abs___int_R_int(threadStateData, SP[-1].data.i);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L892262157, 0);
...
label_L117911771:
    ...
    PUSH_INT(5); /* ICONST_5 */
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1361409513, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1863980798, 0);
...
label_L856047451:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L594783641, 0);
    ...
    PUSH_INT(8);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L862146308, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1234435772, 0);
...
label_L1979825302:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L925024581, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L925024581, 0);
    ...
    if (virtual_com_codename1_ui_Tabs_shouldBlockSideSwipeLeft___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1287401019, 0);
    if (ilocals_4_<0) /* IFLT CustomJump */ JUMP_TO(label_L43473566, 0);
...
label_L1287401019:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L925024581, 0);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L925024581, 0);
...
label_L2114701475:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1986001684, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2100___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1986001684, 0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1986001684, 0);
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1986001684, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1986001684, 0);
...
label_L2050360660:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1465263219, 0);
...
label_L1986001684:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L801996095, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2200___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L801996095, 0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Container_contains___int_int_R_boolean(threadStateData, SP[-1].data.o, ilocals_2_, ilocals_3_);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L801996095, 0);
...
label_L768669591:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1271084832, 0);
...
label_L525551643:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1100___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1728465884, 0);
...
label_L1728465884:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1600___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1249890505, 0);
...
label_L1249890505:
    ...
    if (virtual_com_codename1_ui_Tabs_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1729904998, 0);
    __CN1_DEBUG_INFO(1598);
    /* VarOp.assignFrom */ ilocals_4_=(ilocals_4_ * -1 /* ICONST_M1 */);

label_L1729904998:
    __CN1_DEBUG_INFO(1600);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1406221524, 0);
...
label_L848409667:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L2005293363, 0);
...
label_L408388753:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L1208670252, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2200___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1208670252, 0);
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1208670252, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1208670252, 0);
    ...
    PUSH_INT(6);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1293465402, 0);
    __CN1_DEBUG_INFO(1627);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L393549265, 0);
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$500___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))>=0) /* IFGE CustomJump */ JUMP_TO(label_L1293465402, 0);
    __CN1_DEBUG_INFO(1630);
    /* CustomInvoke */com_codename1_ui_Tabs_access$502___com_codename1_ui_Tabs_int_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject), 0 /* ICONST_0 */); 
    JUMP_TO(label_L1293465402, 0);
...
label_L393549265:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ JUMP_TO(label_L1293465402, 0);
...
label_L1293465402:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1392482765, 0);
