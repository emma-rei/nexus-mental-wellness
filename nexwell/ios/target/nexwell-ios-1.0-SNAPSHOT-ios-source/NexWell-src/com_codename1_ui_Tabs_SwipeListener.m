...
JAVA_VOID com_codename1_ui_Tabs_SwipeListener___INIT_____com_codename1_ui_Tabs_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10448, 201);
...
JAVA_VOID com_codename1_ui_Tabs_SwipeListener_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 8, 0, 10448, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL78057077601;
    int tryBlockOffsetL78057077601;
    DEFINE_CATCH_BLOCK(catch_L78057077601, label_L240000757, restoreToL78057077601);
    int restoreToL52555164302;
    int tryBlockOffsetL52555164302;
    DEFINE_CATCH_BLOCK(catch_L52555164302, label_L240000757, restoreToL52555164302);
    int restoreToL186965250703;
    int tryBlockOffsetL186965250703;
    DEFINE_CATCH_BLOCK(catch_L186965250703, label_L240000757, restoreToL186965250703);
    int restoreToL179346956604;
    int tryBlockOffsetL179346956604;
    DEFINE_CATCH_BLOCK(catch_L179346956604, label_L240000757, restoreToL179346956604);
    int restoreToL24000075705;
    int tryBlockOffsetL24000075705;
    DEFINE_CATCH_BLOCK(catch_L24000075705, label_L240000757, restoreToL24000075705);
    __CN1_DEBUG_INFO(1436);
    if (virtual_com_codename1_ui_Tabs_getComponentCount___R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1829883631, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1400___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1829883631, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1500___com_codename1_ui_Tabs_R_com_codename1_ui_animations_Motion(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1286771084, 0);
...
label_L1286771084:
    ...
    SP--;
    switch((*SP).data.i) {
        case 0: JUMP_TO(label_L1927452108, 0);
        case 1: JUMP_TO(label_L203785427, 0);
        case 2: JUMP_TO(label_L1872774414, 0);
        default: JUMP_TO(label_L927369095, 0);
    }
...
label_L1927452108:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1374431318, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1901018532, 0);
    BC_ALOAD(4);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1901018532, 0);
...
label_L780570776:
 tryBlockOffsetL78057077601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L78057077601);
    restoreToL78057077601 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1450);
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L480943798, 1);
    BC_ALOAD(4);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L480943798, 1);
    __CN1_DEBUG_INFO(1451);
    if (virtual_com_codename1_ui_Component_shouldBlockSideSwipe___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L525551643, 0);
...
label_L525551643:
 tryBlockOffsetL52555164302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L52555164302);
    restoreToL52555164302 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(1459);
    if (virtual_com_codename1_ui_Component_isScrollable___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L801996095, 1);
    __CN1_DEBUG_INFO(1460);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L669501311, 1);
    __CN1_DEBUG_INFO(1461);
    if (virtual_com_codename1_ui_Component_isScrollableX___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1869652507, 0);
...
label_L1869652507:
 tryBlockOffsetL186965250703 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L186965250703);
    restoreToL186965250703 = threadStateData->threadObjectStackOffset;
    ...
    JUMP_TO(label_L480943798, 1);

label_L669501311:
    __CN1_DEBUG_INFO(1474);
    if (virtual_com_codename1_ui_Component_isScrollableY___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1793469566, 0);
...
label_L1793469566:
 tryBlockOffsetL179346956604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L179346956604);
    restoreToL179346956604 = threadStateData->threadObjectStackOffset;
...
label_L801996095:
    ...
    /* VarOp.assignFrom */ locals[4].data.o = virtual_com_codename1_ui_Component_getParent___R_com_codename1_ui_Container(threadStateData, locals[4].data.o);locals[4].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L780570776, 0);
...
label_L240000757:
 tryBlockOffsetL24000075705 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L24000075705);
    restoreToL24000075705 = threadStateData->threadObjectStackOffset;
...
label_L935552520:
    ...
    JUMP_TO(label_L927369095, 0);

label_L203785427:
    __CN1_DEBUG_INFO(1509);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1600___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1565096593, 0);
...
label_L1565096593:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L102185114, 0);
    __CN1_DEBUG_INFO(1513);
    if (virtual_com_codename1_ui_Tabs_isEagerSwipeMode___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L479160976, 0);
...
label_L479160976:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1700___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L810593327, 0);
    __CN1_DEBUG_INFO(1517);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L643552582, 0);
    ...
    { JAVA_INT tmpResult = java_lang_Math_abs___int_R_int(threadStateData, SP[-1].data.i);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ JUMP_TO(label_L643552582, 0);
...
label_L643552582:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L423095039, 0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    /* CustomInvoke */PUSH_INT(com_codename1_ui_Tabs_access$2100___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    ...
    { JAVA_INT tmpResult = java_lang_Math_abs___int_R_int(threadStateData, SP[-1].data.i);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L423095039, 0);
...
label_L423095039:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2114701475, 0);
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1259283097, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L856047451, 0);
...
label_L2114701475:
    ...
    PUSH_INT(5); /* ICONST_5 */
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L356539350, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L892262157, 0);
...
label_L810593327:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L117911771, 0);
    ...
    PUSH_INT(8);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L91831175, 0);
    PUSH_INT(1); /* ICONST_1 */
...
label_L117911771:
    ...
    PUSH_INT(8);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1863980798, 0);
    PUSH_INT(1); /* ICONST_1 */
...
label_L1361409513:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L862146308, 0);
    ...
    if (virtual_com_codename1_ui_Tabs_shouldBlockSideSwipeLeft___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1234435772, 0);
    if (ilocals_4_<0) /* IFLT CustomJump */ JUMP_TO(label_L1979825302, 0);
...
label_L1234435772:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L862146308, 0);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L862146308, 0);
...
label_L102185114:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1218496682, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2100___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1218496682, 0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1218496682, 0);
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1218496682, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1218496682, 0);
...
label_L925024581:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1637000661, 0);
...
label_L1218496682:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L927369095, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2200___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L927369095, 0);
    /* CustomInvoke */PUSH_OBJ(com_codename1_ui_Tabs_access$400___com_codename1_ui_Tabs_R_com_codename1_ui_Container(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject)));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Container_contains___int_int_R_boolean(threadStateData, SP[-1].data.o, ilocals_2_, ilocals_3_);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L927369095, 0);
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1287401019, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1287401019, 0);
...
label_L1986001684:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L43473566, 0);
...
label_L1872774414:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1100___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1465263219, 0);
...
label_L1465263219:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$1600___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L2050360660, 0);
...
label_L2050360660:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1112400678, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2100___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1112400678, 0);
    ...
    if (ilocals_4_==0) /* IFEQ CustomJump */ JUMP_TO(label_L1112400678, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2300___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1112400678, 0);
    ...
    PUSH_INT(6);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L1271084832, 0);
    __CN1_DEBUG_INFO(1597);
    if (virtual_com_codename1_ui_Tabs_isRTL___R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L768669591, 0);
    __CN1_DEBUG_INFO(1598);
    /* VarOp.assignFrom */ ilocals_4_=(ilocals_4_ * -1 /* ICONST_M1 */);

label_L768669591:
    __CN1_DEBUG_INFO(1600);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1728465884, 0);
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$500___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))>=0) /* IFGE CustomJump */ JUMP_TO(label_L1271084832, 0);
...
label_L1728465884:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ JUMP_TO(label_L1271084832, 0);
...
label_L1271084832:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1249890505, 0);
...
label_L1112400678:
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$800___com_codename1_ui_Tabs_R_boolean(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L408388753, 0);
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$2200___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L408388753, 0);
    ...
    PUSH_INT(6);
    SP--; SP[-1].data.i = SP[-1].data.i / (*SP).data.i; /* IDIV */
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L848409667, 0);
    __CN1_DEBUG_INFO(1627);
    if (ilocals_4_<=0) /* IFLE CustomJump */ JUMP_TO(label_L1729904998, 0);
    ...
    if (/* CustomInvoke */com_codename1_ui_Tabs_access$500___com_codename1_ui_Tabs_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject))>=0) /* IFGE CustomJump */ JUMP_TO(label_L848409667, 0);
    __CN1_DEBUG_INFO(1630);
    /* CustomInvoke */com_codename1_ui_Tabs_access$502___com_codename1_ui_Tabs_int_R_int(threadStateData, get_field_com_codename1_ui_Tabs_SwipeListener_this_0(__cn1ThisObject), 0 /* ICONST_0 */); 
    JUMP_TO(label_L848409667, 0);
...
label_L1729904998:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Container_getComponentCount___R_int(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ JUMP_TO(label_L848409667, 0);
...
label_L848409667:
    ...
    if (locals[7].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1406221524, 0);
