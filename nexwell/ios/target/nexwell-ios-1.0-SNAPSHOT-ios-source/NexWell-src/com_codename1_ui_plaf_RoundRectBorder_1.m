...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_1___INIT_____com_codename1_ui_plaf_RoundRectBorder_int_int_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 5868, 202);
...
JAVA_VOID com_codename1_ui_plaf_RoundRectBorder_1_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 13, 0, 5868, 2356);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL42197918201;
    int tryBlockOffsetL42197918201;
    DEFINE_CATCH_BLOCK(catch_L42197918201, label_L39476366, restoreToL42197918201);
    int restoreToL114149245402;
    int tryBlockOffsetL114149245402;
    DEFINE_CATCH_BLOCK(catch_L114149245402, label_L39476366, restoreToL114149245402);
    int restoreToL3947636603;
    int tryBlockOffsetL3947636603;
    DEFINE_CATCH_BLOCK(catch_L3947636603, label_L39476366, restoreToL3947636603);
...
label_L421979182:
 tryBlockOffsetL42197918201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L42197918201);
    restoreToL42197918201 = threadStateData->threadObjectStackOffset;
...
locals[6].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(580);
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$100___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L106350019, 1);
...
label_L2031209493:
    if (ilocals_8_<0) /* IFLT CustomJump */ JUMP_TO(label_L106350019, 1);
...
label_L106350019:
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBgImage___R_com_codename1_ui_Image(threadStateData, locals[9].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1141492454, 0);
    ...
    if (ilocals_10_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L350703813, 1);
    if (ilocals_10_!=0) /* IFNE CustomJump */ JUMP_TO(label_L1141492454, 0);
...
label_L350703813:
    ...
    if (ilocals_11_==0) /* IFEQ CustomJump */ JUMP_TO(label_L607123271, 1);
...
label_L607123271:
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1395259059, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L1395259059, 1);
    ...
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1395259059, 1);
...
label_L1141492454:
 tryBlockOffsetL114149245402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L114149245402);
    restoreToL114149245402 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$700___com_codename1_ui_plaf_RoundRectBorder_R_com_codename1_ui_Stroke(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1501382858, 1);
    if (/* CustomInvoke */com_codename1_ui_plaf_RoundRectBorder_access$800___com_codename1_ui_plaf_RoundRectBorder_R_int(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ JUMP_TO(label_L1501382858, 1);
    /* CustomInvoke */PUSH_FLOAT(com_codename1_ui_plaf_RoundRectBorder_access$900___com_codename1_ui_plaf_RoundRectBorder_R_float(threadStateData, get_field_com_codename1_ui_plaf_RoundRectBorder_1_this_0(__cn1ThisObject)));
    PUSH_FLOAT(0); /* FCONST_0 */
    BC_FCMPL();
    if(POP_INT() <= 0) /* IFLE */ JUMP_TO(label_L1501382858, 1);
...
label_L39476366:
 tryBlockOffsetL3947636603 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L3947636603);
    restoreToL3947636603 = threadStateData->threadObjectStackOffset;
