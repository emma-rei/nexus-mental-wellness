...
JAVA_VOID com_codename1_ui_util_Effects___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 9942, 201);
...
JAVA_OBJECT com_codename1_ui_util_Effects_verticalPerspective___com_codename1_ui_Image_float_float_float_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2, JAVA_FLOAT __cn1Arg3, JAVA_FLOAT __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_util_Effects(threadStateData);
    DEFINE_METHOD_STACK(5, 20, 0, 9942, 9944);
    ...
    if (CN1_CMP_EXPR(flocals_2_, flocals_1_)>=0) /* IFGE CustomJump */ goto label_L1590202270;
...
label_L2047145776:
    ...
    if (ilocals_7_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L990994954;
    __CN1_DEBUG_INFO(157);
    /* VarOp.assignFrom */     ilocals_11_ = 0 /* ICONST_0 */; 

label_L1479446866:
    if (ilocals_11_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L802270602;
...
label_L1755295609:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L897541009;
    ...
    __CN1_DEBUG_INFO(165);
    BC_IINC(18, 1);
    goto label_L1755295609;

label_L897541009:
    __CN1_DEBUG_INFO(157);
    BC_IINC(11, 1);
    goto label_L1479446866;

label_L802270602:
    goto label_L2050083360;
...
label_L233142783:
    if (ilocals_11_>=ilocals_8_) /* IF_ICMPGE CustomJump */ goto label_L2050083360;
...
label_L569235601:
    if (ilocals_18_>=ilocals_16_) /* IF_ICMPGE CustomJump */ goto label_L882658588;
    ...
    __CN1_DEBUG_INFO(178);
    BC_IINC(18, 1);
    goto label_L569235601;

label_L882658588:
    __CN1_DEBUG_INFO(171);
    BC_IINC(11, 1);
    goto label_L233142783;
...
JAVA_OBJECT com_codename1_ui_util_Effects_gaussianBlurImage___com_codename1_ui_Image_float_R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_FLOAT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_util_Effects(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 9942, 307);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    flocals_1_ = __cn1Arg2;
...
JAVA_BOOLEAN com_codename1_ui_util_Effects_isGaussianBlurSupported___R_boolean(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_util_Effects(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 9942, 306);
