...
JAVA_VOID com_codename1_ui_Container_5_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL65430561401;
    int tryBlockOffsetL65430561401;
    DEFINE_CATCH_BLOCK(catch_L65430561401, label_L1152342155, restoreToL65430561401);
    __CN1_DEBUG_INFO(1352);
    if (get_field_com_codename1_ui_Container_5_alreadyRemoved(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L64068997, 0);

label_L654305614:
 tryBlockOffsetL65430561401 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L65430561401);
    restoreToL65430561401 = threadStateData->threadObjectStackOffset;
