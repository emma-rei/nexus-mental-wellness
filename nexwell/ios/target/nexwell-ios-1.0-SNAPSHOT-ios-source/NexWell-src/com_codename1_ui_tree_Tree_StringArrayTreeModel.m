...
JAVA_VOID com_codename1_ui_tree_Tree_StringArrayTreeModel___INIT_____java_lang_String_2ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8947, 201);
...
JAVA_OBJECT com_codename1_ui_tree_Tree_StringArrayTreeModel_getChildren___java_lang_Object_R_java_util_Vector(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 8, 0, 8947, 7601);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(205);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1027217667;
...
label_L356300643:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L40207050;
...
label_L528757371:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L741431520;
    __CN1_DEBUG_INFO(217);
    if (locals[1].data.o!=CN1_ARRAY_ELEMENT_OBJECT(CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_tree_Tree_StringArrayTreeModel_arr(__cn1ThisObject), 0 /* ICONST_0 */), ilocals_5_)) /* IF_ACMPNE CustomJump */ goto label_L1093582436;
    __CN1_DEBUG_INFO(218);
    if (ilocals_2_<=(ilocals_5_ + 1 /* ICONST_1 */)) /* IF_ICMPLE CustomJump */ goto label_L1093582436;
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_tree_Tree_StringArrayTreeModel_arr(__cn1ThisObject), (ilocals_5_ + 1 /* ICONST_1 */))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1093582436;
...
label_L1869813593:
    if (ilocals_7_>=ilocals_6_) /* IF_ICMPGE CustomJump */ goto label_L1093582436;
    ...
    __CN1_DEBUG_INFO(220);
    BC_IINC(7, 1);
    goto label_L1869813593;

label_L1093582436:
    __CN1_DEBUG_INFO(216);
    BC_IINC(5, 1);
    goto label_L528757371;
...
JAVA_BOOLEAN com_codename1_ui_tree_Tree_StringArrayTreeModel_isLeaf___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 8947, 8849);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L961847091;
    if (virtual_java_util_Vector_size___R_int(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L230546403;
