...
class_array1__com_codename1_ui_events_ActionListener.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_2][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_4] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_4][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_6] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_6][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_1][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_3][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_7] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_7][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_5] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_5][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_9] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_9][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_14] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_14][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm__Lambda_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm__Lambda_2][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_10] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_10][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_12] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_12][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_15] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_15][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm__Lambda_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_LoginForm__Lambda_1][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_8] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_8][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_13] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_13][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_11] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_forms_MainForm__Lambda_11][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_2][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_nexus_nexwell_satisfyingvisuals_LangtonsAntForm__Lambda_1][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_SearchBar_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_SearchBar_2][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_Toolbar_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_Toolbar_1][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_MenuBar][0] = 405;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_TextSelection_SelectionMenu][0] = 405;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_Toolbar_ToolbarSideMenu][0] = 405;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_SearchBar_3] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_SearchBar_3][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_SideMenuBar][0] = 405;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_ui_Calendar_MonthView][0] = 405;
    ...
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_components_FloatingActionButton_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_components_FloatingActionButton_1][0] = 10;
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_components_FloatingActionButton_2] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_ActionListener[cn1_class_id_com_codename1_components_FloatingActionButton_2][0] = 10;
