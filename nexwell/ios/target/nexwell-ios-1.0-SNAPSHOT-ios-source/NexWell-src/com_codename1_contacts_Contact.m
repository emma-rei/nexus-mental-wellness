...
JAVA_OBJECT com_codename1_contacts_Contact_getDisplayName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_displayName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L381760603;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(219), get_field_com_codename1_contacts_Contact_displayName(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L663535450;

label_L381760603:
    __CN1_DEBUG_INFO(100);
    if (get_field_com_codename1_contacts_Contact_familyName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L474059546;
    if (get_field_com_codename1_contacts_Contact_firstName(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L474059546;
    ...
    POP_MANY(2);
    goto label_L663535450;

label_L474059546:
    __CN1_DEBUG_INFO(102);
    if (virtual_com_codename1_contacts_Contact_getPrimaryPhoneNumber___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1657509754;
...
label_L1657509754:
    ...
    if (virtual_com_codename1_contacts_Contact_getPrimaryEmail___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2109146260;
...
label_L2109146260:
    ...
    if (virtual_com_codename1_contacts_Contact_getFirstName___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1057161751;
...
label_L1057161751:
    ...
    if (virtual_com_codename1_contacts_Contact_getFamilyName___R_java_lang_String(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L801808302;
...
JAVA_OBJECT com_codename1_contacts_Contact_getPrimaryEmail___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_primaryEmail(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L285519210;
    if (get_field_com_codename1_contacts_Contact_emails(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L285519210;
    ...
    if (virtual_java_util_Collection_size___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L285519210;
...
JAVA_OBJECT com_codename1_contacts_Contact_getPrimaryPhoneNumber___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_contacts_Contact_primaryPhoneNumber(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1423083642;
    if (get_field_com_codename1_contacts_Contact_phoneNumbers(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1423083642;
    ...
    if (virtual_java_util_Collection_size___R_int(threadStateData, locals[1].data.o)<=0) /* IFLE CustomJump */ goto label_L1423083642;
