...
label_L575715826:
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L2117173674;
...
locals[2].type=CN1_TYPE_OBJECT;    { JAVA_LONG tmpResult = virtual_java_util_Calendar_getTimeInMillis___R_long(threadStateData, __cn1ThisObject);
    ...
    PUSH_LONG(tmpResult); }
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L624795507;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L624795507;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L337799666;
...
label_L857394605:
    if (get_field_java_util_Calendar_areFieldsSet(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1104422581;
...
JAVA_VOID java_util_Calendar_set___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    set_field_java_util_Calendar_isTimeSet(threadStateData, POP_INT(), POP_OBJ());
    set_field_java_util_Calendar_areFieldsSet(threadStateData, POP_INT(), POP_OBJ());
    if (ilocals_1_<=2 /* ICONST_2 */) /* IF_ICMPLE CustomJump */ goto label_L254896875;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L254896875;
...
label_L254896875:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1789110533;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(11);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L170052458;
...
label_L170052458:
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1574029810;
    BC_ALOAD(0);
    PUSH_INT(10);
...
JAVA_VOID java_util_Calendar_setTimeInMillis___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (CN1_CMP_EXPR(get_field_java_util_Calendar_time(__cn1ThisObject), llocals_1_)==0) /* IFEQ CustomJump */ goto label_L774895395;
