...
JAVA_VOID com_codename1_ui_Slider___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 8803, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(86);
    /* CustomInvoke */com_codename1_ui_Slider___INIT_____java_lang_String_java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(8804), STRING_FROM_CONSTANT_POOL_OFFSET(8804)); 
    __CN1_DEBUG_INFO(87);
...
JAVA_VOID com_codename1_ui_Slider___INIT_____java_lang_String_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 8803, 201);
    ...
    __CN1_DEBUG_INFO(79);
    set_field_com_codename1_ui_Slider_fullUIID(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(8804), __cn1ThisObject);
    __CN1_DEBUG_INFO(90);
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(3858));
...
JAVA_VOID com_codename1_ui_Slider_setUIID___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 2454);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_Slider_initStyles___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 8803, 8805);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8806));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_BOOLEAN com_codename1_ui_Slider_isStickyDrag___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 2615);
...
JAVA_VOID com_codename1_ui_Slider_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 8803, 1848);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(127);
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1807896178;
    ...
    if (get_field_com_codename1_ui_Slider_thumbImage(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1807896178;
    __CN1_DEBUG_INFO(130);
    BC_ALOAD(0);
    PUSH_OBJ(com_codename1_ui_plaf_UIManager_getInstance___R_com_codename1_ui_plaf_UIManager(threadStateData));
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_getThemeImageConstant___java_lang_String_R_com_codename1_ui_Image(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(8807));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_VOID com_codename1_ui_Slider_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 1326);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(139);
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1917513667;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1917513667;
...
JAVA_BOOLEAN com_codename1_ui_Slider_animate___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 8803, 1587);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(151);
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2096842550;
    ...
    if (((JAVA_INT)flocals_1_)!=0) /* IFNE CustomJump */ goto label_L705265015;
    __CN1_DEBUG_INFO(155);
    if (CN1_CMP_EXPR(flocals_1_, 0 /* FCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1405163418;
    __CN1_DEBUG_INFO(156);
    /* VarOp.assignFrom */     flocals_1_ = -1.0;
    goto label_L705265015;
...
label_L705265015:
    ...
    if (get_field_com_codename1_ui_Slider_value(__cn1ThisObject)<get_field_com_codename1_ui_Slider_maxValue(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L1985011414;
...
label_L1985011414:
    ...
    if (get_field_com_codename1_ui_Slider_value(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L1345648093;
...
JAVA_VOID com_codename1_ui_Slider_setInfinite___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8808);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(191);
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L834132073;
    __CN1_DEBUG_INFO(192);
    set_field_com_codename1_ui_Slider_infinite(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(193);
    if (virtual_com_codename1_ui_Slider_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L834132073;
    __CN1_DEBUG_INFO(194);
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1787913218;
    __CN1_DEBUG_INFO(195);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Slider_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_com_codename1_ui_Form_registerAnimatedInternal___com_codename1_ui_animations_Animation(threadStateData, SP[-1].data.o, __cn1ThisObject);     SP -= 1;
    goto label_L834132073;

label_L1787913218:
    __CN1_DEBUG_INFO(197);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_ui_Slider_getComponentForm___R_com_codename1_ui_Form(threadStateData, __cn1ThisObject);
    PUSH_OBJ(tmpResult); }
    /* CustomInvoke */virtual_com_codename1_ui_Form_deregisterAnimatedInternal___com_codename1_ui_animations_Animation(threadStateData, SP[-1].data.o, __cn1ThisObject);     SP -= 1;
...
JAVA_VOID com_codename1_ui_Slider_refreshTheme___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 2673);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (get_field_com_codename1_ui_Slider_sliderFull(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L440902120;
    ...
    /* CustomInvoke */com_codename1_ui_Slider_initStyles___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(8804)); 
...
JAVA_INT com_codename1_ui_Slider_getProgress___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 3052);
...
JAVA_VOID com_codename1_ui_Slider_setProgress___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 8803, 8810);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(258);
    if (get_field_com_codename1_ui_Slider_value(__cn1ThisObject)==ilocals_1_) /* IF_ICMPEQ CustomJump */ goto label_L1657920572;
...
JAVA_VOID com_codename1_ui_Slider_setProgressInternal___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* value */
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 8803, 8811);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(265);
    set_field_com_codename1_ui_Slider_value(threadStateData, ilocals_1_, __cn1ThisObject);
    __CN1_DEBUG_INFO(266);
    if (get_field_com_codename1_ui_Slider_renderValueOnTop(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L58791184;
    if (get_field_com_codename1_ui_Slider_renderPercentageOnTop(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L619621481;
...
label_L58791184:
    ...
    goto label_L408132785;

label_L619621481:
    __CN1_DEBUG_INFO(269);
    if (virtual_com_codename1_ui_Slider_isInitialized___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L408132785;
...
JAVA_OBJECT com_codename1_ui_Slider_formattedValue___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* value */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8812);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(282);
    if (get_field_com_codename1_ui_Slider_renderValueOnTop(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1955566523;
...
label_L1955566523:
    ...
    if (get_field_com_codename1_ui_Slider_renderPercentageOnTop(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2133668271;
...
JAVA_OBJECT com_codename1_ui_Slider_getStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 8803, 557);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(327);
    if (get_field_com_codename1_ui_Slider_paintingFull(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L779179975;
    __CN1_DEBUG_INFO(328);
    if (get_field_com_codename1_ui_Slider_sliderFull(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L709091500;
...
label_L709091500:
    ...
    if (virtual_com_codename1_ui_Slider_hasFocus___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L584694804;
...
JAVA_OBJECT com_codename1_ui_Slider_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 8803, 1856);
    ...
    if (virtual_com_codename1_ui_plaf_Style_getBorder___R_com_codename1_ui_plaf_Border(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L879706537;
...
label_L879706537:
    ...
    if (get_field_com_codename1_ui_Slider_thumbImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L277149580;
...
label_L277149580:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L636953520;
    if (virtual_com_codename1_ui_Slider_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L636953520;
    __CN1_DEBUG_INFO(356);
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1252069894;
...
label_L636953520:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L864210792;
...
label_L67985650:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L796168203;
...
label_L796168203:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ goto label_L1837602497;
...
JAVA_VOID com_codename1_ui_Slider_paintComponentBackground___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 12, 0, 8803, 702);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (get_field_com_codename1_ui_Slider_thumbImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L48390515;
...
label_L666769352:
    ...
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L742473724;
...
label_L742473724:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1826195973;
...
label_L2099348779:
    ...
    if (get_field_com_codename1_ui_Slider_thumbImage(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L513128019;
    if (get_field_com_codename1_ui_Slider_infinite(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L513128019;
    __CN1_DEBUG_INFO(420);
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1869373559;
...
JAVA_BOOLEAN com_codename1_ui_Slider_isEditable___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 2698);
...
JAVA_VOID com_codename1_ui_Slider_setEditable___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 4113);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_Slider_pointerPressed___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8803, 277);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1338332733;
...
label_L1338332733:
    ...
    if (get_field_com_codename1_ui_Slider_editable(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L42338572;
...
label_L42338572:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L823263265;
...
label_L1039245740:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1482714257;
    __CN1_DEBUG_INFO(487);
    if (get_field_com_codename1_ui_Slider_previousY(__cn1ThisObject)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1788662008;
...
label_L1269749378:
    ...
    goto label_L2078470810;

label_L1482714257:
    __CN1_DEBUG_INFO(494);
    if (get_field_com_codename1_ui_Slider_previousX(__cn1ThisObject)>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L540876179;
    __CN1_DEBUG_INFO(495);
    /* CustomInvoke */com_codename1_ui_Slider_fireDataChanged___int_int(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, get_field_com_codename1_ui_Slider_value(__cn1ThisObject)); 
    goto label_L740950652;
...
JAVA_VOID com_codename1_ui_Slider_pointerDragged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 8803, 279);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_impl_CodenameOneImplementation_isScrollWheeling___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L294505405;
...
label_L294505405:
    ...
    if (get_field_com_codename1_ui_Slider_editable(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2107088180;
...
label_L2107088180:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L890160784;
    if (get_field_com_codename1_ui_Slider_previousY(__cn1ThisObject)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L890160784;
...
label_L890160784:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1238047663;
    if (get_field_com_codename1_ui_Slider_previousX(__cn1ThisObject)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1238047663;
...
label_L1238047663:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L912584968;
...
label_L2010883277:
    ...
    if (ilocals_3_==virtual_com_codename1_ui_Slider_getProgress___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L883087072;
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L623224248;
    __CN1_DEBUG_INFO(537);
    if (get_field_com_codename1_ui_Slider_previousY(__cn1ThisObject)>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L878242981;
    __CN1_DEBUG_INFO(538);
    /* CustomInvoke */com_codename1_ui_Slider_fireDataChanged___int_int(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, get_field_com_codename1_ui_Slider_value(__cn1ThisObject)); 
    goto label_L504355631;
...
label_L504355631:
    ...
    set_field_com_codename1_ui_Slider_previousY(threadStateData, ilocals_2_, __cn1ThisObject);
    goto label_L883087072;

label_L623224248:
    __CN1_DEBUG_INFO(544);
    if (get_field_com_codename1_ui_Slider_previousX(__cn1ThisObject)>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1010306008;
    __CN1_DEBUG_INFO(545);
    /* CustomInvoke */com_codename1_ui_Slider_fireDataChanged___int_int(threadStateData, __cn1ThisObject, 1 /* ICONST_1 */, get_field_com_codename1_ui_Slider_value(__cn1ThisObject)); 
    goto label_L884502914;
...
JAVA_VOID com_codename1_ui_Slider_fireClicked__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 8803, 2476);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(558);
    BC_ALOAD(0);
    if (virtual_com_codename1_ui_Slider_handlesInput___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1198952052;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L658563862;
...
JAVA_BOOLEAN com_codename1_ui_Slider_isSelectableInteraction___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 2477);
...
JAVA_VOID com_codename1_ui_Slider_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 8803, 278);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_impl_CodenameOneImplementation_isScrollWheeling___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1532644077;
...
label_L1532644077:
    ...
    if (get_field_com_codename1_ui_Slider_editable(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L748229733;
...
JAVA_VOID com_codename1_ui_Slider_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 1387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_Slider_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* code */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 8803, 1386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(595);
    if (get_field_com_codename1_ui_Slider_editable(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1609509548;
    if (virtual_com_codename1_ui_Slider_handlesInput___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1609509548;
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L2140617236;
        case 2: goto label_L1980959273;
        case 3: goto label_L307036850;
        case 4: goto label_L307036850;
        case 5: goto label_L877785117;
        case 6: goto label_L1917860633;
        case 7: goto label_L307036850;
        case 8: goto label_L486286648;
        default: goto label_L307036850;
    }

label_L2140617236:
    __CN1_DEBUG_INFO(599);
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1725885575;
...
label_L1917860633:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1563699545;
...
label_L1980959273:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L785340693;
...
label_L877785117:
    ...
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1407675409;
...
label_L1609509548:
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isThirdSoftButton___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1120671806;
    __CN1_DEBUG_INFO(638);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Display_getGameAction___int_R_int(threadStateData, SP[-1].data.o, ilocals_1_);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1120671806;
...
JAVA_VOID com_codename1_ui_Slider_fireDataChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 8803, 4180);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
...
JAVA_VOID com_codename1_ui_Slider_fireActionEventImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 8803, 8820);
...
JAVA_VOID com_codename1_ui_Slider_addDataChangedListener___com_codename1_ui_events_DataChangedListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 4176);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_Slider_removeDataChangedListener___com_codename1_ui_events_DataChangedListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 4177);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_Slider_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 1596);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_Slider_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 1597);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_Slider_isRenderPercentageOnTop___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 8821);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(714);

{
    JAVA_INT ___returnValue=get_field_com_codename1_ui_Slider_renderPercentageOnTop(__cn1ThisObject);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return ___returnValue;
}
}
...
JAVA_VOID com_codename1_ui_Slider_setRenderPercentageOnTop___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* renderPercentageOnTop */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8822);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(724);
    set_field_com_codename1_ui_Slider_renderPercentageOnTop(threadStateData, ilocals_1_, __cn1ThisObject);
...
JAVA_VOID com_codename1_ui_Slider_setRenderValueOnTop___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* renderValueOnTop */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8824);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(738);
    set_field_com_codename1_ui_Slider_renderValueOnTop(threadStateData, ilocals_1_, __cn1ThisObject);
...
JAVA_INT com_codename1_ui_Slider_getMaxValue___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 8825);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(745);

{
    JAVA_INT ___returnValue=get_field_com_codename1_ui_Slider_maxValue(__cn1ThisObject);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return ___returnValue;
}
}
...
JAVA_VOID com_codename1_ui_Slider_setMaxValue___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8826);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_Slider_setMinValue___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 8803, 8828);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_Slider_shouldBlockSideSwipe___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8803, 2727);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(791);
    if (get_field_com_codename1_ui_Slider_editable(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1045336031;
    if (get_field_com_codename1_ui_Slider_vertical(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1045336031;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1780313842;
...
JAVA_INT com_codename1_ui_Slider_access$200___com_codename1_ui_Slider_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_Slider(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 8803, 799);
...
JAVA_VOID virtual_com_codename1_ui_Slider_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_addActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[375])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setInfinite___boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setInfinite___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setInfinite___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[377])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_INT (*functionPtr_com_codename1_ui_Slider_getProgress___R_int)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject);

JAVA_INT virtual_com_codename1_ui_Slider_getProgress___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_Slider_getProgress___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[378])(threadStateData, __cn1ThisObject);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setProgress___int)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setProgress___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setProgress___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[379])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_OBJECT (*functionPtr_com_codename1_ui_Slider_formattedValue___int_R_java_lang_String)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1);

JAVA_OBJECT virtual_com_codename1_ui_Slider_formattedValue___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_Slider_formattedValue___int_R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[380])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setEditable___boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setEditable___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setEditable___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[381])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_addDataChangedListener___com_codename1_ui_events_DataChangedListener)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_addDataChangedListener___com_codename1_ui_events_DataChangedListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_addDataChangedListener___com_codename1_ui_events_DataChangedListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[382])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setRenderPercentageOnTop___boolean)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setRenderPercentageOnTop___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setRenderPercentageOnTop___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[385])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setMaxValue___int)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setMaxValue___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setMaxValue___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[388])(threadStateData, __cn1ThisObject, __cn1Arg1);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_Slider_setMinValue___int)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_Slider_setMinValue___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_Slider_setMinValue___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[389])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
void __INIT_VTABLE_com_codename1_ui_Slider(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[375] = &com_codename1_ui_Slider_addActionListener___com_codename1_ui_events_ActionListener;
    vtable[376] = &com_codename1_ui_Slider_removeActionListener___com_codename1_ui_events_ActionListener;
    vtable[377] = &com_codename1_ui_Slider_setInfinite___boolean;
    vtable[378] = &com_codename1_ui_Slider_getProgress___R_int;
    vtable[379] = &com_codename1_ui_Slider_setProgress___int;
    vtable[380] = &com_codename1_ui_Slider_formattedValue___int_R_java_lang_String;
    vtable[381] = &com_codename1_ui_Slider_setEditable___boolean;
    vtable[382] = &com_codename1_ui_Slider_addDataChangedListener___com_codename1_ui_events_DataChangedListener;
    vtable[383] = &com_codename1_ui_Slider_removeDataChangedListener___com_codename1_ui_events_DataChangedListener;
    vtable[384] = &com_codename1_ui_Slider_isRenderPercentageOnTop___R_boolean;
    vtable[385] = &com_codename1_ui_Slider_setRenderPercentageOnTop___boolean;
    vtable[386] = &com_codename1_ui_Slider_setRenderValueOnTop___boolean;
    vtable[387] = &com_codename1_ui_Slider_getMaxValue___R_int;
    vtable[388] = &com_codename1_ui_Slider_setMaxValue___int;
    vtable[389] = &com_codename1_ui_Slider_setMinValue___int;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_Slider(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_Slider.vtable = malloc(sizeof(void*) *390);
