...
JAVA_VOID com_codename1_processing_ContainsEvaluator___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7626, 201);
...
JAVA_OBJECT com_codename1_processing_ContainsEvaluator__getLeftValue___com_codename1_processing_StructuredContent_java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 7626, 7627);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_processing_ContainsEvaluator_evaluateLeftContainsRight___com_codename1_processing_StructuredContent_java_lang_String_java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 13, 0, 7626, 7625);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2110522006;
    __CN1_DEBUG_INFO(78);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L2110522006:
    __CN1_DEBUG_INFO(82);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(6434))!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1804568540;
    if (CN1_ARRAY_LENGTH(locals[4].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1804568540;
    __CN1_DEBUG_INFO(83);
    ...
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1804568540;
    __CN1_DEBUG_INFO(84);
...
label_L1271196739:
    if (ilocals_10_>=ilocals_9_) /* IF_ICMPGE CustomJump */ goto label_L79843841;
...
label_L1162428486:
    if (ilocals_6_>=ilocals_7_) /* IF_ICMPGE CustomJump */ goto label_L1336606561;
    __CN1_DEBUG_INFO(92);
...
locals[12].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(93);
    if (/* CustomInvoke */virtual_java_lang_String_equalsIgnoreCase___java_lang_String_R_boolean(threadStateData, locals[12].data.o, locals[11].data.o)==0) /* IFEQ CustomJump */ goto label_L1383042224;
    __CN1_DEBUG_INFO(94);
    goto label_L1336606561;

label_L1383042224:
    __CN1_DEBUG_INFO(91);
    BC_IINC(6, 1);
    goto label_L1162428486;

label_L1336606561:
    __CN1_DEBUG_INFO(97);
    if (ilocals_6_!=ilocals_7_) /* IF_ICMPNE CustomJump */ goto label_L1393377460;
    __CN1_DEBUG_INFO(98);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;
