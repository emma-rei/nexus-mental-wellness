...
struct clazz class__com_nexus_nexwell_forms_GamesContainer__Lambda_2 = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_com_nexus_nexwell_forms_GamesContainer__Lambda_2 ,0 , &__GC_MARK_com_nexus_nexwell_forms_GamesContainer__Lambda_2,  0, cn1_class_id_com_nexus_nexwell_forms_GamesContainer__Lambda_2, "com.nexus.nexwell.forms.GamesContainer..Lambda.2", 0, 0, 0, JAVA_FALSE, &class__java_lang_Object, base_interfaces_for_com_nexus_nexwell_forms_GamesContainer__Lambda_2, 1, 0, 0
, 0, JAVA_TRUE, 0, 0, 0, 0};

JAVA_OBJECT get_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_nexus_nexwell_forms_GamesContainer__Lambda_2*)__cn1T).com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1;
}

void set_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_nexus_nexwell_forms_GamesContainer__Lambda_2*)__cn1T).com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1 = __cn1Val;
}

JAVA_OBJECT get_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2(JAVA_OBJECT __cn1T) {
  return (*(struct obj__com_nexus_nexwell_forms_GamesContainer__Lambda_2*)__cn1T).com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2;
}

void set_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Val, JAVA_OBJECT __cn1T) {
    (*(struct obj__com_nexus_nexwell_forms_GamesContainer__Lambda_2*)__cn1T).com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2 = __cn1Val;
}
...
void __GC_MARK_com_nexus_nexwell_forms_GamesContainer__Lambda_2(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    ...
    gcMarkObject(threadStateData, objInstance->com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1, force);
    gcMarkObject(threadStateData, objInstance->com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2, force);
...
JAVA_VOID com_nexus_nexwell_forms_GamesContainer__Lambda_2___INIT_____com_nexus_nexwell_forms_GamesContainer_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 10246, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    java_lang_Object___INIT____(threadStateData, __cn1ThisObject); 
    set_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1(threadStateData, locals[1].data.o, __cn1ThisObject);
    set_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2(threadStateData, locals[2].data.o, __cn1ThisObject);
...
JAVA_VOID com_nexus_nexwell_forms_GamesContainer__Lambda_2_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 10246, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    /* CustomInvoke */com_nexus_nexwell_forms_GamesContainer_lambda$new$0___com_nexus_nexwell_forms_GamesContainer_java_lang_String_com_codename1_ui_events_ActionEvent(threadStateData, get_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_1(__cn1ThisObject), get_field_com_nexus_nexwell_forms_GamesContainer__Lambda_2_arg_2(__cn1ThisObject), locals[1].data.o); 
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}


JAVA_OBJECT com_nexus_nexwell_forms_GamesContainer__Lambda_2_lambdaFactory$___com_nexus_nexwell_forms_GamesContainer_java_lang_String_R_com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_nexus_nexwell_forms_GamesContainer__Lambda_2(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 10246, 10185);
    ...
    BC_DUP(); /* DUP */
    /* CustomInvoke */com_nexus_nexwell_forms_GamesContainer__Lambda_2___INIT_____com_nexus_nexwell_forms_GamesContainer_java_lang_String(threadStateData, SP[-1].data.o, locals[0].data.o, locals[1].data.o);     SP -= 1;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_OBJ();
}
