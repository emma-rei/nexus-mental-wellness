...
JAVA_OBJECT java_util_Arrays_ArrayList_get___int_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    int restoreToL2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    int tryBlockOffsetL2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1, label_L817348612, restoreToL2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);

label_L2101899591:
 tryBlockOffsetL2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_ArrayIndexOutOfBoundsException, catch_L2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);
    restoreToL2101899591cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT java_util_Arrays_ArrayList_set___int_java_lang_Object_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    int tryBlockOffsetL1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1;
    DEFINE_CATCH_BLOCK(catch_L1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1, label_L769429195, restoreToL1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);
    int restoreToL1404112538cn1_class_id_java_lang_ArrayStoreException2;
    int tryBlockOffsetL1404112538cn1_class_id_java_lang_ArrayStoreException2;
    DEFINE_CATCH_BLOCK(catch_L1404112538cn1_class_id_java_lang_ArrayStoreException2, label_L580718781, restoreToL1404112538cn1_class_id_java_lang_ArrayStoreException2);

label_L1404112538:
 tryBlockOffsetL1404112538cn1_class_id_java_lang_ArrayStoreException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_ArrayStoreException, catch_L1404112538cn1_class_id_java_lang_ArrayStoreException2);
    restoreToL1404112538cn1_class_id_java_lang_ArrayStoreException2 = threadStateData->threadObjectStackOffset;
 tryBlockOffsetL1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_ArrayIndexOutOfBoundsException, catch_L1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1);
    restoreToL1404112538cn1_class_id_java_lang_ArrayIndexOutOfBoundsException1 = threadStateData->threadObjectStackOffset;
