...
JAVA_VOID com_codename1_io_JSONParser_ReaderClass___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7531, 202);
...
JAVA_INT com_codename1_io_JSONParser_ReaderClass_read___java_io_Reader_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 7531, 987);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(185);
    /* VarOp.assignFrom */     ilocals_2_ = -1 /* ICONST_M1 */; 
    __CN1_DEBUG_INFO(186);
    if (get_field_com_codename1_io_JSONParser_ReaderClass_buffer(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1910491749;
...
label_L1910491749:
    ...
    if (get_field_com_codename1_io_JSONParser_ReaderClass_buffSize(__cn1ThisObject)<0) /* IFLT CustomJump */ goto label_L2141744605;
    if (get_field_com_codename1_io_JSONParser_ReaderClass_buffOffset(__cn1ThisObject)<get_field_com_codename1_io_JSONParser_ReaderClass_buffSize(__cn1ThisObject)) /* IF_IMPLT CustomJump */ goto label_L513761429;
...
label_L2141744605:
    ...
    if (get_field_com_codename1_io_JSONParser_ReaderClass_buffSize(__cn1ThisObject)>=0) /* IFGE CustomJump */ goto label_L66348462;
