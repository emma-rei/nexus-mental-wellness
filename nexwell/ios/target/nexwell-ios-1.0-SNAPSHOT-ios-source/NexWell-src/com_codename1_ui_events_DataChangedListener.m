...
class_array1__com_codename1_ui_events_DataChangedListener.vtable = initVtableForInterface();
    ...
    classToInterfaceMap_com_codename1_ui_events_DataChangedListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm__Lambda_5] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_DataChangedListener[cn1_class_id_com_nexus_nexwell_games_GameOfLifeForm__Lambda_5][0] = 10;
    ...
    classToInterfaceMap_com_codename1_ui_events_DataChangedListener[cn1_class_id_com_codename1_ui_SearchBar_1] = malloc(sizeof(int*) * 13);
    classToInterfaceMap_com_codename1_ui_events_DataChangedListener[cn1_class_id_com_codename1_ui_SearchBar_1][0] = 10;
