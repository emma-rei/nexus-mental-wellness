...
JAVA_BOOLEAN com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1401980462;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_JSONParser);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1338826013;
...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    int restoreToL279046102cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL279046102cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L279046102cn1_class_id_java_lang_NumberFormatException1, label_L583057596, restoreToL279046102cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL1743011665cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL1743011665cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L1743011665cn1_class_id_java_lang_NumberFormatException2, label_L916608087, restoreToL1743011665cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL1764386225cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL1764386225cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L1764386225cn1_class_id_java_lang_NumberFormatException3, label_L1641289051, restoreToL1764386225cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL898151325cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL898151325cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L898151325cn1_class_id_java_lang_NumberFormatException4, label_L1213794377, restoreToL898151325cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL179258229cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL179258229cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L179258229cn1_class_id_java_lang_Exception5, label_L1815672030, restoreToL179258229cn1_class_id_java_lang_Exception5);
    int restoreToL153337703cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL153337703cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L153337703cn1_class_id_java_lang_Exception6, label_L1815672030, restoreToL153337703cn1_class_id_java_lang_Exception6);
...
label_L179258229:
 tryBlockOffsetL179258229cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L179258229cn1_class_id_java_lang_Exception5);
    restoreToL179258229cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1218188770, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L153337703, 0);
...
label_L153337703:
 tryBlockOffsetL153337703cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L153337703cn1_class_id_java_lang_Exception6);
    restoreToL153337703cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L154723658, 1);
    __CN1_DEBUG_INFO(284);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(285);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L571309751, 1);
...
label_L571309751:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L169237521, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L517608115, 1);
        case 92: JUMP_TO(label_L1342613143, 1);
        default: JUMP_TO(label_L423072486, 1);
    }
...
label_L517608115:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L570008325, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1878553091, 1);
...
label_L1342613143:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L791302244, 1);
...
label_L279046102:
 tryBlockOffsetL279046102cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L279046102cn1_class_id_java_lang_NumberFormatException1);
    restoreToL279046102cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L791302244:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L531068784, 1);
        case 114: JUMP_TO(label_L1660136848, 1);
        case 116: JUMP_TO(label_L416692630, 1);
        default: JUMP_TO(label_L1877161234, 1);
    }
...
label_L169237521:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1246962289, 1);
        case 10: JUMP_TO(label_L1246962289, 1);
        case 11: JUMP_TO(label_L1852560443, 1);
        case 12: JUMP_TO(label_L1852560443, 1);
        case 13: JUMP_TO(label_L1246962289, 1);
        case 14: JUMP_TO(label_L1852560443, 1);
        case 15: JUMP_TO(label_L1852560443, 1);
        case 16: JUMP_TO(label_L1852560443, 1);
        case 17: JUMP_TO(label_L1852560443, 1);
        case 18: JUMP_TO(label_L1852560443, 1);
        case 19: JUMP_TO(label_L1852560443, 1);
        case 20: JUMP_TO(label_L1852560443, 1);
        case 21: JUMP_TO(label_L1852560443, 1);
        case 22: JUMP_TO(label_L1852560443, 1);
        case 23: JUMP_TO(label_L1852560443, 1);
        case 24: JUMP_TO(label_L1852560443, 1);
        case 25: JUMP_TO(label_L1852560443, 1);
        case 26: JUMP_TO(label_L1852560443, 1);
        case 27: JUMP_TO(label_L1852560443, 1);
        case 28: JUMP_TO(label_L1852560443, 1);
        case 29: JUMP_TO(label_L1852560443, 1);
        case 30: JUMP_TO(label_L1852560443, 1);
        case 31: JUMP_TO(label_L1852560443, 1);
        case 32: JUMP_TO(label_L1246962289, 1);
        case 33: JUMP_TO(label_L1852560443, 1);
        case 34: JUMP_TO(label_L900958598, 1);
        case 35: JUMP_TO(label_L1852560443, 1);
        case 36: JUMP_TO(label_L1852560443, 1);
        case 37: JUMP_TO(label_L1852560443, 1);
        case 38: JUMP_TO(label_L1852560443, 1);
        case 39: JUMP_TO(label_L1852560443, 1);
        case 40: JUMP_TO(label_L1852560443, 1);
        case 41: JUMP_TO(label_L1852560443, 1);
        case 42: JUMP_TO(label_L1852560443, 1);
        case 43: JUMP_TO(label_L1852560443, 1);
        case 44: JUMP_TO(label_L469765167, 1);
        case 45: JUMP_TO(label_L746244504, 1);
        case 46: JUMP_TO(label_L746244504, 1);
        case 47: JUMP_TO(label_L1852560443, 1);
        case 48: JUMP_TO(label_L746244504, 1);
        case 49: JUMP_TO(label_L746244504, 1);
        case 50: JUMP_TO(label_L746244504, 1);
        case 51: JUMP_TO(label_L746244504, 1);
        case 52: JUMP_TO(label_L746244504, 1);
        case 53: JUMP_TO(label_L746244504, 1);
        case 54: JUMP_TO(label_L746244504, 1);
        case 55: JUMP_TO(label_L746244504, 1);
        case 56: JUMP_TO(label_L746244504, 1);
        case 57: JUMP_TO(label_L746244504, 1);
        case 58: JUMP_TO(label_L469765167, 1);
        case 59: JUMP_TO(label_L1852560443, 1);
        case 60: JUMP_TO(label_L1852560443, 1);
        case 61: JUMP_TO(label_L1852560443, 1);
        case 62: JUMP_TO(label_L1852560443, 1);
        case 63: JUMP_TO(label_L1852560443, 1);
        case 64: JUMP_TO(label_L1852560443, 1);
        case 65: JUMP_TO(label_L1852560443, 1);
        case 66: JUMP_TO(label_L1852560443, 1);
        case 67: JUMP_TO(label_L1852560443, 1);
        case 68: JUMP_TO(label_L1852560443, 1);
        case 69: JUMP_TO(label_L746244504, 1);
        case 70: JUMP_TO(label_L1852560443, 1);
        case 71: JUMP_TO(label_L1852560443, 1);
        case 72: JUMP_TO(label_L1852560443, 1);
        case 73: JUMP_TO(label_L1852560443, 1);
        case 74: JUMP_TO(label_L1852560443, 1);
        case 75: JUMP_TO(label_L1852560443, 1);
        case 76: JUMP_TO(label_L1852560443, 1);
        case 77: JUMP_TO(label_L1852560443, 1);
        case 78: JUMP_TO(label_L1852560443, 1);
        case 79: JUMP_TO(label_L1852560443, 1);
        case 80: JUMP_TO(label_L1852560443, 1);
        case 81: JUMP_TO(label_L1852560443, 1);
        case 82: JUMP_TO(label_L1852560443, 1);
        case 83: JUMP_TO(label_L1852560443, 1);
        case 84: JUMP_TO(label_L1852560443, 1);
        case 85: JUMP_TO(label_L1852560443, 1);
        case 86: JUMP_TO(label_L1852560443, 1);
        case 87: JUMP_TO(label_L1852560443, 1);
        case 88: JUMP_TO(label_L1852560443, 1);
        case 89: JUMP_TO(label_L1852560443, 1);
        case 90: JUMP_TO(label_L1852560443, 1);
        case 91: JUMP_TO(label_L2137601740, 1);
        case 92: JUMP_TO(label_L1852560443, 1);
        case 93: JUMP_TO(label_L1455386398, 1);
        case 94: JUMP_TO(label_L1852560443, 1);
        case 95: JUMP_TO(label_L1852560443, 1);
        case 96: JUMP_TO(label_L1852560443, 1);
        case 97: JUMP_TO(label_L1852560443, 1);
        case 98: JUMP_TO(label_L1852560443, 1);
        case 99: JUMP_TO(label_L1852560443, 1);
        case 100: JUMP_TO(label_L746244504, 1);
        case 101: JUMP_TO(label_L746244504, 1);
        case 102: JUMP_TO(label_L1254252690, 1);
        case 103: JUMP_TO(label_L1852560443, 1);
        case 104: JUMP_TO(label_L1852560443, 1);
        case 105: JUMP_TO(label_L1852560443, 1);
        case 106: JUMP_TO(label_L1852560443, 1);
        case 107: JUMP_TO(label_L1852560443, 1);
        case 108: JUMP_TO(label_L746244504, 1);
        case 109: JUMP_TO(label_L1852560443, 1);
        case 110: JUMP_TO(label_L814630491, 1);
        case 111: JUMP_TO(label_L1852560443, 1);
        case 112: JUMP_TO(label_L1852560443, 1);
        case 113: JUMP_TO(label_L1852560443, 1);
        case 114: JUMP_TO(label_L1852560443, 1);
        case 115: JUMP_TO(label_L1852560443, 1);
        case 116: JUMP_TO(label_L115857872, 1);
        case 117: JUMP_TO(label_L1852560443, 1);
        case 118: JUMP_TO(label_L1852560443, 1);
        case 119: JUMP_TO(label_L1852560443, 1);
        case 120: JUMP_TO(label_L746244504, 1);
        case 121: JUMP_TO(label_L1852560443, 1);
        case 122: JUMP_TO(label_L1852560443, 1);
        case 123: JUMP_TO(label_L722305421, 1);
        case 124: JUMP_TO(label_L1852560443, 1);
        case 125: JUMP_TO(label_L1913827982, 1);
        default: JUMP_TO(label_L1852560443, 1);
    }
...
label_L814630491:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L179258229, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L179258229, 0);
...
label_L115857872:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L142473357, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1329271270, 1);
...
label_L1254252690:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2089976729, 1);
...
label_L2089976729:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L466396438, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L216998824, 1);
...
label_L722305421:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L508294491, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1615923089, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7506);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L508294491, 1);
...
label_L1743011665:
 tryBlockOffsetL1743011665cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1743011665cn1_class_id_java_lang_NumberFormatException2);
    restoreToL1743011665cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
...
label_L1764386225:
 tryBlockOffsetL1764386225cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1764386225cn1_class_id_java_lang_NumberFormatException3);
    restoreToL1764386225cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
...
label_L469765167:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2024275149, 1);

label_L898151325:
 tryBlockOffsetL898151325cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L898151325cn1_class_id_java_lang_NumberFormatException4);
    restoreToL898151325cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1091437627, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L97755704, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L167599568, 2);
...
label_L167599568:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1316719030, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L80682690;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L384500180;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L384500180;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1111947524;
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1526838264;
...
label_L1526838264:
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1777328089;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1592225010;
...
label_L1338926429:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L234223191;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L644015103;
...
label_L644015103:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1747223278;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L639313883;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L391595516;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1625676573;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L854246299;
