...
JAVA_VOID com_codename1_io_JSONParser___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 7486, 202);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isUseLongsInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7486, 7488);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7486, 7494);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isUseBooleanInstance___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7486, 7496);
...
JAVA_BOOLEAN com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_io_JSONParser(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 7486, 7500);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(220);
    BC_ALOAD(0);
    BC_INSTANCEOF(cn1_class_id_com_codename1_io_JSONParser);
    if(POP_INT() == 0) /* IFEQ */ goto label_L343298013;
...
JAVA_VOID com_codename1_io_JSONParser_parse___java_io_Reader_com_codename1_io_JSONParseCallback(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_io_JSONParser(threadStateData);
    DEFINE_METHOD_STACK(3, 23, 0, 7486, 1071);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL153465621cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL153465621cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L153465621cn1_class_id_java_lang_NumberFormatException1, label_L1076879089, restoreToL153465621cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL261414157cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL261414157cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L261414157cn1_class_id_java_lang_NumberFormatException2, label_L1776875429, restoreToL261414157cn1_class_id_java_lang_NumberFormatException2);
    int restoreToL1366980972cn1_class_id_java_lang_NumberFormatException3;
    int tryBlockOffsetL1366980972cn1_class_id_java_lang_NumberFormatException3;
    DEFINE_CATCH_BLOCK(catch_L1366980972cn1_class_id_java_lang_NumberFormatException3, label_L269724308, restoreToL1366980972cn1_class_id_java_lang_NumberFormatException3);
    int restoreToL1444380816cn1_class_id_java_lang_NumberFormatException4;
    int tryBlockOffsetL1444380816cn1_class_id_java_lang_NumberFormatException4;
    DEFINE_CATCH_BLOCK(catch_L1444380816cn1_class_id_java_lang_NumberFormatException4, label_L918357996, restoreToL1444380816cn1_class_id_java_lang_NumberFormatException4);
    int restoreToL821664929cn1_class_id_java_lang_Exception5;
    int tryBlockOffsetL821664929cn1_class_id_java_lang_Exception5;
    DEFINE_CATCH_BLOCK(catch_L821664929cn1_class_id_java_lang_Exception5, label_L140222364, restoreToL821664929cn1_class_id_java_lang_Exception5);
    int restoreToL728386983cn1_class_id_java_lang_Exception6;
    int tryBlockOffsetL728386983cn1_class_id_java_lang_Exception6;
    DEFINE_CATCH_BLOCK(catch_L728386983cn1_class_id_java_lang_Exception6, label_L140222364, restoreToL728386983cn1_class_id_java_lang_Exception6);
    ...
    /* VarOp.assignFrom */ locals[8].type=CN1_TYPE_INVALID;    locals[8].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(220);
...
label_L821664929:
 tryBlockOffsetL821664929cn1_class_id_java_lang_Exception5 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L821664929cn1_class_id_java_lang_Exception5);
    restoreToL821664929cn1_class_id_java_lang_Exception5 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(277);
    if (virtual_com_codename1_io_JSONParseCallback_isAlive___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L648021229, 1);
    ...
    if (ilocals_10_>=0) /* IFGE CustomJump */ JUMP_TO(label_L728386983, 0);
...
label_L728386983:
 tryBlockOffsetL728386983cn1_class_id_java_lang_Exception6 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L728386983cn1_class_id_java_lang_Exception6);
    restoreToL728386983cn1_class_id_java_lang_Exception6 = threadStateData->threadObjectStackOffset;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1974910273, 1);
    __CN1_DEBUG_INFO(284);
    BC_IINC(4, 1);
    __CN1_DEBUG_INFO(285);
    /* VarOp.assignFrom */     ilocals_5_ = 0 /* ICONST_0 */; 
    JUMP_TO(label_L558201620, 1);
...
label_L558201620:
    ...
    if (ilocals_2_==0) /* IFEQ CustomJump */ JUMP_TO(label_L132416701, 1);
    ...
    SP--;
    switch((*SP).data.i) {
        case 34: JUMP_TO(label_L2115692179, 1);
        case 92: JUMP_TO(label_L1040580772, 1);
        default: JUMP_TO(label_L873546155, 1);
    }
...
label_L2115692179:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L393476856, 1);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L1056221435, 1);
...
label_L1040580772:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L249270028, 1);
...
label_L153465621:
 tryBlockOffsetL153465621cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L153465621cn1_class_id_java_lang_NumberFormatException1);
    restoreToL153465621cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L249270028:
    ...
    SP--;
    switch((*SP).data.i) {
        case 110: JUMP_TO(label_L1631537374, 1);
        case 114: JUMP_TO(label_L869140506, 1);
        case 116: JUMP_TO(label_L226972126, 1);
        default: JUMP_TO(label_L492815168, 1);
    }
...
label_L132416701:
    ...
    SP--;
    switch((*SP).data.i) {
        case 9: JUMP_TO(label_L1975716431, 1);
        case 10: JUMP_TO(label_L1975716431, 1);
        case 11: JUMP_TO(label_L1847707373, 1);
        case 12: JUMP_TO(label_L1847707373, 1);
        case 13: JUMP_TO(label_L1975716431, 1);
        case 14: JUMP_TO(label_L1847707373, 1);
        case 15: JUMP_TO(label_L1847707373, 1);
        case 16: JUMP_TO(label_L1847707373, 1);
        case 17: JUMP_TO(label_L1847707373, 1);
        case 18: JUMP_TO(label_L1847707373, 1);
        case 19: JUMP_TO(label_L1847707373, 1);
        case 20: JUMP_TO(label_L1847707373, 1);
        case 21: JUMP_TO(label_L1847707373, 1);
        case 22: JUMP_TO(label_L1847707373, 1);
        case 23: JUMP_TO(label_L1847707373, 1);
        case 24: JUMP_TO(label_L1847707373, 1);
        case 25: JUMP_TO(label_L1847707373, 1);
        case 26: JUMP_TO(label_L1847707373, 1);
        case 27: JUMP_TO(label_L1847707373, 1);
        case 28: JUMP_TO(label_L1847707373, 1);
        case 29: JUMP_TO(label_L1847707373, 1);
        case 30: JUMP_TO(label_L1847707373, 1);
        case 31: JUMP_TO(label_L1847707373, 1);
        case 32: JUMP_TO(label_L1975716431, 1);
        case 33: JUMP_TO(label_L1847707373, 1);
        case 34: JUMP_TO(label_L906904117, 1);
        case 35: JUMP_TO(label_L1847707373, 1);
        case 36: JUMP_TO(label_L1847707373, 1);
        case 37: JUMP_TO(label_L1847707373, 1);
        case 38: JUMP_TO(label_L1847707373, 1);
        case 39: JUMP_TO(label_L1847707373, 1);
        case 40: JUMP_TO(label_L1847707373, 1);
        case 41: JUMP_TO(label_L1847707373, 1);
        case 42: JUMP_TO(label_L1847707373, 1);
        case 43: JUMP_TO(label_L1847707373, 1);
        case 44: JUMP_TO(label_L28376203, 1);
        case 45: JUMP_TO(label_L1640383742, 1);
        case 46: JUMP_TO(label_L1640383742, 1);
        case 47: JUMP_TO(label_L1847707373, 1);
        case 48: JUMP_TO(label_L1640383742, 1);
        case 49: JUMP_TO(label_L1640383742, 1);
        case 50: JUMP_TO(label_L1640383742, 1);
        case 51: JUMP_TO(label_L1640383742, 1);
        case 52: JUMP_TO(label_L1640383742, 1);
        case 53: JUMP_TO(label_L1640383742, 1);
        case 54: JUMP_TO(label_L1640383742, 1);
        case 55: JUMP_TO(label_L1640383742, 1);
        case 56: JUMP_TO(label_L1640383742, 1);
        case 57: JUMP_TO(label_L1640383742, 1);
        case 58: JUMP_TO(label_L28376203, 1);
        case 59: JUMP_TO(label_L1847707373, 1);
        case 60: JUMP_TO(label_L1847707373, 1);
        case 61: JUMP_TO(label_L1847707373, 1);
        case 62: JUMP_TO(label_L1847707373, 1);
        case 63: JUMP_TO(label_L1847707373, 1);
        case 64: JUMP_TO(label_L1847707373, 1);
        case 65: JUMP_TO(label_L1847707373, 1);
        case 66: JUMP_TO(label_L1847707373, 1);
        case 67: JUMP_TO(label_L1847707373, 1);
        case 68: JUMP_TO(label_L1847707373, 1);
        case 69: JUMP_TO(label_L1640383742, 1);
        case 70: JUMP_TO(label_L1847707373, 1);
        case 71: JUMP_TO(label_L1847707373, 1);
        case 72: JUMP_TO(label_L1847707373, 1);
        case 73: JUMP_TO(label_L1847707373, 1);
        case 74: JUMP_TO(label_L1847707373, 1);
        case 75: JUMP_TO(label_L1847707373, 1);
        case 76: JUMP_TO(label_L1847707373, 1);
        case 77: JUMP_TO(label_L1847707373, 1);
        case 78: JUMP_TO(label_L1847707373, 1);
        case 79: JUMP_TO(label_L1847707373, 1);
        case 80: JUMP_TO(label_L1847707373, 1);
        case 81: JUMP_TO(label_L1847707373, 1);
        case 82: JUMP_TO(label_L1847707373, 1);
        case 83: JUMP_TO(label_L1847707373, 1);
        case 84: JUMP_TO(label_L1847707373, 1);
        case 85: JUMP_TO(label_L1847707373, 1);
        case 86: JUMP_TO(label_L1847707373, 1);
        case 87: JUMP_TO(label_L1847707373, 1);
        case 88: JUMP_TO(label_L1847707373, 1);
        case 89: JUMP_TO(label_L1847707373, 1);
        case 90: JUMP_TO(label_L1847707373, 1);
        case 91: JUMP_TO(label_L213560315, 1);
        case 92: JUMP_TO(label_L1847707373, 1);
        case 93: JUMP_TO(label_L1214336947, 1);
        case 94: JUMP_TO(label_L1847707373, 1);
        case 95: JUMP_TO(label_L1847707373, 1);
        case 96: JUMP_TO(label_L1847707373, 1);
        case 97: JUMP_TO(label_L1847707373, 1);
        case 98: JUMP_TO(label_L1847707373, 1);
        case 99: JUMP_TO(label_L1847707373, 1);
        case 100: JUMP_TO(label_L1640383742, 1);
        case 101: JUMP_TO(label_L1640383742, 1);
        case 102: JUMP_TO(label_L1320400528, 1);
        case 103: JUMP_TO(label_L1847707373, 1);
        case 104: JUMP_TO(label_L1847707373, 1);
        case 105: JUMP_TO(label_L1847707373, 1);
        case 106: JUMP_TO(label_L1847707373, 1);
        case 107: JUMP_TO(label_L1847707373, 1);
        case 108: JUMP_TO(label_L1640383742, 1);
        case 109: JUMP_TO(label_L1847707373, 1);
        case 110: JUMP_TO(label_L486668812, 1);
        case 111: JUMP_TO(label_L1847707373, 1);
        case 112: JUMP_TO(label_L1847707373, 1);
        case 113: JUMP_TO(label_L1847707373, 1);
        case 114: JUMP_TO(label_L1847707373, 1);
        case 115: JUMP_TO(label_L1847707373, 1);
        case 116: JUMP_TO(label_L1153269540, 1);
        case 117: JUMP_TO(label_L1847707373, 1);
        case 118: JUMP_TO(label_L1847707373, 1);
        case 119: JUMP_TO(label_L1847707373, 1);
        case 120: JUMP_TO(label_L1640383742, 1);
        case 121: JUMP_TO(label_L1847707373, 1);
        case 122: JUMP_TO(label_L1847707373, 1);
        case 123: JUMP_TO(label_L115584215, 1);
        case 124: JUMP_TO(label_L1847707373, 1);
        case 125: JUMP_TO(label_L1438092717, 1);
        default: JUMP_TO(label_L1847707373, 1);
    }
...
label_L486668812:
    ...
    SP++;
    PUSH_INT(117);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1207229581, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L821664929, 0);
    ...
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L821664929, 0);
...
label_L1153269540:
    ...
    SP++;
    PUSH_INT(114);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1755303688, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1937855448, 1);
    ...
    JUMP_TO(label_L439513824, 1);

label_L1937855448:
    __CN1_DEBUG_INFO(361);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_stringToken___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(209)); 

label_L439513824:
    __CN1_DEBUG_INFO(363);
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L821664929, 0);
    __CN1_DEBUG_INFO(364);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_keyValue___java_lang_String_java_lang_String(threadStateData, locals[1].data.o, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(209)); 
...
label_L1320400528:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L2076427679, 1);
...
label_L2076427679:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ JUMP_TO(label_L1840423520, 1);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useBoolean___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L341062557, 1);
    ...
    JUMP_TO(label_L502851205, 1);

label_L341062557:
    __CN1_DEBUG_INFO(389);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_stringToken___java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(263)); 

label_L502851205:
    __CN1_DEBUG_INFO(391);
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L821664929, 0);
    __CN1_DEBUG_INFO(392);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_keyValue___java_lang_String_java_lang_String(threadStateData, locals[1].data.o, locals[9].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(263)); 
...
label_L115584215:
    ...
    if (locals[9].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L2020751256, 1);
    __CN1_DEBUG_INFO(403);
    if (virtual_com_codename1_io_JSONParser_KeyStack_size___R_int(threadStateData, locals[7].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L11221844, 1);
    __CN1_DEBUG_INFO(404);
    /* VarOp.assignFrom */ locals[9].type=CN1_TYPE_INVALID;    locals[9].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(7507);
locals[9].type=CN1_TYPE_OBJECT;    JUMP_TO(label_L2020751256, 1);
...
label_L1438092717:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L903227399, 1);

label_L261414157:
 tryBlockOffsetL261414157cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L261414157cn1_class_id_java_lang_NumberFormatException2);
    restoreToL261414157cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1874869494, 2);
    __CN1_DEBUG_INFO(418);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L115804257, 2);
...
label_L1607463538:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1532850076, 1);
...
label_L1214336947:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L890560397, 1);

label_L1366980972:
 tryBlockOffsetL1366980972cn1_class_id_java_lang_NumberFormatException3 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1366980972cn1_class_id_java_lang_NumberFormatException3);
    restoreToL1366980972cn1_class_id_java_lang_NumberFormatException3 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L185494862, 2);
    __CN1_DEBUG_INFO(452);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L737301055, 2);
    __CN1_DEBUG_INFO(453);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L467921234, 2);
...
label_L467921234:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L135832852, 1);
...
label_L28376203:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[6].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L1879362884, 1);

label_L1444380816:
 tryBlockOffsetL1444380816cn1_class_id_java_lang_NumberFormatException4 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1444380816cn1_class_id_java_lang_NumberFormatException4);
    restoreToL1444380816cn1_class_id_java_lang_NumberFormatException4 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_io_JSONParser_useLongs___com_codename1_io_JSONParseCallback_R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1230904017, 2);
    __CN1_DEBUG_INFO(490);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[22].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1299436497, 2);
    __CN1_DEBUG_INFO(491);
    /* CustomInvoke */virtual_com_codename1_io_JSONParseCallback_numericToken___double(threadStateData, locals[1].data.o, /* CustomInvoke */java_lang_Double_parseDouble___java_lang_String_R_double(threadStateData, locals[22].data.o)); 
    JUMP_TO(label_L978798, 2);
...
label_L978798:
    ...
    if (locals[9].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1454795974, 1);
...
JAVA_OBJECT com_codename1_io_JSONParser_parse___java_io_Reader_R_java_util_Hashtable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7486, 1071);
    ...
    if (get_field_com_codename1_io_JSONParser_strict(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1262168655;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isStackHash___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7486, 7510);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(594);
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L781103026;
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L781103026;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L2050964420;
...
JAVA_OBJECT com_codename1_io_JSONParser_getStackHash___R_java_util_Map(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7486, 7511);
...
JAVA_OBJECT com_codename1_io_JSONParser_getStackVec___R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 7486, 7512);
...
JAVA_VOID com_codename1_io_JSONParser_startBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7486, 7513);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(610);
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L147663797;
    ...
    goto label_L439751089;

label_L147663797:
    __CN1_DEBUG_INFO(614);
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1100926586;
...
label_L1115434134:
    ...
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L596453359;
...
JAVA_VOID com_codename1_io_JSONParser_endBlock___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7486, 7514);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_io_JSONParser_startArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 7486, 7517);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(685);
    if (get_field_com_codename1_io_JSONParser_modern(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1053225969;
    __CN1_DEBUG_INFO(686);
    PUSH_POINTER(__NEW_java_util_ArrayList(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    java_util_ArrayList___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    BC_ASTORE(2);
    goto label_L503144483;
...
label_L503144483:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1468374572;
    __CN1_DEBUG_INFO(693);
    /* CustomInvoke */virtual_java_util_List_add___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_io_JSONParser_parseStack(__cn1ThisObject), get_field_com_codename1_io_JSONParser_state(__cn1ThisObject)); 
    __CN1_DEBUG_INFO(694);
    set_field_com_codename1_io_JSONParser_currentKey(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(7507), __cn1ThisObject);

label_L1468374572:
    __CN1_DEBUG_INFO(696);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1048421579;
...
JAVA_VOID com_codename1_io_JSONParser_endArray___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7486, 7518);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_io_JSONParser_stringToken___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7486, 7519);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(716);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1093079840;
    __CN1_DEBUG_INFO(717);
    if (get_field_com_codename1_io_JSONParser_currentKey(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L975733206;
    __CN1_DEBUG_INFO(718);
    set_field_com_codename1_io_JSONParser_currentKey(threadStateData, locals[1].data.o, __cn1ThisObject);
    goto label_L1772106148;

label_L975733206:
    __CN1_DEBUG_INFO(720);
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L853175535;
    if (virtual_com_codename1_io_JSONParser_isIncludeNullsInstance___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1268635527;
...
JAVA_VOID com_codename1_io_JSONParser_numericToken___double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_DOUBLE __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 7486, 7520);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     dlocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(734);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L893765907;
...
JAVA_VOID com_codename1_io_JSONParser_longToken___long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 7486, 7521);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     llocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(746);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1021071701;
...
JAVA_VOID com_codename1_io_JSONParser_booleanToken___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 7486, 7522);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(758);
    if (com_codename1_io_JSONParser_isStackHash___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L47110095;
...
JAVA_BOOLEAN com_codename1_io_JSONParser_isAlive___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7486, 1161);
