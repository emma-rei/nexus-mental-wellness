...
JAVA_VOID java_util_Locale___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    POP_MANY(2);
    if (get_field_java_util_Locale_language(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L447981768;
    ...
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L447981768;
    BC_ALOAD(0);
...
label_L447981768:
    if (get_field_java_util_Locale_language(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1125736023;
    ...
    BC_ISTORE(1);
    PUSH_INT(-1); /* ICONST_M1 */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1125736023;
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_String_substring___int_R_java_lang_String(threadStateData, get_field_java_util_Locale_language(__cn1ThisObject), (ilocals_1_ + 1 /* ICONST_1 */));
    PUSH_OBJ(tmpResult); }
    set_field_java_util_Locale_country(threadStateData, PEEK_OBJ(1), PEEK_OBJ(2));
