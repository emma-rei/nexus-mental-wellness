...
JAVA_BOOLEAN java_lang_Double_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L48305285;
...
locals[2].type=CN1_TYPE_OBJECT;    if (virtual_java_lang_Double_isNaN___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L1625090026;
    if (virtual_java_lang_Double_isNaN___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1625090026;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1625090026:
    if (CN1_CMP_EXPR(get_field_java_lang_Double_value(__cn1ThisObject), 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1714378342;
    if (CN1_CMP_EXPR(get_field_java_lang_Double_value(locals[2].data.o), 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L1714378342;
    ...
    BC_LCMP();
    if(POP_INT() != 0) /* IFNE */ goto label_L265824587;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L93798665;
...
label_L1714378342:
    if (CN1_CMP_EXPR(get_field_java_lang_Double_value(locals[2].data.o), get_field_java_lang_Double_value(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L41092582;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L519303080;
...
label_L812143047:
    if (CN1_CMP_EXPR(dlocals_2_, 0.001)<0) /* IFLT CustomJump */ goto label_L1205559205;
    if (CN1_CMP_EXPR(dlocals_2_, 1.0E7)>=0) /* IFGE CustomJump */ goto label_L1205559205;
...
label_L1098986569:
    if (ilocals_6_<0) /* IFLT CustomJump */ goto label_L894421232;
    BC_ALOAD(5);
    ...
    BC_ISTORE(7);
    PUSH_INT(48);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L894421232;
    BC_IINC(6, -1);
    goto label_L1098986569;

label_L894421232:
    if (ilocals_6_<0) /* IFLT CustomJump */ goto label_L1182311147;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[4].data.o, 46)!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1531182070;
...
label_L1531182070:
    ...
    SP[-1].data.i = ((JAVA_ARRAY_CHAR*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(46);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L276869158;
    BC_ALOAD(5);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_6_; 
    SP++;
    ...
    SP[-1].data.i = ((JAVA_ARRAY_CHAR*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(44);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1491860739;
...
JAVA_INT java_lang_Double_compare___double_double_R_int(CODENAME_ONE_THREAD_STATE, JAVA_DOUBLE __cn1Arg1, JAVA_DOUBLE __cn1Arg2) {
    ...
    if (/* CustomInvoke */java_lang_Double_isNaN___double_R_boolean(threadStateData, dlocals_2_)==0) /* IFEQ CustomJump */ goto label_L1527214863;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L1527214863:
    if (/* CustomInvoke */java_lang_Double_isNaN___double_R_boolean(threadStateData, dlocals_0_)==0) /* IFEQ CustomJump */ goto label_L534753234;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L534753234:
    if (/* CustomInvoke */java_lang_Double_isNaN___double_R_boolean(threadStateData, dlocals_2_)==0) /* IFEQ CustomJump */ goto label_L172699023;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return -1 /* ICONST_M1 */;

label_L172699023:
    if (CN1_CMP_EXPR(dlocals_0_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L231725600;
    if (CN1_CMP_EXPR(dlocals_2_, 0 /* DCONST_0 */)!=0) /* IFNE CustomJump */ goto label_L231725600;
    ...
    if (CN1_CMP_EXPR(llocals_4_, llocals_6_)!=0) /* IFNE CustomJump */ goto label_L1831882653;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L259251414;

label_L1831882653:
    if (CN1_CMP_EXPR(llocals_4_, get_static_java_lang_Double_NEGATIVE_ZERO_BITS(threadStateData))!=0) /* IFNE CustomJump */ goto label_L1552400354;
...
label_L231725600:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_2_)>=0) /* IFGE CustomJump */ goto label_L803893384;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L1078566479;

label_L803893384:
    if (CN1_CMP_EXPR(dlocals_0_, dlocals_2_)<=0) /* IFLE CustomJump */ goto label_L1372422140;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1078566479;
