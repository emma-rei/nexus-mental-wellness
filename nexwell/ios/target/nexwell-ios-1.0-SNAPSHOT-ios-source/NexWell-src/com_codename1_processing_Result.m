...
JAVA_OBJECT com_codename1_processing_Result_fromContent___com_codename1_processing_StructuredContent_boolean_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L70104063;
...
JAVA_VOID com_codename1_processing_Result___INIT_____com_codename1_processing_StructuredContent_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1519757998;
...
label_L1519757998:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L85583486;
    if (virtual_com_codename1_processing_StructuredContent_getParent___R_com_codename1_processing_StructuredContent(threadStateData, get_field_com_codename1_processing_Result_root(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L85583486;
...
JAVA_OBJECT com_codename1_processing_Result_fromContent___java_lang_String_java_lang_String_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL1785610508cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1785610508cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1785610508cn1_class_id_java_io_IOException1, label_L1946337255, restoreToL1785610508cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(175);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L492394707, 0);
...
label_L1785610508:
 tryBlockOffsetL1785610508cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1785610508cn1_class_id_java_io_IOException1);
    restoreToL1785610508cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_processing_Result_fromContent___java_io_Reader_java_lang_String_R_com_codename1_processing_Result(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L214507491;
...
label_L214507491:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1209802386;
...
label_L1209802386:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(146), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1727144954;
    ...
    BC_ASTORE(2);
    goto label_L2059697940;

label_L1727144954:
    __CN1_DEBUG_INFO(268);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(145), locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1052131752;
...
JAVA_INT com_codename1_processing_Result_getAsInteger___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L333820514;
    __CN1_DEBUG_INFO(403);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 0 /* ICONST_0 */;

label_L333820514:
    __CN1_DEBUG_INFO(405);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[2].data.o, 46)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1694558342;
...
JAVA_OBJECT com_codename1_processing_Result_getAsString___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1781893382;
...
JAVA_OBJECT com_codename1_processing_Result__internalGet___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1519656884;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)!=0) /* IFNE CustomJump */ goto label_L1684921376;
...
JAVA_OBJECT com_codename1_processing_Result_getAsStringArray___java_lang_String_R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1208417271;
    PUSH_INT(0); /* ICONST_0 */
    goto label_L1115730443;
...
label_L1261949348:
    if (ilocals_5_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1357174989;
...
JAVA_OBJECT com_codename1_processing_Result__internalGetAsArray___java_lang_String_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L725882377;
...
label_L725882377:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L586661686;
...
label_L586661686:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)<=1 /* ICONST_1 */) /* IF_ICMPLE CustomJump */ goto label_L1244923130;
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1244923130;
...
label_L1244923130:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[4].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(5206))==0) /* IFEQ CustomJump */ goto label_L1068809905;
    ...
    if (locals[5].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L885723920;
...
label_L1068809905:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(93);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L727319728;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)<4/* ICONST_4 */) /* IF_IMPLT CustomJump */ goto label_L727319728;
...
JAVA_OBJECT com_codename1_processing_Result_apply___com_codename1_processing_StructuredContent_java_util_List_int_R_com_codename1_processing_StructuredContent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1101252341;
...
label_L1101252341:
    ...
    if (ilocals_3_<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1534634310;
...
label_L327662980:
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L935813802;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[7].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L1279496038;
    BC_ALOAD(7);
    PUSH_INT(0); /* ICONST_0 */
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1279496038;
    __CN1_DEBUG_INFO(948);
    goto label_L319323253;

label_L1279496038:
    __CN1_DEBUG_INFO(950);
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[7].data.o)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L228902347;
    __CN1_DEBUG_INFO(951);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[7].data.o, get_static_com_codename1_processing_Result_SELECT_GLOB(threadStateData))==0) /* IFEQ CustomJump */ goto label_L33170663;
...
label_L33170663:
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[7].data.o, get_static_com_codename1_processing_Result_SELECT_PARENT(threadStateData))==0) /* IFEQ CustomJump */ goto label_L228902347;
...
label_L228902347:
    ...
    if ((ilocals_6_ + 1 /* ICONST_1 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1368568577;
...
label_L1368568577:
    ...
    SP--;
    switch((*SP).data.i) {
        case 47: goto label_L27891346;
        case 91: goto label_L705200625;
        default: goto label_L319323253;
    }

label_L27891346:
    __CN1_DEBUG_INFO(967);
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L2055554379;
    __CN1_DEBUG_INFO(968);
    /* VarOp.assignFrom */ locals[10].data.o = /* CustomInvoke */virtual_com_codename1_processing_StructuredContent_getDescendants___java_lang_String_R_java_util_List(threadStateData, locals[1].data.o, locals[7].data.o);locals[10].type=CN1_TYPE_OBJECT;    goto label_L1053555617;
...
label_L1053555617:
    ...
    if (virtual_java_util_List_size___R_int(threadStateData, locals[10].data.o)<=0) /* IFLE CustomJump */ goto label_L1939597292;
...
label_L705200625:
    ...
    if ((ilocals_6_ + 2 /* ICONST_2 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L502458215;
...
label_L502458215:
    ...
    if ((ilocals_6_ + 3 /* ICONST_3 */)<ilocals_4_) /* IF_IMPLT CustomJump */ goto label_L1292719759;
...
label_L1292719759:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[13].data.o)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L746240636;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[13].data.o, 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    PUSH_INT(93);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L746240636;
...
label_L746240636:
    ...
    if (ilocals_6_>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L7511192;
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[14].data.o)==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L7511192;
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[14].data.o, 0 /* ICONST_0 */);
    PUSH_INT(tmpResult); }
    PUSH_INT(47);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L7511192;
...
label_L7511192:
    ...
    if (ilocals_5_==0) /* IFEQ CustomJump */ goto label_L171022894;
    __CN1_DEBUG_INFO(1010);
    /* VarOp.assignFrom */ locals[14].data.o = /* CustomInvoke */virtual_com_codename1_processing_StructuredContent_getDescendants___java_lang_String_R_java_util_List(threadStateData, locals[1].data.o, locals[7].data.o);locals[14].type=CN1_TYPE_OBJECT;    goto label_L766446793;
...
label_L766446793:
    ...
    BC_ALOAD(15);
    BC_INSTANCEOF(cn1_class_id_com_codename1_processing_StructuredContent);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1426061914;
...
label_L1426061914:
    ...
    if (locals[15].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L319323253;
    if (virtual_java_util_List_size___R_int(threadStateData, locals[15].data.o)<=0) /* IFLE CustomJump */ goto label_L319323253;
...
label_L1176189130:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[17].data.o)==0) /* IFEQ CustomJump */ goto label_L1081944577;
