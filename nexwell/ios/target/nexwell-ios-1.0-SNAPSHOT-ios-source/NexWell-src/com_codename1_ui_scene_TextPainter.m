...
JAVA_VOID com_codename1_ui_scene_TextPainter_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle_com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1246335388;
    __CN1_DEBUG_INFO(59);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L1246335388:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1046160944;
    __CN1_DEBUG_INFO(63);
...
label_L1046160944:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L472015917;
        case 4: goto label_L1974219375;
        default: goto label_L1936689207;
    }
...
label_L1936689207:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L341985996;
        case 4: goto label_L460212065;
        default: goto label_L256192809;
    }
