...
JAVA_VOID com_codename1_ui_scene_TextPainter_paint___com_codename1_ui_Graphics_com_codename1_ui_geom_Rectangle_com_codename1_ui_scene_Node(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L6565574;
    __CN1_DEBUG_INFO(59);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L6565574:
    ...
    if (locals[5].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L106311724;
    __CN1_DEBUG_INFO(63);
...
label_L106311724:
    ...
    SP--;
    switch((*SP).data.i) {
        case 3: goto label_L1869228744;
        case 4: goto label_L1233162869;
        default: goto label_L1756600221;
    }
...
label_L1756600221:
    ...
    SP--;
    switch((*SP).data.i) {
        case 2: goto label_L1607671287;
        case 4: goto label_L1641107631;
        default: goto label_L747595226;
    }
