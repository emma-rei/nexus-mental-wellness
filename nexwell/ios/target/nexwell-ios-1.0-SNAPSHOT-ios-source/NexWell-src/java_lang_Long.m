...
JAVA_VOID java_lang_Long___INIT_____long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_LONG __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 1126, 202);
...
JAVA_DOUBLE java_lang_Long_doubleValue___R_double(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 1017);
...
JAVA_BOOLEAN java_lang_Long_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 1126, 877);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1408279755;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1408279755;
    if (CN1_CMP_EXPR(get_field_java_lang_Long_value(locals[1].data.o), get_field_java_lang_Long_value(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1408279755;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L2007486296;
...
JAVA_FLOAT java_lang_Long_floatValue___R_float(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 1018);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_LONG(get_field_java_lang_Long_value(__cn1ThisObject));
...
JAVA_INT java_lang_Long_hashCode___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 1126, 882);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_LONG(get_field_java_lang_Long_value(__cn1ThisObject));
...
JAVA_LONG java_lang_Long_longValue___R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 1023);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_LONG(get_field_java_lang_Long_value(__cn1ThisObject));
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return POP_LONG();
}
...
JAVA_INT java_lang_Long_intValue___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 1019);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_LONG(get_field_java_lang_Long_value(__cn1ThisObject));
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return SP[-1].data.i;
}
...
JAVA_BYTE java_lang_Long_byteValue___R_byte(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 1015);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     PUSH_LONG(get_field_java_lang_Long_value(__cn1ThisObject));
    SP[-1].data.i = (JAVA_INT)SP[-1].data.l; /* L2I */
...
JAVA_LONG java_lang_Long_parseLong___java_lang_String_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 1126, 1127);
...
JAVA_LONG java_lang_Long_parseLong___java_lang_String_int_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 1126, 1127);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_1_ = __cn1Arg2;
    if (ilocals_1_<2 /* ICONST_2 */) /* IF_IMPLT CustomJump */ goto label_L1033348658;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    PUSH_INT(36);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1634723627;
...
label_L1033348658:
    ...
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1070));
...
label_L1634723627:
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L938463537;
...
label_L938463537:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L2121995675;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
label_L2121995675:
    ...
    PUSH_INT(tmpResult); }
    PUSH_INT(45);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2120063568;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1620409359;
...
label_L1620409359:
    BC_ISTORE(4);
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L691691381;
    BC_IINC(3, 1);
    if (ilocals_3_!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L691691381;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
JAVA_LONG java_lang_Long_parse___java_lang_String_int_int_boolean_R_long(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_BOOLEAN __cn1Arg4) {
    ...
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(4, 13, 0, 1126, 1071);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    JAVA_INT ilocals_1_ = __cn1Arg2;
...
label_L2018260103:
    if (CN1_CMP_EXPR(((JAVA_LONG)ilocals_1_), llocals_8_)>=0) /* IFGE CustomJump */ goto label_L264978436;
    BC_ALOAD(0);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_1_; 
    SP++;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    BC_ISTORE(10);
    if (ilocals_10_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L500618423;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());

label_L500618423:
    if (CN1_CMP_EXPR(llocals_4_, llocals_6_)<=0) /* IFLE CustomJump */ goto label_L1458091526;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());

label_L1458091526:
    /* VarOp.assignFrom */ llocals_11_=((llocals_6_ * ((JAVA_LONG)ilocals_2_)) - ((JAVA_LONG)ilocals_10_));
    if (CN1_CMP_EXPR(llocals_11_, llocals_6_)<=0) /* IFLE CustomJump */ goto label_L768776793;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());

label_L768776793:
    /* VarOp.assignFrom */     llocals_6_ = llocals_11_;
    goto label_L2018260103;

label_L264978436:
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1393828949;
    BC_LLOAD(6);
    SP[-1].data.l *= -1; /* LNEG */
    BC_LSTORE(6);
    if (CN1_CMP_EXPR(llocals_6_, 0 /* LCONST_0 */)>=0) /* IFGE CustomJump */ goto label_L1393828949;
    /* CustomInvoke */PUSH_OBJ(java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(threadStateData, locals[0].data.o));
    throwException(threadStateData, POP_OBJ());
...
JAVA_OBJECT java_lang_Long_invalidLong___java_lang_String_R_java_lang_NumberFormatException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(4, 1, 0, 1126, 1128);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    PUSH_POINTER(__NEW_java_lang_NumberFormatException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(1129));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
JAVA_OBJECT java_lang_Long_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 1126, 896);
...
JAVA_OBJECT java_lang_Long_toString___long_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 1126, 896);
...
JAVA_OBJECT java_lang_Long_valueOf___long_R_java_lang_Long(CODENAME_ONE_THREAD_STATE, JAVA_LONG __cn1Arg1) {
    __STATIC_INITIALIZER_java_lang_Long(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 1126, 899);
    JAVA_LONG llocals_0_ = __cn1Arg1;
...
JAVA_INT java_lang_Long_compareTo___java_lang_Long_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 1126, 871);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    if (CN1_CMP_EXPR(get_field_java_lang_Long_value(__cn1ThisObject), get_field_java_lang_Long_value(locals[1].data.o))>=0) /* IFGE CustomJump */ goto label_L1620529408;
    PUSH_INT(-1); /* ICONST_M1 */
    goto label_L307488715;

label_L1620529408:
    if (CN1_CMP_EXPR(get_field_java_lang_Long_value(__cn1ThisObject), get_field_java_lang_Long_value(locals[1].data.o))<=0) /* IFLE CustomJump */ goto label_L758572926;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L307488715;
...
JAVA_INT java_lang_Long_compareTo___java_lang_Object_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1126, 871);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID java_lang_Long___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 1126, 860);
