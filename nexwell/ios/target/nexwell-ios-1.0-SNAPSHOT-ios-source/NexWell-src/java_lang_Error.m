...
const struct clazz *base_interfaces_for_java_lang_Error[] = {};
struct clazz class__java_lang_Error = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_java_lang_Error ,0 , &__GC_MARK_java_lang_Error,  0, cn1_class_id_java_lang_Error, "java.lang.Error", 0, 0, 0, JAVA_FALSE, &class__java_lang_Throwable, base_interfaces_for_java_lang_Error, 0, &__NEW_INSTANCE_java_lang_Error, 0
, 0, 0, 0, 0, 0, 0};

JAVA_VOID __FINALIZER_java_lang_Error(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete) {
    __FINALIZER_java_lang_Throwable(threadStateData, objToDelete);
}

void __GC_MARK_java_lang_Error(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    struct obj__java_lang_Error* objInstance = (struct obj__java_lang_Error*)objToMark;
    __GC_MARK_java_lang_Throwable(threadStateData, objToMark, force);
}

JAVA_OBJECT __NEW_java_lang_Error(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_java_lang_Error(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__java_lang_Error), &class__java_lang_Error);
    return o;
}

JAVA_OBJECT __NEW_INSTANCE_java_lang_Error(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_java_lang_Error(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__java_lang_Error), &class__java_lang_Error);
java_lang_Error___INIT____(threadStateData, o);
    return o;
}


JAVA_VOID java_lang_Error___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7182, 202);
...
JAVA_VOID java_lang_Error___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7182, 202);
...
JAVA_VOID java_lang_Error___INIT_____java_lang_String_java_lang_Throwable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 7182, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
void __INIT_VTABLE_java_lang_Error(CODENAME_ONE_THREAD_STATE, void** vtable) {
        __INIT_VTABLE_java_lang_Throwable(threadStateData, vtable);
}

static int __java_lang_Error_LOADED__=0;
void __STATIC_INITIALIZER_java_lang_Error(CODENAME_ONE_THREAD_STATE) {
    if(__java_lang_Error_LOADED__) return;

    monitorEnter(threadStateData, (JAVA_OBJECT)&class__java_lang_Error);
    if(class__java_lang_Error.initialized) {
        monitorExit(threadStateData, (JAVA_OBJECT)&class__java_lang_Error);
        return;
    }

    class__java_lang_Error.vtable = malloc(sizeof(void*) *12);
    __INIT_VTABLE_java_lang_Error(threadStateData, class__java_lang_Error.vtable);
    class__java_lang_Error.initialized = JAVA_TRUE;
monitorExit(threadStateData, (JAVA_OBJECT)&class__java_lang_Error);
__java_lang_Error_LOADED__=1;
}
