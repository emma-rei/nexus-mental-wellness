...
JAVA_OBJECT com_nexus_nexwell_homepage_ContentFeed_getRandomQuote___R_java_lang_String(CODENAME_ONE_THREAD_STATE) {
    ...
    __STATIC_INITIALIZER_com_nexus_nexwell_homepage_ContentFeed(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 10397, 10400);
...
JAVA_VOID com_nexus_nexwell_homepage_ContentFeed___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 10397, 859);
    __CN1_DEBUG_INFO(16);
    PUSH_INT(60);
    SP--;
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10401));
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10402));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10403));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10404));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(10405));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    SP--;
    __CN1_DEBUG_INFO(83);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10461), STRING_FROM_CONSTANT_POOL_OFFSET(10462)); 
    __CN1_DEBUG_INFO(84);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10463), STRING_FROM_CONSTANT_POOL_OFFSET(10464)); 
    __CN1_DEBUG_INFO(85);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10465), STRING_FROM_CONSTANT_POOL_OFFSET(10466)); 
    __CN1_DEBUG_INFO(86);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10467), STRING_FROM_CONSTANT_POOL_OFFSET(10468)); 
    __CN1_DEBUG_INFO(87);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10469), STRING_FROM_CONSTANT_POOL_OFFSET(10470)); 
    __CN1_DEBUG_INFO(88);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10471), STRING_FROM_CONSTANT_POOL_OFFSET(10472)); 
    __CN1_DEBUG_INFO(89);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10473), STRING_FROM_CONSTANT_POOL_OFFSET(10474)); 
    __CN1_DEBUG_INFO(90);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10475), STRING_FROM_CONSTANT_POOL_OFFSET(10476)); 
    __CN1_DEBUG_INFO(91);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10477), STRING_FROM_CONSTANT_POOL_OFFSET(10478)); 
    __CN1_DEBUG_INFO(92);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10479), STRING_FROM_CONSTANT_POOL_OFFSET(10480)); 
    __CN1_DEBUG_INFO(93);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(10481), STRING_FROM_CONSTANT_POOL_OFFSET(10482)); 
    __CN1_DEBUG_INFO(94);
    /* CustomInvoke */virtual_java_util_Map_put___java_lang_Object_java_lang_Object_R_java_lang_Object(threadStateData, get_static_com_nexus_nexwell_homepage_ContentFeed_webLinks(threadStateData), STRING_FROM_CONSTANT_POOL_OFFSET(3196), STRING_FROM_CONSTANT_POOL_OFFSET(10483)); 
    __CN1_DEBUG_INFO(95);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
}
