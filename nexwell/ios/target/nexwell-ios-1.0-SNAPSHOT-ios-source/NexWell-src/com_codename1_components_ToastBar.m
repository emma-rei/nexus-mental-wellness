...
JAVA_OBJECT com_codename1_components_ToastBar_getInstance___R_com_codename1_components_ToastBar(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(2, 0, 0, 10540, 1318);
    __CN1_DEBUG_INFO(130);
    if (get_static_com_codename1_components_ToastBar_instance(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L325023242;
...
JAVA_VOID com_codename1_components_ToastBar___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 10540, 201);
...
JAVA_INT com_codename1_components_ToastBar_getPosition___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 10540, 6148);
...
JAVA_VOID com_codename1_components_ToastBar_updateStatus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(6, 10, 0, 10540, 10548);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL70546486901;
    int tryBlockOffsetL70546486901;
    DEFINE_CATCH_BLOCK(catch_L70546486901, label_L747717476, restoreToL70546486901);
    int restoreToL172449296202;
    int tryBlockOffsetL172449296202;
    DEFINE_CATCH_BLOCK(catch_L172449296202, label_L747717476, restoreToL172449296202);
    int restoreToL17433710803;
    int tryBlockOffsetL17433710803;
    DEFINE_CATCH_BLOCK(catch_L17433710803, label_L747717476, restoreToL17433710803);
    int restoreToL74771747604;
    int tryBlockOffsetL74771747604;
    DEFINE_CATCH_BLOCK(catch_L74771747604, label_L747717476, restoreToL74771747604);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L633820912, 0);

label_L705464869:
 tryBlockOffsetL70546486901 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L70546486901);
    restoreToL70546486901 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(535);
    if (get_field_com_codename1_components_ToastBar_updatingStatus(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1724492962, 0);
...
label_L1724492962:
 tryBlockOffsetL172449296202 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L172449296202);
    restoreToL172449296202 = threadStateData->threadObjectStackOffset;
    ...
    if (/* CustomInvoke */com_codename1_components_ToastBar_ToastBarComponent_access$500___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_components_ToastBar_Status(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1049401729, 1);
    ...
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1049401729, 1);
...
label_L1049401729:
    ...
    if (/* CustomInvoke */com_codename1_components_ToastBar_ToastBarComponent_access$500___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_components_ToastBar_Status(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L568535158, 1);
    if (virtual_java_util_ArrayList_isEmpty___R_boolean(threadStateData, get_field_com_codename1_components_ToastBar_statuses(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L174337108, 0);

label_L568535158:
    __CN1_DEBUG_INFO(545);
    if (virtual_java_util_ArrayList_isEmpty___R_boolean(threadStateData, get_field_com_codename1_components_ToastBar_statuses(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L298021609, 1);
...
label_L174337108:
 tryBlockOffsetL17433710803 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L17433710803);
    restoreToL17433710803 = threadStateData->threadObjectStackOffset;
    ...
    BC_DUP(); /* DUP */
    if (virtual_com_codename1_components_ToastBar_Status_getMessage___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1933672516, 1);
...
label_L1491862772:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1387426106, 1);
...
label_L1424200964:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L736062588, 1);
    if (virtual_com_codename1_ui_Image_getWidth___R_int(threadStateData, locals[4].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L736062588, 1);
...
label_L736062588:
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L330045015, 1);
    if (virtual_com_codename1_ui_Image_getHeight___R_int(threadStateData, locals[4].data.o)<=0) /* IFLE CustomJump */ JUMP_TO(label_L330045015, 1);
...
label_L1387426106:
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1389792953, 1);
...
label_L1389792953:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getProgress___R_int(threadStateData, locals[2].data.o)<-1 /* ICONST_M1 */) /* IF_IMPLT CustomJump */ JUMP_TO(label_L441809490, 1);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L1253661160, 1);
...
label_L1253661160:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getProgress___R_int(threadStateData, locals[2].data.o)<-1 /* ICONST_M1 */) /* IF_IMPLT CustomJump */ JUMP_TO(label_L970256454, 1);
    ...
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L1603338883, 1);
...
label_L1603338883:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getProgress___R_int(threadStateData, locals[2].data.o)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1848075465, 1);
...
label_L1850803964:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1880726960, 1);
    PUSH_INT(1); /* ICONST_1 */
...
label_L659229738:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1914647846, 1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_components_ToastBar_ToastBarComponent_access$1100___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_ui_Label(threadStateData, locals[1].data.o));
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1914647846, 1);
...
label_L1914647846:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L346008447, 1);
    BC_ALOAD(1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_components_ToastBar_ToastBarComponent_access$1100___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_ui_Label(threadStateData, locals[1].data.o));
    { JAVA_INT tmpResult = virtual_com_codename1_components_ToastBar_ToastBarComponent_contains___com_codename1_ui_Component_R_boolean(threadStateData, SP[-2].data.o, SP[-1].data.o);
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L346008447, 1);
    __CN1_DEBUG_INFO(606);
    BC_ALOAD(1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_components_ToastBar_ToastBarComponent_access$1100___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_ui_Label(threadStateData, locals[1].data.o));
    virtual_com_codename1_components_ToastBar_ToastBarComponent_removeComponent___com_codename1_ui_Component(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    JUMP_TO(label_L685195329, 1);

label_L346008447:
    __CN1_DEBUG_INFO(607);
    if (virtual_com_codename1_components_ToastBar_Status_getIcon___R_com_codename1_ui_Image(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L685195329, 1);
    BC_ALOAD(1);
    /* CustomInvoke */PUSH_OBJ(com_codename1_components_ToastBar_ToastBarComponent_access$1100___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_ui_Label(threadStateData, locals[1].data.o));
    { JAVA_INT tmpResult = virtual_com_codename1_components_ToastBar_ToastBarComponent_contains___com_codename1_ui_Component_R_boolean(threadStateData, SP[-2].data.o, SP[-1].data.o);
    SP-=1;
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ JUMP_TO(label_L685195329, 1);
...
label_L685195329:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getUiid___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1556060910, 1);
...
label_L1556060910:
    ...
    if (get_field_com_codename1_components_ToastBar_defaultUIID(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L898762325, 1);
...
label_L898762325:
    ...
    if (virtual_com_codename1_components_ToastBar_ToastBarComponent_isVisible___R_boolean(threadStateData, locals[1].data.o)==0) /* IFEQ CustomJump */ JUMP_TO(label_L659918318, 1);
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getMessageUIID___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1627965794, 1);
    ...
    JUMP_TO(label_L1103124295, 1);

label_L1627965794:
    __CN1_DEBUG_INFO(634);
    if (get_field_com_codename1_components_ToastBar_defaultMessageUIID(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1682264452, 1);
...
label_L1103124295:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getUiid___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1869912607, 1);
    __CN1_DEBUG_INFO(640);
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_ToastBar_Status_getUiid___R_java_lang_String(threadStateData, locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    virtual_com_codename1_components_ToastBar_ToastBarComponent_setUIID___java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    JUMP_TO(label_L1217400138, 1);

label_L1869912607:
    __CN1_DEBUG_INFO(641);
    if (get_field_com_codename1_components_ToastBar_defaultUIID(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1217400138, 1);
...
label_L1217400138:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    if(POP_OBJ() == JAVA_NULL) /* IFNULL */ JUMP_TO(label_L195625328, 1);
    ...
    if (virtual_com_codename1_ui_geom_Dimension_getHeight___R_int(threadStateData, locals[6].data.o)==virtual_com_codename1_ui_geom_Dimension_getHeight___R_int(threadStateData, locals[7].data.o)) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L195625328, 1);
...
label_L659918318:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getMessageUIID___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L239171112, 1);
    __CN1_DEBUG_INFO(667);
    /* CustomInvoke */PUSH_OBJ(com_codename1_components_ToastBar_ToastBarComponent_access$1200___com_codename1_components_ToastBar_ToastBarComponent_R_com_codename1_ui_TextArea(threadStateData, locals[1].data.o));
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_ToastBar_Status_getMessageUIID___R_java_lang_String(threadStateData, locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    virtual_com_codename1_ui_TextArea_setUIID___java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    JUMP_TO(label_L1190383863, 1);

label_L239171112:
    __CN1_DEBUG_INFO(668);
    if (get_field_com_codename1_components_ToastBar_defaultMessageUIID(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1190383863, 1);
...
label_L1190383863:
    ...
    if (virtual_com_codename1_components_ToastBar_Status_getUiid___R_java_lang_String(threadStateData, locals[2].data.o)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L93518808, 1);
    __CN1_DEBUG_INFO(672);
    BC_ALOAD(1);
    { JAVA_OBJECT tmpResult = virtual_com_codename1_components_ToastBar_Status_getUiid___R_java_lang_String(threadStateData, locals[2].data.o);
    PUSH_OBJ(tmpResult); }
    virtual_com_codename1_components_ToastBar_ToastBarComponent_setUIID___java_lang_String(threadStateData, SP[-2].data.o, SP[-1].data.o);     SP-= 2;
    JUMP_TO(label_L894151346, 1);

label_L93518808:
    __CN1_DEBUG_INFO(673);
    if (get_field_com_codename1_components_ToastBar_defaultUIID(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L894151346, 1);
...
label_L1160685808:
    ...
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L817785349, 0);

label_L1938527144:

label_L1261185332:
END_TRY(1);    __CN1_DEBUG_INFO(695);
    JUMP_TO(label_L633820912, 0);

label_L747717476:
 tryBlockOffsetL74771747604 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L74771747604);
    restoreToL74771747604 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(686);
    BC_ASTORE(8);
    PUSH_POINTER(JAVA_NULL); /* ACONST_NULL */
    JUMP_TO(label_L1746038925, 0);
...
label_L404775810:
    ...
    if (get_field_com_codename1_components_ToastBar_pendingUpdateStatus(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L2051807852, 0);
...
label_L1264165313:
    ...
    set_field_com_codename1_components_ToastBar_updatingStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(687);
    if (get_field_com_codename1_components_ToastBar_pendingUpdateStatus(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1360502701, 0);
    __CN1_DEBUG_INFO(688);
    set_field_com_codename1_components_ToastBar_pendingUpdateStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(689);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
label_L817785349:
    ...
    set_field_com_codename1_components_ToastBar_updatingStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(687);
    if (get_field_com_codename1_components_ToastBar_pendingUpdateStatus(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L822082387, 0);
    __CN1_DEBUG_INFO(688);
    set_field_com_codename1_components_ToastBar_pendingUpdateStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(689);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
label_L1746038925:
    ...
    set_field_com_codename1_components_ToastBar_updatingStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(687);
    if (get_field_com_codename1_components_ToastBar_pendingUpdateStatus(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L512528515, 0);
    __CN1_DEBUG_INFO(688);
    set_field_com_codename1_components_ToastBar_pendingUpdateStatus(threadStateData, 0 /* ICONST_0 */, __cn1ThisObject);
    __CN1_DEBUG_INFO(689);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
...
JAVA_OBJECT com_codename1_components_ToastBar_createStatus___R_com_codename1_components_ToastBar_Status(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 10540, 10549);
...
JAVA_VOID com_codename1_components_ToastBar_removeStatus___com_codename1_components_ToastBar_Status(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10540, 10550);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(780);
    if (/* CustomInvoke */com_codename1_components_ToastBar_Status_access$200___com_codename1_components_ToastBar_Status_R_java_util_Timer(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L725491769;
...
JAVA_OBJECT com_codename1_components_ToastBar_getLayeredPane___R_com_codename1_ui_Container(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 10540, 2878);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L76017701;
    __CN1_DEBUG_INFO(791);
    PUSH_POINTER(__NEW_java_lang_IllegalStateException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalStateException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10551));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L76017701:
    __CN1_DEBUG_INFO(793);
    if (get_field_com_codename1_components_ToastBar_useFormLayeredPane(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2130014398;
...
JAVA_VOID com_codename1_components_ToastBar_moveLayerToFront__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 10540, 10552);
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L959618433;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); 
    return;
...
label_L959618433:
    ...
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1666665846;
...
label_L1666665846:
    ...
    PUSH_INT(1); /* ICONST_1 */
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1483382753;
...
JAVA_OBJECT com_codename1_components_ToastBar_getToastBarComponent___R_com_codename1_components_ToastBar_ToastBarComponent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 10540, 10553);
...
JAVA_OBJECT com_codename1_components_ToastBar_getToastBarComponent___boolean_R_com_codename1_components_ToastBar_ToastBarComponent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 5, 0, 10540, 10553);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L231695570;
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_Dialog);
    if(POP_INT() != 0) /* IFNE */ goto label_L231695570;
    __CN1_DEBUG_INFO(828);
    /* VarOp.assignFrom */ locals[3].data.o = /* CustomInvoke */virtual_com_codename1_ui_Form_getClientProperty___java_lang_String_R_java_lang_Object(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10554));locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(829);
    if (locals[3].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L549207679;
    if (ilocals_1_!=0) /* IFNE CustomJump */ goto label_L549207679;
    __CN1_DEBUG_INFO(830);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return JAVA_NULL /* ACONST_NULL */;

label_L549207679:
    __CN1_DEBUG_INFO(832);
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2035940323;
    if (virtual_com_codename1_components_ToastBar_ToastBarComponent_getParent___R_com_codename1_ui_Container(threadStateData, locals[3].data.o)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1975576254;
...
label_L2035940323:
    ...
    /* CustomInvoke */virtual_com_codename1_ui_Form_putClientProperty___java_lang_String_java_lang_Object(threadStateData, locals[2].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(10554), locals[3].data.o); 
    ...
    BC_ALOAD(4);
    if (get_field_com_codename1_components_ToastBar_position(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L65004832;
    /* LDC: 'North'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(62));
    goto label_L1112632546;
...
label_L1975576254:
    ...
    if (get_field_com_codename1_components_ToastBar_position(__cn1ThisObject)!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1960907176;
    if (virtual_com_codename1_ui_Form_getInvisibleAreaUnderVKB___R_int(threadStateData, locals[2].data.o)<=0) /* IFLE CustomJump */ goto label_L1960907176;
...
JAVA_VOID com_codename1_components_ToastBar_setVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 4, 0, 10540, 2418);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L115797148;
    if (virtual_com_codename1_components_ToastBar_ToastBarComponent_isVisible___R_boolean(threadStateData, locals[2].data.o)!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L2062352261;
...
label_L2062352261:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L865315398;
...
label_L865315398:
    ...
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
    BC_ALOAD(3);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1305643394;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1305643394;
...
JAVA_OBJECT com_codename1_components_ToastBar_access$000___com_codename1_components_ToastBar_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 10540, 217);
...
JAVA_OBJECT com_codename1_components_ToastBar_access$100___com_codename1_components_ToastBar_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 10540, 798);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(82);
...
JAVA_VOID com_codename1_components_ToastBar_access$300___com_codename1_components_ToastBar(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 10540, 1148);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(82);
...
JAVA_OBJECT com_codename1_components_ToastBar_access$400___com_codename1_components_ToastBar_R_com_codename1_components_ToastBar_ToastBarComponent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 10540, 1149);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(82);
...
JAVA_VOID com_codename1_components_ToastBar_access$700___com_codename1_components_ToastBar_com_codename1_components_ToastBar_Status(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_components_ToastBar(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 10540, 805);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_components_ToastBar___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 10540, 859);
    __CN1_DEBUG_INFO(87);
    PUSH_INT(4000);
