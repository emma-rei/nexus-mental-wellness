...
JAVA_OBJECT com_codename1_processing_XMLContent_wrap___java_lang_String_R_java_io_Reader(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL1474798104cn1_class_id_java_io_UnsupportedEncodingException1;
    int tryBlockOffsetL1474798104cn1_class_id_java_io_UnsupportedEncodingException1;
    DEFINE_CATCH_BLOCK(catch_L1474798104cn1_class_id_java_io_UnsupportedEncodingException1, label_L1963318443, restoreToL1474798104cn1_class_id_java_io_UnsupportedEncodingException1);

label_L1474798104:
 tryBlockOffsetL1474798104cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L1474798104cn1_class_id_java_io_UnsupportedEncodingException1);
    restoreToL1474798104cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_processing_XMLContent_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1838459238;
...
label_L1467448355:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L526395696;
...
JAVA_OBJECT com_codename1_processing_XMLContent_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_xml_Element_isTextElement___R_boolean(threadStateData, get_field_com_codename1_processing_XMLContent_root(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L61210602;
...
label_L61210602:
    ...
    if (virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, get_field_com_codename1_processing_XMLContent_root(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L487747335;
