...
JAVA_OBJECT com_codename1_processing_XMLContent_wrap___java_lang_String_R_java_io_Reader(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    int restoreToL2145336702cn1_class_id_java_io_UnsupportedEncodingException1;
    int tryBlockOffsetL2145336702cn1_class_id_java_io_UnsupportedEncodingException1;
    DEFINE_CATCH_BLOCK(catch_L2145336702cn1_class_id_java_io_UnsupportedEncodingException1, label_L487747335, restoreToL2145336702cn1_class_id_java_io_UnsupportedEncodingException1);

label_L2145336702:
 tryBlockOffsetL2145336702cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_UnsupportedEncodingException, catch_L2145336702cn1_class_id_java_io_UnsupportedEncodingException1);
    restoreToL2145336702cn1_class_id_java_io_UnsupportedEncodingException1 = threadStateData->threadObjectStackOffset;
...
JAVA_OBJECT com_codename1_processing_XMLContent_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1902681826;
...
label_L403937859:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L758750856;
...
JAVA_OBJECT com_codename1_processing_XMLContent_getParent___R_com_codename1_processing_StructuredContent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1307963673;
...
JAVA_OBJECT com_codename1_processing_XMLContent_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (virtual_com_codename1_xml_Element_isTextElement___R_boolean(threadStateData, get_field_com_codename1_processing_XMLContent_root(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L64731067;
...
label_L64731067:
    ...
    if (virtual_com_codename1_xml_Element_getNumChildren___R_int(threadStateData, get_field_com_codename1_processing_XMLContent_root(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1652008086;
...
label_L1652008086:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L1714613017;
