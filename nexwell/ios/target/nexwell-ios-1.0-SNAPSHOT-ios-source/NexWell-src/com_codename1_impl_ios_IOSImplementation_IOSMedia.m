...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia___INIT_____com_codename1_impl_ios_IOSImplementation_java_lang_String_boolean_java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_BOOLEAN __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1243495105;
...
label_L1243495105:
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1853422837;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia___INIT_____com_codename1_impl_ios_IOSImplementation_java_io_InputStream_java_lang_String_java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_OBJECT __cn1Arg4) {
    ...
    locals[4].data.o = __cn1Arg4;
    locals[4].type = CN1_TYPE_OBJECT;
    int restoreToL170126580cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL170126580cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L170126580cn1_class_id_java_io_IOException1, label_L91220956, restoreToL170126580cn1_class_id_java_io_IOException1);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L999221400, 0);
...
label_L999221400:
    ...
    BC_ALOAD(0);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___java_lang_String_R_int(threadStateData, locals[3].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(9647))<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L8197402, 0);
    PUSH_INT(1); /* ICONST_1 */
    JUMP_TO(label_L692838068, 0);
...
label_L692838068:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1392570698, 0);

label_L170126580:
 tryBlockOffsetL170126580cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L170126580cn1_class_id_java_io_IOException1);
    restoreToL170126580cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_markActive__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$2000___com_codename1_impl_ios_IOSImplementation_R_java_util_List(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_this_0(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L528877978;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_fireCompletionHandlers__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_completionHandlers(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2008746677;
    if (virtual_java_util_List_isEmpty___R_boolean(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_completionHandlers(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L2008746677;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_addCompletionHandler___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL12891818201;
    int tryBlockOffsetL12891818201;
    DEFINE_CATCH_BLOCK(catch_L12891818201, label_L15910024, restoreToL12891818201);
    int restoreToL1591002402;
    int tryBlockOffsetL1591002402;
    DEFINE_CATCH_BLOCK(catch_L1591002402, label_L15910024, restoreToL1591002402);
...
label_L128918182:
 tryBlockOffsetL12891818201 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L12891818201);
    restoreToL12891818201 = threadStateData->threadObjectStackOffset;

    __CN1_DEBUG_INFO(3698);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_completionHandlers(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1420623741, 1);
...
label_L1687813541:
END_TRY(1);    JUMP_TO(label_L2076829355, 0);

label_L15910024:
 tryBlockOffsetL1591002402 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L1591002402);
    restoreToL1591002402 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_removeCompletionHandler___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL130165897001;
    int tryBlockOffsetL130165897001;
    DEFINE_CATCH_BLOCK(catch_L130165897001, label_L1418245573, restoreToL130165897001);
    int restoreToL141824557302;
    int tryBlockOffsetL141824557302;
    DEFINE_CATCH_BLOCK(catch_L141824557302, label_L1418245573, restoreToL141824557302);
    __CN1_DEBUG_INFO(3707);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_completionHandlers(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1112075608, 0);
...
label_L1301658970:
 tryBlockOffsetL130165897001 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L130165897001);
    restoreToL130165897001 = threadStateData->threadObjectStackOffset;
...
label_L1790202239:
END_TRY(1);    JUMP_TO(label_L1112075608, 0);

label_L1418245573:
 tryBlockOffsetL141824557302 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L141824557302);
    restoreToL141824557302 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_playImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL1366581056cn1_class_id_java_io_IOException1;
    int tryBlockOffsetL1366581056cn1_class_id_java_io_IOException1;
    DEFINE_CATCH_BLOCK(catch_L1366581056cn1_class_id_java_io_IOException1, label_L1898751355, restoreToL1366581056cn1_class_id_java_io_IOException1);
    __CN1_DEBUG_INFO(3716);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1164241227, 0);
    __CN1_DEBUG_INFO(3717);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_component(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1414744767, 0);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_nativePlayer(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L1414744767, 0);
    __CN1_DEBUG_INFO(3720);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_uri(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1366581056, 0);
    ...
    PUSH_LONG(tmpResult); }
    set_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(threadStateData, POP_LONG(), POP_OBJ());
    JUMP_TO(label_L1164394344, 0);

label_L1366581056:
 tryBlockOffsetL1366581056cn1_class_id_java_io_IOException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_io_IOException, catch_L1366581056cn1_class_id_java_io_IOException1);
    restoreToL1366581056cn1_class_id_java_io_IOException1 = threadStateData->threadObjectStackOffset;
    ...
    if (CN1_CMP_EXPR(llocals_1_, 0 /* LCONST_0 */)<=0) /* IFLE CustomJump */ JUMP_TO(label_L665565246, 1);
...
label_L1414744767:
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ JUMP_TO(label_L438228197, 0);
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_unmarkActive__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (/* CustomInvoke */com_codename1_impl_ios_IOSImplementation_access$2000___com_codename1_impl_ios_IOSImplementation_R_java_util_List(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_this_0(__cn1ThisObject))==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1719547057;
    /* CustomInvoke */PUSH_OBJ(com_codename1_impl_ios_IOSImplementation_access$2000___com_codename1_impl_ios_IOSImplementation_R_java_util_List(threadStateData, get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_this_0(__cn1ThisObject)));
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1719547057;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_pauseImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L476973576;
    __CN1_DEBUG_INFO(3758);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1840940155;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_prepare__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L32496853;
    __CN1_DEBUG_INFO(3771);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L32496853;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_cleanup__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L2062667107;
...
label_L2062667107:
    ...
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1129387802;
...
JAVA_VOID com_codename1_impl_ios_IOSImplementation_IOSMedia_setTime___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L1128158063;
    __CN1_DEBUG_INFO(3816);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L144467413;
...
JAVA_BOOLEAN com_codename1_impl_ios_IOSImplementation_IOSMedia_isPlaying___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (CN1_CMP_EXPR(get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_moviePlayerPeer(__cn1ThisObject), 0 /* LCONST_0 */)==0) /* IFEQ CustomJump */ goto label_L159917166;
    __CN1_DEBUG_INFO(3849);
    if (get_field_com_codename1_impl_ios_IOSImplementation_IOSMedia_isVideo(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1649498695;
