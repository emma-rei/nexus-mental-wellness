...
JAVA_VOID com_codename1_ui_Label_1___INIT_____com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6830, 202);
...
JAVA_VOID com_codename1_ui_Label_1_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 6830, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(59);
    if (virtual_com_codename1_ui_Label_isInitialized___R_boolean(threadStateData, get_field_com_codename1_ui_Label_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1354314579;
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1354314579;
    __CN1_DEBUG_INFO(60);
