...
JAVA_VOID com_codename1_io_NetworkManager_2WaitingClass___INIT_____com_codename1_io_NetworkManager_com_codename1_io_ConnectionRequest(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 7330, 202);
...
JAVA_VOID com_codename1_io_NetworkManager_2WaitingClass_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7330, 204);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL546850887cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL546850887cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L546850887cn1_class_id_java_lang_InterruptedException1, label_L1943829936, restoreToL546850887cn1_class_id_java_lang_InterruptedException1);
    int restoreToL1065695827cn1_class_id_java_lang_InterruptedException2;
    int tryBlockOffsetL1065695827cn1_class_id_java_lang_InterruptedException2;
    DEFINE_CATCH_BLOCK(catch_L1065695827cn1_class_id_java_lang_InterruptedException2, label_L440033814, restoreToL1065695827cn1_class_id_java_lang_InterruptedException2);
    __CN1_DEBUG_INFO(701);
    if (get_field_com_codename1_io_NetworkManager_2WaitingClass_edt(__cn1ThisObject)==0) /* IFEQ CustomJump */ JUMP_TO(label_L832481686, 0);

label_L230836018:
    __CN1_DEBUG_INFO(702);
    if (get_field_com_codename1_io_NetworkManager_2WaitingClass_finishedWaiting(__cn1ThisObject)!=0) /* IFNE CustomJump */ JUMP_TO(label_L501455043, 0);

label_L546850887:
 tryBlockOffsetL546850887cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L546850887cn1_class_id_java_lang_InterruptedException1);
    restoreToL546850887cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L832481686:
    ...
    if (get_field_com_codename1_io_ConnectionRequest_complete(get_field_com_codename1_io_NetworkManager_2WaitingClass_val_request(__cn1ThisObject))!=0) /* IFNE CustomJump */ JUMP_TO(label_L501455043, 0);

label_L1065695827:
 tryBlockOffsetL1065695827cn1_class_id_java_lang_InterruptedException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L1065695827cn1_class_id_java_lang_InterruptedException2);
    restoreToL1065695827cn1_class_id_java_lang_InterruptedException2 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_io_NetworkManager_2WaitingClass_actionPerformed___com_codename1_io_NetworkEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 7330, 3048);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(721);
    if (virtual_com_codename1_io_NetworkEvent_getError___R_java_lang_Exception(threadStateData, locals[1].data.o)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1151446606;
...
label_L1151446606:
    ...
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L3636565;
    __CN1_DEBUG_INFO(728);
    if (virtual_com_codename1_io_NetworkEvent_getProgressType___R_int(threadStateData, locals[1].data.o)!=4/* ICONST_4 */) /* IF_ICMPNE CustomJump */ goto label_L3636565;
    __CN1_DEBUG_INFO(729);
    if (get_field_com_codename1_io_ConnectionRequest_retrying(get_field_com_codename1_io_NetworkManager_2WaitingClass_val_request(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L26462224;
