...
JAVA_OBJECT com_codename1_processing_MapContent_toString___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L1703412736;
    __CN1_DEBUG_INFO(110);
    if (/* CustomInvoke */virtual_java_util_Map_containsKey___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_processing_MapContent_root(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(7638))==0) /* IFEQ CustomJump */ goto label_L1096030628;
...
JAVA_BOOLEAN com_codename1_processing_MapContent_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (virtual_java_lang_Object_hashCode___R_int(threadStateData, get_field_com_codename1_processing_MapContent_root(__cn1ThisObject))!=virtual_java_lang_Object_hashCode___R_int(threadStateData, locals[1].data.o)) /* IF_ICMPNE CustomJump */ goto label_L1251935072;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1863497271;
...
JAVA_OBJECT com_codename1_processing_MapContent__asStructuredContentArray___java_util_List_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L250219336;
...
label_L1329489396:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L394568342;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(179);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1723212594;
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_java_util_Vector);
    if(POP_INT() == 0) /* IFEQ */ goto label_L404923931;

label_L1723212594:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L604991790;
...
label_L1002650329:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[5].data.o)==0) /* IFEQ CustomJump */ goto label_L1761988656;
    ...
    if (/* CustomInvoke */virtual_java_util_Map_containsKey___java_lang_Object_R_boolean(threadStateData, locals[4].data.o, locals[1].data.o)==0) /* IFEQ CustomJump */ goto label_L1679470965;
    __CN1_DEBUG_INFO(186);
    goto label_L1761988656;

label_L1679470965:
    __CN1_DEBUG_INFO(189);
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;    locals[4].data.o = JAVA_NULL /* ACONST_NULL */; 
locals[4].type=CN1_TYPE_OBJECT;    goto label_L1002650329;

label_L1761988656:
    __CN1_DEBUG_INFO(191);
    if (locals[4].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1798680820;
    __CN1_DEBUG_INFO(192);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L754346482;
...
label_L1048435582:
    ...
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L500622336;
    __CN1_DEBUG_INFO(202);
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L1071714449;
...
label_L500622336:
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_java_util_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L2039850377;
...
label_L2039850377:
    ...
    BC_ALOAD(2);
    BC_INSTANCEOF(cn1_class_id_java_util_Map);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1723067056;
...
label_L1723067056:
    ...
    if (ilocals_3_==0) /* IFEQ CustomJump */ goto label_L802183957;
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(239);
    if (ilocals_1_<0) /* IFLT CustomJump */ goto label_L1989797386;
    if (ilocals_1_<virtual_java_util_Map_size___R_int(threadStateData, locals[2].data.o)) /* IF_IMPLT CustomJump */ goto label_L1539048255;
...
label_L757046979:
    if (ilocals_4_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L1934240791;
...
JAVA_OBJECT com_codename1_processing_MapContent_getDescendants___java_lang_String_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    PUSH_POINTER(get_field_com_codename1_processing_MapContent_root(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_java_util_Vector);
    if(POP_INT() != 0) /* IFNE */ goto label_L344954076;
    PUSH_POINTER(get_field_com_codename1_processing_MapContent_root(__cn1ThisObject));
    BC_INSTANCEOF(cn1_class_id_java_util_Hashtable);
    if(POP_INT() == 0) /* IFEQ */ goto label_L789698697;
...
label_L826733527:
    if (ilocals_4_>=virtual_java_util_List_size___R_int(threadStateData, locals[2].data.o)) /* IF_ICMPGE CustomJump */ goto label_L362023079;
...
label_L1398063054:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_java_util_List);
    if(POP_INT() == 0) /* IFEQ */ goto label_L122225111;
...
JAVA_VOID com_codename1_processing_MapContent__findByName___java_util_List_java_util_Map_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    if (/* CustomInvoke */virtual_java_util_Map_containsKey___java_lang_Object_R_boolean(threadStateData, locals[2].data.o, locals[3].data.o)==0) /* IFEQ CustomJump */ goto label_L69338216;
...
label_L785197732:
    if (virtual_java_util_Iterator_hasNext___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1039565260;
...
label_L1000871406:
    ...
    BC_ALOAD(5);
    BC_INSTANCEOF(cn1_class_id_java_util_Map);
    if(POP_INT() == 0) /* IFEQ */ goto label_L800933815;
    __CN1_DEBUG_INFO(310);
    /* CustomInvoke */com_codename1_processing_MapContent__findByName___java_util_List_java_util_Map_java_lang_String(threadStateData, __cn1ThisObject, locals[1].data.o, locals[5].data.o, locals[3].data.o); 

label_L800933815:
    __CN1_DEBUG_INFO(312);
    goto label_L785197732;
...
JAVA_OBJECT com_codename1_processing_MapContent_getParent___R_com_codename1_processing_StructuredContent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_processing_MapContent_parent(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L666642000;
...
label_L1547714604:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L428156140;
