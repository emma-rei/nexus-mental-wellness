...
JAVA_VOID java_util_HashMap_AbstractMapIterator___INIT_____java_util_HashMap(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 5725, 201);
...
JAVA_BOOLEAN java_util_HashMap_AbstractMapIterator_hasNext___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 5725, 1249);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     if (get_field_java_util_HashMap_AbstractMapIterator_futureEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L608519258;
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L608519258:
    if (get_field_java_util_HashMap_AbstractMapIterator_position(__cn1ThisObject)>=CN1_ARRAY_LENGTH(get_field_java_util_HashMap_elementData(get_field_java_util_HashMap_AbstractMapIterator_associatedMap(__cn1ThisObject)))) /* IF_ICMPGE CustomJump */ goto label_L1963075870;
    if (CN1_ARRAY_ELEMENT_OBJECT(get_field_java_util_HashMap_elementData(get_field_java_util_HashMap_AbstractMapIterator_associatedMap(__cn1ThisObject)), get_field_java_util_HashMap_AbstractMapIterator_position(__cn1ThisObject))!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L397071633;
...
JAVA_VOID java_util_HashMap_AbstractMapIterator_makeNext__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(6, 1, 0, 5725, 5727);
    ...
    if (virtual_java_util_HashMap_AbstractMapIterator_hasNext___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1184124073;
...
label_L1184124073:
    if (get_field_java_util_HashMap_AbstractMapIterator_futureEntry(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L582666172;
    BC_ALOAD(0);
    ...
    goto label_L1668910247;

label_L582666172:
    if (get_field_java_util_HashMap_AbstractMapIterator_currentEntry(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1175631958;
...
JAVA_VOID java_util_HashMap_AbstractMapIterator_remove__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 5725, 1231);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     virtual_java_util_HashMap_AbstractMapIterator_checkConcurrentMod__(threadStateData, __cn1ThisObject); 
    if (get_field_java_util_HashMap_AbstractMapIterator_currentEntry(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L579294521;
...
label_L579294521:
    if (get_field_java_util_HashMap_AbstractMapIterator_prevEntry(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1450500594;
