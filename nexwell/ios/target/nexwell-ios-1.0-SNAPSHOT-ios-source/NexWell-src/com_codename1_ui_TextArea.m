...
JAVA_INT com_codename1_ui_TextArea_getDefaultValign___R_int(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 4096, 4097);
    __CN1_DEBUG_INFO(75);
...
JAVA_VOID com_codename1_ui_TextArea_setDefaultValign___int(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 4098);
...
JAVA_VOID com_codename1_ui_TextArea___INIT_____int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(271);
    /* CustomInvoke */com_codename1_ui_TextArea___INIT_____java_lang_String_int_int_int_int(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219), get_static_com_codename1_ui_TextArea_defaultMaxSize(threadStateData), ilocals_1_, ilocals_2_, 0 /* ICONST_0 */); 
...
JAVA_VOID com_codename1_ui_TextArea___INIT_____int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    __CN1_DEBUG_INFO(285);
    /* CustomInvoke */com_codename1_ui_TextArea___INIT_____java_lang_String_int_int_int_int(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219), get_static_com_codename1_ui_TextArea_defaultMaxSize(threadStateData), ilocals_1_, ilocals_2_, ilocals_3_); 
...
JAVA_VOID com_codename1_ui_TextArea___INIT_____java_lang_String_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
JAVA_VOID com_codename1_ui_TextArea___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(6, 2, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_TextArea_initComponent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 1848);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L448569108;
...
JAVA_VOID com_codename1_ui_TextArea_deinitialize__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 1326);
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1779090574;
...
JAVA_INT com_codename1_ui_TextArea_numCols___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(2, 2, 0, 4096, 4099);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(384);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L618696025;
...
label_L618696025:
    ...
    if (ilocals_1_>=3 /* ICONST_3 */) /* IF_ICMPGE CustomJump */ goto label_L2009832657;
...
label_L2009832657:
    ...
    SP++;
    PUSH_INT(80);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L158460163;
...
JAVA_INT com_codename1_ui_TextArea_nl___java_lang_String_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 4100);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(398);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L895705623;
...
JAVA_VOID com_codename1_ui_TextArea___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(407);
    /* CustomInvoke */com_codename1_ui_TextArea___INIT_____java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
...
JAVA_VOID com_codename1_ui_TextArea___INIT_____java_lang_String_int_int_int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 6, 0, 4096, 201);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ...
    set_field_com_codename1_ui_TextArea_unsupportedChars(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(4101), __cn1ThisObject);
    __CN1_DEBUG_INFO(203);
    set_field_com_codename1_ui_TextArea_constraint(threadStateData, 2097152, __cn1ThisObject);
    __CN1_DEBUG_INFO(205);
    set_field_com_codename1_ui_TextArea_text(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(219), __cn1ThisObject);
    ...
    set_field_com_codename1_ui_TextArea_lastTextValue(threadStateData, STRING_FROM_CONSTANT_POOL_OFFSET(219), __cn1ThisObject);
    ...
    /* CustomInvoke */virtual_com_codename1_ui_TextArea_setUIID___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(4102)); 
    ...
    if (ilocals_3_>0) /* IFGT CustomJump */ goto label_L357153703;
    __CN1_DEBUG_INFO(430);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4103));     SP -= 1;
    throwException(threadStateData, POP_OBJ());

label_L357153703:
    __CN1_DEBUG_INFO(432);
    if (ilocals_4_>1 /* ICONST_1 */) /* IF_ICMPGT CustomJump */ goto label_L1045397707;
    if (ilocals_3_==1 /* ICONST_1 */) /* IF_ICMPEQ CustomJump */ goto label_L1045397707;
    __CN1_DEBUG_INFO(433);
    PUSH_POINTER(__NEW_java_lang_IllegalArgumentException(threadStateData)); /* NEW */
    BC_DUP(); /* DUP */
    /* CustomInvoke */java_lang_IllegalArgumentException___INIT_____java_lang_String(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4104));     SP -= 1;
    throwException(threadStateData, POP_OBJ());
...
JAVA_VOID com_codename1_ui_TextArea_initLaf___com_codename1_ui_plaf_UIManager(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 4096, 2387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    BC_ALOAD(0);
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_com_codename1_ui_plaf_UIManager_localize___java_lang_String_java_lang_String_R_java_lang_String(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4105), STRING_FROM_CONSTANT_POOL_OFFSET(3209));
    PUSH_OBJ(tmpResult); }
...
JAVA_VOID com_codename1_ui_TextArea_setConstraint___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4106);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_TextArea_getConstraint___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4107);
...
JAVA_VOID com_codename1_ui_TextArea_setWidth___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 2450);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(478);
    if (ilocals_1_==virtual_com_codename1_ui_TextArea_getWidth___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPEQ CustomJump */ goto label_L946884592;
    ...
    if (get_field_com_codename1_ui_TextArea_growByContent(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L946884592;
...
JAVA_VOID com_codename1_ui_TextArea_setText___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 4096, 3045);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    int restoreToL164473397601;
    int tryBlockOffsetL164473397601;
    DEFINE_CATCH_BLOCK(catch_L164473397601, label_L380494131, restoreToL164473397601);
    int restoreToL38049413102;
    int tryBlockOffsetL38049413102;
    DEFINE_CATCH_BLOCK(catch_L38049413102, label_L380494131, restoreToL38049413102);
...
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(495);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1315038402, 0);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L208301085, 0);
    JUMP_TO(label_L920632751, 0);

label_L1315038402:
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L208301085, 0);
...
label_L208301085:
    ...
    BC_ALOAD(0);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1333945918, 0);
    BC_ALOAD(1);
    JUMP_TO(label_L235195640, 0);
...
label_L235195640:
    ...
    if (get_field_com_codename1_ui_TextArea_maxSize(__cn1ThisObject)>=virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1372668833, 0);
...
label_L1644733976:
 tryBlockOffsetL164473397601 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L164473397601);
    restoreToL164473397601 = threadStateData->threadObjectStackOffset;
...
label_L295349235:
END_TRY(1);    JUMP_TO(label_L438873841, 0);

label_L380494131:
 tryBlockOffsetL38049413102 = threadStateData->tryBlockOffset;
    BEGIN_TRY(0, catch_L38049413102);
    restoreToL38049413102 = threadStateData->threadObjectStackOffset;
...
label_L438873841:
    ...
    if (/* CustomInvoke */com_codename1_compat_java_util_Objects_equals___java_lang_Object_java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject), locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L1179093020, 0);
...
label_L1179093020:
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1846345504, 0);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    ...
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject), locals[2].data.o)!=0) /* IFNE CustomJump */ JUMP_TO(label_L899376395, 0);
...
JAVA_OBJECT com_codename1_ui_TextArea_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4108);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isEditable___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2698);
...
JAVA_INT com_codename1_ui_TextArea_getPreferredTabIndex___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2562);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(585);
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2009591182;
...
JAVA_VOID com_codename1_ui_TextArea_updateCursor__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 4112);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(592);
    BC_ALOAD(0);
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1161644395;
    if (virtual_com_codename1_ui_TextArea_isTextSelectionEnabled___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1723518396;

label_L1161644395:
    PUSH_INT(2); /* ICONST_2 */
    goto label_L745465688;
...
JAVA_VOID com_codename1_ui_TextArea_setEditable___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4113);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_TextArea_getMaxSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4114);
...
JAVA_VOID com_codename1_ui_TextArea_keyPressed___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(6, 5, 0, 4096, 1386);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1678623942;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1263841085;
...
label_L1263841085:
    ...
    SP++;
    PUSH_INT(6);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L2075352262;
    ...
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L540811471;
...
label_L2075352262:
    ...
    if (ilocals_2_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L706604026;
    __CN1_DEBUG_INFO(650);
    if (virtual_com_codename1_ui_TextArea_getScrollY___R_int(threadStateData, __cn1ThisObject)<=0) /* IFLE CustomJump */ goto label_L1155437763;
...
label_L706604026:
    ...
    if (ilocals_2_==5 /* ICONST_5 */) /* IF_ICMPEQ CustomJump */ goto label_L627746290;
    if (ilocals_2_!=2 /* ICONST_2 */) /* IF_ICMPNE CustomJump */ goto label_L1678889928;
...
JAVA_VOID com_codename1_ui_TextArea_fireClicked__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2476);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isSelectableInteraction___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2477);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isTypedKey___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 4096, 4116);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(681);
    if (ilocals_1_<=0) /* IFLE CustomJump */ goto label_L555136651;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L299783910;
...
JAVA_VOID com_codename1_ui_TextArea_keyReleased___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* keyCode */
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    DEFINE_INSTANCE_METHOD_STACK(6, 4, 0, 4096, 1387);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1634411546;
    __CN1_DEBUG_INFO(700);
    if (get_field_com_codename1_ui_TextArea_triggerClose(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L193864812;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_2_; 
    SP++;
    PUSH_INT(8);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L523794808;
    if (/* CustomInvoke */virtual_com_codename1_ui_TextArea_isEnterKey___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L193864812;
...
label_L193864812:
    ...
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1634411546;
    if (/* CustomInvoke */com_codename1_ui_TextArea_isTypedKey___int_R_boolean(threadStateData, __cn1ThisObject, ilocals_1_)==0) /* IFEQ CustomJump */ goto label_L1634411546;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isScrollableY___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2535);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(717);
    if (virtual_com_codename1_ui_TextArea_isFocusable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2092066079;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_TextArea_getHeight___R_int(threadStateData, __cn1ThisObject);
    PUSH_INT(tmpResult); }
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L2092066079;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1145165159;
...
JAVA_VOID com_codename1_ui_TextArea_deinitializeImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2695);
...
JAVA_VOID com_codename1_ui_TextArea_onClick__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4117);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(728);
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1041638599;
...
JAVA_VOID com_codename1_ui_TextArea_editString__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 4096, 260);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL424703849cn1_class_id_java_lang_IllegalArgumentException1;
    int tryBlockOffsetL424703849cn1_class_id_java_lang_IllegalArgumentException1;
    DEFINE_CATCH_BLOCK(catch_L424703849cn1_class_id_java_lang_IllegalArgumentException1, label_L1656318404, restoreToL424703849cn1_class_id_java_lang_IllegalArgumentException1);
    __CN1_DEBUG_INFO(734);
    if (get_static_com_codename1_ui_TextArea_autoDegradeMaxSize(threadStateData)==0) /* IFEQ CustomJump */ JUMP_TO(label_L231498257, 0);
    if (get_static_com_codename1_ui_TextArea_hadSuccessfulEdit(threadStateData)!=0) /* IFNE CustomJump */ JUMP_TO(label_L231498257, 0);
    PUSH_INT(get_field_com_codename1_ui_TextArea_maxSize(__cn1ThisObject));
    PUSH_INT(1024);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ JUMP_TO(label_L231498257, 0);

label_L424703849:
 tryBlockOffsetL424703849cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_IllegalArgumentException, catch_L424703849cn1_class_id_java_lang_IllegalArgumentException1);
    restoreToL424703849cn1_class_id_java_lang_IllegalArgumentException1 = threadStateData->threadObjectStackOffset;
...
JAVA_VOID com_codename1_ui_TextArea_pointerHover___int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 4096, 1393);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1213419524;
...
JAVA_VOID com_codename1_ui_TextArea_pointerHoverReleased___int_1ARRAY_int_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 4096, 1395);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    ...
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isDesktop___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1628305283;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_showLightweightVKB___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4118);
...
JAVA_VOID com_codename1_ui_TextArea_pointerReleased___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 278);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(776);
    if (virtual_com_codename1_ui_TextArea_isDragActivated___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L255839577;
...
label_L255839577:
    ...
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L727119352;
    if (virtual_com_codename1_ui_TextArea_isEnabled___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L727119352;
    if (virtual_com_codename1_ui_TextArea_isCellRenderer___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L727119352;
    __CN1_DEBUG_INFO(781);
    if (virtual_com_codename1_impl_CodenameOneImplementation_isNativeInputImmediate___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))==0) /* IFEQ CustomJump */ goto label_L2044150758;
...
label_L2044150758:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2003305136;
    __CN1_DEBUG_INFO(786);
    if (virtual_com_codename1_ui_TextArea_showLightweightVKB___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L105663489;
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    ...
    if(POP_INT() != 0) /* IFNE */ goto label_L447320069;
...
label_L105663489:
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L727119352;
...
JAVA_VOID com_codename1_ui_TextArea_focusGainedInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2485);
...
JAVA_VOID com_codename1_ui_TextArea_focusLostInternal__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2490);
    ...
    if (virtual_com_codename1_ui_TextArea_isEditing___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1495414981;
...
JAVA_INT com_codename1_ui_TextArea_getColumns___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4119);
...
JAVA_INT com_codename1_ui_TextArea_getActualRows___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 4120);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(839);
    if (get_field_com_codename1_ui_TextArea_growByContent(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1860754643;
    __CN1_DEBUG_INFO(840);
    if (get_field_com_codename1_ui_TextArea_growLimit(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L169916747;
...
JAVA_INT com_codename1_ui_TextArea_getRows___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4121);
...
JAVA_VOID com_codename1_ui_TextArea_setColumns___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4122);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_TextArea_setRows___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* rows */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4123);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_TextArea_initComponentImpl__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2694);
...
JAVA_OBJECT com_codename1_ui_TextArea_getRowStrings___R_java_util_ArrayList(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 4096, 4124);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(883);
    if (get_field_com_codename1_ui_TextArea_rowStrings(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1558133170;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    SP--; SP[-1].data.i = (SP[-1].data.i - (*SP).data.i); /* ISUB */
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L351520508;
...
JAVA_INT com_codename1_ui_TextArea_getLines___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_1_ = 0; /* v1 */
    DEFINE_INSTANCE_METHOD_STACK(1, 3, 0, 4096, 4125);
...
JAVA_OBJECT com_codename1_ui_TextArea_getTextAt___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 4, 0, 4096, 4126);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    if (ilocals_3_!=0) /* IFNE CustomJump */ goto label_L1020632821;
...
label_L1020632821:
    ...
    if (ilocals_1_<ilocals_3_) /* IF_IMPLT CustomJump */ goto label_L867205829;
...
JAVA_INT com_codename1_ui_TextArea_indexOf___char_1ARRAY_char_int_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_CHAR __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 7, 0, 4096, 882);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
...
label_L217827560:
    if (ilocals_6_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L369573800;
    if (ilocals_6_>=(ilocals_3_ + ilocals_4_)) /* IF_ICMPGE CustomJump */ goto label_L369573800;
    __CN1_DEBUG_INFO(924);
    if (CN1_ARRAY_ELEMENT_CHAR(locals[1].data.o, ilocals_6_)!=ilocals_2_) /* IF_ICMPNE CustomJump */ goto label_L482987954;
...
JAVA_OBJECT com_codename1_ui_TextArea_preprocess___java_lang_String_R_char_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(1, 2, 0, 4096, 4127);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_TextArea_updateRowWidth___char_com_codename1_ui_Font_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_CHAR __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 3, 0, 4096, 4128);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_fastCharWidthCheck___char_1ARRAY_int_int_int_int_com_codename1_ui_Font_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2, JAVA_INT __cn1Arg3, JAVA_INT __cn1Arg4, JAVA_INT __cn1Arg5, JAVA_OBJECT __cn1Arg6) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(4, 7, 0, 4096, 1840);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ilocals_2_ = __cn1Arg2;
    ilocals_3_ = __cn1Arg3;
    ...
    if ((ilocals_3_ * ilocals_5_)>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L1005245720;
...
label_L1005245720:
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Font_charsWidth___char_1ARRAY_int_int_R_int(threadStateData, locals[6].data.o, locals[1].data.o, ilocals_2_, ilocals_3_)>=ilocals_4_) /* IF_ICMPGE CustomJump */ goto label_L348084146;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1188671176;
...
JAVA_VOID com_codename1_ui_TextArea_initRowString__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(8, 20, 0, 4096, 4129);
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L339186291;
    __CN1_DEBUG_INFO(964);
    if (get_field_com_codename1_ui_TextArea_rowStrings(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L339186291;
...
label_L339186291:
    ...
    if (virtual_com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L2031667192;
...
label_L2031667192:
    ...
    if (get_field_com_codename1_ui_TextArea_widthForRowCalculations(__cn1ThisObject)>0) /* IFGT CustomJump */ goto label_L393481646;
...
label_L393481646:
    ...
    if (get_field_com_codename1_ui_TextArea_text(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L475024998;
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(219))==0) /* IFEQ CustomJump */ goto label_L878506901;
...
label_L878506901:
    ...
    if (get_field_com_codename1_ui_TextArea_actAsLabel(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L197449185;
    if (virtual_java_lang_String_length___R_int(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject))>get_field_com_codename1_ui_TextArea_columns(__cn1ThisObject)) /* IF_ICMPGT CustomJump */ goto label_L197449185;
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, get_field_com_codename1_ui_TextArea_text(__cn1ThisObject), 10)>=0) /* IFGE CustomJump */ goto label_L197449185;
    ...
    if (ilocals_3_>virtual_com_codename1_ui_TextArea_getWidth___R_int(threadStateData, __cn1ThisObject)) /* IF_ICMPGT CustomJump */ goto label_L197449185;
    __CN1_DEBUG_INFO(991);
    if (get_field_com_codename1_ui_TextArea_rowStrings(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1013620810;
...
label_L197449185:
    ...
    if (get_field_com_codename1_ui_TextArea_growByContent(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L576191199;
...
label_L576191199:
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ goto label_L1900307803;
    ...
    if (ilocals_7_<=ilocals_5_) /* IF_ICMPLE CustomJump */ goto label_L1900307803;
...
label_L1900307803:
    ...
    if (ilocals_8_>ilocals_5_) /* IF_ICMPGT CustomJump */ goto label_L1552076111;
    __CN1_DEBUG_INFO(1028);
    if (virtual_com_codename1_ui_TextArea_isInitialized___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L897801829;
...
label_L2049121789:
    if (ilocals_10_>=ilocals_9_) /* IF_ICMPGE CustomJump */ goto label_L681564936;
...
locals[13].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1050);
    if ((ilocals_12_ / ilocals_9_)<=/* CustomInvoke */java_lang_Math_max___int_int_R_int(threadStateData, 2 /* ICONST_2 */, ilocals_4_)) /* IF_ICMPLE CustomJump */ goto label_L813780803;
...
label_L167692593:
    ...
    if (ilocals_11_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L534662976;
    __CN1_DEBUG_INFO(1068);
    if (ilocals_11_<=ilocals_12_) /* IF_ICMPLE CustomJump */ goto label_L1238339624;
...
locals[13].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1074);
    ...
    if (get_static_com_codename1_ui_TextArea_useStringWidth(threadStateData)!=0) /* IFNE CustomJump */ goto label_L727818265;
    if (get_field_com_codename1_ui_TextArea_actAsLabel(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L295700833;

label_L727818265:
    __CN1_DEBUG_INFO(1079);
    /* VarOp.assignFrom */ locals[18].type=CN1_TYPE_INVALID;    locals[18].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(219);
locals[18].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1082);
    /* VarOp.assignFrom */     ilocals_14_ = ilocals_11_;

label_L1362501759:
    if (ilocals_14_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L2095702106;
    if (/* CustomInvoke */com_codename1_ui_TextArea_fastCharWidthCheck___char_1ARRAY_int_int_int_int_com_codename1_ui_Font_R_boolean(threadStateData, __cn1ThisObject, locals[3].data.o, ilocals_10_, ((ilocals_14_ - ilocals_10_) + 1 /* ICONST_1 */), ilocals_8_, ilocals_5_, locals[2].data.o)==0) /* IFEQ CustomJump */ goto label_L2095702106;
    ...
    if (ilocals_14_>=(ilocals_12_ - 1 /* ICONST_1 */)) /* IF_ICMPGE CustomJump */ goto label_L1234329919;
    if (/* CustomInvoke */java_lang_Character_isSurrogatePair___char_char_R_boolean(threadStateData, ilocals_19_, CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, (ilocals_14_ + 1 /* ICONST_1 */)))==0) /* IFEQ CustomJump */ goto label_L1234329919;
    ...
    if (/* CustomInvoke */virtual_com_codename1_ui_Font_stringWidth___java_lang_String_R_int(threadStateData, locals[2].data.o, locals[18].data.o)<ilocals_8_) /* IF_IMPLT CustomJump */ goto label_L1876259196;
    __CN1_DEBUG_INFO(1093);
    goto label_L2095702106;

label_L1234329919:
    __CN1_DEBUG_INFO(1097);
    if (/* CustomInvoke */virtual_com_codename1_ui_Font_stringWidth___java_lang_String_R_int(threadStateData, locals[2].data.o, locals[18].data.o)<ilocals_8_) /* IF_IMPLT CustomJump */ goto label_L2117043942;
    __CN1_DEBUG_INFO(1098);
    goto label_L2095702106;

label_L2117043942:
    __CN1_DEBUG_INFO(1100);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[16].data.o, ilocals_19_)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1299661385;
...
label_L1299661385:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L397822273;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_19_; 
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1403815002;
...
label_L295700833:
    ...
    if (ilocals_11_==ilocals_10_) /* IF_ICMPEQ CustomJump */ goto label_L66972878;
...
label_L660915526:
    if (ilocals_14_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L648303898;
    ...
    if (ilocals_14_>=(ilocals_12_ - 1 /* ICONST_1 */)) /* IF_ICMPGE CustomJump */ goto label_L876881599;
    if (/* CustomInvoke */java_lang_Character_isSurrogatePair___char_char_R_boolean(threadStateData, ilocals_18_, CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, (ilocals_14_ + 1 /* ICONST_1 */)))==0) /* IFEQ CustomJump */ goto label_L876881599;
    ...
    if (/* CustomInvoke */com_codename1_ui_TextArea_updateRowWidth___java_lang_String_com_codename1_ui_Font_R_int(threadStateData, __cn1ThisObject, locals[19].data.o, locals[2].data.o)<ilocals_8_) /* IF_IMPLT CustomJump */ goto label_L1410456976;
...
label_L1410456976:
    ...
    goto label_L1343835789;

label_L876881599:
    __CN1_DEBUG_INFO(1134);
    if (/* CustomInvoke */com_codename1_ui_TextArea_updateRowWidth___char_com_codename1_ui_Font_R_int(threadStateData, __cn1ThisObject, ilocals_18_, locals[2].data.o)<ilocals_8_) /* IF_IMPLT CustomJump */ goto label_L1022251996;
    __CN1_DEBUG_INFO(1135);
    goto label_L648303898;

label_L1022251996:
    __CN1_DEBUG_INFO(1137);
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[16].data.o, ilocals_18_)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L688581408;
...
label_L688581408:
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1940737740;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_18_; 
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1775897362;
...
label_L1343835789:
    __CN1_DEBUG_INFO(1119);
    BC_IINC(14, 1);
    goto label_L660915526;

label_L648303898:
    __CN1_DEBUG_INFO(1152);
    if (ilocals_14_==ilocals_12_) /* IF_ICMPEQ CustomJump */ goto label_L1497983329;
    BC_ALOAD(3);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_14_; 
    SP++;
    ...
    SP[-1].data.i = ((JAVA_ARRAY_CHAR*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1497983329;
    BC_ALOAD(3);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_14_; 
    SP++;
    ...
    SP[-1].data.i = ((JAVA_ARRAY_CHAR*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1082886058;
...
label_L1082886058:
    ...
    if (ilocals_15_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L2041611826;
    ...
    if (ilocals_18_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L2021601975;
    if (ilocals_18_>=ilocals_15_) /* IF_ICMPGE CustomJump */ goto label_L2021601975;
...
label_L1171713907:
    if (ilocals_15_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1992630936;
    if (ilocals_14_<ilocals_10_) /* IF_IMPLT CustomJump */ goto label_L1992630936;
    ...
    SP++;
    PUSH_INT(32);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L196717412;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_18_; 
    SP++;
    PUSH_INT(10);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L173197870;
...
label_L196717412:
    ...
    if (ilocals_19_<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L450420562;
    if (ilocals_19_>=ilocals_15_) /* IF_ICMPGE CustomJump */ goto label_L450420562;
...
label_L173197870:
    __CN1_DEBUG_INFO(1170);
    BC_IINC(14, -1);
    goto label_L1171713907;

label_L1992630936:
    __CN1_DEBUG_INFO(1187);
    if (ilocals_15_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1794068152;
    __CN1_DEBUG_INFO(1189);
    if (ilocals_17_>0) /* IFGT CustomJump */ goto label_L66231846;
...
label_L66231846:
    ...
    if (ilocals_15_<=0) /* IFLE CustomJump */ goto label_L527247308;
    if (ilocals_15_>=ilocals_12_) /* IF_ICMPGE CustomJump */ goto label_L527247308;
    if (/* CustomInvoke */java_lang_Character_isSurrogatePair___char_char_R_boolean(threadStateData, CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, (ilocals_15_ - 1 /* ICONST_1 */)), CN1_ARRAY_ELEMENT_CHAR(locals[3].data.o, ilocals_15_))==0) /* IFEQ CustomJump */ goto label_L527247308;
...
label_L1794068152:
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[13].data.o)!=0) /* IFNE CustomJump */ goto label_L1133730108;
    __CN1_DEBUG_INFO(1204);
    if (ilocals_8_>ilocals_5_) /* IF_ICMPGT CustomJump */ goto label_L1133730108;
    __CN1_DEBUG_INFO(1205);
    if (virtual_com_codename1_ui_TextArea_isInitialized___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L827099978;
...
label_L1350377659:
    if (ilocals_19_>=ilocals_18_) /* IF_ICMPGE CustomJump */ goto label_L651698411;
...
label_L534662976:
    ...
    SP[-1].data.i = ((JAVA_ARRAY_CHAR*) (*(JAVA_ARRAY)SP[-1].data.o).data)[(*SP).data.i];
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1555895711;
    __CN1_DEBUG_INFO(1224);
    /* CustomInvoke */virtual_java_util_ArrayList_add___java_lang_Object_R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_rowStrings(__cn1ThisObject), STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
...
JAVA_INT com_codename1_ui_TextArea_getRowsGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4130);
...
JAVA_VOID com_codename1_ui_TextArea_paint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 2355);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L990226843;
    __CN1_DEBUG_INFO(1252);
    if (virtual_com_codename1_impl_CodenameOneImplementation_nativeEditorPaintsHint___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))!=0) /* IFNE CustomJump */ goto label_L46415544;
...
JAVA_VOID com_codename1_ui_TextArea_paintHint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 2738);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isNativeEditorVisible___com_codename1_ui_Component_R_boolean(threadStateData, SP[-1].data.o, __cn1ThisObject);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() == 0) /* IFEQ */ goto label_L2097989776;
    if (virtual_com_codename1_impl_CodenameOneImplementation_nativeEditorPaintsHint___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))==0) /* IFEQ CustomJump */ goto label_L2097989776;
...
JAVA_OBJECT com_codename1_ui_TextArea_calcPreferredSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 4, 0, 4096, 1856);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1273);
    if (virtual_com_codename1_ui_TextArea_shouldShowHint___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1227438915;
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1227438915;
...
JAVA_OBJECT com_codename1_ui_TextArea_calcScrollSize___R_com_codename1_ui_geom_Dimension(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 1, 0, 4096, 2440);
...
JAVA_VOID com_codename1_ui_TextArea_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 1596);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1299);
    if (get_field_com_codename1_ui_TextArea_actionListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1609960076;
...
JAVA_VOID com_codename1_ui_TextArea_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 1597);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1311);
    if (get_field_com_codename1_ui_TextArea_actionListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L2095373876;
...
label_L2095373876:
    ...
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_actionListeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1740095856;
...
JAVA_VOID com_codename1_ui_TextArea_setSuppressActionEvent___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4132);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_TextArea_fireActionEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 2, 0, 4096, 2482);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1353);
    if (get_field_com_codename1_ui_TextArea_suppressActionEvent(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1732513254;
...
label_L1732513254:
    ...
    if (get_field_com_codename1_ui_TextArea_actionListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L143251944;
...
label_L143251944:
    ...
    if (get_field_com_codename1_ui_TextArea_bindListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1380361139;
...
JAVA_VOID com_codename1_ui_TextArea_fireCloseEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 4137);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1402);
    if (get_field_com_codename1_ui_TextArea_closeListeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L181372317;
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_closeListeners(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L181372317;
...
JAVA_VOID com_codename1_ui_TextArea_onEditComplete___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 2711);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1844700236;
    __CN1_DEBUG_INFO(1413);
    /* CustomInvoke */virtual_com_codename1_ui_TextArea_setText___java_lang_String(threadStateData, __cn1ThisObject, locals[1].data.o); 

label_L1844700236:
    __CN1_DEBUG_INFO(1415);
    if (virtual_com_codename1_ui_TextArea_getParent___R_com_codename1_ui_Container(threadStateData, __cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2095573052;
...
JAVA_VOID com_codename1_ui_TextArea_setDefaultMaxSize___int(CODENAME_ONE_THREAD_STATE, JAVA_INT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 4138);
    ilocals_0_ = __cn1Arg1;
...
JAVA_VOID com_codename1_ui_TextArea_setGrowByContent___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4140);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_OBJECT com_codename1_ui_TextArea_getUnsupportedChars___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4143);
...
JAVA_CHAR com_codename1_ui_TextArea_getWidestChar___R_char(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 0, 0, 4096, 4149);
...
JAVA_VOID com_codename1_ui_TextArea_setSingleLineTextArea___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4150);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4151);
...
JAVA_VOID com_codename1_ui_TextArea_setAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 3030);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_INT com_codename1_ui_TextArea_getAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 3452);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isPendingCommit___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4153);
...
JAVA_INT com_codename1_ui_TextArea_getCursorPosition___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4154);
...
JAVA_INT com_codename1_ui_TextArea_getCursorY___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4155);
...
JAVA_INT com_codename1_ui_TextArea_getCursorX___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4156);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isQwertyInput___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4157);
...
JAVA_OBJECT com_codename1_ui_TextArea_getInputMode___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4158);
...
JAVA_OBJECT com_codename1_ui_TextArea_getInputModeOrder___R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4159);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isEnableInputScroll___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4160);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isEnterKey___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* keyCode */
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4161);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1769128714;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1470400901;
...
JAVA_VOID com_codename1_ui_TextArea_setHint___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 2741);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_TextArea_getHint___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2739);
...
JAVA_OBJECT com_codename1_ui_TextArea_getHintIcon___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2740);
...
JAVA_VOID com_codename1_ui_TextArea_setHint___java_lang_String_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 2741);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_TextArea_getHintLabel___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4166);
...
JAVA_OBJECT com_codename1_ui_TextArea_getHintLabelImpl___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2735);
...
JAVA_VOID com_codename1_ui_TextArea_setHintLabelImpl___com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 2736);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_shouldShowHint___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2737);
...
JAVA_VOID com_codename1_ui_TextArea_setVerticalAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    volatile JAVA_INT ilocals_1_ = 0; /* valign */
    DEFINE_INSTANCE_METHOD_STACK(4, 2, 0, 4096, 4167);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    __CN1_DEBUG_INFO(1823);
    if (ilocals_1_==4/* ICONST_4 */) /* IF_ICMPEQ CustomJump */ goto label_L891175246;
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L891175246;
    if (ilocals_1_==2 /* ICONST_2 */) /* IF_ICMPEQ CustomJump */ goto label_L891175246;
    ...
    BC_DUP(); /* DUP */
    java_lang_StringBuilder___INIT____(threadStateData, SP[-1].data.o);     SP -= 1;
    /* CustomInvoke */{ JAVA_OBJECT tmpResult = virtual_java_lang_StringBuilder_append___java_lang_String_R_java_lang_StringBuilder(threadStateData, SP[-1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4168));
    SP[-1].data.o = tmpResult; SP[-1].type = CN1_TYPE_OBJECT; }
...
label_L891175246:
    ...
    set_field_com_codename1_ui_TextArea_valign(threadStateData, ilocals_1_, __cn1ThisObject);
...
JAVA_INT com_codename1_ui_TextArea_getVerticalAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4169);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(1844);
    if (get_field_com_codename1_ui_TextArea_valign(__cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1876390738;
    if (virtual_com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1876390738;
    if (virtual_com_codename1_ui_TextArea_isEditable___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1876390738;
    if (virtual_com_codename1_impl_CodenameOneImplementation_supportsNativeTextAreaVerticalAlignment___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))!=0) /* IFNE CustomJump */ goto label_L1876390738;
...
JAVA_VOID com_codename1_ui_TextArea_bindProperty___java_lang_String_com_codename1_cloud_BindTarget(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 2760);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1874);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4134))==0) /* IFEQ CustomJump */ goto label_L1359603919;
    __CN1_DEBUG_INFO(1875);
    if (get_field_com_codename1_ui_TextArea_bindListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1063723524;
...
JAVA_VOID com_codename1_ui_TextArea_unbindProperty___java_lang_String_com_codename1_cloud_BindTarget(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 2761);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1888);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4134))==0) /* IFEQ CustomJump */ goto label_L2025066647;
    __CN1_DEBUG_INFO(1889);
    if (get_field_com_codename1_ui_TextArea_bindListeners(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L741191984;
...
label_L741191984:
    ...
    if (virtual_com_codename1_ui_util_EventDispatcher_hasListeners___R_boolean(threadStateData, get_field_com_codename1_ui_TextArea_bindListeners(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L847018986;
...
JAVA_OBJECT com_codename1_ui_TextArea_getBoundPropertyValue___java_lang_String_R_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 2762);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1905);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4134))==0) /* IFEQ CustomJump */ goto label_L881662115;
...
JAVA_VOID com_codename1_ui_TextArea_setBoundPropertyValue___java_lang_String_java_lang_Object(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 2763);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    locals[2].data.o = __cn1Arg2;
    locals[2].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(1915);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[1].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4134))==0) /* IFEQ CustomJump */ goto label_L1818592781;
    __CN1_DEBUG_INFO(1916);
    if (locals[2].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L754978432;
    __CN1_DEBUG_INFO(1917);
    /* CustomInvoke */virtual_com_codename1_ui_TextArea_setText___java_lang_String(threadStateData, __cn1ThisObject, STRING_FROM_CONSTANT_POOL_OFFSET(219)); 
    goto label_L2096268257;
...
JAVA_INT com_codename1_ui_TextArea_getGrowLimit___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4170);
...
JAVA_VOID com_codename1_ui_TextArea_setEndsWith3Points___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4172);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isEndsWith3Points___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4173);
...
JAVA_VOID com_codename1_ui_TextArea_registerAsInputDevice__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 4096, 4174);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL50815173cn1_class_id_java_lang_Exception1;
    int tryBlockOffsetL50815173cn1_class_id_java_lang_Exception1;
    DEFINE_CATCH_BLOCK(catch_L50815173cn1_class_id_java_lang_Exception1, label_L551994588, restoreToL50815173cn1_class_id_java_lang_Exception1);
...
locals[1].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(1999);
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1618180899, 0);
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o == SP[1].data.o) /* IF_ACMPEQ */ JUMP_TO(label_L1618180899, 0);

label_L50815173:
 tryBlockOffsetL50815173cn1_class_id_java_lang_Exception1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_Exception, catch_L50815173cn1_class_id_java_lang_Exception1);
    restoreToL50815173cn1_class_id_java_lang_Exception1 = threadStateData->threadObjectStackOffset;
...
locals[3].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(2004);
    ...
    if(POP_INT() == 0) /* IFEQ */ JUMP_TO(label_L1294605731, 1);
    ...
    BC_ALOAD(0);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L1294605731, 1);
...
label_L1294605731:
    ...
    if (locals[3].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L623862380, 1);
...
JAVA_VOID com_codename1_ui_TextArea_startEditingAsync__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(6, 3, 0, 4096, 2696);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2045);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    /* CustomInvoke */{ JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isTextEditing___com_codename1_ui_Component_R_boolean(threadStateData, SP[-1].data.o, __cn1ThisObject);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1210600718;
    __CN1_DEBUG_INFO(2046);
    if (virtual_com_codename1_impl_CodenameOneImplementation_usesInvokeAndBlockForEditString___R_boolean(threadStateData, get_static_com_codename1_ui_Display_impl(threadStateData))==0) /* IFEQ CustomJump */ goto label_L1433568941;
    ...
    if (locals[1].data.o==__cn1ThisObject) /* IF_ACMPEQ CustomJump */ goto label_L1433568941;
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1433568941;
    __CN1_DEBUG_INFO(2053);
    BC_ALOAD(1);
    BC_INSTANCEOF(cn1_class_id_com_codename1_ui_TextArea);
    if(POP_INT() == 0) /* IFEQ */ goto label_L1433568941;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isEditing___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 2697);
...
JAVA_VOID com_codename1_ui_TextArea_stopEditing__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(2, 1, 0, 4096, 1376);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2090);
    if (virtual_com_codename1_ui_TextArea_isEditing___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L185639533;
...
JAVA_VOID com_codename1_ui_TextArea_stopEditing___java_lang_Runnable(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 1376);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(2101);
    if (virtual_com_codename1_ui_TextArea_isEditing___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1946636596;
    ...
    goto label_L2118984327;

label_L1946636596:
    __CN1_DEBUG_INFO(2104);
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2118984327;
...
JAVA_OBJECT com_codename1_ui_TextArea_getStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 557);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2117);
    if (virtual_com_codename1_ui_TextArea_isEditing___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L1061913613;
...
JAVA_VOID com_codename1_ui_TextArea_addDataChangedListener___com_codename1_ui_events_DataChangedListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4176);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_TextArea_removeDataChangedListener___com_codename1_ui_events_DataChangedListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4177);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_VOID com_codename1_ui_TextArea_fireDataChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 3, 0, 4096, 4180);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
    ilocals_2_ = __cn1Arg2;
    __CN1_DEBUG_INFO(2171);
    if (get_field_com_codename1_ui_TextArea_listeners(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L826690115;
...
JAVA_VOID com_codename1_ui_TextArea_fireDoneEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(5, 1, 0, 4096, 4183);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2200);
    if (get_field_com_codename1_ui_TextArea_doneListener(__cn1ThisObject)==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2139501486;
    __CN1_DEBUG_INFO(2201);
    PUSH_OBJ(com_codename1_ui_Display_getInstance___R_com_codename1_ui_Display(threadStateData));
    { JAVA_INT tmpResult = virtual_com_codename1_ui_Display_isEdt___R_boolean(threadStateData, SP[-1].data.o);
    SP[-1].data.i = tmpResult; SP[-1].type = CN1_TYPE_INT; }
    if(POP_INT() != 0) /* IFNE */ goto label_L1757970371;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isActAsLabel___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4184);
...
JAVA_VOID com_codename1_ui_TextArea_setActAsLabel___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 4096, 4185);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     ilocals_1_ = __cn1Arg1;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_shouldRenderComponentSelection___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 2587);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2238);
    if (virtual_com_codename1_ui_TextArea_isEditing___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L197195067;
    if (com_codename1_ui_Component_shouldRenderComponentSelection___R_boolean(threadStateData, __cn1ThisObject)==0) /* IFEQ CustomJump */ goto label_L148353618;

label_L197195067:
    PUSH_INT(1); /* ICONST_1 */
    goto label_L1182985125;
...
JAVA_OBJECT com_codename1_ui_TextArea_calculateTextSelectionSpan___com_codename1_ui_TextSelection_R_com_codename1_ui_TextSelection_Spans(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 4096, 4186);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_TextArea_isTextSelectionEnabled___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 4096, 4188);
...
JAVA_OBJECT com_codename1_ui_TextArea_getTextSelectionSupport___R_com_codename1_ui_TextSelection_TextSelectionSupport(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 4096, 2622);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(2290);
    if (get_field_com_codename1_ui_TextArea_textSelectionSupport(__cn1ThisObject)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1839182545;
...
JAVA_INT com_codename1_ui_TextArea_access$300___com_codename1_ui_TextArea_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 1148);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(64);
...
JAVA_INT com_codename1_ui_TextArea_access$400___com_codename1_ui_TextArea_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 1149);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(64);
...
JAVA_OBJECT com_codename1_ui_TextArea_access$500___com_codename1_ui_TextArea_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 1857);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(64);
...
JAVA_OBJECT com_codename1_ui_TextArea_access$602___com_codename1_ui_TextArea_com_codename1_ui_TextSelection_Spans_R_com_codename1_ui_TextSelection_Spans(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(3, 2, 0, 4096, 804);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_OBJECT com_codename1_ui_TextArea_access$600___com_codename1_ui_TextArea_R_com_codename1_ui_TextSelection_Spans(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 1522);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(64);
...
JAVA_BOOLEAN com_codename1_ui_TextArea_access$700___com_codename1_ui_TextArea_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_ui_TextArea(threadStateData);
    DEFINE_METHOD_STACK(1, 1, 0, 4096, 805);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(64);
...
JAVA_VOID com_codename1_ui_TextArea___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(1, 0, 0, 4096, 859);
    __CN1_DEBUG_INFO(68);
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isFocusable___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isFocusable___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[147])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setFocusable___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setFocusable___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[149])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setPreferredTabIndex___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setPreferredTabIndex___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[152])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setShouldCalcPreferredSize___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setShouldCalcPreferredSize___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[154])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_handlesInput___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_handlesInput___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[155])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setHandlesInput___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setHandlesInput___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[156])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_hasFocus___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_hasFocus___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[157])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getComponentForm___R_com_codename1_ui_Form(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getComponentForm___R_com_codename1_ui_Form)__cn1ThisObject->__codenameOneParentClsReference->vtable[159])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_repaint__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_repaint__)__cn1ThisObject->__codenameOneParentClsReference->vtable[161])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setSmoothScrolling___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setSmoothScrolling___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[176])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[222])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getPressedStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getPressedStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[224])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getUnselectedStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getUnselectedStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[230])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getSelectedStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getSelectedStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[231])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getDisabledStyle___R_com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getDisabledStyle___R_com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[232])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setUnselectedStyle___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setUnselectedStyle___com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[233])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setSelectedStyle___com_codename1_ui_plaf_Style(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setSelectedStyle___com_codename1_ui_plaf_Style)__cn1ThisObject->__codenameOneParentClsReference->vtable[234])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_requestFocus__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_requestFocus__)__cn1ThisObject->__codenameOneParentClsReference->vtable[237])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isDragActivated___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isDragActivated___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[244])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_scrollRectToVisible___com_codename1_ui_geom_Rectangle_com_codename1_ui_Component(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_scrollRectToVisible___com_codename1_ui_geom_Rectangle_com_codename1_ui_Component)__cn1ThisObject->__codenameOneParentClsReference->vtable[252])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isCellRenderer___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isCellRenderer___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[257])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setScrollVisible___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setScrollVisible___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[259])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isInitialized___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isInitialized___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[268])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isEnabled___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isEnabled___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[275])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setEnabled___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setEnabled___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[277])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getName___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getName___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[278])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setName___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setName___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[279])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isRTL___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isRTL___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[282])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getHintLabelImpl___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getHintLabelImpl___R_com_codename1_ui_Label)__cn1ThisObject->__codenameOneParentClsReference->vtable[298])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_shouldShowHint___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_shouldShowHint___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[300])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_paintHint___com_codename1_ui_Graphics(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_paintHint___com_codename1_ui_Graphics)__cn1ThisObject->__codenameOneParentClsReference->vtable[301])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getHint___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getHint___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[302])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getHintIcon___R_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getHintIcon___R_com_codename1_ui_Image)__cn1ThisObject->__codenameOneParentClsReference->vtable[303])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setHint___java_lang_String_com_codename1_ui_Image(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setHint___java_lang_String_com_codename1_ui_Image)__cn1ThisObject->__codenameOneParentClsReference->vtable[304])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setHidden___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setHidden___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[319])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_addActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_addActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[323])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_removeActionListener___com_codename1_ui_events_ActionListener(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_removeActionListener___com_codename1_ui_events_ActionListener)__cn1ThisObject->__codenameOneParentClsReference->vtable[324])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setText___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setText___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[325])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getText___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getText___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[326])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setConstraint___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setConstraint___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[327])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getConstraint___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getConstraint___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[328])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setEditable___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setEditable___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[329])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getMaxSize___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getMaxSize___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[330])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_onClick__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_onClick__)__cn1ThisObject->__codenameOneParentClsReference->vtable[331])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_editString__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_editString__)__cn1ThisObject->__codenameOneParentClsReference->vtable[332])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_showLightweightVKB___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_showLightweightVKB___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[333])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getColumns___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getColumns___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[334])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getActualRows___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getActualRows___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[335])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getRows___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getRows___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[336])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setColumns___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setColumns___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[337])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setRows___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setRows___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[338])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getLines___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getLines___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[339])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getTextAt___int_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getTextAt___int_R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[340])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_preprocess___java_lang_String_R_char_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_preprocess___java_lang_String_R_char_1ARRAY)__cn1ThisObject->__codenameOneParentClsReference->vtable[341])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getRowsGap___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getRowsGap___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[342])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setSuppressActionEvent___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setSuppressActionEvent___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[343])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_fireCloseEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_fireCloseEvent__)__cn1ThisObject->__codenameOneParentClsReference->vtable[344])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setGrowByContent___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setGrowByContent___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[345])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getUnsupportedChars___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getUnsupportedChars___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[346])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[348])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setAlignment___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[349])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getAlignment___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[350])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isPendingCommit___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isPendingCommit___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[351])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getCursorPosition___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getCursorPosition___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[352])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getCursorY___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getCursorY___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[353])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getCursorX___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getCursorX___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[354])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isQwertyInput___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isQwertyInput___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[355])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getInputMode___R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getInputMode___R_java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[356])(threadStateData, __cn1ThisObject);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getInputModeOrder___R_java_lang_String_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getInputModeOrder___R_java_lang_String_1ARRAY)__cn1ThisObject->__codenameOneParentClsReference->vtable[357])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isEnableInputScroll___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isEnableInputScroll___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[358])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isEnterKey___int_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isEnterKey___int_R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[359])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setHint___java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setHint___java_lang_String)__cn1ThisObject->__codenameOneParentClsReference->vtable[360])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_getHintLabel___R_com_codename1_ui_Label(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getHintLabel___R_com_codename1_ui_Label)__cn1ThisObject->__codenameOneParentClsReference->vtable[361])(threadStateData, __cn1ThisObject);
}


typedef JAVA_VOID (*functionPtr_com_codename1_ui_TextArea_setVerticalAlignment___int)(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1);

JAVA_VOID virtual_com_codename1_ui_TextArea_setVerticalAlignment___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setVerticalAlignment___int)__cn1ThisObject->__codenameOneParentClsReference->vtable[362])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getVerticalAlignment___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getVerticalAlignment___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[363])(threadStateData, __cn1ThisObject);
}
...
JAVA_INT virtual_com_codename1_ui_TextArea_getGrowLimit___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_getGrowLimit___R_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[364])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isEndsWith3Points___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isEndsWith3Points___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[366])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_registerAsInputDevice__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_registerAsInputDevice__)__cn1ThisObject->__codenameOneParentClsReference->vtable[367])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_stopEditing__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_stopEditing__)__cn1ThisObject->__codenameOneParentClsReference->vtable[368])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_fireDataChanged___int_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_fireDataChanged___int_int)__cn1ThisObject->__codenameOneParentClsReference->vtable[371])(threadStateData, __cn1ThisObject, __cn1Arg1, __cn1Arg2);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_fireDoneEvent__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_fireDoneEvent__)__cn1ThisObject->__codenameOneParentClsReference->vtable[372])(threadStateData, __cn1ThisObject);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isActAsLabel___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isActAsLabel___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[373])(threadStateData, __cn1ThisObject);
}
...
JAVA_VOID virtual_com_codename1_ui_TextArea_setActAsLabel___boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_BOOLEAN __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    (*(functionPtr_com_codename1_ui_TextArea_setActAsLabel___boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[374])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_OBJECT virtual_com_codename1_ui_TextArea_calculateTextSelectionSpan___com_codename1_ui_TextSelection_R_com_codename1_ui_TextSelection_Spans(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_calculateTextSelectionSpan___com_codename1_ui_TextSelection_R_com_codename1_ui_TextSelection_Spans)__cn1ThisObject->__codenameOneParentClsReference->vtable[375])(threadStateData, __cn1ThisObject, __cn1Arg1);
}
...
JAVA_BOOLEAN virtual_com_codename1_ui_TextArea_isTextSelectionEnabled___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if(__cn1ThisObject == JAVA_NULL) THROW_NULL_POINTER_EXCEPTION();
    return (*(functionPtr_com_codename1_ui_TextArea_isTextSelectionEnabled___R_boolean)__cn1ThisObject->__codenameOneParentClsReference->vtable[376])(threadStateData, __cn1ThisObject);
}
...
void __INIT_VTABLE_com_codename1_ui_TextArea(CODENAME_ONE_THREAD_STATE, void** vtable) {
    ...
    vtable[143] = &com_codename1_ui_TextArea_calcPreferredSize___R_com_codename1_ui_geom_Dimension;
    vtable[153] = &com_codename1_ui_TextArea_getPreferredTabIndex___R_int;
    vtable[164] = &com_codename1_ui_TextArea_keyPressed___int;
    vtable[165] = &com_codename1_ui_TextArea_keyReleased___int;
    vtable[174] = &com_codename1_ui_TextArea_shouldRenderComponentSelection___R_boolean;
    vtable[177] = &com_codename1_ui_TextArea_pointerHover___int_1ARRAY_int_1ARRAY;
    vtable[179] = &com_codename1_ui_TextArea_pointerHoverReleased___int_1ARRAY_int_1ARRAY;
    vtable[202] = &com_codename1_ui_TextArea_pointerReleased___int_int;
    vtable[205] = &com_codename1_ui_TextArea_getTextSelectionSupport___R_com_codename1_ui_TextSelection_TextSelectionSupport;
    vtable[222] = &com_codename1_ui_TextArea_getStyle___R_com_codename1_ui_plaf_Style;
    vtable[263] = &com_codename1_ui_TextArea_initComponentImpl__;
    vtable[264] = &com_codename1_ui_TextArea_deinitializeImpl__;
    vtable[266] = &com_codename1_ui_TextArea_deinitialize__;
    vtable[267] = &com_codename1_ui_TextArea_initComponent__;
    vtable[276] = &com_codename1_ui_TextArea_onEditComplete___java_lang_String;
    vtable[298] = &com_codename1_ui_TextArea_getHintLabelImpl___R_com_codename1_ui_Label;
    vtable[299] = &com_codename1_ui_TextArea_setHintLabelImpl___com_codename1_ui_Label;
    vtable[300] = &com_codename1_ui_TextArea_shouldShowHint___R_boolean;
    vtable[301] = &com_codename1_ui_TextArea_paintHint___com_codename1_ui_Graphics;
    vtable[302] = &com_codename1_ui_TextArea_getHint___R_java_lang_String;
    vtable[303] = &com_codename1_ui_TextArea_getHintIcon___R_com_codename1_ui_Image;
    vtable[304] = &com_codename1_ui_TextArea_setHint___java_lang_String_com_codename1_ui_Image;
    vtable[314] = &com_codename1_ui_TextArea_bindProperty___java_lang_String_com_codename1_cloud_BindTarget;
    vtable[315] = &com_codename1_ui_TextArea_unbindProperty___java_lang_String_com_codename1_cloud_BindTarget;
    vtable[316] = &com_codename1_ui_TextArea_getBoundPropertyValue___java_lang_String_R_java_lang_Object;
    vtable[317] = &com_codename1_ui_TextArea_setBoundPropertyValue___java_lang_String_java_lang_Object;
    vtable[323] = &com_codename1_ui_TextArea_addActionListener___com_codename1_ui_events_ActionListener;
    vtable[324] = &com_codename1_ui_TextArea_removeActionListener___com_codename1_ui_events_ActionListener;
    vtable[325] = &com_codename1_ui_TextArea_setText___java_lang_String;
    vtable[326] = &com_codename1_ui_TextArea_getText___R_java_lang_String;
    vtable[327] = &com_codename1_ui_TextArea_setConstraint___int;
    vtable[328] = &com_codename1_ui_TextArea_getConstraint___R_int;
    vtable[329] = &com_codename1_ui_TextArea_setEditable___boolean;
    vtable[330] = &com_codename1_ui_TextArea_getMaxSize___R_int;
    vtable[331] = &com_codename1_ui_TextArea_onClick__;
    vtable[332] = &com_codename1_ui_TextArea_editString__;
    vtable[333] = &com_codename1_ui_TextArea_showLightweightVKB___R_boolean;
    vtable[334] = &com_codename1_ui_TextArea_getColumns___R_int;
    vtable[335] = &com_codename1_ui_TextArea_getActualRows___R_int;
    vtable[336] = &com_codename1_ui_TextArea_getRows___R_int;
    vtable[337] = &com_codename1_ui_TextArea_setColumns___int;
    vtable[338] = &com_codename1_ui_TextArea_setRows___int;
    vtable[339] = &com_codename1_ui_TextArea_getLines___R_int;
    vtable[340] = &com_codename1_ui_TextArea_getTextAt___int_R_java_lang_String;
    vtable[341] = &com_codename1_ui_TextArea_preprocess___java_lang_String_R_char_1ARRAY;
    vtable[342] = &com_codename1_ui_TextArea_getRowsGap___R_int;
    vtable[343] = &com_codename1_ui_TextArea_setSuppressActionEvent___boolean;
    vtable[344] = &com_codename1_ui_TextArea_fireCloseEvent__;
    vtable[345] = &com_codename1_ui_TextArea_setGrowByContent___boolean;
    vtable[346] = &com_codename1_ui_TextArea_getUnsupportedChars___R_java_lang_String;
    vtable[347] = &com_codename1_ui_TextArea_setSingleLineTextArea___boolean;
    vtable[348] = &com_codename1_ui_TextArea_isSingleLineTextArea___R_boolean;
    vtable[349] = &com_codename1_ui_TextArea_setAlignment___int;
    vtable[350] = &com_codename1_ui_TextArea_getAlignment___R_int;
    vtable[351] = &com_codename1_ui_TextArea_isPendingCommit___R_boolean;
    vtable[352] = &com_codename1_ui_TextArea_getCursorPosition___R_int;
    vtable[353] = &com_codename1_ui_TextArea_getCursorY___R_int;
    vtable[354] = &com_codename1_ui_TextArea_getCursorX___R_int;
    vtable[355] = &com_codename1_ui_TextArea_isQwertyInput___R_boolean;
    vtable[356] = &com_codename1_ui_TextArea_getInputMode___R_java_lang_String;
    vtable[357] = &com_codename1_ui_TextArea_getInputModeOrder___R_java_lang_String_1ARRAY;
    vtable[358] = &com_codename1_ui_TextArea_isEnableInputScroll___R_boolean;
    vtable[359] = &com_codename1_ui_TextArea_isEnterKey___int_R_boolean;
    vtable[360] = &com_codename1_ui_TextArea_setHint___java_lang_String;
    vtable[361] = &com_codename1_ui_TextArea_getHintLabel___R_com_codename1_ui_Label;
    vtable[362] = &com_codename1_ui_TextArea_setVerticalAlignment___int;
    vtable[363] = &com_codename1_ui_TextArea_getVerticalAlignment___R_int;
    vtable[364] = &com_codename1_ui_TextArea_getGrowLimit___R_int;
    vtable[365] = &com_codename1_ui_TextArea_setEndsWith3Points___boolean;
    vtable[366] = &com_codename1_ui_TextArea_isEndsWith3Points___R_boolean;
    vtable[367] = &com_codename1_ui_TextArea_registerAsInputDevice__;
    vtable[368] = &com_codename1_ui_TextArea_stopEditing__;
    vtable[369] = &com_codename1_ui_TextArea_addDataChangedListener___com_codename1_ui_events_DataChangedListener;
    vtable[370] = &com_codename1_ui_TextArea_removeDataChangedListener___com_codename1_ui_events_DataChangedListener;
    vtable[371] = &com_codename1_ui_TextArea_fireDataChanged___int_int;
    vtable[372] = &com_codename1_ui_TextArea_fireDoneEvent__;
    vtable[373] = &com_codename1_ui_TextArea_isActAsLabel___R_boolean;
    vtable[374] = &com_codename1_ui_TextArea_setActAsLabel___boolean;
    vtable[375] = &com_codename1_ui_TextArea_calculateTextSelectionSpan___com_codename1_ui_TextSelection_R_com_codename1_ui_TextSelection_Spans;
    vtable[376] = &com_codename1_ui_TextArea_isTextSelectionEnabled___R_boolean;
}
...
void __STATIC_INITIALIZER_com_codename1_ui_TextArea(CODENAME_ONE_THREAD_STATE) {
    ...
    class__com_codename1_ui_TextArea.vtable = malloc(sizeof(void*) *377);
