...
const struct clazz *base_interfaces_for_java_lang_StringIndexOutOfBoundsException[] = {};
struct clazz class__java_lang_StringIndexOutOfBoundsException = {
  DEBUG_GC_INIT &class__java_lang_Class, 999999, 0, 0, 0, 0, &__FINALIZER_java_lang_StringIndexOutOfBoundsException ,0 , &__GC_MARK_java_lang_StringIndexOutOfBoundsException,  0, cn1_class_id_java_lang_StringIndexOutOfBoundsException, "java.lang.StringIndexOutOfBoundsException", 0, 0, 0, JAVA_FALSE, &class__java_lang_IndexOutOfBoundsException, base_interfaces_for_java_lang_StringIndexOutOfBoundsException, 0, &__NEW_INSTANCE_java_lang_StringIndexOutOfBoundsException, 0
, 0, 0, 0, 0, 0, 0};

JAVA_VOID __FINALIZER_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToDelete) {
    __FINALIZER_java_lang_IndexOutOfBoundsException(threadStateData, objToDelete);
}

void __GC_MARK_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT objToMark, JAVA_BOOLEAN force) {
    struct obj__java_lang_StringIndexOutOfBoundsException* objInstance = (struct obj__java_lang_StringIndexOutOfBoundsException*)objToMark;
    __GC_MARK_java_lang_IndexOutOfBoundsException(threadStateData, objToMark, force);
}

JAVA_OBJECT __NEW_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_java_lang_StringIndexOutOfBoundsException(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__java_lang_StringIndexOutOfBoundsException), &class__java_lang_StringIndexOutOfBoundsException);
    return o;
}

JAVA_OBJECT __NEW_INSTANCE_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE) {
    __STATIC_INITIALIZER_java_lang_StringIndexOutOfBoundsException(threadStateData);
    JAVA_OBJECT o = codenameOneGcMalloc(threadStateData, sizeof(struct obj__java_lang_StringIndexOutOfBoundsException), &class__java_lang_StringIndexOutOfBoundsException);
java_lang_StringIndexOutOfBoundsException___INIT____(threadStateData, o);
    return o;
}


JAVA_VOID java_lang_StringIndexOutOfBoundsException___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 1133, 202);
...
JAVA_VOID java_lang_StringIndexOutOfBoundsException___INIT_____int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(3, 2, 0, 1133, 202);
...
JAVA_VOID java_lang_StringIndexOutOfBoundsException___INIT_____java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 1133, 202);
...
void __INIT_VTABLE_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE, void** vtable) {
        __INIT_VTABLE_java_lang_IndexOutOfBoundsException(threadStateData, vtable);
}

static int __java_lang_StringIndexOutOfBoundsException_LOADED__=0;
void __STATIC_INITIALIZER_java_lang_StringIndexOutOfBoundsException(CODENAME_ONE_THREAD_STATE) {
    if(__java_lang_StringIndexOutOfBoundsException_LOADED__) return;

    monitorEnter(threadStateData, (JAVA_OBJECT)&class__java_lang_StringIndexOutOfBoundsException);
    if(class__java_lang_StringIndexOutOfBoundsException.initialized) {
        monitorExit(threadStateData, (JAVA_OBJECT)&class__java_lang_StringIndexOutOfBoundsException);
        return;
    }

    class__java_lang_StringIndexOutOfBoundsException.vtable = malloc(sizeof(void*) *12);
    __INIT_VTABLE_java_lang_StringIndexOutOfBoundsException(threadStateData, class__java_lang_StringIndexOutOfBoundsException.vtable);
    class__java_lang_StringIndexOutOfBoundsException.initialized = JAVA_TRUE;
monitorExit(threadStateData, (JAVA_OBJECT)&class__java_lang_StringIndexOutOfBoundsException);
__java_lang_StringIndexOutOfBoundsException_LOADED__=1;
}
