...
JAVA_BOOLEAN com_codename1_location_Geofence_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    if(POP_INT() == 0) /* IFEQ */ goto label_L2115589111;
    __CN1_DEBUG_INFO(168);
    /* VarOp.assignFrom */ locals[2].type=CN1_TYPE_INVALID;    locals[2].data.o = locals[1].data.o;
locals[2].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(169);
    if (/* CustomInvoke */com_codename1_location_Geofence_eq___java_lang_Object_java_lang_Object_R_boolean(threadStateData, __cn1ThisObject, get_field_com_codename1_location_Geofence_id(__cn1ThisObject), get_field_com_codename1_location_Geofence_id(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L653292129;
    if (get_field_com_codename1_location_Geofence_radius(locals[2].data.o)!=get_field_com_codename1_location_Geofence_radius(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L653292129;
    if (/* CustomInvoke */com_codename1_location_Geofence_eq___com_codename1_location_Location_com_codename1_location_Location_R_boolean(threadStateData, __cn1ThisObject, get_field_com_codename1_location_Geofence_loc(__cn1ThisObject), get_field_com_codename1_location_Geofence_loc(locals[2].data.o))==0) /* IFEQ CustomJump */ goto label_L653292129;
    if (CN1_CMP_EXPR(get_field_com_codename1_location_Geofence_expiration(locals[2].data.o), get_field_com_codename1_location_Geofence_expiration(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L653292129;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L727050829;
...
JAVA_BOOLEAN com_codename1_location_Geofence_eq___java_lang_Object_java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1676534432;
...
label_L1676534432:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1474270145;
...
JAVA_BOOLEAN com_codename1_location_Geofence_eq___com_codename1_location_Location_com_codename1_location_Location_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (locals[1].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1922662433;
...
label_L1922662433:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1981418429;
