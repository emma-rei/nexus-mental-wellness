...
locals[5].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(59);
    ...
    __CN1_DEBUG_INFO(60);
    if (ilocals_4_!=-1 /* ICONST_M1 */) /* IF_ICMPNE CustomJump */ goto label_L1710488034;
    __CN1_DEBUG_INFO(61);
...
label_L1710488034:
    __CN1_DEBUG_INFO(64);
    if (ilocals_4_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L961106093;
    __CN1_DEBUG_INFO(65);
    BC_ALOAD(3);
...
JAVA_OBJECT com_codename1_util_StringUtil_tokenize___java_lang_String_char_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_CHAR __cn1Arg2) {
    ...
    if (get_static_com_codename1_util_StringUtil_impl(threadStateData)!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L1129569088;
...
label_L2016335685:
    if (ilocals_6_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1451785359;
    __CN1_DEBUG_INFO(187);
    /* VarOp.assignFrom */ ilocals_7_ = /* CustomInvoke */virtual_java_lang_String_charAt___int_R_char(threadStateData, locals[0].data.o, ilocals_6_);
    __CN1_DEBUG_INFO(188);
    if (ilocals_7_!=ilocals_1_) /* IF_ICMPNE CustomJump */ goto label_L61966686;
    __CN1_DEBUG_INFO(189);
    if (ilocals_4_==0) /* IFEQ CustomJump */ goto label_L813950703;
...
label_L813950703:
    ...
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[5].data.o)<=0) /* IFLE CustomJump */ goto label_L1834463844;
...
label_L1834463844:
    __CN1_DEBUG_INFO(186);
    BC_IINC(6, 1);
    goto label_L2016335685;

label_L1451785359:
    __CN1_DEBUG_INFO(204);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[5].data.o)<=0) /* IFLE CustomJump */ goto label_L2002410087;
...
JAVA_OBJECT com_codename1_util_StringUtil_tokenize___java_lang_String_java_lang_String_R_java_util_List(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    ...
    if (virtual_java_lang_String_length___R_int(threadStateData, locals[1].data.o)!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L148185875;
...
label_L1374355136:
    if (ilocals_5_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L105859507;
    ...
    if (/* CustomInvoke */virtual_java_lang_String_indexOf___int_R_int(threadStateData, locals[1].data.o, ilocals_6_)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L602120831;
    __CN1_DEBUG_INFO(232);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[4].data.o)<=0) /* IFLE CustomJump */ goto label_L1887868536;
...
label_L1887868536:
    __CN1_DEBUG_INFO(229);
    BC_IINC(5, 1);
    goto label_L1374355136;

label_L105859507:
    __CN1_DEBUG_INFO(240);
    if (virtual_java_lang_StringBuilder_length___R_int(threadStateData, locals[4].data.o)<=0) /* IFLE CustomJump */ goto label_L764684191;
