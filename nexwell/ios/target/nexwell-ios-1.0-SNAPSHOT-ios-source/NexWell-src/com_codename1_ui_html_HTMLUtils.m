...
JAVA_VOID com_codename1_ui_html_HTMLUtils___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 7830, 201);
...
JAVA_OBJECT com_codename1_ui_html_HTMLUtils_convertCharEntity___java_lang_String_boolean_java_util_Hashtable_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_html_HTMLUtils(threadStateData);
    DEFINE_METHOD_STACK(4, 5, 0, 7830, 7784);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    locals[2].data.o = __cn1Arg3;
    locals[2].type = CN1_TYPE_OBJECT;
    int restoreToL1550654008cn1_class_id_java_lang_NumberFormatException1;
    int tryBlockOffsetL1550654008cn1_class_id_java_lang_NumberFormatException1;
    DEFINE_CATCH_BLOCK(catch_L1550654008cn1_class_id_java_lang_NumberFormatException1, label_L1387462740, restoreToL1550654008cn1_class_id_java_lang_NumberFormatException1);
    int restoreToL1387473776cn1_class_id_java_lang_NumberFormatException2;
    int tryBlockOffsetL1387473776cn1_class_id_java_lang_NumberFormatException2;
    DEFINE_CATCH_BLOCK(catch_L1387473776cn1_class_id_java_lang_NumberFormatException2, label_L2137741298, restoreToL1387473776cn1_class_id_java_lang_NumberFormatException2);
    __CN1_DEBUG_INFO(112);
    /* VarOp.assignFrom */     ilocals_3_ = -1 /* ICONST_M1 */; 
    __CN1_DEBUG_INFO(113);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(4579))==0) /* IFEQ CustomJump */ JUMP_TO(label_L340715687, 0);
    __CN1_DEBUG_INFO(114);
    if (/* CustomInvoke */virtual_java_lang_String_startsWith___java_lang_String_R_boolean(threadStateData, locals[0].data.o, STRING_FROM_CONSTANT_POOL_OFFSET(7833))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1387473776, 0);

label_L1550654008:
 tryBlockOffsetL1550654008cn1_class_id_java_lang_NumberFormatException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1550654008cn1_class_id_java_lang_NumberFormatException1);
    restoreToL1550654008cn1_class_id_java_lang_NumberFormatException1 = threadStateData->threadObjectStackOffset;
...
label_L1387473776:
 tryBlockOffsetL1387473776cn1_class_id_java_lang_NumberFormatException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_NumberFormatException, catch_L1387473776cn1_class_id_java_lang_NumberFormatException2);
    restoreToL1387473776cn1_class_id_java_lang_NumberFormatException2 = threadStateData->threadObjectStackOffset;
...
label_L415768786:
    ...
    if (ilocals_3_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ JUMP_TO(label_L1027158270, 0);
...
JAVA_INT com_codename1_ui_html_HTMLUtils_getCharEntityCode___java_lang_String_boolean_java_util_Hashtable_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2, JAVA_OBJECT __cn1Arg3) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_html_HTMLUtils(threadStateData);
    DEFINE_METHOD_STACK(3, 5, 0, 7830, 7835);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ilocals_1_ = __cn1Arg2;
    locals[2].data.o = __cn1Arg3;
...
label_L1281743075:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(get_static_com_codename1_ui_html_HTMLUtils_XML_CHAR_ENTITIES(threadStateData))) /* IF_ICMPGE CustomJump */ goto label_L1582427182;
    __CN1_DEBUG_INFO(145);
    if (/* CustomInvoke */virtual_java_lang_String_equalsIgnoreCase___java_lang_String_R_boolean(threadStateData, locals[0].data.o, CN1_ARRAY_ELEMENT_OBJECT(get_static_com_codename1_ui_html_HTMLUtils_XML_CHAR_ENTITIES(threadStateData), ilocals_4_))==0) /* IFEQ CustomJump */ goto label_L368223295;
...
label_L368223295:
    __CN1_DEBUG_INFO(144);
    BC_IINC(4, 1);
    goto label_L1281743075;

label_L1582427182:
    __CN1_DEBUG_INFO(149);
    if (ilocals_3_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L942649169;
...
label_L942649169:
    ...
    if (ilocals_1_==0) /* IFEQ CustomJump */ goto label_L1775113446;
    ...
    if (ilocals_3_==-1 /* ICONST_M1 */) /* IF_ICMPEQ CustomJump */ goto label_L1775113446;
...
label_L1775113446:
    ...
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1771935420;
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L1771935420;
...
JAVA_OBJECT com_codename1_ui_html_HTMLUtils_encodeString___java_lang_String_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_ui_html_HTMLUtils(threadStateData);
    DEFINE_METHOD_STACK(3, 7, 0, 7830, 7836);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(181);
    if (locals[0].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ goto label_L190704044;
...
label_L634250683:
    if (ilocals_2_>=virtual_java_lang_String_length___R_int(threadStateData, locals[0].data.o)) /* IF_ICMPGE CustomJump */ goto label_L1322093233;
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1472057002;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L1385208471;
...
label_L1472057002:
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L920914400;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(90);
...
label_L920914400:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L341742991;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(57);
...
label_L341742991:
    ...
    SP++;
    PUSH_INT(45);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1385208471;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(46);
    ...
    SP++;
    PUSH_INT(126);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L758104368;
...
label_L758104368:
    ...
    SP++;
    PUSH_INT(128);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1828724670;
    if (ilocals_3_>65535) /* IF_ICMPGT CustomJump */ goto label_L1828724670;
    ...
    SP++;
    PUSH_INT(2047);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L219286908;
...
label_L1828724670:
    ...
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;    locals[4].data.o = STRING_FROM_CONSTANT_POOL_OFFSET(1646);
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(225);
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_3_; 
    SP++;
    PUSH_INT(16);
    SP-=2; if((*SP).data.i >= SP[1].data.i) /* IF_ICMPGE */ goto label_L1214115553;
...
JAVA_INT com_codename1_ui_html_HTMLUtils_getStringVal___java_lang_String_java_lang_String_1ARRAY_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2) {
    __STATIC_INITIALIZER_com_codename1_ui_html_HTMLUtils(threadStateData);
    DEFINE_METHOD_STACK(4, 2, 0, 7830, 7837);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
JAVA_INT com_codename1_ui_html_HTMLUtils_getStringVal___java_lang_String_java_lang_String_1ARRAY_int_1ARRAY_int_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_OBJECT __cn1Arg2, JAVA_OBJECT __cn1Arg3, JAVA_INT __cn1Arg4) {
    ...
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    __STATIC_INITIALIZER_com_codename1_ui_html_HTMLUtils(threadStateData);
    DEFINE_METHOD_STACK(3, 5, 0, 7830, 7837);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    locals[1].data.o = __cn1Arg2;
    locals[1].type = CN1_TYPE_OBJECT;
    ...
    if (locals[0].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L950625683;
    __CN1_DEBUG_INFO(282);
    /* VarOp.assignFrom */     ilocals_4_ = 0 /* ICONST_0 */; 

label_L819027530:
    if (ilocals_4_>=CN1_ARRAY_LENGTH(locals[1].data.o)) /* IF_ICMPGE CustomJump */ goto label_L950625683;
    __CN1_DEBUG_INFO(283);
    if (/* CustomInvoke */virtual_java_lang_String_equals___java_lang_Object_R_boolean(threadStateData, locals[0].data.o, CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_4_))==0) /* IFEQ CustomJump */ goto label_L1576422186;
    __CN1_DEBUG_INFO(284);
    if (locals[2].data.o==JAVA_NULL) /* IFNULL CustomJump */ goto label_L2063309971;
...
JAVA_VOID com_codename1_ui_html_HTMLUtils___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 7830, 859);
    __CN1_DEBUG_INFO(44);
    PUSH_INT(5); /* ICONST_5 */
    SP--;
    ...
    PUSH_INT(0); /* ICONST_0 */
    /* LDC: 'lt'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(7838));
    ...
    PUSH_INT(9);
    /* LDC: 'copy'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(2240));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
    ...
    PUSH_INT(16);
    /* LDC: 'deg'*/
    PUSH_POINTER(STRING_FROM_CONSTANT_POOL_OFFSET(5739));
    CHECK_ARRAY_ACCESS(3, SP[-2].data.i); { /* BC_AASTORE */
    JAVA_OBJECT aastoreTmp = SP[-3].data.o; 
    ((JAVA_ARRAY_OBJECT*) (*(JAVA_ARRAY)aastoreTmp).data)[SP[-2].data.i] = SP[-1].data.o; 
    SP -= 3; }
