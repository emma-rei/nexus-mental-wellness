...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation___INIT_____com_codename1_ui_animations_ComponentAnimation_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 2801, 202);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation___INIT_____com_codename1_ui_animations_ComponentAnimation_1ARRAY_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1, JAVA_BOOLEAN __cn1Arg2) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 3, 0, 2801, 202);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
...
JAVA_BOOLEAN com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(3, 5, 0, 2801, 2792);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(190);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1483997353;
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L1483997353;
    __CN1_DEBUG_INFO(191);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L521114357;
    __CN1_DEBUG_INFO(192);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L521114357:
    __CN1_DEBUG_INFO(194);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))<=get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L1949363603;
    __CN1_DEBUG_INFO(195);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L591853434;
...
label_L1268473253:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1540348659;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(203);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L942961477;
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(4, 5, 0, 2801, 2793);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(212);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1609735819;
...
label_L1643787651:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L2060439492;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_flush__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    volatile JAVA_INT ilocals_2_ = 0; /* v2 */
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    DEFINE_INSTANCE_METHOD_STACK(2, 5, 0, 2801, 931);
...
label_L995161138:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1889348204;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
JAVA_INT com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_getMaxSteps___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(2, 6, 0, 2801, 2791);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     __CN1_DEBUG_INFO(230);
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1072016755;
...
label_L374625527:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L260296993;
...
label_L948268398:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L706331499;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_setStep___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    volatile JAVA_INT ilocals_3_ = 0; /* v3 */
    volatile JAVA_INT ilocals_4_ = 0; /* v4 */
    DEFINE_INSTANCE_METHOD_STACK(3, 6, 0, 2801, 2789);
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L698263942;
...
label_L2042575333:
    ...
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L500802478;
    if (virtual_com_codename1_ui_animations_ComponentAnimation_getMaxSteps___R_int(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), ilocals_2_))>ilocals_1_) /* IF_ICMPGT CustomJump */ goto label_L500802478;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(254);
    ...
    goto label_L2042575333;

label_L500802478:
    __CN1_DEBUG_INFO(258);
    if (ilocals_2_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1791149473;
...
label_L1717080658:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L910988262;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
