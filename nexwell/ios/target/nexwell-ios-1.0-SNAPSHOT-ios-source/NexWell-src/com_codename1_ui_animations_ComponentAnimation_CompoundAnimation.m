...
JAVA_BOOLEAN com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_isInProgress___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L303934490;
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L303934490;
    __CN1_DEBUG_INFO(191);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L1838444270;
    __CN1_DEBUG_INFO(192);
    releaseForReturn(threadStateData, cn1LocalsBeginInThread); return 1 /* ICONST_1 */;

label_L1838444270:
    __CN1_DEBUG_INFO(194);
    if (CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))<=get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)) /* IF_ICMPLE CustomJump */ goto label_L601649345;
    __CN1_DEBUG_INFO(195);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)))==0) /* IFEQ CustomJump */ goto label_L1404635097;
...
label_L571267668:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L742067400;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(203);
    if (virtual_com_codename1_ui_animations_ComponentAnimation_isInProgress___R_boolean(threadStateData, locals[4].data.o)==0) /* IFEQ CustomJump */ goto label_L1654056127;
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_updateState__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L957388291;
...
label_L417277601:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1295618213;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
label_L1641587857:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ goto label_L1548063124;
    /* VarOp.assignFrom */ locals[4].type=CN1_TYPE_INVALID;locals[4].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[1].data.o, ilocals_3_);
...
JAVA_INT com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_getMaxSteps___R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1617280183;
...
label_L1909951660:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L32400436;
...
label_L407034937:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L1427067435;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
...
JAVA_VOID com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_setStep___int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_INT __cn1Arg1) {
    ...
    if (get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_sequence(__cn1ThisObject)<=-1 /* ICONST_M1 */) /* IF_ICMPLE CustomJump */ goto label_L1786758337;
...
label_L145823503:
    ...
    if (ilocals_2_>=CN1_ARRAY_LENGTH(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject))) /* IF_ICMPGE CustomJump */ goto label_L654350286;
    if (virtual_com_codename1_ui_animations_ComponentAnimation_getMaxSteps___R_int(threadStateData, CN1_ARRAY_ELEMENT_OBJECT(get_field_com_codename1_ui_animations_ComponentAnimation_CompoundAnimation_anims(__cn1ThisObject), ilocals_2_))>ilocals_1_) /* IF_ICMPGT CustomJump */ goto label_L654350286;
...
locals[4].type=CN1_TYPE_OBJECT;    __CN1_DEBUG_INFO(254);
    ...
    goto label_L145823503;

label_L654350286:
    __CN1_DEBUG_INFO(258);
    if (ilocals_2_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L110932276;
...
label_L827092873:
    if (ilocals_4_>=ilocals_3_) /* IF_ICMPGE CustomJump */ goto label_L307307754;
    /* VarOp.assignFrom */ locals[5].type=CN1_TYPE_INVALID;locals[5].data.o=CN1_ARRAY_ELEMENT_OBJECT(locals[2].data.o, ilocals_4_);
