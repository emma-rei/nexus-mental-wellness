...
JAVA_VOID com_codename1_components_Switch_3___INIT_____com_codename1_components_Switch(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    DEFINE_INSTANCE_METHOD_STACK(2, 2, 0, 10663, 201);
...
JAVA_BOOLEAN com_codename1_components_Switch_3_dragWasActuallyATap___R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(4, 1, 0, 10663, 10664);
...
JAVA_VOID com_codename1_components_Switch_3_actionPerformed___com_codename1_ui_events_ActionEvent(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    DEFINE_INSTANCE_METHOD_STACK(5, 3, 0, 10663, 3047);
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     locals[1].data.o = __cn1Arg1;
    locals[1].type = CN1_TYPE_OBJECT;
    __CN1_DEBUG_INFO(724);
    if (/* CustomInvoke */com_codename1_components_Switch_access$600___com_codename1_components_Switch_R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1980711696;
...
label_L1980711696:
    ...
    if (com_codename1_components_Switch_3_dragWasActuallyATap___R_boolean(threadStateData, __cn1ThisObject)!=0) /* IFNE CustomJump */ goto label_L1000179138;
    if (/* CustomInvoke */com_codename1_components_Switch_access$000___com_codename1_components_Switch_R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1000179138;
    __CN1_DEBUG_INFO(730);
    if (/* CustomInvoke */com_codename1_components_Switch_access$200___com_codename1_components_Switch_R_int(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))<=0) /* IFLE CustomJump */ goto label_L1709501349;
    __CN1_DEBUG_INFO(731);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(732);
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L125745007;
...
label_L199582547:
    ...
    if (/* CustomInvoke */com_codename1_components_Switch_access$200___com_codename1_components_Switch_R_int(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))<=(ilocals_2_ / 2 /* ICONST_2 */)) /* IF_ICMPLE CustomJump */ goto label_L1551979640;
...
label_L1551979640:
    ...
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L1825389809;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1709501349:
    ...
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1434389049;
...
label_L1347456723:
    ...
    SP-=2; if((*SP).data.i <= SP[1].data.i) /* IF_ICMPLE */ goto label_L221355308;
    __CN1_DEBUG_INFO(750);
    PUSH_POINTER(get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject));
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))!=0) /* IFNE CustomJump */ goto label_L598529374;
    PUSH_INT(1); /* ICONST_1 */
...
label_L1000179138:
    ...
    if (/* CustomInvoke */com_codename1_components_Switch_access$1100___com_codename1_components_Switch_R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1526997578;
    __CN1_DEBUG_INFO(757);
    /* VarOp.assignFrom */     ilocals_2_ = 0 /* ICONST_0 */; 
    __CN1_DEBUG_INFO(758);
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L507972177;
...
label_L1526997578:
    ...
    if (virtual_com_codename1_components_Switch_isRTL___R_boolean(threadStateData, get_field_com_codename1_components_Switch_3_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ goto label_L1534611222;
