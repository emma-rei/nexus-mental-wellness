...
JAVA_BOOLEAN java_lang_Short_equals___java_lang_Object_R_boolean(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    PUSH_OBJ(tmpResult); }
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ goto label_L1648582256;
    if (get_field_java_lang_Short_value(locals[1].data.o)!=get_field_java_lang_Short_value(__cn1ThisObject)) /* IF_ICMPNE CustomJump */ goto label_L1648582256;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L865858182;
...
JAVA_INT java_lang_Short_compareTo___java_lang_Short_R_int(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject, JAVA_OBJECT __cn1Arg1) {
    ...
    goto label_L647973805;

label_L951988316:
    if (get_field_java_lang_Short_value(__cn1ThisObject)<=get_field_java_lang_Short_value(locals[1].data.o)) /* IF_ICMPLE CustomJump */ goto label_L1591161296;
    PUSH_INT(1); /* ICONST_1 */
    goto label_L647973805;
