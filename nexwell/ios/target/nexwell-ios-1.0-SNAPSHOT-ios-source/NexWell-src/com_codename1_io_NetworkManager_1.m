...
JAVA_VOID com_codename1_io_NetworkManager_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL280250507cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL280250507cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L280250507cn1_class_id_java_lang_InterruptedException1, label_L1671164933, restoreToL280250507cn1_class_id_java_lang_InterruptedException1);
    int restoreToL229209479cn1_class_id_java_lang_InterruptedException2;
    int tryBlockOffsetL229209479cn1_class_id_java_lang_InterruptedException2;
    DEFINE_CATCH_BLOCK(catch_L229209479cn1_class_id_java_lang_InterruptedException2, label_L249200083, restoreToL229209479cn1_class_id_java_lang_InterruptedException2);

label_L518072030:
    __CN1_DEBUG_INFO(528);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L165128275, 0);

label_L280250507:
 tryBlockOffsetL280250507cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L280250507cn1_class_id_java_lang_InterruptedException1);
    restoreToL280250507cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L1908839976:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L1304522697, 0);
...
label_L1912973495:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L271099719, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L612958241, 0);
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeout___R_int(threadStateData, locals[4].data.o)>=0) /* IFGE CustomJump */ JUMP_TO(label_L1631298894, 0);
...
label_L1631298894:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L612958241, 0);
...
label_L229209479:
 tryBlockOffsetL229209479cn1_class_id_java_lang_InterruptedException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L229209479cn1_class_id_java_lang_InterruptedException2);
    restoreToL229209479cn1_class_id_java_lang_InterruptedException2 = threadStateData->threadObjectStackOffset;
...
label_L658645383:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(4);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L612958241, 0);
    __CN1_DEBUG_INFO(559);
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L612958241, 0);
    __CN1_DEBUG_INFO(561);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L612958241, 0);
...
label_L612958241:
    __CN1_DEBUG_INFO(540);
    BC_IINC(3, 1);
    JUMP_TO(label_L1912973495, 0);

label_L271099719:
    __CN1_DEBUG_INFO(570);
    JUMP_TO(label_L518072030, 0);
