...
JAVA_VOID com_codename1_io_NetworkManager_1_run__(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    ...
    locals[0].data.o = __cn1ThisObject; locals[0].type = CN1_TYPE_OBJECT;     int restoreToL42153992cn1_class_id_java_lang_InterruptedException1;
    int tryBlockOffsetL42153992cn1_class_id_java_lang_InterruptedException1;
    DEFINE_CATCH_BLOCK(catch_L42153992cn1_class_id_java_lang_InterruptedException1, label_L658645383, restoreToL42153992cn1_class_id_java_lang_InterruptedException1);
    int restoreToL422135638cn1_class_id_java_lang_InterruptedException2;
    int tryBlockOffsetL422135638cn1_class_id_java_lang_InterruptedException2;
    DEFINE_CATCH_BLOCK(catch_L422135638cn1_class_id_java_lang_InterruptedException2, label_L1912973495, restoreToL422135638cn1_class_id_java_lang_InterruptedException2);

label_L1072499716:
    __CN1_DEBUG_INFO(528);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L518072030, 0);

label_L42153992:
 tryBlockOffsetL42153992cn1_class_id_java_lang_InterruptedException1 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L42153992cn1_class_id_java_lang_InterruptedException1);
    restoreToL42153992cn1_class_id_java_lang_InterruptedException1 = threadStateData->threadObjectStackOffset;
...
label_L583852441:
    ...
    if (locals[1].data.o!=JAVA_NULL) /* IFNONNULL CustomJump */ JUMP_TO(label_L347386462, 0);
...
label_L1019562230:
    if (ilocals_3_>=ilocals_2_) /* IF_ICMPGE CustomJump */ JUMP_TO(label_L1269555311, 0);
    ...
    if (locals[4].data.o==JAVA_NULL) /* IFNULL CustomJump */ JUMP_TO(label_L1550575634, 0);
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeout___R_int(threadStateData, locals[4].data.o)>=0) /* IFGE CustomJump */ JUMP_TO(label_L435030575, 0);
...
label_L435030575:
    ...
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1550575634, 0);
...
label_L422135638:
 tryBlockOffsetL422135638cn1_class_id_java_lang_InterruptedException2 = threadStateData->tryBlockOffset;
    BEGIN_TRY(cn1_class_id_java_lang_InterruptedException, catch_L422135638cn1_class_id_java_lang_InterruptedException2);
    restoreToL422135638cn1_class_id_java_lang_InterruptedException2 = threadStateData->threadObjectStackOffset;
...
label_L679046414:
    ...
    PUSH_OBJ(tmpResult); }
    BC_ALOAD(4);
    SP-=2; if((*SP).data.o != SP[1].data.o) /* IF_ACMPNE */ JUMP_TO(label_L1550575634, 0);
    __CN1_DEBUG_INFO(559);
    if (virtual_com_codename1_io_ConnectionRequest_getTimeSinceLastActivity___R_int(threadStateData, locals[4].data.o)<=ilocals_5_) /* IF_ICMPLE CustomJump */ JUMP_TO(label_L1550575634, 0);
    __CN1_DEBUG_INFO(561);
    if (/* CustomInvoke */com_codename1_io_NetworkManager_access$700___com_codename1_io_NetworkManager_R_boolean(threadStateData, get_field_com_codename1_io_NetworkManager_1_this_0(__cn1ThisObject))==0) /* IFEQ CustomJump */ JUMP_TO(label_L1550575634, 0);
