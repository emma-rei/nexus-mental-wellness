...
JAVA_VOID com_codename1_util_Base64___INIT____(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT  __cn1ThisObject) {
    DEFINE_INSTANCE_METHOD_STACK(1, 1, 0, 8135, 201);
...
JAVA_OBJECT com_codename1_util_Base64_decode___byte_1ARRAY_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(2, 1, 0, 8135, 1963);
...
JAVA_OBJECT com_codename1_util_Base64_decode___byte_1ARRAY_int_R_byte_1ARRAY(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1, JAVA_INT __cn1Arg2) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(5, 11, 0, 8135, 1963);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
    ...
    __CN1_DEBUG_INFO(44);
    if (ilocals_2_!=0) /* IFNE CustomJump */ goto label_L1152013701;
    __CN1_DEBUG_INFO(45);
    PUSH_INT(0); /* ICONST_0 */
...
label_L843251829:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L1090329208;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L87785224;
    __CN1_DEBUG_INFO(59);
    goto label_L1090329208;
...
label_L87785224:
    ...
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L609447687;
    __CN1_DEBUG_INFO(62);
    BC_IINC(4, 1);
...
label_L1483869881:
    if (ilocals_10_>=ilocals_1_) /* IF_ICMPGE CustomJump */ goto label_L440787615;
    __CN1_DEBUG_INFO(76);
    ...
    SP++;
    PUSH_INT(61);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1146621408;
    __CN1_DEBUG_INFO(78);
    goto label_L440787615;
...
label_L1146621408:
    ...
    SP++;
    PUSH_INT(10);
    SP-=2; if((*SP).data.i == SP[1].data.i) /* IF_ICMPEQ */ goto label_L2068609339;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(13);
    ...
    SP++;
    PUSH_INT(9);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1369874063;
    __CN1_DEBUG_INFO(83);
    goto label_L2068609339;
...
label_L1369874063:
    ...
    SP++;
    PUSH_INT(65);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L1682100030;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(90);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L1682100030;
    __CN1_DEBUG_INFO(89);
    /* VarOp.assignFrom */ ilocals_8_=(ilocals_5_ - 65);
    goto label_L1626470747;
...
label_L1682100030:
    ...
    SP++;
    PUSH_INT(97);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L2020393439;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(122);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L2020393439;
    __CN1_DEBUG_INFO(94);
...
label_L2020393439:
    ...
    SP++;
    PUSH_INT(48);
    SP-=2; if((*SP).data.i < SP[1].data.i) /* IF_ICMPLT */ goto label_L500918971;
    (*SP).type = CN1_TYPE_INT; /* ILOAD */ 
    (*SP).data.i = ilocals_5_; 
    SP++;
    PUSH_INT(57);
    SP-=2; if((*SP).data.i > SP[1].data.i) /* IF_ICMPGT */ goto label_L500918971;
    __CN1_DEBUG_INFO(99);
...
label_L500918971:
    ...
    SP++;
    PUSH_INT(43);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L1871867137;
...
label_L1871867137:
    ...
    SP++;
    PUSH_INT(47);
    SP-=2; if((*SP).data.i != SP[1].data.i) /* IF_ICMPNE */ goto label_L13007497;
...
label_L1626470747:
    ...
    if ((ilocals_7_ % 4/* ICONST_4 */)!=3 /* ICONST_3 */) /* IF_ICMPNE CustomJump */ goto label_L507126135;
...
label_L2068609339:
    __CN1_DEBUG_INFO(75);
    BC_IINC(10, 1);
    goto label_L1483869881;

label_L440787615:
    __CN1_DEBUG_INFO(117);
    if (ilocals_4_<=0) /* IFLE CustomJump */ goto label_L611621587;
    ...
    if (ilocals_4_!=1 /* ICONST_1 */) /* IF_ICMPNE CustomJump */ goto label_L611621587;
...
JAVA_OBJECT com_codename1_util_Base64_encodeNoNewline___byte_1ARRAY_R_java_lang_String(CODENAME_ONE_THREAD_STATE, JAVA_OBJECT __cn1Arg1) {
    ...
    __STATIC_INITIALIZER_com_codename1_util_Base64(threadStateData);
    DEFINE_METHOD_STACK(7, 6, 0, 8135, 8136);
    locals[0].data.o = __cn1Arg1;
    locals[0].type = CN1_TYPE_OBJECT;
...
label_L1072899931:
    if (ilocals_4_>=ilocals_5_) /* IF_ICMPGE CustomJump */ goto label_L485807188;
...
label_L485807188:
    ...
    SP--;
    switch((*SP).data.i) {
        case 1: goto label_L1675625850;
        case 2: goto label_L1534507153;
        default: goto label_L1629131231;
    }
...
JAVA_VOID com_codename1_util_Base64___CLINIT____(CODENAME_ONE_THREAD_STATE) {
    DEFINE_METHOD_STACK(4, 0, 0, 8135, 859);
