...
void __STATIC_INITIALIZER_com_codename1_ui_TextHolder(CODENAME_ONE_THREAD_STATE) {
    ...
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_nexus_nexwell_components_CircleProgress] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_nexus_nexwell_components_CircleProgress][0] = 334;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_nexus_nexwell_components_CircleProgress][1] = 335;
    ...
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_SpanLabel][0] = 418;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_SpanLabel][1] = 419;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_MultiButton] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_MultiButton][0] = 429;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_MultiButton][1] = 430;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_SpanButton] = malloc(sizeof(int*) * 14);
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_SpanButton][0] = 429;
    classToInterfaceMap_com_codename1_ui_TextHolder[cn1_class_id_com_codename1_components_SpanButton][1] = 430;
